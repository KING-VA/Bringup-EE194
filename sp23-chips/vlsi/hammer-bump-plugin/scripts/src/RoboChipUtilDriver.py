...
from BumpInfo import robo_table
...
chip_power = f"{gen_file_path}/Robo-power"
...
boom_cpf = f"{chip_power}/boom.cpf"
out_file_path_yaml = f"{gen_file_path}/robo-design-gen.yml"
rocket_1_cpf = f"{chip_power}/rocket_1.cpf"
...
if GEN_CPF:
  ...
  gen_util.create_cpf(boom_cpf, "BoomTile", "PD1", "0.85", boom_supply_list, gnd_list)
  gen_util.create_cpf(scheduler_cpf, "Scheduler", "PD1", "0.85", scheduler_supply_list, gnd_list)
  gen_util.create_cpf(rocket_1_cpf, "RocketTile_1", "PD1", "0.85", rocket_1_supply_list, gnd_list)
...
if GEN_DESIGN_JSON:
  with open(out_file_path_yaml, 'w+') as f:
      #f.write(json.dumps(gen_ir, indent=2))
