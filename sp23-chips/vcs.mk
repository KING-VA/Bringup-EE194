...
PREPROC_DEFINES += +define+INTEL_NO_PWR_PINS
PREPROC_DEFINES += +define+INTEL_EMULATION
PREPROC_DEFINES += -sverilog 
PREPROC_DEFINES += +define+ip2211ringpll_SVA_OFF 
PREPROC_DEFINES += +define+ip2211ringpll_INTC_NO_PWR_PINS 