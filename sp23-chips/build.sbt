...
lazy val `bearly-nearmem` = (project in file("generators/bearly-near-mem"))
...
lazy val chipyard = (project in file("generators/chipyard"))
  .dependsOn(testchipip, rocketchip, boom, hwacha, sifive_blocks, sifive_cache, iocell,
    ...
    constellation, mempress, spaccel, spaccel_reserve, kalman, bar_prefetchers, lqr)
  .dependsOn(`bearly-nearmem`)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(commonSettings)

lazy val spaccel = (project in file ("generators/sp-accel"))
  .dependsOn(rocketchip)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(commonSettings)

lazy val spaccel_reserve = (project in file ("generators/sp-accel-reserve"))
  .dependsOn(rocketchip)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(commonSettings)
...
lazy val kalman = (project in file("generators/kalman"))
  .dependsOn(rocketchip)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .settings(chiselTestSettings)
  .settings(commonSettings)
...
lazy val lqr = (project in file("generators/lqr-rocc"))
  .settings(commonSettings)
  .settings(libraryDependencies ++= rocketLibDeps.value)
  .dependsOn(rocketchip)
