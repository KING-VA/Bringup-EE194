...
class DigitalTop(implicit p: Parameters) extends ChipyardSystem
  ...
  with prefetchers.CanHavePeripheryPrefetcher //Enables MMIO controlled prefetchers (on/off switch)
  ...
  with bearlynearmem.CanHavePeripheryNearMemDMA
{
...
class DigitalTopModule[+L <: DigitalTop](l: L) extends ChipyardSystemModule(l)
  ...
  with prefetchers.CanHavePeripheryPrefetcherModuleImp
