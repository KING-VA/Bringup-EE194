...
class DromajoBoomConfig extends Config(
  ...
  class MediumMTEBoomConfig extends Config(
  new boom.common.WithBoomSmallBPD ++
  new boom.common.WithBoomMemtracePrintf ++
  new boom.common.WithBoomCommitLogPrintf ++
  new boom.common.WithBoomMTE(mteRegions = List(
