...
class AbstractConfig extends Config(
  ...
  //new chipyard.iobinders.WithGPIOCells ++		// These signals rely on DigitalGPIO which are handled differently with DummyIO; replaced with DummyIO variants
	//new chipyard.iobinders.WithSPIIOCells ++ 	// These signals rely on DigitalGPIO which are handled differently with DummyIO; replaced with DummyIO variants
  new chipyard.WithDummyGPIOCells ++
  new chipyard.WithDummySPIIOCells ++
