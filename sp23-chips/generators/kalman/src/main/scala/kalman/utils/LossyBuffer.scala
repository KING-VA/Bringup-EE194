 ...
 *
 * @param gen the type of data to buffer
 * @param flow true if the data should be available on the same cycle (the input and
 * output are combinatorially coupled)
 * @note source: https://github.com/ethanwu10/chisel-utils/
 */
