...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/DDR4_altera_emif_arch_fm_191_tcgrhxq_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
DDR4_altera_emif_arch_fm_191_tcgrhxq_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_DDR4_altera_emif_arch_fm_191_tcgrhxq_corename}"
   } else {
      set fbasename "${::GLOBAL_DDR4_altera_emif_arch_fm_191_tcgrhxq_corename}_${inst_id}"
   }
   ...
   DDR4_altera_emif_arch_fm_191_tcgrhxq_perform_core_analysis $opcname $inst pins var summary


   set summary [lsort -command DDR4_altera_emif_arch_fm_191_tcgrhxq_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_DDR4_altera_emif_arch_fm_191_tcgrhxq_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ DDR4_altera_emif_arch_fm_191_tcgrhxq_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ DDR4_altera_emif_arch_fm_191_tcgrhxq_round_3dp $hold]
      }
