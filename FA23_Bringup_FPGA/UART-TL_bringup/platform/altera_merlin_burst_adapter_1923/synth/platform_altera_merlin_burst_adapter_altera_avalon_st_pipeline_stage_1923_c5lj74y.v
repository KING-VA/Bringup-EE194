// platform_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_c5lj74y.v

// Generated using ACDS version 22.4 94

`timescale 1 ps / 1 ps
module platform_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1923_c5lj74y #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 681,
	...
	platform_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 681,          .data
		...
		.out_data          (out_data),          //  output,  width = 681,          .data
