...
module TLAtomicAutomata_1(
  ...
  wire [3:0]      _GEN = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16]};	// @[Parameters.scala:137:45]
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & _GEN == 4'h0 : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & _GEN == 4'h0;	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Bundles.scala:259:74, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :670:56]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[15:12];	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_address = {_RANDOM_0[31:16], _RANDOM_1[11:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        ...
        d_first_counter = _RANDOM_6[15:7];	// @[Arbiter.scala:88:30, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
