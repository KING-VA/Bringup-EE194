...
module TLXbar_9(
  ...
  assign auto_in_a_ready = auto_in_a_bits_address[28] & auto_out_0_a_ready | ~(auto_in_a_bits_address[28]) & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65]
  assign auto_in_d_valid = out_9_valid;	// @[Arbiter.scala:126:29]
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_1};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_param = muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 4'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_sink = muxStateEarly_0 & auto_out_0_d_bits_sink;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
