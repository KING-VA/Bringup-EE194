...
module TLXbar_6(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        ...
        beatsLeft <= beatsLeft - {2'h0, auto_in_d_ready & out_9_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, Bundles.scala:259:74, ReadyValidCancel.scala:49:33]
  ...
  assign auto_in_a_ready = auto_in_a_bits_address[31] & auto_out_0_a_ready | ~(auto_in_a_bits_address[31]) & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65]
  ...
  assign auto_in_d_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 5'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 5'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
