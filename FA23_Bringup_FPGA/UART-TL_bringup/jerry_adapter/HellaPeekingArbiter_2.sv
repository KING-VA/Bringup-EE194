...
module HellaPeekingArbiter_2(
  ...
  input  [3:0]  io_in_4_bits_size,
                io_in_4_bits_source,
  input  [34:0] io_in_4_bits_address,
  ...
  wire [2:0][7:0]  _GEN = '{8'h0, 8'h0, 8'h0};	// @[Arbiters.scala:43:16]
  wire [2:0]       _GEN_0 = '{1'h0, 1'h0, 1'h0};	// @[Arbiters.scala:43:16]
  wire [2:0][63:0] _GEN_1 = '{64'h0, 64'h0, 64'h0};	// @[Arbiters.scala:43:16]
  wire [2:0][34:0] _GEN_2 = '{35'h0, 35'h0, 35'h0};	// @[Arbiters.scala:43:16]
  wire [2:0][3:0]  _GEN_3 = '{4'h0, 4'h0, 4'h0};	// @[Arbiters.scala:43:16]
  ...
  wire [7:0]       _GEN_6 = {_GEN_0, {{io_in_4_valid}, {1'h0}, {1'h0}, {io_in_1_valid}, {1'h0}}};	// @[Arbiters.scala:43:16]
  ...
  wire [7:0][2:0]  _GEN_8 = {_GEN_4, {{io_in_4_bits_param}, {3'h0}, {3'h0}, {3'h0}, {3'h0}}};	// @[Arbiters.scala:43:16]
  wire [7:0][3:0]  _GEN_9 = {_GEN_3, {{io_in_4_bits_size}, {4'h0}, {4'h0}, {io_in_1_bits_size}, {4'h0}}};	// @[Arbiters.scala:43:16]
  wire [7:0][3:0]  _GEN_10 = {_GEN_3, {{io_in_4_bits_source}, {4'h0}, {4'h0}, {io_in_1_bits_source}, {4'h0}}};	// @[Arbiters.scala:43:16]
  wire [7:0][34:0] _GEN_11 = {_GEN_2, {{io_in_4_bits_address}, {35'h0}, {35'h0}, {35'h0}, {35'h0}}};	// @[Arbiters.scala:43:16]
  wire [7:0][63:0] _GEN_12 = {_GEN_1, {{io_in_4_bits_data}, {64'h0}, {64'h0}, {io_in_1_bits_data}, {64'h0}}};	// @[Arbiters.scala:43:16]
  wire [7:0]       _GEN_13 = {_GEN_0, {{io_in_4_bits_corrupt}, {1'h0}, {1'h0}, {1'h0}, {1'h0}}};	// @[Arbiters.scala:43:16]
  wire [7:0][7:0]  _GEN_14 = {_GEN, {{io_in_4_bits_union}, {8'h0}, {8'h0}, {8'h0}, {8'h0}}};	// @[Arbiters.scala:43:16]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      locked <= ~_T & locked;	// @[Arbiters.scala:27:23, :59:22, :65:35, Decoupled.scala:51:35]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
