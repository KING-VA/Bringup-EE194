...
module ICache(
  ...
  wire         tag_array_MPORT_en = refill_one_beat & (counter == 9'h1 | beats1 == 9'h0) & auto_master_out_d_valid;	// @[Edges.scala:220:14, :228:27, :231:{25,37,47}, ICache.scala:383:41, :391:37]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = {_RANDOM_3[31:26], _RANDOM_4[2:0]};	// @[Edges.scala:228:27]
        accruedRefillError = _RANDOM_4[3];	// @[Edges.scala:228:27, ICache.scala:420:31]
        vb_array = {_RANDOM_4[31:4], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12[3:0]};	// @[Edges.scala:228:27, ICache.scala:440:25]
