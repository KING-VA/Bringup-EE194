...
module TLToAXI4(
  ...
  Queue_33 deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_34 queue_arw_deq (	// @[Decoupled.scala:375:21]
    .clock                            (clock),
    .reset                            (reset),
  ...
  assign auto_in_d_bits_opcode = {2'h0, r_wins};	// @[Edges.scala:231:25, ToAXI4.scala:218:53, :240:23]
  assign auto_in_d_bits_size = r_wins ? auto_out_r_bits_echo_tl_state_size[2:0] : auto_out_b_bits_echo_tl_state_size[2:0];	// @[Edges.scala:758:15, :774:15, ToAXI4.scala:218:53, :240:23]
