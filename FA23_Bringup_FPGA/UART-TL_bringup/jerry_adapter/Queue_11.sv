...
module Queue_11(
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[27:14];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[35:28];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[99:36];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[100];	// @[Decoupled.scala:273:95]
endmodule
