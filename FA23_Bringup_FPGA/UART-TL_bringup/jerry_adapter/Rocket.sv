...
module Rocket(
  ...
  wire [39:0]      _mem_npc_T_4 = mem_ctrl_jalr | mem_reg_sfence ? {mem_reg_wdata[63:39] == 25'h0 | (&(mem_reg_wdata[63:39])) ? mem_reg_wdata[39] : ~(mem_reg_wdata[38]), mem_reg_wdata[38:0]} : _mem_br_target_T_10;	// @[Cat.scala:33:92, RocketCore.scala:211:21, :243:27, :251:26, :578:41, :582:{21,36}, :1096:17, :1097:{18,21,29,34,46,51,54}, :1098:16, pla.scala:114:39]
  ...
  wire             _T_138 = dmem_resp_replay & ~(io_dmem_resp_bits_tag[0]);	// @[RocketCore.scala:729:{23,45}, :733:42, :748:26]
  assign _GEN = ~_T_138 & ~wb_wxd;	// @[RocketCore.scala:721:29, :735:{21,24}, :748:{26,44}, :749:23]
  wire [4:0]       ll_waddr = _T_138 ? io_dmem_resp_bits_tag[5:1] : _div_io_resp_bits_tag;	// @[RocketCore.scala:474:19, :731:46, :737:29, :748:{26,44}, :752:14]
  wire             ll_wen = _T_138 | _GEN & _div_io_resp_valid;	// @[Decoupled.scala:51:35, RocketCore.scala:474:19, :735:21, :738:27, :748:{26,44}, :749:23, :753:12]
  ...
  wire [63:0]      coreMonitorBundle_wrdata = dmem_resp_valid & ~(io_dmem_resp_bits_tag[0]) ? io_dmem_resp_bits_data : ll_wen ? _div_io_resp_bits_data : (|wb_ctrl_csr) ? _csr_io_rw_rdata : wb_reg_wdata;	// @[RocketCore.scala:212:20, :270:25, :308:19, :474:19, :729:{23,45}, :732:44, :738:27, :748:44, :753:12, :760:{21,38}, :761:21, :762:{21,34}]
  ...
  wire             _T_145 = (|_id_ctrl_decoder_decoded_orMatrixOutputs_T_55) & (|_ibuf_io_inst_0_bits_inst_rs1);	// @[Cat.scala:33:92, RocketCore.scala:279:20, :816:{42,55}, pla.scala:114:39]
  wire             _T_147 = (|_id_ctrl_decoder_decoded_orMatrixOutputs_T_57) & (|_ibuf_io_inst_0_bits_inst_rs2);	// @[Cat.scala:33:92, RocketCore.scala:279:20, :817:{42,55}, pla.scala:114:39]
  wire             _T_149 = (|_id_ctrl_decoder_decoded_orMatrixOutputs_T_10) & (|_ibuf_io_inst_0_bits_inst_rd);	// @[Cat.scala:33:92, RocketCore.scala:279:20, :818:{42,55}, pla.scala:114:39]
  ...
  wire             data_hazard_mem = mem_ctrl_wxd & (_T_145 & _fp_data_hazard_mem_T_1 | _T_147 & _fp_data_hazard_mem_T_3 | _T_149 & _fp_data_hazard_mem_T_7);	// @[RocketCore.scala:211:21, :400:82, :816:42, :817:42, :818:42, :845:{38,72}, :1090:{27,50}]
  ...
  wire [31:0]      _T_153 = r & ~(ll_wen ? 32'h1 << ll_waddr : 32'h0);	// @[RocketCore.scala:737:29, :738:27, :748:44, :752:14, :753:12, :1104:{62,64}, :1109:40, :1112:{49,58}]
  wire             _T_155 = wb_set_sboard & wb_wen;	// @[RocketCore.scala:722:53, :757:25, :832:28]
  ...
  always @(posedge clock) begin
    id_reg_pause <= ~(_csr_io_time[4:0] == 5'h0 | _csr_io_inhibit_cycle | io_dmem_perf_release | take_pc_mem_wb) & (~ctrl_killd & (&_id_ctrl_decoder_decoded_T_10) & _ibuf_io_inst_0_bits_inst_bits[23:20] == 4'h0 | id_reg_pause);	// @[Cat.scala:33:92, RocketCore.scala:124:25, :275:35, :279:20, :308:19, :343:33, :488:19, :493:22, :499:{42,51,66}, :886:104, :967:{28,62,118}, :968:{18,33}, pla.scala:98:74]
    ...
    if (ctrl_killd) begin	// @[RocketCore.scala:886:104]
      ...
      ex_reg_flush_pipe <= (&_id_ctrl_decoder_decoded_T_52) | id_system_insn | id_csr_en & ~id_csr_ren & _csr_io_decode_0_write_flush;	// @[Cat.scala:33:92, RocketCore.scala:219:35, :308:19, :310:36, :311:54, :313:{54,66}, :516:42, package.scala:73:59, pla.scala:98:74]
    ...
    if (_T_69 | ~(ex_pc_valid & ex_ctrl_rxs2 & (ex_ctrl_mem | ex_ctrl_rocc | ex_sfence))) begin	// @[RocketCore.scala:210:20, :252:24, :559:51, :568:44, :601:{23,46}, :603:28, :633:{56,71}, :635:19]
      ...
      mem_reg_rs2 <= _GEN_6[ex_ctrl_rocc ? 2'h3 : ex_reg_mem_size];	// @[AMOALU.scala:27:{13,19}, Mux.scala:47:70, RocketCore.scala:210:20, :224:28, :252:24, :634:21]
    ...
    if (reset) begin
      ...
      id_reg_fence <= ~ctrl_killd & ((&_id_ctrl_decoder_decoded_T_10) | (|_id_ctrl_decoder_decoded_orMatrixOutputs_T_2) & _ibuf_io_inst_0_bits_inst_bits[26]) | id_mem_busy & id_reg_fence;	// @[Cat.scala:33:92, RocketCore.scala:279:20, :300:29, :340:29, :344:{37,52}, :345:38, :346:{23,38}, :488:19, :493:22, :500:{26,41}, :886:104, pla.scala:98:74, :114:39]
      if (ll_wen | _T_155)	// @[RocketCore.scala:738:27, :748:44, :753:12, :832:28, :1115:17]
        _r <= _T_153 | (_T_155 ? _id_stall_fpu_T_3 : 32'h0);	// @[RocketCore.scala:832:28, :1103:60, :1104:62, :1108:29, :1112:{49,58}]
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_165 = wb_ctrl_rxs1 | wb_ctrl_rfs1;	// @[RocketCore.scala:212:20, :1043:27]
    wire         _T_169 = wb_ctrl_rxs2 | wb_ctrl_rfs2;	// @[RocketCore.scala:212:20, :1045:27]
  ...
  CSRFile csr (	// @[RocketCore.scala:308:19]
    ...
    .io_tval                    (wb_xcpt & (~wb_reg_xcpt | wb_reg_cause == 64'h3 | wb_reg_cause == 64'h1 | wb_reg_cause == 64'hC | _csr_io_htval_htval_valid_imem_T | wb_reg_cause == 64'h2) ? {wb_reg_wdata[63:39] == 25'h0 | (&(wb_reg_wdata[63:39])) ? wb_reg_wdata[39] : ~(wb_reg_wdata[38]), wb_reg_wdata[38:0]} : 40'h0),	// @[Cat.scala:33:92, RocketCore.scala:258:35, :261:35, :270:25, :782:24, :785:32, :786:{28,46}, :788:21, :1081:26, :1096:17, :1097:{18,21,29,34,46,51,54}, :1098:16, package.scala:16:47, pla.scala:114:39]
  ...
  assign io_dmem_req_bits_addr = {ex_rs_0[63:39] == 25'h0 | (&(ex_rs_0[63:39])) ? _alu_io_adder_out[39] : ~(_alu_io_adder_out[38]), _alu_io_adder_out[38:0]};	// @[Cat.scala:33:92, RocketCore.scala:408:14, :418:19, :1096:17, :1097:{18,21,29,34,46,51,54}, :1098:16, pla.scala:114:39]
  ...
  assign io_fpu_valid = ~ctrl_killd & (|_id_ctrl_decoder_decoded_orMatrixOutputs_T_63);	// @[Cat.scala:33:92, RocketCore.scala:488:19, :886:104, :930:31, pla.scala:114:39]
