...
module TLAtomicAutomata(
  ...
  reg  [3:0]      cam_a_0_bits_source;	// @[AtomicAutomata.scala:79:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_source = _RANDOM_0[14:11];	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_address = _RANDOM_0[29:15];	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_mask = {_RANDOM_0[31:30], _RANDOM_1[5:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_data = {_RANDOM_1[31:6], _RANDOM_2, _RANDOM_3[5:0]};	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_corrupt = _RANDOM_3[6];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_fifoId = _RANDOM_3[7];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_lut = _RANDOM_3[11:8];	// @[AtomicAutomata.scala:79:24]
        cam_d_0_data = {_RANDOM_3[31:12], _RANDOM_4, _RANDOM_5[11:0]};	// @[AtomicAutomata.scala:79:24, :80:24]
        cam_d_0_denied = _RANDOM_5[12];	// @[AtomicAutomata.scala:80:24]
        cam_d_0_corrupt = _RANDOM_5[13];	// @[AtomicAutomata.scala:80:24]
        beatsLeft = _RANDOM_5[16:14];	// @[Arbiter.scala:88:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_5[17];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
        state_1 = _RANDOM_5[18];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
        d_first_counter = _RANDOM_5[21:19];	// @[AtomicAutomata.scala:80:24, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? cam_a_0_bits_source : 4'h0) | (muxStateEarly_1 ? auto_in_a_bits_source : 4'h0);	// @[Arbiter.scala:118:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
