...
module DCache(
  ...
  wire [1:0]       _GEN_50 = tlb_mpu_ppn[16:15] ^ 2'h2;	// @[Parameters.scala:137:31, TLB.scala:186:28, :399:20]
  wire [1:0]       _GEN_51 = tlb_mpu_ppn[5:4] ^ 2'h2;	// @[Cat.scala:33:92, Parameters.scala:137:31, TLB.scala:186:28, :399:20]
  wire             tlb_legal_address = tlb_mpu_ppn == 28'h3 | tlb_mpu_ppn == 28'h4 | tlb_mpu_ppn[27:14] == 14'h3 | tlb_mpu_ppn[27:4] == 24'h200 | tlb_mpu_ppn[27:4] == 24'h1 | tlb_mpu_ppn == 28'h100 | tlb_mpu_ppn == 28'h110 | tlb_mpu_ppn[27:16] == 12'h8 | tlb_mpu_ppn == 28'h10000 | tlb_mpu_ppn[27:4] == 24'h2;	// @[Cat.scala:33:92, Parameters.scala:137:{31,65}, TLB.scala:399:20, :410:67]
  wire [1:0]       _GEN_52 = {~(tlb_mpu_ppn[19]), tlb_mpu_ppn[16]};	// @[Cat.scala:33:92, Parameters.scala:137:{31,45}, TLB.scala:399:20]
  wire             tlb_newEntry_c = tlb_legal_address & ({tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], tlb_mpu_ppn[13], tlb_mpu_ppn[8], _GEN_51[1]} == 6'h0 | {tlb_mpu_ppn[19], _GEN_50, tlb_mpu_ppn[13], tlb_mpu_ppn[8], tlb_mpu_ppn[5]} == 6'h0 | _GEN_52 == 2'h0);	// @[Cat.scala:33:92, DCache.scala:431:98, Parameters.scala:137:{31,45,65}, :615:89, TLB.scala:399:20, :410:67, :413:19]
  wire             tlb_newEntry_pr = tlb_legal_address & _tlb_pmp_io_r;	// @[TLB.scala:403:19, :410:67, :419:66]
  wire [5:0]       _GEN_53 = {tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], tlb_mpu_ppn[8], tlb_mpu_ppn[5:4]};	// @[Cat.scala:33:92, Parameters.scala:137:45, TLB.scala:399:20]
  wire [5:0]       _GEN_54 = {tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], tlb_mpu_ppn[13], ~(tlb_mpu_ppn[8]), tlb_mpu_ppn[5]};	// @[Cat.scala:33:92, Parameters.scala:137:{31,45}, TLB.scala:399:20]
  wire [2:0]       _GEN_55 = {tlb_mpu_ppn[19], tlb_mpu_ppn[16:15] ^ 2'h1};	// @[Cat.scala:33:92, Parameters.scala:137:{31,45}, TLB.scala:399:20, package.scala:16:47]
  wire [6:0]       _GEN_56 = {tlb_mpu_ppn[19], _GEN_50, tlb_mpu_ppn[13], tlb_mpu_ppn[8], tlb_mpu_ppn[5:4]};	// @[Cat.scala:33:92, Parameters.scala:137:{31,45}, TLB.scala:399:20]
  wire             tlb_newEntry_pw = tlb_legal_address & (_GEN_53 == 6'h0 | _GEN_54 == 6'h0 | _GEN_55 == 3'h0 | _GEN_56 == 7'h0 | _GEN_52 == 2'h0) & _tlb_pmp_io_w;	// @[DCache.scala:431:98, Parameters.scala:137:{45,65}, :615:89, Replacement.scala:168:70, TLB.scala:403:19, :410:67, :420:70]
  wire             tlb_newEntry_ppp = tlb_legal_address & (_GEN_53 == 6'h0 | _GEN_54 == 6'h0 | _GEN_55 == 3'h0 | _GEN_56 == 7'h0 | _GEN_52 == 2'h0);	// @[DCache.scala:431:98, Parameters.scala:137:{45,65}, :615:89, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire             tlb_newEntry_pal = tlb_legal_address & (_GEN_53 == 6'h0 | _GEN_54 == 6'h0 | _GEN_55 == 3'h0);	// @[DCache.scala:431:98, Parameters.scala:137:{45,65}, :615:89, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire             tlb_newEntry_paa = tlb_legal_address & (_GEN_53 == 6'h0 | _GEN_54 == 6'h0 | _GEN_55 == 3'h0);	// @[DCache.scala:431:98, Parameters.scala:137:{45,65}, :615:89, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire             tlb_newEntry_px = tlb_legal_address & ({tlb_mpu_ppn[19], tlb_mpu_ppn[15], tlb_mpu_ppn[13], tlb_mpu_ppn[8], tlb_mpu_ppn[5:4], tlb_mpu_ppn[2]} == 7'h0 | {tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], tlb_mpu_ppn[13], tlb_mpu_ppn[8], tlb_mpu_ppn[5:4] ^ 2'h1} == 7'h0 | {tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], tlb_mpu_ppn[13], tlb_mpu_ppn[8], _GEN_51} == 7'h0 | _GEN_52 == 2'h0) & _tlb_pmp_io_x;	// @[Cat.scala:33:92, Parameters.scala:137:{31,45,65}, :615:89, Replacement.scala:168:70, TLB.scala:399:20, :403:19, :410:67, :424:65, package.scala:16:47]
  wire             tlb_newEntry_eff = tlb_legal_address & ({tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], tlb_mpu_ppn[13], tlb_mpu_ppn[8], tlb_mpu_ppn[5:4], ~(tlb_mpu_ppn[2])} == 8'h0 | {tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], tlb_mpu_ppn[13], ~(tlb_mpu_ppn[8]), tlb_mpu_ppn[5], tlb_mpu_ppn[2]} == 7'h0 | {tlb_mpu_ppn[19], tlb_mpu_ppn[16:15], ~(tlb_mpu_ppn[13]), tlb_mpu_ppn[8], tlb_mpu_ppn[5:4]} == 7'h0 | _GEN_55 == 3'h0);	// @[Cat.scala:33:92, Parameters.scala:137:{31,45,65}, :615:89, Replacement.scala:168:70, TLB.scala:399:20, :410:67, :413:19]
  ...
  wire             _GEN_166 = _T_342 & _T_358 & c_first;	// @[DCache.scala:651:26, :840:102, :856:41, :857:26, Decoupled.scala:51:35, Edges.scala:230:25, package.scala:73:59]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = {_RANDOM_175[31:29], _RANDOM_176[5:0]};	// @[Edges.scala:228:27, Reg.scala:19:16]
        grantInProgress = _RANDOM_176[6];	// @[DCache.scala:644:32, Edges.scala:228:27]
        blockProbeAfterGrantCount = _RANDOM_176[9:7];	// @[DCache.scala:645:42, Edges.scala:228:27]
        blockUncachedGrant = _RANDOM_176[10];	// @[DCache.scala:727:33, Edges.scala:228:27]
        counter_1 = _RANDOM_176[19:11];	// @[Edges.scala:228:27]
        s1_release_data_valid = _RANDOM_176[20];	// @[DCache.scala:778:38, Edges.scala:228:27]
        s2_release_data_valid = _RANDOM_176[21];	// @[DCache.scala:779:38, Edges.scala:228:27]
        io_cpu_s2_xcpt_REG = _RANDOM_176[22];	// @[DCache.scala:909:32, Edges.scala:228:27]
        doUncachedResp = _RANDOM_178[23];	// @[DCache.scala:924:31]
        REG = _RANDOM_178[24];	// @[DCache.scala:924:31, :984:18]
        io_cpu_perf_release_counter = _RANDOM_179[10:2];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_c_bits_param = _T_342 ? ((&s2_victim_state_state) | s2_victim_state_state == 2'h2 ? 3'h1 : s2_victim_state_state == 2'h1 ? 3'h2 : s2_victim_state_state == 2'h0 ? 3'h5 : 3'h0) : _T_337 | _T_336 | ~(~s2_probe | _GEN_32 | ~(|s2_probe_state_state)) ? (_GEN_26 ? 3'h3 : _T_196 ? 3'h4 : _T_192 ? 3'h5 : _T_188 | _T_184 ? 3'h0 : _T_180 ? 3'h4 : _T_176 ? 3'h5 : _T_173 | _T_147 == 4'hA ? 3'h1 : _T_147 == 4'h9 ? 3'h2 : _T_147 == 4'h8 ? 3'h5 : 3'h0) : 3'h5;	// @[Cat.scala:33:92, DCache.scala:310:25, :411:28, :788:17, :801:21, :803:28, :805:36, :807:45, :831:{25,48}, :833:21, :836:48, :837:21, :840:102, :841:52, Metadata.scala:49:45, Misc.scala:37:36, :55:20, Reg.scala:19:16, Replacement.scala:168:70, TLB.scala:186:28, :475:75, package.scala:16:47, :73:59]
