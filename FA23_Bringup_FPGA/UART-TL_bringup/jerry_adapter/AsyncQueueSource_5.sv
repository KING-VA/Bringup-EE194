...
module AsyncQueueSource_5(
  ...
  reg        mem_0;	// @[AsyncQueue.scala:80:16]
  reg        mem_1;	// @[AsyncQueue.scala:80:16]
  reg        mem_2;	// @[AsyncQueue.scala:80:16]
  reg        mem_3;	// @[AsyncQueue.scala:80:16]
  reg        mem_4;	// @[AsyncQueue.scala:80:16]
  reg        mem_5;	// @[AsyncQueue.scala:80:16]
  reg        mem_6;	// @[AsyncQueue.scala:80:16]
  reg        mem_7;	// @[AsyncQueue.scala:80:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        mem_0 = _RANDOM_0[0];	// @[AsyncQueue.scala:80:16]
        mem_1 = _RANDOM_0[1];	// @[AsyncQueue.scala:80:16]
        mem_2 = _RANDOM_0[2];	// @[AsyncQueue.scala:80:16]
        mem_3 = _RANDOM_0[3];	// @[AsyncQueue.scala:80:16]
        mem_4 = _RANDOM_0[4];	// @[AsyncQueue.scala:80:16]
        mem_5 = _RANDOM_0[5];	// @[AsyncQueue.scala:80:16]
        mem_6 = _RANDOM_0[6];	// @[AsyncQueue.scala:80:16]
        mem_7 = _RANDOM_0[7];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_0[11:8];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_0[12];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_0[16:13];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
