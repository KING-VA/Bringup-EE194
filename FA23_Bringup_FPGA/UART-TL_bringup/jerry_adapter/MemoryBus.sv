...
module MemoryBus(
  ...
  wire [4:0]  _coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [1:0]  _picker_auto_in_0_d_bits_param;	// @[ProbePicker.scala:66:28]
  ...
  TLXbar_6 subsystem_mbus_xbar (	// @[MemoryBus.scala:42:32]
    ...
    .auto_out_0_d_bits_param   (_picker_auto_in_0_d_bits_param),	// @[ProbePicker.scala:66:28]
  ...
  ProbePicker picker (	// @[ProbePicker.scala:66:28]
    ...
    .auto_out_0_a_ready        (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_valid        (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_opcode  (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_param   (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_param),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_size    (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_source  (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_denied  (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_denied),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_data    (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_data),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_corrupt (_coupler_to_memory_controller_port_named_tl_mem_auto_tl_in_d_bits_corrupt),	// @[LazyModule.scala:489:27]
  ...
  TLInterconnectCoupler_15 coupler_to_port_named_serial_tl_mem (	// @[LazyModule.scala:489:27]
    .clock                                             (auto_subsystem_mbus_clock_groups_in_member_subsystem_mbus_0_clock),
    .reset                                             (auto_subsystem_mbus_clock_groups_in_member_subsystem_mbus_0_reset),
