...
module TLSerdesser_1(
  ...
  wire        _inDes_io_out_valid;	// @[Serdes.scala:651:23]
  wire [2:0]  _inDes_io_out_bits_chanId;	// @[Serdes.scala:651:23]
  wire [2:0]  _inDes_io_out_bits_opcode;	// @[Serdes.scala:651:23]
  wire [2:0]  _inDes_io_out_bits_param;	// @[Serdes.scala:651:23]
  wire [7:0]  _inDes_io_out_bits_size;	// @[Serdes.scala:651:23]
  wire [7:0]  _inDes_io_out_bits_source;	// @[Serdes.scala:651:23]
  wire [63:0] _inDes_io_out_bits_address;	// @[Serdes.scala:651:23]
  wire [63:0] _inDes_io_out_bits_data;	// @[Serdes.scala:651:23]
  wire        _inDes_io_out_bits_corrupt;	// @[Serdes.scala:651:23]
  wire [8:0]  _inDes_io_out_bits_union;	// @[Serdes.scala:651:23]
  wire        _outSer_io_in_ready;	// @[Serdes.scala:646:24]
  wire        _outArb_io_in_1_ready;	// @[Serdes.scala:644:24]
  wire        _outArb_io_in_4_ready;	// @[Serdes.scala:644:24]
  wire        _outArb_io_out_valid;	// @[Serdes.scala:644:24]
  wire [2:0]  _outArb_io_out_bits_chanId;	// @[Serdes.scala:644:24]
  wire [2:0]  _outArb_io_out_bits_opcode;	// @[Serdes.scala:644:24]
  wire [2:0]  _outArb_io_out_bits_param;	// @[Serdes.scala:644:24]
  wire [7:0]  _outArb_io_out_bits_size;	// @[Serdes.scala:644:24]
  wire [7:0]  _outArb_io_out_bits_source;	// @[Serdes.scala:644:24]
  wire [63:0] _outArb_io_out_bits_address;	// @[Serdes.scala:644:24]
  wire [63:0] _outArb_io_out_bits_data;	// @[Serdes.scala:644:24]
  wire        _outArb_io_out_bits_corrupt;	// @[Serdes.scala:644:24]
  wire [8:0]  _outArb_io_out_bits_union;	// @[Serdes.scala:644:24]
  wire        _outArb_io_out_bits_last;	// @[Serdes.scala:644:24]
  ...
  wire        _inDes_io_out_ready_T = _inDes_io_out_bits_chanId == 3'h0;	// @[Bundles.scala:260:74, Serdes.scala:234:37, :651:23]
  wire        _inDes_io_out_ready_T_6 = _inDes_io_out_bits_chanId == 3'h3;	// @[Serdes.scala:237:37, :651:23]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_outArb_io_in_1_ready & auto_client_out_d_valid) begin	// @[Decoupled.scala:51:35, Serdes.scala:644:24]
      ...
      if (_outArb_io_in_4_ready & auto_manager_in_a_valid) begin	// @[Decoupled.scala:51:35, Serdes.scala:644:24]
  ...
  HellaPeekingArbiter outArb (	// @[Serdes.scala:644:24]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_out_ready         (_outSer_io_in_ready),	// @[Serdes.scala:646:24]
  ...
  GenericSerializer outSer (	// @[Serdes.scala:646:24]
    .clock              (clock),
    .reset              (reset),
    .io_in_valid        (_outArb_io_out_valid),	// @[Serdes.scala:644:24]
    .io_in_bits_chanId  (_outArb_io_out_bits_chanId),	// @[Serdes.scala:644:24]
    .io_in_bits_opcode  (_outArb_io_out_bits_opcode),	// @[Serdes.scala:644:24]
    .io_in_bits_param   (_outArb_io_out_bits_param),	// @[Serdes.scala:644:24]
    .io_in_bits_size    (_outArb_io_out_bits_size),	// @[Serdes.scala:644:24]
    .io_in_bits_source  (_outArb_io_out_bits_source),	// @[Serdes.scala:644:24]
    .io_in_bits_address (_outArb_io_out_bits_address),	// @[Serdes.scala:644:24]
    .io_in_bits_data    (_outArb_io_out_bits_data),	// @[Serdes.scala:644:24]
    .io_in_bits_corrupt (_outArb_io_out_bits_corrupt),	// @[Serdes.scala:644:24]
    .io_in_bits_union   (_outArb_io_out_bits_union),	// @[Serdes.scala:644:24]
    .io_in_bits_last    (_outArb_io_out_bits_last),	// @[Serdes.scala:644:24]
    .io_out_ready       (io_ser_out_ready),
    .io_in_ready        (_outSer_io_in_ready),
    .io_out_valid       (io_ser_out_valid),
    .io_out_bits        (io_ser_out_bits)
  );
  GenericDeserializer inDes (	// @[Serdes.scala:651:23]
    .clock               (clock),
    .reset               (reset),
    .io_in_valid         (io_ser_in_valid),
    .io_in_bits          (io_ser_in_bits),
    .io_out_ready        (_inDes_io_out_bits_chanId != 3'h4 & (_inDes_io_out_ready_T_6 ? auto_manager_in_d_ready : ~(_inDes_io_out_bits_chanId == 3'h2 | _inDes_io_out_bits_chanId == 3'h1) & _inDes_io_out_ready_T & auto_client_out_a_ready)),	// @[Edges.scala:231:25, Mux.scala:81:58, Serdes.scala:234:37, :235:37, :236:37, :237:37, :238:37, :331:20, :651:23]
  ...
  assign auto_manager_in_a_ready = _outArb_io_in_4_ready;	// @[Serdes.scala:644:24]
  assign auto_manager_in_d_valid = _inDes_io_out_valid & _inDes_io_out_ready_T_6;	// @[Serdes.scala:237:37, :651:23, :659:46]
  assign auto_manager_in_d_bits_opcode = _inDes_io_out_bits_opcode;	// @[Serdes.scala:651:23]
  assign auto_manager_in_d_bits_param = _inDes_io_out_bits_param[1:0];	// @[Serdes.scala:402:15, :651:23]
  assign auto_manager_in_d_bits_size = _inDes_io_out_bits_size[3:0];	// @[Serdes.scala:403:15, :651:23]
  assign auto_manager_in_d_bits_source = _inDes_io_out_bits_source[0];	// @[Serdes.scala:404:15, :651:23]
  assign auto_manager_in_d_bits_sink = _inDes_io_out_bits_union[2:1];	// @[Serdes.scala:465:17, :651:23]
  assign auto_manager_in_d_bits_denied = _inDes_io_out_bits_union[0];	// @[Serdes.scala:466:30, :651:23]
  assign auto_manager_in_d_bits_data = _inDes_io_out_bits_data;	// @[Serdes.scala:651:23]
  assign auto_manager_in_d_bits_corrupt = _inDes_io_out_bits_corrupt;	// @[Serdes.scala:651:23]
  assign auto_client_out_a_valid = _inDes_io_out_valid & _inDes_io_out_ready_T;	// @[Serdes.scala:234:37, :651:23, :653:45]
  assign auto_client_out_a_bits_opcode = _inDes_io_out_bits_opcode;	// @[Serdes.scala:651:23]
  assign auto_client_out_a_bits_param = _inDes_io_out_bits_param;	// @[Serdes.scala:651:23]
  assign auto_client_out_a_bits_size = _inDes_io_out_bits_size[2:0];	// @[Serdes.scala:374:15, :651:23]
  assign auto_client_out_a_bits_source = _inDes_io_out_bits_source[3:0];	// @[Serdes.scala:375:15, :651:23]
  assign auto_client_out_a_bits_address = _inDes_io_out_bits_address[28:0];	// @[Serdes.scala:376:15, :651:23]
  assign auto_client_out_a_bits_mask = _inDes_io_out_bits_union[7:0];	// @[Serdes.scala:382:15, :651:23]
  assign auto_client_out_a_bits_data = _inDes_io_out_bits_data;	// @[Serdes.scala:651:23]
  assign auto_client_out_a_bits_corrupt = _inDes_io_out_bits_corrupt;	// @[Serdes.scala:651:23]
  assign auto_client_out_d_ready = _outArb_io_in_1_ready;	// @[Serdes.scala:644:24]
endmodule
