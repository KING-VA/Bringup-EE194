...
module TLXbar_5(
  ...
  output [20:0] auto_out_5_a_bits_address,
  ...
  output [14:0] auto_out_1_a_bits_address,
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14]} == 5'h0;	// @[Parameters.scala:137:{45,65}]
  wire        requestAIO_0_1 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], ~(auto_in_a_bits_address[14])} == 5'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_3 = {auto_in_a_bits_address[27], ~(auto_in_a_bits_address[25]), auto_in_a_bits_address[20], auto_in_a_bits_address[16]} == 4'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_4 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], ~(auto_in_a_bits_address[16])} == 4'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_5 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], ~(auto_in_a_bits_address[20]), auto_in_a_bits_address[16], auto_in_a_bits_address[14]} == 5'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire [4:0]  _GEN = auto_in_a_bits_address[20:16] ^ 5'h11;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_6 = {auto_in_a_bits_address[27], auto_in_a_bits_address[25], _GEN[4], _GEN[0], auto_in_a_bits_address[14]} == 5'h0;	// @[Parameters.scala:137:{31,45,65}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[11:3]) : 9'h0) | {6'h0, (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0) | (winnerQual_2 & auto_out_2_d_bits_opcode[0] ? ~(_beatsDO_decode_T_9[5:3]) : 3'h0) | (winnerQual_3 & auto_out_3_d_bits_opcode[0] ? ~(_beatsDO_decode_T_13[5:3]) : 3'h0) | (winnerQual_4 ? ~(_beatsDO_decode_T_17[5:3]) : 3'h0) | (winnerQual_5 & auto_out_5_d_bits_opcode[0] ? ~(_beatsDO_decode_T_21[5:3]) : 3'h0) | (winnerQual_6 & auto_out_6_d_bits_opcode[0] ? ~(_beatsDO_decode_T_25[5:3]) : 3'h0)};	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:105:36, :220:14, package.scala:235:{46,71,76}]
  ...
  assign auto_in_a_ready = requestAIO_0_0 & auto_out_0_a_ready | requestAIO_0_1 & auto_out_1_a_ready | auto_in_a_bits_address[27] & auto_out_2_a_ready | requestAIO_0_3 & auto_out_3_a_ready | requestAIO_0_4 & auto_out_4_a_ready | requestAIO_0_5 & auto_out_5_a_ready | requestAIO_0_6 & auto_out_6_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:{45,65}]
  assign auto_in_d_valid = out_24_valid;	// @[Arbiter.scala:126:29]
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_4} | (muxStateEarly_5 ? auto_out_5_d_bits_opcode : 3'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_param : 2'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 4'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 4'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 4'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 4'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 4'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 4'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 4'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_sink = muxStateEarly_0 & auto_out_0_d_bits_sink | muxStateEarly_1 & auto_out_1_d_bits_sink | muxStateEarly_5 & auto_out_5_d_bits_sink | muxStateEarly_6 & auto_out_6_d_bits_sink;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied | muxStateEarly_5 & auto_out_5_d_bits_denied | muxStateEarly_6 & auto_out_6_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt | muxStateEarly_5 & auto_out_5_d_bits_corrupt | muxStateEarly_6 & auto_out_6_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  assign auto_out_5_a_bits_address = auto_in_a_bits_address[20:0];	// @[BundleMap.scala:247:19]
  ...
  assign auto_out_4_a_bits_address = auto_in_a_bits_address[16:0];	// @[BundleMap.scala:247:19]
  ...
  assign auto_out_2_a_valid = auto_in_a_valid & auto_in_a_bits_address[27];	// @[Parameters.scala:137:45, Xbar.scala:431:50]
  ...
  assign auto_out_1_a_bits_address = auto_in_a_bits_address[14:0];	// @[BundleMap.scala:247:19]
