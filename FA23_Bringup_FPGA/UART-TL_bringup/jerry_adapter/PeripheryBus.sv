...
module PeripheryBus(
  ...
  wire [3:0]  _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  TLFIFOFixer_1 fixer (	// @[PeripheryBus.scala:47:33]
    ...
    .auto_out_a_ready        (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_out_d_valid        (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_out_d_bits_opcode  (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_out_d_bits_size    (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_out_d_bits_source  (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_out_d_bits_data    (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_data),	// @[LazyModule.scala:489:27]
  ...
  TLInterconnectCoupler_4 coupler_to_slave_named_bootaddressreg (	// @[LazyModule.scala:489:27]
    .clock                              (auto_subsystem_pbus_clock_groups_in_member_subsystem_pbus_0_clock),
    .reset                              (auto_subsystem_pbus_clock_groups_in_member_subsystem_pbus_0_reset),
    .auto_buffer_in_a_valid             (_fixer_auto_out_a_valid),	// @[PeripheryBus.scala:47:33]
    .auto_buffer_in_a_bits_opcode       (_fixer_auto_out_a_bits_opcode),	// @[PeripheryBus.scala:47:33]
    .auto_buffer_in_a_bits_size         (_fixer_auto_out_a_bits_size),	// @[PeripheryBus.scala:47:33]
    .auto_buffer_in_a_bits_source       (_fixer_auto_out_a_bits_source),	// @[PeripheryBus.scala:47:33]
    .auto_buffer_in_a_bits_address      (_fixer_auto_out_a_bits_address),	// @[PeripheryBus.scala:47:33]
    .auto_buffer_in_a_bits_mask         (_fixer_auto_out_a_bits_mask),	// @[PeripheryBus.scala:47:33]
    .auto_buffer_in_a_bits_data         (_fixer_auto_out_a_bits_data),	// @[PeripheryBus.scala:47:33]
    .auto_buffer_in_d_ready             (_fixer_auto_out_d_ready),	// @[PeripheryBus.scala:47:33]
    ...
    .auto_fragmenter_out_d_bits_opcode  ({2'h0, out_front_bits_read}),	// @[LazyModule.scala:489:27, RegisterRouter.scala:71:36, :97:19]
