...
module SerialRAM(
  ...
  wire [1:0]  _serdesser_auto_manager_in_d_bits_sink;	// @[SerialAdapter.scala:443:29]
  ...
  TLFragmenter_8 fragmenter_1 (	// @[Fragmenter.scala:334:34]
    .clock                   (clock),
    .reset                   (reset),
  ...
  TLBuffer_3 buffer_1 (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
    ...
    .auto_in_a_bits_source   (1'h0),	// @[Buffer.scala:69:28]
    ...
    .auto_in_a_bits_corrupt  (1'h0),	// @[Buffer.scala:69:28]
