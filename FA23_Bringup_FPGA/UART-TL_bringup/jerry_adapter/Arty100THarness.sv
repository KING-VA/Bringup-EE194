...
module Arty100THarness(
  ...
  wire        _trolling_io_uart_txd;	// @[HarnessBinders.scala:40:30]
  wire        _trolling_io_serial_in_ready;	// @[HarnessBinders.scala:40:30]
  wire        _trolling_io_serial_out_valid;	// @[HarnessBinders.scala:40:30]
  wire        _trolling_io_serial_out_bits;	// @[HarnessBinders.scala:40:30]
  wire        _trolling_io_dropped;	// @[HarnessBinders.scala:40:30]
  wire        _SerialWidthAdapter_io_narrow_in_ready;	// @[HarnessBinders.scala:36:42]
  wire        _SerialWidthAdapter_io_narrow_out_valid;	// @[HarnessBinders.scala:36:42]
  wire [7:0]  _SerialWidthAdapter_io_narrow_out_bits;	// @[HarnessBinders.scala:36:42]
  wire        _SerialWidthAdapter_io_wide_in_ready;	// @[HarnessBinders.scala:36:42]
  wire        _SerialWidthAdapter_io_wide_out_valid;	// @[HarnessBinders.scala:36:42]
  wire [31:0] _SerialWidthAdapter_io_wide_out_bits;	// @[HarnessBinders.scala:36:42]
  wire        _UARTToSerial_io_uart_txd;	// @[HarnessBinders.scala:34:36]
  wire        _UARTToSerial_io_serial_in_ready;	// @[HarnessBinders.scala:34:36]
  wire        _UARTToSerial_io_serial_out_valid;	// @[HarnessBinders.scala:34:36]
  wire [7:0]  _UARTToSerial_io_serial_out_bits;	// @[HarnessBinders.scala:34:36]
  wire        _ram_io_ser_in_valid;	// @[SerialAdapter.scala:58:24]
  wire        _ram_io_ser_in_bits;	// @[SerialAdapter.scala:58:24]
  ...
  wire        _in_queue_io_enq_ready;	// @[SerialAdapter.scala:34:28]
  wire        _in_queue_io_deq_valid;	// @[SerialAdapter.scala:34:28]
  wire        _in_queue_io_deq_bits;	// @[SerialAdapter.scala:34:28]
  wire        _out_queue_io_enq_ready;	// @[SerialAdapter.scala:28:29]
  wire        _out_queue_io_deq_valid;	// @[SerialAdapter.scala:28:29]
  wire        _out_queue_io_deq_bits;	// @[SerialAdapter.scala:28:29]
  ...
  wire        _chiptop_serial_tl_bits_out_bits;	// @[Harness.scala:24:27]
  ...
  reg  [25:0] REG;	// @[Harness.scala:67:28]
  reg  [1:0]  REG_1;	// @[Harness.scala:68:23]
  wire        bundleIn_0_9 = REG_1 == 2'h2;	// @[Harness.scala:68:23, :69:60]
  ...
  always @(posedge _sys_clock_ibufg_O) begin	// @[ClockOverlay.scala:32:22]
    if (REG == 26'h2155554)	// @[Harness.scala:67:28, :70:30]
      REG <= 26'h0;	// @[Harness.scala:67:28, :70:21]
    else	// @[Harness.scala:70:30]
      REG <= REG + 26'h1;	// @[Harness.scala:67:28, :70:61]
    if (REG == 26'h0) begin	// @[Harness.scala:67:28, :70:21, :71:21]
      if (bundleIn_0_9)	// @[Harness.scala:69:60]
        REG_1 <= 2'h0;	// @[Counter.scala:61:40, Harness.scala:68:23]
      else	// @[Harness.scala:69:60]
        REG_1 <= REG_1 + 2'h1;	// @[Harness.scala:68:23, :69:60, :72:58]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        REG = _RANDOM_0[31:6];	// @[Counter.scala:61:40, Harness.scala:67:28]
        REG_1 = _RANDOM_1[1:0];	// @[Harness.scala:68:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ChipTop chiptop (	// @[Harness.scala:24:27]
    .serial_tl_bits_in_valid   (_in_queue_io_deq_valid),	// @[SerialAdapter.scala:34:28]
    .serial_tl_bits_in_bits    (_in_queue_io_deq_bits),	// @[SerialAdapter.scala:34:28]
    .serial_tl_bits_out_ready  (_out_queue_io_enq_ready),	// @[SerialAdapter.scala:28:29]
  ...
  UIntToAnalog_1 a2b (	// @[Util.scala:58:21]
    .a    (uart_txd),
    .b    (_UARTToSerial_io_uart_txd),	// @[HarnessBinders.scala:34:36]
  ...
  AsyncQueue out_queue (	// @[SerialAdapter.scala:28:29]
    ...
    .io_enq_ready (_out_queue_io_enq_ready),
    .io_deq_valid (_out_queue_io_deq_valid),
    .io_deq_bits  (_out_queue_io_deq_bits)
  );
  AsyncQueue in_queue (	// @[SerialAdapter.scala:34:28]
    ...
    .io_enq_ready (_in_queue_io_enq_ready),
    .io_deq_valid (_in_queue_io_deq_valid),
    .io_deq_bits  (_in_queue_io_deq_bits)
  );
  SerialRAM ram (	// @[SerialAdapter.scala:58:24]
    .clock                (_dutWrangler_auto_out_0_clock),	// @[Harness.scala:31:31]
    .reset                (_dutWrangler_auto_out_0_reset),	// @[Harness.scala:31:31]
    .io_ser_in_ready      (_in_queue_io_enq_ready),	// @[SerialAdapter.scala:34:28]
    .io_ser_out_valid     (_out_queue_io_deq_valid),	// @[SerialAdapter.scala:28:29]
    .io_ser_out_bits      (_out_queue_io_deq_bits),	// @[SerialAdapter.scala:28:29]
    .io_tsi_ser_in_valid  (_SerialWidthAdapter_io_wide_out_valid),	// @[HarnessBinders.scala:36:42]
    .io_tsi_ser_in_bits   (_SerialWidthAdapter_io_wide_out_bits),	// @[HarnessBinders.scala:36:42]
    .io_tsi_ser_out_ready (_SerialWidthAdapter_io_wide_in_ready),	// @[HarnessBinders.scala:36:42]
  ...
  UARTToSerial UARTToSerial (	// @[HarnessBinders.scala:34:36]
    .clock               (_dutWrangler_auto_out_0_clock),	// @[Harness.scala:31:31]
    .reset               (_dutWrangler_auto_out_0_reset),	// @[Harness.scala:31:31]
    .io_uart_rxd         (_bundleIn_0_rxd_a2b_b),	// @[Util.scala:30:21]
    .io_serial_in_valid  (_SerialWidthAdapter_io_narrow_out_valid),	// @[HarnessBinders.scala:36:42]
    .io_serial_in_bits   (_SerialWidthAdapter_io_narrow_out_bits),	// @[HarnessBinders.scala:36:42]
    .io_serial_out_ready (_SerialWidthAdapter_io_narrow_in_ready),	// @[HarnessBinders.scala:36:42]
    .io_uart_txd         (_UARTToSerial_io_uart_txd),
    .io_serial_in_ready  (_UARTToSerial_io_serial_in_ready),
    .io_serial_out_valid (_UARTToSerial_io_serial_out_valid),
    .io_serial_out_bits  (_UARTToSerial_io_serial_out_bits),
    .io_dropped          (led_4)
  );
  SerialWidthAdapter SerialWidthAdapter (	// @[HarnessBinders.scala:36:42]
    .clock               (_dutWrangler_auto_out_0_clock),	// @[Harness.scala:31:31]
    .reset               (_dutWrangler_auto_out_0_reset),	// @[Harness.scala:31:31]
    .io_narrow_in_valid  (_UARTToSerial_io_serial_out_valid),	// @[HarnessBinders.scala:34:36]
    .io_narrow_in_bits   (_UARTToSerial_io_serial_out_bits),	// @[HarnessBinders.scala:34:36]
    .io_narrow_out_ready (_UARTToSerial_io_serial_in_ready),	// @[HarnessBinders.scala:34:36]
    ...
    .io_narrow_in_ready  (_SerialWidthAdapter_io_narrow_in_ready),
    .io_narrow_out_valid (_SerialWidthAdapter_io_narrow_out_valid),
    .io_narrow_out_bits  (_SerialWidthAdapter_io_narrow_out_bits),
    .io_wide_in_ready    (_SerialWidthAdapter_io_wide_in_ready),
    .io_wide_out_valid   (_SerialWidthAdapter_io_wide_out_valid),
    .io_wide_out_bits    (_SerialWidthAdapter_io_wide_out_bits)
  );
  UARTToSerializedTL trolling (	// @[HarnessBinders.scala:40:30]
    .clock               (_dutWrangler_auto_out_0_clock),	// @[Harness.scala:31:31]
    .reset               (_dutWrangler_auto_out_0_reset),	// @[Harness.scala:31:31]
    .io_uart_rxd         (1'h0),	// @[LazyModule.scala:411:29]
    .io_serial_in_valid  (1'h0),	// @[LazyModule.scala:411:29]
    .io_serial_in_bits   (1'h0),	// @[LazyModule.scala:411:29]
    .io_serial_out_ready (1'h0),	// @[LazyModule.scala:411:29]
    .io_uart_txd         (_trolling_io_uart_txd),
    .io_serial_in_ready  (_trolling_io_serial_in_ready),
    .io_serial_out_valid (_trolling_io_serial_out_valid),
    .io_serial_out_bits  (_trolling_io_serial_out_bits),
    .io_dropped          (_trolling_io_dropped)
  );
  plusarg_reader #(
  ...
  assign led_0 = REG_1 == 2'h0;	// @[Counter.scala:61:40, Harness.scala:68:23, :69:60]
  assign led_1 = REG_1 == 2'h1;	// @[Harness.scala:68:23, :69:60]
  assign led_2 = bundleIn_0_9;	// @[Harness.scala:69:60]
  assign led_3 = _reset_ibuf_O;	// @[Arty100TShell.scala:323:28]
  assign led_5 = 1'h0;	// @[LazyModule.scala:411:29]
  assign led_6 = 1'h0;	// @[LazyModule.scala:411:29]
  assign led_7 = 1'h0;	// @[LazyModule.scala:411:29]
  assign led_8 = 1'h0;	// @[LazyModule.scala:411:29]
  assign led_9 = _mig_io_port_init_calib_complete;	// @[Arty100TShell.scala:239:23]
  assign led_10 = 1'h0;	// @[LazyModule.scala:411:29]
  assign led_11 = 1'h0;	// @[LazyModule.scala:411:29]
  assign led_12 = _ram_io_adapter_state[0];	// @[HarnessBinders.scala:52:57, SerialAdapter.scala:58:24]
  assign led_13 = _ram_io_adapter_state[1];	// @[HarnessBinders.scala:53:58, SerialAdapter.scala:58:24]
  assign led_14 = _ram_io_adapter_state[2];	// @[HarnessBinders.scala:54:58, SerialAdapter.scala:58:24]
  assign led_15 = _ram_io_adapter_state[3];	// @[HarnessBinders.scala:55:58, SerialAdapter.scala:58:24]
endmodule
