...
module DigitalTop(
  ...
  wire [7:0]  _prci_ctrl_domain_auto_tileResetSetter_tl_in_d_bits_source;	// @[HasChipyardPRCI.scala:36:36]
  ...
  wire [7:0]  _prci_ctrl_domain_auto_tileClockGater_tile_clock_gater_in_d_bits_source;	// @[HasChipyardPRCI.scala:36:36]
  ...
  wire [2:0]  _subsystem_l2_wrapper_auto_coherent_jbar_in_d_bits_source;	// @[BankedL2Params.scala:47:31]
  ...
  wire [3:0]  _subsystem_cbus_auto_coupler_to_bus_named_subsystem_pbus_bus_xing_out_a_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [2:0]  _subsystem_cbus_auto_bus_xing_in_d_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire        _subsystem_fbus_buffer_auto_in_d_bits_source;	// @[Buffer.scala:69:28]
  ...
  wire [3:0]  _subsystem_pbus_auto_bus_xing_in_d_bits_source;	// @[PeripheryBus.scala:31:26]
  ...
  wire [2:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_a_bits_source;	// @[SystemBus.scala:24:26]
  ...
  wire [2:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_l2_widget_out_c_bits_source;	// @[SystemBus.scala:24:26]
  ...
  wire [2:0]  _subsystem_sbus_auto_coupler_to_bus_named_subsystem_cbus_bus_xing_out_a_bits_source;	// @[SystemBus.scala:24:26]
  ...
  always @(posedge clock) begin
    if (reset) begin
      serial_tl_bits_out_c_value <= 2'h0;	// @[Counter.scala:61:40, HasChipyardPRCI.scala:36:36]
      serial_tl_bits_out_r <= 1'h0;	// @[HasChipyardPRCI.scala:36:36, Reg.scala:35:20]
      serial_tl_domain_serial_tl_in_c_value <= 2'h0;	// @[Counter.scala:61:40, HasChipyardPRCI.scala:36:36]
      serial_tl_domain_serial_tl_in_r <= 1'h0;	// @[HasChipyardPRCI.scala:36:36, Reg.scala:35:20]
    end
    else begin
  ...
  FixedClockBroadcast_2 subsystem_fbus_fixedClockNode (	// @[ClockGroup.scala:110:107]
  ...
  TLBuffer_3 subsystem_fbus_buffer (	// @[Buffer.scala:69:28]
    ...
    .auto_out_d_bits_source  (1'h0),	// @[HasChipyardPRCI.scala:36:36]
  ...
  TLInterconnectCoupler_5 subsystem_fbus_coupler_from_port_named_serial_tl_ctrl (	// @[LazyModule.scala:489:27]
    .clock                         (_subsystem_fbus_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                         (_subsystem_fbus_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
  ...
  PeripheryBus_1 subsystem_cbus (	// @[PeripheryBus.scala:31:26]
    ...
    .auto_coupler_to_plic_fragmenter_out_d_bits_data                       (64'h0),	// @[Plic.scala:359:39]
