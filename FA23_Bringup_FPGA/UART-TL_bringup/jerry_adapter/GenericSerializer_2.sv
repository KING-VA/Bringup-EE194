...
module GenericSerializer_2(
  ...
  reg  [125:0] data;	// @[Serdes.scala:173:17]
  reg          sending;	// @[Serdes.scala:175:24]
  reg  [6:0]   sendCount;	// @[Counter.scala:61:40]
  wire         wrap_wrap = sendCount == 7'h7D;	// @[Counter.scala:61:40, :73:24]
  ...
  always @(posedge clock) begin
    if (_T_2)	// @[Decoupled.scala:51:35]
      data <= {1'h0, data[125:1]};	// @[Counter.scala:77:24, Serdes.scala:173:17, :187:37]
    ...
    if (reset) begin
      ...
      sendCount <= 7'h0;	// @[Counter.scala:61:40]
    end
    else begin
      ...
      if (_T_2) begin	// @[Decoupled.scala:51:35]
        if (wrap_wrap)	// @[Counter.scala:73:24]
          ...
          sendCount <= sendCount + 7'h1;	// @[Counter.scala:61:40, :77:24]
      end
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_3 = `RANDOM;
        _RANDOM_4 = `RANDOM;
        data = {_RANDOM_0, _RANDOM_1, _RANDOM_2, _RANDOM_3[29:0]};	// @[Serdes.scala:173:17]
        sending = _RANDOM_3[30];	// @[Serdes.scala:173:17, :175:24]
        sendCount = {_RANDOM_3[31], _RANDOM_4[5:0]};	// @[Counter.scala:61:40, Serdes.scala:173:17]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_bits = data[0];	// @[Serdes.scala:173:17, :180:22]
endmodule
