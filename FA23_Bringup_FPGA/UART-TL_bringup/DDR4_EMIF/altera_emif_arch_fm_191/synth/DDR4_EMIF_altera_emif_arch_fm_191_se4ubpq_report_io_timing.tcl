...
source "$script_dir/DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_report_timing_core.tcl"


if [ info exists ddr_db ] {
   unset ddr_db
}
DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_corename}"
   } else {
      set fbasename "${::GLOBAL_DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_corename}_${inst_id}"
   }
   ...
   DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_perform_core_analysis $opcname $inst pins var summary

   #######################################
   # Print out the Summary Panel for this instance

   set summary [lsort -command DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ DDR4_EMIF_altera_emif_arch_fm_191_se4ubpq_round_3dp $hold]
      }
