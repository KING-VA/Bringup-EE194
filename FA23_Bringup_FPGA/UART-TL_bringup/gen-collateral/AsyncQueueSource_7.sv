...
module AsyncQueueSource_7(
  ...
  output [5:0]  io_async_mem_0_source,
  ...
  output [5:0]  io_async_mem_1_source,
  ...
  output [5:0]  io_async_mem_2_source,
  ...
  output [5:0]  io_async_mem_3_source,
  ...
  output [5:0]  io_async_mem_4_source,
  ...
  output [5:0]  io_async_mem_5_source,
  ...
  output [5:0]  io_async_mem_6_source,
  ...
  output [5:0]  io_async_mem_7_source,
  ...
  reg  [5:0]  mem_0_source;	// @[AsyncQueue.scala:80:16]
  ...
  reg  [5:0]  mem_1_source;	// @[AsyncQueue.scala:80:16]
  reg         mem_1_sink;	// @[AsyncQueue.scala:80:16]
  ...
  reg  [5:0]  mem_2_source;	// @[AsyncQueue.scala:80:16]
  reg         mem_2_sink;	// @[AsyncQueue.scala:80:16]
  ...
  reg  [5:0]  mem_3_source;	// @[AsyncQueue.scala:80:16]
  reg         mem_3_sink;	// @[AsyncQueue.scala:80:16]
  ...
  reg  [5:0]  mem_4_source;	// @[AsyncQueue.scala:80:16]
  reg         mem_4_sink;	// @[AsyncQueue.scala:80:16]
  ...
  reg  [5:0]  mem_5_source;	// @[AsyncQueue.scala:80:16]
  reg         mem_5_sink;	// @[AsyncQueue.scala:80:16]
  ...
  reg  [5:0]  mem_6_source;	// @[AsyncQueue.scala:80:16]
  reg         mem_6_sink;	// @[AsyncQueue.scala:80:16]
  ...
  reg  [5:0]  mem_7_source;	// @[AsyncQueue.scala:80:16]
  reg         mem_7_sink;	// @[AsyncQueue.scala:80:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_size = _RANDOM_0[7:5];	// @[AsyncQueue.scala:80:16]
        mem_0_source = _RANDOM_0[13:8];	// @[AsyncQueue.scala:80:16]
        mem_0_sink = _RANDOM_0[14];	// @[AsyncQueue.scala:80:16]
        ...
        mem_1_size = _RANDOM_2[24:22];	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_2[30:25];	// @[AsyncQueue.scala:80:16]
        mem_1_sink = _RANDOM_2[31];	// @[AsyncQueue.scala:80:16]
        ...
        mem_2_size = _RANDOM_5[9:7];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_5[15:10];	// @[AsyncQueue.scala:80:16]
        mem_2_sink = _RANDOM_5[16];	// @[AsyncQueue.scala:80:16]
        ...
        mem_3_size = _RANDOM_7[26:24];	// @[AsyncQueue.scala:80:16]
        mem_3_source = {_RANDOM_7[31:27], _RANDOM_8[0]};	// @[AsyncQueue.scala:80:16]
        mem_3_sink = _RANDOM_8[1];	// @[AsyncQueue.scala:80:16]
        ...
        mem_4_size = _RANDOM_10[11:9];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_10[17:12];	// @[AsyncQueue.scala:80:16]
        mem_4_sink = _RANDOM_10[18];	// @[AsyncQueue.scala:80:16]
        ...
        mem_5_size = _RANDOM_12[28:26];	// @[AsyncQueue.scala:80:16]
        mem_5_source = {_RANDOM_12[31:29], _RANDOM_13[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_sink = _RANDOM_13[3];	// @[AsyncQueue.scala:80:16]
        ...
        mem_6_size = _RANDOM_15[13:11];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_15[19:14];	// @[AsyncQueue.scala:80:16]
        mem_6_sink = _RANDOM_15[20];	// @[AsyncQueue.scala:80:16]
        ...
        mem_7_size = _RANDOM_17[30:28];	// @[AsyncQueue.scala:80:16]
        mem_7_source = {_RANDOM_17[31], _RANDOM_18[4:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_sink = _RANDOM_18[5];	// @[AsyncQueue.scala:80:16]
