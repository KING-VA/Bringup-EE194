...
module TLBuffer_18(
  ...
  input  [3:0]  auto_out_3_b_bits_source,
  ...
  input  [3:0]  auto_out_2_b_bits_source,
  ...
  input  [3:0]  auto_out_0_b_bits_source,
  ...
  wire [3:0] _bundleIn_3_d_q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  ...
  wire [3:0] _bundleIn_2_d_q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  ...
  wire [3:0] _bundleIn_1_d_q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  ...
  TLMonitor_60 monitor_2 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  TLMonitor_61 monitor_3 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  Queue_260 x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_261 bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_260 bundleOut_1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_261 bundleIn_1_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_260 bundleOut_2_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_261 bundleIn_2_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_260 bundleOut_3_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_261 bundleIn_3_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
