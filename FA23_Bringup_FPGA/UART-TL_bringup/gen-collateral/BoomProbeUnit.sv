...
module BoomProbeUnit(
  ...
  output [34:0] io_rep_bits_address,
  ...
  reg  [34:0]      req_address;	// @[dcache.scala:167:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_address = {_RANDOM_0[31:15], _RANDOM_1[17:0]};	// @[dcache.scala:165:22, :167:16]
        way_en = _RANDOM_3[30:27];	// @[dcache.scala:171:19]
        old_coh_state = {_RANDOM_3[31], _RANDOM_4[0]};	// @[dcache.scala:171:19, :173:20]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_meta_read_bits_tag = req_address[34:12];	// @[dcache.scala:167:16, :169:29]
  ...
  assign io_meta_write_bits_data_tag = req_address[34:12];	// @[dcache.scala:167:16, :169:29]
  assign io_wb_req_valid = _io_wb_req_valid_output;	// @[dcache.scala:200:28]
  assign io_wb_req_bits_tag = req_address[34:12];	// @[dcache.scala:167:16, :169:29]
  ...
  assign io_state_bits = {5'h0, req_address};	// @[dcache.scala:167:16, :179:18]
endmodule
