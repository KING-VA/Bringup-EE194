  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_1_param = _RANDOM_3[29:27];	// @[AsyncQueue.scala:80:16]
        mem_1_size = {_RANDOM_3[31:30], _RANDOM_4[1:0]};	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_4[3:2];	// @[AsyncQueue.scala:80:16]
        ...
        mem_2_param = _RANDOM_7[21:19];	// @[AsyncQueue.scala:80:16]
        mem_2_size = _RANDOM_7[25:22];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_7[27:26];	// @[AsyncQueue.scala:80:16]
        ...
        mem_3_param = _RANDOM_11[13:11];	// @[AsyncQueue.scala:80:16]
        mem_3_size = _RANDOM_11[17:14];	// @[AsyncQueue.scala:80:16]
        mem_3_source = _RANDOM_11[19:18];	// @[AsyncQueue.scala:80:16]
        ...
        mem_4_param = _RANDOM_15[5:3];	// @[AsyncQueue.scala:80:16]
        mem_4_size = _RANDOM_15[9:6];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_15[11:10];	// @[AsyncQueue.scala:80:16]
        ...
        mem_5_param = _RANDOM_18[29:27];	// @[AsyncQueue.scala:80:16]
        mem_5_size = {_RANDOM_18[31:30], _RANDOM_19[1:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_source = _RANDOM_19[3:2];	// @[AsyncQueue.scala:80:16]
        ...
        mem_6_param = _RANDOM_22[21:19];	// @[AsyncQueue.scala:80:16]
        mem_6_size = _RANDOM_22[25:22];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_22[27:26];	// @[AsyncQueue.scala:80:16]
        ...
        mem_7_param = _RANDOM_26[13:11];	// @[AsyncQueue.scala:80:16]
        mem_7_size = _RANDOM_26[17:14];	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_26[19:18];	// @[AsyncQueue.scala:80:16]
