  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_source = _RANDOM_0[11:8];	// @[AsyncQueue.scala:80:16]
        mem_0_sink = _RANDOM_0[12];	// @[AsyncQueue.scala:80:16]
        mem_0_denied = _RANDOM_0[13];	// @[AsyncQueue.scala:80:16]
        mem_0_data = {_RANDOM_0[31:14], _RANDOM_1, _RANDOM_2[13:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_corrupt = _RANDOM_2[14];	// @[AsyncQueue.scala:80:16]
        mem_1_opcode = _RANDOM_2[17:15];	// @[AsyncQueue.scala:80:16]
        mem_1_param = _RANDOM_2[19:18];	// @[AsyncQueue.scala:80:16]
        mem_1_size = _RANDOM_2[22:20];	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_2[26:23];	// @[AsyncQueue.scala:80:16]
        mem_1_sink = _RANDOM_2[27];	// @[AsyncQueue.scala:80:16]
        mem_1_denied = _RANDOM_2[28];	// @[AsyncQueue.scala:80:16]
        mem_1_data = {_RANDOM_2[31:29], _RANDOM_3, _RANDOM_4[28:0]};	// @[AsyncQueue.scala:80:16]
        mem_1_corrupt = _RANDOM_4[29];	// @[AsyncQueue.scala:80:16]
        mem_2_opcode = {_RANDOM_4[31:30], _RANDOM_5[0]};	// @[AsyncQueue.scala:80:16]
        mem_2_param = _RANDOM_5[2:1];	// @[AsyncQueue.scala:80:16]
        mem_2_size = _RANDOM_5[5:3];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_5[9:6];	// @[AsyncQueue.scala:80:16]
        mem_2_sink = _RANDOM_5[10];	// @[AsyncQueue.scala:80:16]
        mem_2_denied = _RANDOM_5[11];	// @[AsyncQueue.scala:80:16]
        mem_2_data = {_RANDOM_5[31:12], _RANDOM_6, _RANDOM_7[11:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_corrupt = _RANDOM_7[12];	// @[AsyncQueue.scala:80:16]
        mem_3_opcode = _RANDOM_7[15:13];	// @[AsyncQueue.scala:80:16]
        mem_3_param = _RANDOM_7[17:16];	// @[AsyncQueue.scala:80:16]
        mem_3_size = _RANDOM_7[20:18];	// @[AsyncQueue.scala:80:16]
        mem_3_source = _RANDOM_7[24:21];	// @[AsyncQueue.scala:80:16]
        mem_3_sink = _RANDOM_7[25];	// @[AsyncQueue.scala:80:16]
        mem_3_denied = _RANDOM_7[26];	// @[AsyncQueue.scala:80:16]
        mem_3_data = {_RANDOM_7[31:27], _RANDOM_8, _RANDOM_9[26:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_corrupt = _RANDOM_9[27];	// @[AsyncQueue.scala:80:16]
        mem_4_opcode = _RANDOM_9[30:28];	// @[AsyncQueue.scala:80:16]
        mem_4_param = {_RANDOM_9[31], _RANDOM_10[0]};	// @[AsyncQueue.scala:80:16]
        mem_4_size = _RANDOM_10[3:1];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_10[7:4];	// @[AsyncQueue.scala:80:16]
        mem_4_sink = _RANDOM_10[8];	// @[AsyncQueue.scala:80:16]
        mem_4_denied = _RANDOM_10[9];	// @[AsyncQueue.scala:80:16]
        mem_4_data = {_RANDOM_10[31:10], _RANDOM_11, _RANDOM_12[9:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_corrupt = _RANDOM_12[10];	// @[AsyncQueue.scala:80:16]
        mem_5_opcode = _RANDOM_12[13:11];	// @[AsyncQueue.scala:80:16]
        mem_5_param = _RANDOM_12[15:14];	// @[AsyncQueue.scala:80:16]
        mem_5_size = _RANDOM_12[18:16];	// @[AsyncQueue.scala:80:16]
        mem_5_source = _RANDOM_12[22:19];	// @[AsyncQueue.scala:80:16]
        mem_5_sink = _RANDOM_12[23];	// @[AsyncQueue.scala:80:16]
        mem_5_denied = _RANDOM_12[24];	// @[AsyncQueue.scala:80:16]
        mem_5_data = {_RANDOM_12[31:25], _RANDOM_13, _RANDOM_14[24:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_corrupt = _RANDOM_14[25];	// @[AsyncQueue.scala:80:16]
        mem_6_opcode = _RANDOM_14[28:26];	// @[AsyncQueue.scala:80:16]
        mem_6_param = _RANDOM_14[30:29];	// @[AsyncQueue.scala:80:16]
        mem_6_size = {_RANDOM_14[31], _RANDOM_15[1:0]};	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_15[5:2];	// @[AsyncQueue.scala:80:16]
        mem_6_sink = _RANDOM_15[6];	// @[AsyncQueue.scala:80:16]
        mem_6_denied = _RANDOM_15[7];	// @[AsyncQueue.scala:80:16]
        mem_6_data = {_RANDOM_15[31:8], _RANDOM_16, _RANDOM_17[7:0]};	// @[AsyncQueue.scala:80:16]
        mem_6_corrupt = _RANDOM_17[8];	// @[AsyncQueue.scala:80:16]
        mem_7_opcode = _RANDOM_17[11:9];	// @[AsyncQueue.scala:80:16]
        mem_7_param = _RANDOM_17[13:12];	// @[AsyncQueue.scala:80:16]
        mem_7_size = _RANDOM_17[16:14];	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_17[20:17];	// @[AsyncQueue.scala:80:16]
        mem_7_sink = _RANDOM_17[21];	// @[AsyncQueue.scala:80:16]
        mem_7_denied = _RANDOM_17[22];	// @[AsyncQueue.scala:80:16]
        mem_7_data = {_RANDOM_17[31:23], _RANDOM_18, _RANDOM_19[22:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_corrupt = _RANDOM_19[23];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_19[27:24];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_19[28];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = {_RANDOM_19[31:29], _RANDOM_20[0]};	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
