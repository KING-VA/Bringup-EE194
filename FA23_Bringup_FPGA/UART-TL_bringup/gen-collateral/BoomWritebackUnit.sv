...
module BoomWritebackUnit(
  ...
  wire [34:0]      voluntaryRelease_address = {req_tag, req_idx, 6'h0};	// @[dcache.scala:37:16, :63:41]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_17 = `RANDOM;
        _RANDOM_18 = `RANDOM;
        req_tag = _RANDOM_0[22:0];	// @[dcache.scala:37:16]
        req_idx = _RANDOM_0[28:23];	// @[dcache.scala:37:16]
        req_param = {_RANDOM_0[31], _RANDOM_1[1:0]};	// @[dcache.scala:37:16]
        req_way_en = _RANDOM_1[5:2];	// @[dcache.scala:37:16]
        req_voluntary = _RANDOM_1[6];	// @[dcache.scala:37:16]
        state = _RANDOM_1[9:7];	// @[dcache.scala:37:16, :39:22]
        r1_data_req_fired = _RANDOM_1[10];	// @[dcache.scala:37:16, :40:34]
        r2_data_req_fired = _RANDOM_1[11];	// @[dcache.scala:37:16, :41:34]
        r1_data_req_cnt = _RANDOM_1[15:12];	// @[dcache.scala:37:16, :42:28]
        r2_data_req_cnt = _RANDOM_1[19:16];	// @[dcache.scala:37:16, :43:28]
        data_req_cnt = _RANDOM_1[23:20];	// @[dcache.scala:37:16, :44:29]
        wb_buffer_0 = {_RANDOM_2[31:1], _RANDOM_3, _RANDOM_4[0]};	// @[dcache.scala:46:22]
        wb_buffer_1 = {_RANDOM_4[31:1], _RANDOM_5, _RANDOM_6[0]};	// @[dcache.scala:46:22]
        wb_buffer_2 = {_RANDOM_6[31:1], _RANDOM_7, _RANDOM_8[0]};	// @[dcache.scala:46:22]
        wb_buffer_3 = {_RANDOM_8[31:1], _RANDOM_9, _RANDOM_10[0]};	// @[dcache.scala:46:22]
        wb_buffer_4 = {_RANDOM_10[31:1], _RANDOM_11, _RANDOM_12[0]};	// @[dcache.scala:46:22]
        wb_buffer_5 = {_RANDOM_12[31:1], _RANDOM_13, _RANDOM_14[0]};	// @[dcache.scala:46:22]
        wb_buffer_6 = {_RANDOM_14[31:1], _RANDOM_15, _RANDOM_16[0]};	// @[dcache.scala:46:22]
        wb_buffer_7 = {_RANDOM_16[31:1], _RANDOM_17, _RANDOM_18[0]};	// @[dcache.scala:46:22]
        acked = _RANDOM_18[1];	// @[dcache.scala:46:22, :47:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
