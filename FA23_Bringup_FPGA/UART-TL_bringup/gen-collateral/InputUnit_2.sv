...
module InputUnit_2(
  ...
  wire        vcalloc_vals_6;	// @[InputUnit.scala:249:32]
  ...
  wire        _salloc_arb_io_in_6_ready;	// @[InputUnit.scala:279:26]
  ...
  wire        _input_buffer_io_deq_6_valid;	// @[InputUnit.scala:180:28]
  ...
  reg  [2:0]  states_6_g;	// @[InputUnit.scala:191:19]
  reg         states_6_vc_sel_2_0;	// @[InputUnit.scala:191:19]
  reg         states_6_vc_sel_1_0;	// @[InputUnit.scala:191:19]
  reg         states_6_vc_sel_0_6;	// @[InputUnit.scala:191:19]
  reg  [2:0]  states_6_flow_vnet_id;	// @[InputUnit.scala:191:19]
  reg  [3:0]  states_6_flow_ingress_node;	// @[InputUnit.scala:191:19]
  reg  [2:0]  states_6_flow_ingress_node_id;	// @[InputUnit.scala:191:19]
  reg  [3:0]  states_6_flow_egress_node;	// @[InputUnit.scala:191:19]
  reg  [2:0]  states_6_flow_egress_node_id;	// @[InputUnit.scala:191:19]
  ...
  wire        _route_arbiter_io_in_6_valid_T = states_6_g == 3'h1;	// @[InputUnit.scala:191:19, :199:26, :212:22]
  ...
  wire [9:0]  _vcalloc_filter_T_3 = {vcalloc_vals_9, vcalloc_vals_8, 1'h0, vcalloc_vals_6, vcalloc_vals_5, vcalloc_vals_4, 1'h0, vcalloc_vals_2, vcalloc_vals_1, vcalloc_vals_0} & ~mask;	// @[InputUnit.scala:233:21, :236:{80,87,89}, :249:32]
  wire [19:0] vcalloc_filter = _vcalloc_filter_T_3[0] ? 20'h1 : _vcalloc_filter_T_3[1] ? 20'h2 : _vcalloc_filter_T_3[2] ? 20'h4 : _vcalloc_filter_T_3[4] ? 20'h10 : _vcalloc_filter_T_3[5] ? 20'h20 : _vcalloc_filter_T_3[6] ? 20'h40 : _vcalloc_filter_T_3[8] ? 20'h100 : _vcalloc_filter_T_3[9] ? 20'h200 : vcalloc_vals_0 ? 20'h400 : vcalloc_vals_1 ? 20'h800 : vcalloc_vals_2 ? 20'h1000 : vcalloc_vals_4 ? 20'h4000 : vcalloc_vals_5 ? 20'h8000 : vcalloc_vals_6 ? 20'h10000 : vcalloc_vals_8 ? 20'h40000 : {vcalloc_vals_9, 19'h0};	// @[InputUnit.scala:236:87, :249:32, Mux.scala:47:70, OneHot.scala:84:71]
  wire [9:0]  vcalloc_sel = vcalloc_filter[9:0] | vcalloc_filter[19:10];	// @[InputUnit.scala:237:{35,58,76}, Mux.scala:47:70]
  wire        _io_vcalloc_req_valid_output = vcalloc_vals_0 | vcalloc_vals_1 | vcalloc_vals_2 | vcalloc_vals_4 | vcalloc_vals_5 | vcalloc_vals_6 | vcalloc_vals_8 | vcalloc_vals_9;	// @[InputUnit.scala:249:32, package.scala:73:59]
  ...
  assign vcalloc_vals_6 = states_6_g == 3'h2;	// @[InputUnit.scala:191:19, :199:26, :249:32]
  ...
  wire        _T_68 = io_vcalloc_req_ready & _io_vcalloc_req_valid_output;	// @[Decoupled.scala:51:35, package.scala:73:59]
  wire        _GEN = _T_68 & vcalloc_sel[0];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire        _GEN_0 = _T_68 & vcalloc_sel[1];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire        _GEN_1 = _T_68 & vcalloc_sel[2];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire        _GEN_2 = _T_68 & vcalloc_sel[4];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire        _GEN_3 = _T_68 & vcalloc_sel[5];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire        _GEN_4 = _T_68 & vcalloc_sel[6];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire        _GEN_5 = _T_68 & vcalloc_sel[8];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire        _GEN_6 = _T_68 & vcalloc_sel[9];	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :270:29, Mux.scala:29:36]
  wire [11:0] _credit_available_T_2 = {states_0_vc_sel_2_0, states_0_vc_sel_1_0, 9'h0, states_0_vc_sel_0_0} & {io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, 2'h3, io_out_credit_available_0_5, io_out_credit_available_0_4, 1'h1, io_out_credit_available_0_2, io_out_credit_available_0_1, io_out_credit_available_0_0};	// @[InputUnit.scala:191:19, :287:{40,47,73}]
  wire        _salloc_arb_io_in_0_valid_T_2 = states_0_g == 3'h3 & (|{_credit_available_T_2[11:10], _credit_available_T_2[0]}) & _input_buffer_io_deq_0_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{47,81}, :288:{22,50}]
  wire [11:0] _credit_available_T_5 = {states_1_vc_sel_2_0, states_1_vc_sel_1_0, 8'h0, states_1_vc_sel_0_1, states_1_vc_sel_0_0} & {io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, 2'h3, io_out_credit_available_0_5, io_out_credit_available_0_4, 1'h1, io_out_credit_available_0_2, io_out_credit_available_0_1, io_out_credit_available_0_0};	// @[InputUnit.scala:191:19, :287:{40,47,73}]
  wire        _salloc_arb_io_in_1_valid_T_2 = states_1_g == 3'h3 & (|{_credit_available_T_5[11:10], _credit_available_T_5[1:0]}) & _input_buffer_io_deq_1_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{47,81}, :288:{22,50}]
  wire [9:0]  _GEN_7 = {states_2_vc_sel_2_0, states_2_vc_sel_1_0, 7'h0, states_2_vc_sel_0_2} & {io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, 2'h3, io_out_credit_available_0_5, io_out_credit_available_0_4, 1'h1, io_out_credit_available_0_2};	// @[InputUnit.scala:191:19, :287:{40,47,73}]
  wire        _salloc_arb_io_in_2_valid_T_2 = states_2_g == 3'h3 & (|{_GEN_7[9:8], _GEN_7[0]}) & _input_buffer_io_deq_2_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{47,81}, :288:{22,50}]
  wire [7:0]  _GEN_8 = {io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, 2'h3, io_out_credit_available_0_5, io_out_credit_available_0_4};	// @[InputUnit.scala:287:73]
  wire [7:0]  _GEN_9 = {states_4_vc_sel_2_0, states_4_vc_sel_1_0, 5'h0, states_4_vc_sel_0_4} & _GEN_8;	// @[InputUnit.scala:191:19, :287:{40,47,73}]
  wire        _salloc_arb_io_in_4_valid_T_2 = states_4_g == 3'h3 & (|{_GEN_9[7:6], _GEN_9[0]}) & _input_buffer_io_deq_4_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{47,81}, :288:{22,50}]
  wire [7:0]  _GEN_10 = {states_5_vc_sel_2_0, states_5_vc_sel_1_0, 4'h0, states_5_vc_sel_0_5, states_5_vc_sel_0_4} & _GEN_8;	// @[InputUnit.scala:191:19, :199:20, :287:{40,47,73}]
  wire        _salloc_arb_io_in_5_valid_T_2 = states_5_g == 3'h3 & (|{_GEN_10[7:6], _GEN_10[1:0]}) & _input_buffer_io_deq_5_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{47,81}, :288:{22,50}]
  wire [5:0]  _GEN_11 = {states_6_vc_sel_2_0, states_6_vc_sel_1_0, 3'h0, states_6_vc_sel_0_6} & {io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, 2'h3};	// @[InputUnit.scala:191:19, :197:27, :287:{40,47,73}]
  wire        _salloc_arb_io_in_6_valid_T_2 = states_6_g == 3'h3 & (|{_GEN_11[5:4], _GEN_11[0]}) & _input_buffer_io_deq_6_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{47,81}, :288:{22,50}]
  wire [3:0]  _GEN_12 = {io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8};	// @[InputUnit.scala:287:73]
  wire [3:0]  _GEN_13 = {states_8_vc_sel_2_0, states_8_vc_sel_1_0, 1'h0, states_8_vc_sel_0_8} & _GEN_12;	// @[InputUnit.scala:191:19, :287:{40,47,73}]
  wire        _salloc_arb_io_in_8_valid_T_2 = states_8_g == 3'h3 & (|{_GEN_13[3:2], _GEN_13[0]}) & _input_buffer_io_deq_8_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{47,81}, :288:{22,50}]
  wire        _salloc_arb_io_in_9_valid_T_2 = states_9_g == 3'h3 & (|({states_9_vc_sel_2_0, states_9_vc_sel_1_0, states_9_vc_sel_0_9, states_9_vc_sel_0_8} & _GEN_12)) & _input_buffer_io_deq_9_valid;	// @[InputUnit.scala:180:28, :191:19, :253:82, :287:{40,47,73,81}, :288:{22,50}]
  ...
  wire        _T_135 = io_salloc_req_0_ready & _salloc_arb_io_out_0_valid;	// @[Decoupled.scala:51:35, InputUnit.scala:279:26]
  ...
  wire        _GEN_16 = _route_arbiter_io_out_valid & _route_arbiter_io_out_bits_src_virt_id == 4'h2;	// @[InputUnit.scala:186:29, :194:60, :199:20, :222:31, :227:{17,25}, :228:26]
  ...
  wire        _GEN_19 = _route_arbiter_io_out_valid & _route_arbiter_io_out_bits_src_virt_id == 4'h6;	// @[InputUnit.scala:186:29, :194:60, :199:20, :222:31, :227:{17,25}, :228:26]
  ...
  wire        at_dest = io_in_flit_0_bits_flow_egress_node == 4'h2;	// @[InputUnit.scala:198:57, :199:20]
  ...
  wire        _GEN_26 = io_in_flit_0_bits_virt_channel_id == 4'h2;	// @[InputUnit.scala:199:20]
  ...
  wire        _GEN_32 = io_in_flit_0_bits_virt_channel_id == 4'h6;	// @[InputUnit.scala:199:20]
  ...
  wire        _vc_sel_WIRE_7 = _salloc_arb_io_chosen_oh_0[6] & states_6_vc_sel_0_6;	// @[InputUnit.scala:191:19, :279:26, Mux.scala:27:73, :29:36]
  ...
  always @(posedge clock) begin
    ...
    else if (_T_68 & vcalloc_sel[0] | vcalloc_vals_0 & vcalloc_sel[0] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
    ...
    else if (_T_68 & vcalloc_sel[1] | vcalloc_vals_1 & vcalloc_sel[1] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
    ...
    else if (_T_68 & vcalloc_sel[2] | vcalloc_vals_2 & vcalloc_sel[2] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
    ...
    if (_GEN_1) begin	// @[InputUnit.scala:270:29]
      ...
      states_2_vc_sel_2_0 <= ~_GEN_16 & (_T ? _T_10 & _GEN_26 | ~_GEN_26 & states_2_vc_sel_2_0 : states_2_vc_sel_2_0);	// @[InputUnit.scala:191:19, :194:{32,60}, :199:20, :200:45, :202:{19,63}, :203:44, :222:31, :227:25, :228:26]
      states_2_vc_sel_1_0 <= ~_GEN_16 & (_T ? _T_9 & _GEN_26 | ~_GEN_26 & states_2_vc_sel_1_0 : states_2_vc_sel_1_0);	// @[InputUnit.scala:191:19, :194:{32,60}, :199:20, :200:45, :202:{19,63}, :203:44, :222:31, :227:25, :228:26]
      if (_GEN_16)	// @[InputUnit.scala:194:60, :222:31, :227:25, :228:26]
        ...
        states_2_vc_sel_0_2 <= ~_GEN_27 & states_2_vc_sel_0_2;	// @[InputUnit.scala:191:19, :194:60, :199:20, :200:45]
    end
    ...
    else if (_T_68 & vcalloc_sel[4] | vcalloc_vals_4 & vcalloc_sel[4] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
    ...
    else if (_T_68 & vcalloc_sel[5] | vcalloc_vals_5 & vcalloc_sel[5] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
    ...
    if (reset | _salloc_arb_io_in_6_ready & _salloc_arb_io_in_6_valid_T_2 & _input_buffer_io_deq_6_bits_tail)	// @[InputUnit.scala:180:28, :268:32, :279:26, :288:50, :292:{22,35}, :293:13, :377:23, :378:24]
      states_6_g <= 3'h0;	// @[InputUnit.scala:191:19, :197:27]
    else if (_T_68 & vcalloc_sel[6] | vcalloc_vals_6 & vcalloc_sel[6] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
      states_6_g <= 3'h3;	// @[InputUnit.scala:191:19, :253:82]
    else if (_route_arbiter_io_out_valid & _route_arbiter_io_out_bits_src_virt_id == 4'h6 | _route_arbiter_io_in_6_ready & _route_arbiter_io_in_6_valid_T)	// @[Decoupled.scala:51:35, InputUnit.scala:186:29, :194:60, :199:20, :212:22, :215:{23,29}, :222:31, :225:18]
      states_6_g <= 3'h2;	// @[InputUnit.scala:191:19, :199:26]
    else if (_GEN_33) begin	// @[InputUnit.scala:191:19, :194:60, :199:20]
      if (at_dest)	// @[InputUnit.scala:198:57]
        states_6_g <= 3'h2;	// @[InputUnit.scala:191:19, :199:26]
      else	// @[InputUnit.scala:198:57]
        states_6_g <= 3'h1;	// @[InputUnit.scala:191:19, :199:26]
    end
    if (_GEN_4) begin	// @[InputUnit.scala:270:29]
      states_6_vc_sel_2_0 <= io_vcalloc_resp_vc_sel_2_0;	// @[InputUnit.scala:191:19]
      states_6_vc_sel_1_0 <= io_vcalloc_resp_vc_sel_1_0;	// @[InputUnit.scala:191:19]
      states_6_vc_sel_0_6 <= io_vcalloc_resp_vc_sel_0_6;	// @[InputUnit.scala:191:19]
    end
    else begin	// @[InputUnit.scala:270:29]
      states_6_vc_sel_2_0 <= ~_GEN_19 & (_T ? _T_10 & _GEN_32 | ~_GEN_32 & states_6_vc_sel_2_0 : states_6_vc_sel_2_0);	// @[InputUnit.scala:191:19, :194:{32,60}, :199:20, :200:45, :202:{19,63}, :203:44, :222:31, :227:25, :228:26]
      states_6_vc_sel_1_0 <= ~_GEN_19 & (_T ? _T_9 & _GEN_32 | ~_GEN_32 & states_6_vc_sel_1_0 : states_6_vc_sel_1_0);	// @[InputUnit.scala:191:19, :194:{32,60}, :199:20, :200:45, :202:{19,63}, :203:44, :222:31, :227:25, :228:26]
      if (_GEN_19)	// @[InputUnit.scala:194:60, :222:31, :227:25, :228:26]
        states_6_vc_sel_0_6 <= io_router_resp_vc_sel_0_6;	// @[InputUnit.scala:191:19]
      else	// @[InputUnit.scala:194:60, :222:31, :227:25, :228:26]
        states_6_vc_sel_0_6 <= ~_GEN_33 & states_6_vc_sel_0_6;	// @[InputUnit.scala:191:19, :194:60, :199:20, :200:45]
    end
    if (_GEN_33) begin	// @[InputUnit.scala:191:19, :194:60, :199:20]
      states_6_flow_vnet_id <= io_in_flit_0_bits_flow_vnet_id;	// @[InputUnit.scala:191:19]
      states_6_flow_ingress_node <= io_in_flit_0_bits_flow_ingress_node;	// @[InputUnit.scala:191:19]
      states_6_flow_ingress_node_id <= io_in_flit_0_bits_flow_ingress_node_id;	// @[InputUnit.scala:191:19]
      states_6_flow_egress_node <= io_in_flit_0_bits_flow_egress_node;	// @[InputUnit.scala:191:19]
      states_6_flow_egress_node_id <= io_in_flit_0_bits_flow_egress_node_id;	// @[InputUnit.scala:191:19]
    end
    ...
    else if (_T_68 & vcalloc_sel[8] | vcalloc_vals_8 & vcalloc_sel[8] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
    ...
    else if (_T_68 & vcalloc_sel[9] | vcalloc_vals_9 & vcalloc_sel[9] & io_vcalloc_req_ready)	// @[Decoupled.scala:51:35, InputUnit.scala:222:31, :237:58, :249:32, :253:{51,76,82}, :268:32, :270:29, :272:21, Mux.scala:29:36]
    ...
    salloc_outs_0_valid <= _T_135;	// @[Decoupled.scala:51:35, InputUnit.scala:318:8]
    if (_salloc_arb_io_chosen_oh_0[0] & states_0_vc_sel_0_0 | _salloc_arb_io_chosen_oh_0[1] & states_1_vc_sel_0_0 | _vc_sel_WIRE_2 | _vc_sel_WIRE_3 | _vc_sel_WIRE_5 | _vc_sel_WIRE_6 | _vc_sel_WIRE_7 | _vc_sel_WIRE_9 | _vc_sel_WIRE_10)	// @[InputUnit.scala:191:19, :279:26, :334:43, Mux.scala:27:73, :29:36]
      salloc_outs_0_out_vid <= {|{_vc_sel_WIRE_10, _vc_sel_WIRE_9}, |{_vc_sel_WIRE_7, _vc_sel_WIRE_6, _vc_sel_WIRE_5}, _vc_sel_WIRE_7 | _vc_sel_WIRE_3, _vc_sel_WIRE_6 | _vc_sel_WIRE_10 | _vc_sel_WIRE_2};	// @[Cat.scala:33:92, InputUnit.scala:318:8, Mux.scala:27:73, OneHot.scala:30:18, :32:{14,28}]
    ...
    salloc_outs_0_flit_flow_vnet_id <= (_salloc_arb_io_chosen_oh_0[0] ? states_0_flow_vnet_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[1] ? states_1_flow_vnet_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[2] ? states_2_flow_vnet_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[4] ? states_4_flow_vnet_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[5] ? states_5_flow_vnet_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[6] ? states_6_flow_vnet_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[8] ? states_8_flow_vnet_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[9] ? states_9_flow_vnet_id : 3'h0);	// @[InputUnit.scala:191:19, :197:27, :279:26, :318:8, Mux.scala:27:73, :29:36]
    salloc_outs_0_flit_flow_ingress_node <= (_salloc_arb_io_chosen_oh_0[0] ? states_0_flow_ingress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[1] ? states_1_flow_ingress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[2] ? states_2_flow_ingress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[4] ? states_4_flow_ingress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[5] ? states_5_flow_ingress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[6] ? states_6_flow_ingress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[8] ? states_8_flow_ingress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[9] ? states_9_flow_ingress_node : 4'h0);	// @[InputUnit.scala:191:19, :199:20, :279:26, :318:8, Mux.scala:27:73, :29:36]
    salloc_outs_0_flit_flow_ingress_node_id <= (_salloc_arb_io_chosen_oh_0[0] ? states_0_flow_ingress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[1] ? states_1_flow_ingress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[2] ? states_2_flow_ingress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[4] ? states_4_flow_ingress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[5] ? states_5_flow_ingress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[6] ? states_6_flow_ingress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[8] ? states_8_flow_ingress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[9] ? states_9_flow_ingress_node_id : 3'h0);	// @[InputUnit.scala:191:19, :197:27, :279:26, :318:8, Mux.scala:27:73, :29:36]
    salloc_outs_0_flit_flow_egress_node <= (_salloc_arb_io_chosen_oh_0[0] ? states_0_flow_egress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[1] ? states_1_flow_egress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[2] ? states_2_flow_egress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[4] ? states_4_flow_egress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[5] ? states_5_flow_egress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[6] ? states_6_flow_egress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[8] ? states_8_flow_egress_node : 4'h0) | (_salloc_arb_io_chosen_oh_0[9] ? states_9_flow_egress_node : 4'h0);	// @[InputUnit.scala:191:19, :199:20, :279:26, :318:8, Mux.scala:27:73, :29:36]
    salloc_outs_0_flit_flow_egress_node_id <= (_salloc_arb_io_chosen_oh_0[0] ? states_0_flow_egress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[1] ? states_1_flow_egress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[2] ? states_2_flow_egress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[4] ? states_4_flow_egress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[5] ? states_5_flow_egress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[6] ? states_6_flow_egress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[8] ? states_8_flow_egress_node_id : 3'h0) | (_salloc_arb_io_chosen_oh_0[9] ? states_9_flow_egress_node_id : 3'h0);	// @[InputUnit.scala:191:19, :197:27, :279:26, :318:8, Mux.scala:27:73, :29:36]
    if (reset)
    ...
    else if (vcalloc_vals_0 | vcalloc_vals_1 | vcalloc_vals_2 | vcalloc_vals_4 | vcalloc_vals_5 | vcalloc_vals_6 | vcalloc_vals_8 | vcalloc_vals_9)	// @[InputUnit.scala:249:32, package.scala:73:59]
  ...
  `ifndef SYNTHESIS
    wire  [15:0][2:0] _GEN_38 = {{states_0_g}, {states_0_g}, {states_0_g}, {states_0_g}, {states_0_g}, {states_0_g}, {states_9_g}, {states_8_g}, {3'h0}, {states_6_g}, {states_5_g}, {states_4_g}, {3'h0}, {states_2_g}, {states_1_g}, {states_0_g}};	// @[InputUnit.scala:191:19, :197:27]
    always @(posedge clock) begin	// @[InputUnit.scala:196:13]
      ...
      if (_T_68 & vcalloc_sel[3] & ~reset) begin	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :274:17, Mux.scala:29:36]
        if (`ASSERT_VERBOSE_COND_)	// @[InputUnit.scala:274:17]
          $error("Assertion failed\n    at InputUnit.scala:274 assert(states(i).g === g_v)\n");	// @[InputUnit.scala:274:17]
        if (`STOP_COND_)	// @[InputUnit.scala:274:17]
          $fatal;	// @[InputUnit.scala:274:17]
      ...
      if (_GEN_4 & ~reset & ~vcalloc_vals_6) begin	// @[InputUnit.scala:249:32, :270:29, :274:17]
        if (`ASSERT_VERBOSE_COND_)	// @[InputUnit.scala:274:17]
          $error("Assertion failed\n    at InputUnit.scala:274 assert(states(i).g === g_v)\n");	// @[InputUnit.scala:274:17]
        if (`STOP_COND_)	// @[InputUnit.scala:274:17]
          $fatal;	// @[InputUnit.scala:274:17]
      end
      if (_T_68 & vcalloc_sel[7] & ~reset) begin	// @[Decoupled.scala:51:35, InputUnit.scala:237:58, :274:17, Mux.scala:29:36]
        if (`ASSERT_VERBOSE_COND_)	// @[InputUnit.scala:274:17]
          $error("Assertion failed\n    at InputUnit.scala:274 assert(states(i).g === g_v)\n");	// @[InputUnit.scala:274:17]
        if (`STOP_COND_)	// @[InputUnit.scala:274:17]
          $fatal;	// @[InputUnit.scala:274:17]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        states_0_vc_sel_2_0 = _RANDOM_0[3];	// @[InputUnit.scala:191:19]
        states_0_vc_sel_1_0 = _RANDOM_0[4];	// @[InputUnit.scala:191:19]
        states_0_vc_sel_0_0 = _RANDOM_0[5];	// @[InputUnit.scala:191:19]
        states_0_flow_vnet_id = _RANDOM_0[17:15];	// @[InputUnit.scala:191:19]
        states_0_flow_ingress_node = _RANDOM_0[21:18];	// @[InputUnit.scala:191:19]
        states_0_flow_ingress_node_id = _RANDOM_0[24:22];	// @[InputUnit.scala:191:19]
        states_0_flow_egress_node = _RANDOM_0[28:25];	// @[InputUnit.scala:191:19]
        states_0_flow_egress_node_id = _RANDOM_0[31:29];	// @[InputUnit.scala:191:19]
        states_1_g = _RANDOM_1[2:0];	// @[InputUnit.scala:191:19]
        states_1_vc_sel_2_0 = _RANDOM_1[3];	// @[InputUnit.scala:191:19]
        states_1_vc_sel_1_0 = _RANDOM_1[4];	// @[InputUnit.scala:191:19]
        states_1_vc_sel_0_0 = _RANDOM_1[5];	// @[InputUnit.scala:191:19]
        states_1_vc_sel_0_1 = _RANDOM_1[6];	// @[InputUnit.scala:191:19]
        states_1_flow_vnet_id = _RANDOM_1[17:15];	// @[InputUnit.scala:191:19]
        states_1_flow_ingress_node = _RANDOM_1[21:18];	// @[InputUnit.scala:191:19]
        states_1_flow_ingress_node_id = _RANDOM_1[24:22];	// @[InputUnit.scala:191:19]
        states_1_flow_egress_node = _RANDOM_1[28:25];	// @[InputUnit.scala:191:19]
        states_1_flow_egress_node_id = _RANDOM_1[31:29];	// @[InputUnit.scala:191:19]
        states_2_g = _RANDOM_2[2:0];	// @[InputUnit.scala:191:19]
        states_2_vc_sel_2_0 = _RANDOM_2[3];	// @[InputUnit.scala:191:19]
        states_2_vc_sel_1_0 = _RANDOM_2[4];	// @[InputUnit.scala:191:19]
        states_2_vc_sel_0_2 = _RANDOM_2[7];	// @[InputUnit.scala:191:19]
        states_2_flow_vnet_id = _RANDOM_2[17:15];	// @[InputUnit.scala:191:19]
        states_2_flow_ingress_node = _RANDOM_2[21:18];	// @[InputUnit.scala:191:19]
        states_2_flow_ingress_node_id = _RANDOM_2[24:22];	// @[InputUnit.scala:191:19]
        states_2_flow_egress_node = _RANDOM_2[28:25];	// @[InputUnit.scala:191:19]
        states_2_flow_egress_node_id = _RANDOM_2[31:29];	// @[InputUnit.scala:191:19]
        states_4_g = _RANDOM_4[2:0];	// @[InputUnit.scala:191:19]
        states_4_vc_sel_2_0 = _RANDOM_4[3];	// @[InputUnit.scala:191:19]
        states_4_vc_sel_1_0 = _RANDOM_4[4];	// @[InputUnit.scala:191:19]
        states_4_vc_sel_0_4 = _RANDOM_4[9];	// @[InputUnit.scala:191:19]
        states_4_flow_vnet_id = _RANDOM_4[17:15];	// @[InputUnit.scala:191:19]
        states_4_flow_ingress_node = _RANDOM_4[21:18];	// @[InputUnit.scala:191:19]
        states_4_flow_ingress_node_id = _RANDOM_4[24:22];	// @[InputUnit.scala:191:19]
        states_4_flow_egress_node = _RANDOM_4[28:25];	// @[InputUnit.scala:191:19]
        states_4_flow_egress_node_id = _RANDOM_4[31:29];	// @[InputUnit.scala:191:19]
        states_5_g = _RANDOM_5[2:0];	// @[InputUnit.scala:191:19]
        states_5_vc_sel_2_0 = _RANDOM_5[3];	// @[InputUnit.scala:191:19]
        states_5_vc_sel_1_0 = _RANDOM_5[4];	// @[InputUnit.scala:191:19]
        states_5_vc_sel_0_4 = _RANDOM_5[9];	// @[InputUnit.scala:191:19]
        states_5_vc_sel_0_5 = _RANDOM_5[10];	// @[InputUnit.scala:191:19]
        states_5_flow_vnet_id = _RANDOM_5[17:15];	// @[InputUnit.scala:191:19]
        states_5_flow_ingress_node = _RANDOM_5[21:18];	// @[InputUnit.scala:191:19]
        states_5_flow_ingress_node_id = _RANDOM_5[24:22];	// @[InputUnit.scala:191:19]
        states_5_flow_egress_node = _RANDOM_5[28:25];	// @[InputUnit.scala:191:19]
        states_5_flow_egress_node_id = _RANDOM_5[31:29];	// @[InputUnit.scala:191:19]
        states_6_g = _RANDOM_6[2:0];	// @[InputUnit.scala:191:19]
        states_6_vc_sel_2_0 = _RANDOM_6[3];	// @[InputUnit.scala:191:19]
        states_6_vc_sel_1_0 = _RANDOM_6[4];	// @[InputUnit.scala:191:19]
        states_6_vc_sel_0_6 = _RANDOM_6[11];	// @[InputUnit.scala:191:19]
        states_6_flow_vnet_id = _RANDOM_6[17:15];	// @[InputUnit.scala:191:19]
        states_6_flow_ingress_node = _RANDOM_6[21:18];	// @[InputUnit.scala:191:19]
        states_6_flow_ingress_node_id = _RANDOM_6[24:22];	// @[InputUnit.scala:191:19]
        states_6_flow_egress_node = _RANDOM_6[28:25];	// @[InputUnit.scala:191:19]
        states_6_flow_egress_node_id = _RANDOM_6[31:29];	// @[InputUnit.scala:191:19]
        states_8_g = _RANDOM_8[2:0];	// @[InputUnit.scala:191:19]
        states_8_vc_sel_2_0 = _RANDOM_8[3];	// @[InputUnit.scala:191:19]
        states_8_vc_sel_1_0 = _RANDOM_8[4];	// @[InputUnit.scala:191:19]
        states_8_vc_sel_0_8 = _RANDOM_8[13];	// @[InputUnit.scala:191:19]
        states_8_flow_vnet_id = _RANDOM_8[17:15];	// @[InputUnit.scala:191:19]
        states_8_flow_ingress_node = _RANDOM_8[21:18];	// @[InputUnit.scala:191:19]
        states_8_flow_ingress_node_id = _RANDOM_8[24:22];	// @[InputUnit.scala:191:19]
        states_8_flow_egress_node = _RANDOM_8[28:25];	// @[InputUnit.scala:191:19]
        states_8_flow_egress_node_id = _RANDOM_8[31:29];	// @[InputUnit.scala:191:19]
        states_9_g = _RANDOM_9[2:0];	// @[InputUnit.scala:191:19]
        states_9_vc_sel_2_0 = _RANDOM_9[3];	// @[InputUnit.scala:191:19]
        states_9_vc_sel_1_0 = _RANDOM_9[4];	// @[InputUnit.scala:191:19]
        states_9_vc_sel_0_8 = _RANDOM_9[13];	// @[InputUnit.scala:191:19]
        states_9_vc_sel_0_9 = _RANDOM_9[14];	// @[InputUnit.scala:191:19]
        states_9_flow_vnet_id = _RANDOM_9[17:15];	// @[InputUnit.scala:191:19]
        states_9_flow_ingress_node = _RANDOM_9[21:18];	// @[InputUnit.scala:191:19]
        states_9_flow_ingress_node_id = _RANDOM_9[24:22];	// @[InputUnit.scala:191:19]
        states_9_flow_egress_node = _RANDOM_9[28:25];	// @[InputUnit.scala:191:19]
        states_9_flow_egress_node_id = _RANDOM_9[31:29];	// @[InputUnit.scala:191:19]
        mask = _RANDOM_10[9:0];	// @[InputUnit.scala:233:21]
        salloc_outs_0_valid = _RANDOM_10[10];	// @[InputUnit.scala:233:21, :318:8]
        salloc_outs_0_out_vid = _RANDOM_10[18:15];	// @[InputUnit.scala:233:21, :318:8]
        salloc_outs_0_flit_head = _RANDOM_10[19];	// @[InputUnit.scala:233:21, :318:8]
        salloc_outs_0_flit_tail = _RANDOM_10[20];	// @[InputUnit.scala:233:21, :318:8]
        salloc_outs_0_flit_payload = {_RANDOM_10[31:21], _RANDOM_11, _RANDOM_12[29:0]};	// @[InputUnit.scala:233:21, :318:8]
        salloc_outs_0_flit_flow_vnet_id = {_RANDOM_12[31:30], _RANDOM_13[0]};	// @[InputUnit.scala:318:8]
        salloc_outs_0_flit_flow_ingress_node = _RANDOM_13[4:1];	// @[InputUnit.scala:318:8]
        salloc_outs_0_flit_flow_ingress_node_id = _RANDOM_13[7:5];	// @[InputUnit.scala:318:8]
        salloc_outs_0_flit_flow_egress_node = _RANDOM_13[11:8];	// @[InputUnit.scala:318:8]
        salloc_outs_0_flit_flow_egress_node_id = _RANDOM_13[14:12];	// @[InputUnit.scala:318:8]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  InputBuffer_2 input_buffer (	// @[InputUnit.scala:180:28]
    .clock                         (clock),
    .reset                         (reset),
    ...
    .io_deq_6_ready                (_salloc_arb_io_in_6_ready),	// @[InputUnit.scala:279:26]
  ...
  Arbiter route_arbiter (	// @[InputUnit.scala:186:29]
    ...
    .io_in_6_valid                     (_route_arbiter_io_in_6_valid_T),	// @[InputUnit.scala:212:22]
    .io_in_6_bits_src_virt_id          (4'h6),	// @[InputUnit.scala:199:20]
    .io_in_6_bits_flow_vnet_id         (states_6_flow_vnet_id),	// @[InputUnit.scala:191:19]
    .io_in_6_bits_flow_ingress_node    (states_6_flow_ingress_node),	// @[InputUnit.scala:191:19]
    .io_in_6_bits_flow_ingress_node_id (states_6_flow_ingress_node_id),	// @[InputUnit.scala:191:19]
    .io_in_6_bits_flow_egress_node     (states_6_flow_egress_node),	// @[InputUnit.scala:191:19]
    .io_in_6_bits_flow_egress_node_id  (states_6_flow_egress_node_id),	// @[InputUnit.scala:191:19]
    .io_in_7_valid                     (1'h0),
  ...
  SwitchArbiter salloc_arb (	// @[InputUnit.scala:279:26]
    ...
    .io_in_6_valid            (_salloc_arb_io_in_6_valid_T_2),	// @[InputUnit.scala:288:50]
    .io_in_6_bits_vc_sel_2_0  (states_6_vc_sel_2_0),	// @[InputUnit.scala:191:19]
    .io_in_6_bits_vc_sel_1_0  (states_6_vc_sel_1_0),	// @[InputUnit.scala:191:19]
    .io_in_6_bits_vc_sel_0_6  (states_6_vc_sel_0_6),	// @[InputUnit.scala:191:19]
    .io_in_6_bits_tail        (_input_buffer_io_deq_6_bits_tail),	// @[InputUnit.scala:180:28]
  ...
  assign io_vcalloc_req_bits_vc_sel_0_6 = vcalloc_sel[6] & states_6_vc_sel_0_6;	// @[InputUnit.scala:191:19, :237:58, Mux.scala:27:73, :29:36]
  ...
  assign io_debug_va_stall = {1'h0, {1'h0, {1'h0, vcalloc_vals_0} + {1'h0, vcalloc_vals_1}} + {1'h0, {1'h0, vcalloc_vals_2} + {1'h0, vcalloc_vals_4}}} + {1'h0, {1'h0, {1'h0, vcalloc_vals_5} + {1'h0, vcalloc_vals_6}} + {1'h0, {1'h0, vcalloc_vals_8} + {1'h0, vcalloc_vals_9}}} - {3'h0, io_vcalloc_req_ready};	// @[Bitwise.scala:51:90, InputUnit.scala:197:27, :249:32, :266:47]
  assign io_debug_sa_stall = {1'h0, {1'h0, {1'h0, _salloc_arb_io_in_0_valid_T_2 & ~_salloc_arb_io_in_0_ready} + {1'h0, _salloc_arb_io_in_1_valid_T_2 & ~_salloc_arb_io_in_1_ready}} + {1'h0, {1'h0, _salloc_arb_io_in_2_valid_T_2 & ~_salloc_arb_io_in_2_ready} + {1'h0, _salloc_arb_io_in_4_valid_T_2 & ~_salloc_arb_io_in_4_ready}}} + {1'h0, {1'h0, {1'h0, _salloc_arb_io_in_5_valid_T_2 & ~_salloc_arb_io_in_5_ready} + {1'h0, _salloc_arb_io_in_6_valid_T_2 & ~_salloc_arb_io_in_6_ready}} + {1'h0, {1'h0, _salloc_arb_io_in_8_valid_T_2 & ~_salloc_arb_io_in_8_ready} + {1'h0, _salloc_arb_io_in_9_valid_T_2 & ~_salloc_arb_io_in_9_ready}}};	// @[Bitwise.scala:51:90, InputUnit.scala:279:26, :288:50, :301:{67,70}]
  assign io_in_credit_return = _T_135 ? _salloc_arb_io_chosen_oh_0 : 10'h0;	// @[Decoupled.scala:51:35, InputUnit.scala:233:21, :279:26, :322:8]
  assign io_in_vc_free = _T_135 & (_salloc_arb_io_chosen_oh_0[0] & _input_buffer_io_deq_0_bits_tail | _salloc_arb_io_chosen_oh_0[1] & _input_buffer_io_deq_1_bits_tail | _salloc_arb_io_chosen_oh_0[2] & _input_buffer_io_deq_2_bits_tail | _salloc_arb_io_chosen_oh_0[3] & _input_buffer_io_deq_3_bits_tail | _salloc_arb_io_chosen_oh_0[4] & _input_buffer_io_deq_4_bits_tail | _salloc_arb_io_chosen_oh_0[5] & _input_buffer_io_deq_5_bits_tail | _salloc_arb_io_chosen_oh_0[6] & _input_buffer_io_deq_6_bits_tail | _salloc_arb_io_chosen_oh_0[7] & _input_buffer_io_deq_7_bits_tail | _salloc_arb_io_chosen_oh_0[8] & _input_buffer_io_deq_8_bits_tail | _salloc_arb_io_chosen_oh_0[9] & _input_buffer_io_deq_9_bits_tail) ? _salloc_arb_io_chosen_oh_0 : 10'h0;	// @[Decoupled.scala:51:35, InputUnit.scala:180:28, :233:21, :279:26, :325:{8,18}, Mux.scala:27:73, :29:36]
endmodule
