...
module TLAsyncCrossingSource_1(
  ...
  input  [5:0]  auto_out_d_mem_0_source,
  ...
  input  [5:0]  auto_out_d_mem_1_source,
  ...
  input  [5:0]  auto_out_d_mem_2_source,
  ...
  input  [5:0]  auto_out_d_mem_3_source,
  ...
  input  [5:0]  auto_out_d_mem_4_source,
  ...
  input  [5:0]  auto_out_d_mem_5_source,
  ...
  input  [5:0]  auto_out_d_mem_6_source,
  ...
  input  [5:0]  auto_out_d_mem_7_source,
  ...
  output [5:0]  auto_out_a_mem_0_source,
  ...
  output [5:0]  auto_out_a_mem_1_source,
  output [28:0] auto_out_a_mem_1_address,
  ...
  output [5:0]  auto_out_a_mem_2_source,
  output [28:0] auto_out_a_mem_2_address,
  ...
  output [5:0]  auto_out_a_mem_3_source,
  output [28:0] auto_out_a_mem_3_address,
  ...
  output [5:0]  auto_out_a_mem_4_source,
  output [28:0] auto_out_a_mem_4_address,
  ...
  output [5:0]  auto_out_a_mem_5_source,
  output [28:0] auto_out_a_mem_5_address,
  ...
  output [5:0]  auto_out_a_mem_6_source,
  output [28:0] auto_out_a_mem_6_address,
  ...
  output [5:0]  auto_out_a_mem_7_source,
  output [28:0] auto_out_a_mem_7_address,
  ...
  wire [5:0] _bundleIn_0_d_sink_io_deq_bits_source;	// @[AsyncQueue.scala:207:22]
  ...
  AsyncQueueSource_9 x1_a_source (	// @[AsyncQueue.scala:216:24]
    .clock                        (clock),
    .reset                        (reset),
  ...
  AsyncQueueSink_12 bundleIn_0_d_sink (	// @[AsyncQueue.scala:207:22]
    .clock                        (clock),
    .reset                        (reset),
