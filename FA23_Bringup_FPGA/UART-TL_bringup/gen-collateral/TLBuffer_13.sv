...
module TLBuffer_13(
  ...
  Queue_271 x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_272 bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_271 bundleOut_1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_272 bundleIn_1_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_271 bundleOut_2_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_272 bundleIn_2_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_271 bundleOut_3_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_272 bundleIn_3_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
