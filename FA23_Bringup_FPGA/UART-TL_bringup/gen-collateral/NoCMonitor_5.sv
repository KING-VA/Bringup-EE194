...
module NoCMonitor_5(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_550 = io_in_flit_0_bits_flow_ingress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_586 = io_in_flit_0_bits_flow_egress_node == 4'h6;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_141 = io_in_flit_0_bits_flow_ingress_node_id == 3'h2;	// @[Types.scala:55:25]
    wire         _T_143 = io_in_flit_0_bits_flow_egress_node_id == 3'h2;	// @[Types.scala:55:25, :56:24]
    wire         _T_578 = io_in_flit_0_bits_flow_ingress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_579 = io_in_flit_0_bits_flow_egress_node == 4'h5;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_585 = io_in_flit_0_bits_flow_ingress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_558 = io_in_flit_0_bits_flow_egress_node == 4'h7;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_394 = io_in_flit_0_bits_flow_ingress_node == 4'h4;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_388 = io_in_flit_0_bits_flow_egress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_358 = io_in_flit_0_bits_flow_ingress_node_id == 3'h1;	// @[Types.scala:55:25]
    wire         _T_360 = io_in_flit_0_bits_flow_egress_node_id == 3'h1;	// @[Types.scala:55:25, :56:24]
    wire         _T_564 = io_in_flit_0_bits_flow_ingress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_208 = io_in_flit_0_bits_flow_ingress_node_id == 3'h4;	// @[Types.scala:53:21, :55:25]
    wire         _T_395 = io_in_flit_0_bits_flow_egress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_381 = io_in_flit_0_bits_flow_egress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_588 = io_in_flit_0_bits_flow_ingress_node_id == 3'h0;	// @[Types.scala:53:21, :55:25]
    wire         _T_590 = io_in_flit_0_bits_flow_egress_node_id == 3'h0;	// @[Types.scala:53:21, :56:24]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:22:16]
      ...
      if (_T_4 & ~reset & ~((|io_in_flit_0_bits_virt_channel_id) | _T_550 & _T_586 & _T_141 & _T_143 | _T_578 & _T_586 & _T_141 & _T_143 | _T_550 & _T_579 & _T_141 & _T_143 | _T_585 & _T_558 & _T_141 & _T_143 | _T_585 & _T_579 & _T_141 & _T_143 | _T_578 & _T_579 & _T_141 & _T_143 | _T_550 & _T_558 & _T_141 & _T_143 | _T_578 & _T_558 & _T_141 & _T_143 | _T_585 & _T_586 & _T_141 & _T_143)) begin	// @[Monitor.scala:29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h1 | _T_550 & _T_586 & _T_141 & _T_143 | _T_578 & _T_586 & _T_141 & _T_143 | _T_550 & _T_579 & _T_141 & _T_143 | _T_585 & _T_558 & _T_141 & _T_143 | _T_585 & _T_579 & _T_141 & _T_143 | _T_578 & _T_579 & _T_141 & _T_143 | _T_550 & _T_558 & _T_141 & _T_143 | _T_578 & _T_558 & _T_141 & _T_143 | _T_585 & _T_586 & _T_141 & _T_143)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h3 | _T_394 & _T_388 & _T_358 & _T_360 | _T_394 & io_in_flit_0_bits_flow_egress_node == 4'h3 & _T_358 & _T_360 | _T_564 & _T_388 & _T_208 & _T_360 | _T_564 & _T_395 & _T_208 & _T_360 | _T_394 & _T_381 & _T_358 & _T_360 | _T_394 & _T_395 & _T_358 & _T_360 | _T_564 & _T_381 & _T_208 & _T_360)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h4 | _T_578 & _T_586 & _T_358 & _T_360 | _T_578 & _T_558 & _T_358 & _T_360 | _T_550 & _T_579 & _T_358 & _T_360 | _T_585 & _T_579 & _T_358 & _T_360 | _T_550 & _T_558 & _T_358 & _T_360 | _T_585 & _T_558 & _T_358 & _T_360 | _T_578 & _T_579 & _T_358 & _T_360 | _T_550 & _T_586 & _T_358 & _T_360 | _T_585 & _T_586 & _T_358 & _T_360)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h5 | _T_578 & _T_586 & _T_358 & _T_360 | _T_578 & _T_558 & _T_358 & _T_360 | _T_550 & _T_579 & _T_358 & _T_360 | _T_585 & _T_579 & _T_358 & _T_360 | _T_550 & _T_558 & _T_358 & _T_360 | _T_585 & _T_558 & _T_358 & _T_360 | _T_578 & _T_579 & _T_358 & _T_360 | _T_550 & _T_586 & _T_358 & _T_360 | _T_585 & _T_586 & _T_358 & _T_360)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h7 | _T_394 & _T_381 & _T_588 & _T_590 | _T_394 & _T_388 & _T_588 & _T_590 | _T_394 & _T_395 & _T_588 & _T_590)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h8 | _T_550 & _T_579 & _T_588 & _T_590 | _T_585 & _T_558 & _T_588 & _T_590 | _T_550 & _T_558 & _T_588 & _T_590 | _T_564 & _T_586 & _T_588 & _T_590 | _T_585 & _T_579 & _T_588 & _T_590 | _T_564 & _T_558 & _T_588 & _T_590 | _T_550 & _T_586 & _T_588 & _T_590 | _T_578 & _T_558 & _T_588 & _T_590 | _T_564 & _T_579 & _T_588 & _T_590 | _T_578 & _T_586 & _T_588 & _T_590 | _T_578 & _T_579 & _T_588 & _T_590 | _T_585 & _T_586 & _T_588 & _T_590)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h9 | _T_550 & _T_579 & _T_588 & _T_590 | _T_585 & _T_558 & _T_588 & _T_590 | _T_550 & _T_558 & _T_588 & _T_590 | _T_564 & _T_586 & _T_588 & _T_590 | _T_585 & _T_579 & _T_588 & _T_590 | _T_564 & _T_558 & _T_588 & _T_590 | _T_550 & _T_586 & _T_588 & _T_590 | _T_578 & _T_558 & _T_588 & _T_590 | _T_564 & _T_579 & _T_588 & _T_590 | _T_578 & _T_586 & _T_588 & _T_590 | _T_578 & _T_579 & _T_588 & _T_590 | _T_585 & _T_586 & _T_588 & _T_590)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
