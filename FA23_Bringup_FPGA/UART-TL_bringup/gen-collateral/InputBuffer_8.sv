...
module InputBuffer_8(
  ...
  output        io_deq_5_bits_head,
                io_deq_5_bits_tail,
  output [72:0] io_deq_5_bits_payload,
  output        io_deq_6_bits_head,
                io_deq_6_bits_tail,
  output [72:0] io_deq_6_bits_payload,
  output        io_deq_7_valid,
                io_deq_7_bits_head,
                io_deq_7_bits_tail,
  ...
  wire             _qs_6_io_deq_valid;	// @[InputUnit.scala:90:49]
  wire             _qs_5_io_enq_ready;	// @[InputUnit.scala:90:49]
  wire             _qs_5_io_deq_valid;	// @[InputUnit.scala:90:49]
  ...
  reg  [2:0]       heads_0;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_1;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_2;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_3;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_4;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_5;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_6;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_7;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_8;	// @[InputUnit.scala:86:24]
  reg  [2:0]       heads_9;	// @[InputUnit.scala:86:24]
  reg  [2:0]       tails_0;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_1;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_2;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_3;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_4;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_5;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_6;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_7;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_8;	// @[InputUnit.scala:87:24]
  reg  [2:0]       tails_9;	// @[InputUnit.scala:87:24]
  ...
  wire             _tails_T_30 = io_enq_0_bits_virt_channel_id == 4'h0;	// @[Mux.scala:29:36]
  ...
  wire             _tails_T_38 = io_enq_0_bits_virt_channel_id == 4'h8;	// @[InputUnit.scala:109:46, Mux.scala:29:36]
  ...
  wire [15:0][2:0] _GEN = {{tails_0}, {tails_0}, {tails_0}, {tails_0}, {tails_0}, {tails_0}, {tails_9}, {tails_8}, {tails_7}, {tails_6}, {tails_5}, {tails_4}, {tails_3}, {tails_2}, {tails_1}, {tails_0}};	// @[InputUnit.scala:87:24]
  wire [2:0]       mem_MPORT_addr = _GEN[io_enq_0_bits_virt_channel_id];
  ...
  wire [2:0]       head = (to_q_oh_enc[0] ? heads_0 : 3'h0) | (to_q_oh_enc[1] ? heads_1 : 3'h0) | (to_q_oh_enc[2] ? heads_2 : 3'h0) | (to_q_oh_enc[3] ? heads_3 : 3'h0) | (to_q_oh_enc[4] ? heads_4 : 3'h0) | (to_q_oh_enc[5] ? heads_5 : 3'h0) | (to_q_oh_enc[6] ? heads_6 : 3'h0) | (to_q_oh_enc[7] ? heads_7 : 3'h0) | (to_q_oh_enc[8] ? heads_8 : 3'h0) | (to_q_oh_enc[9] ? heads_9 : 3'h0);	// @[InputUnit.scala:86:{24,32}, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  ...
  wire             _tails_T_29 = mem_MPORT_addr == ({1'h0, {2{_tails_T_33}}} | {3{_tails_T_37}});	// @[InputUnit.scala:104:14, Mux.scala:27:73, :29:36]
  wire [2:0]       _tails_WIRE_2 = {_tails_T_37, 2'h0};	// @[Mux.scala:27:73, :29:36]
  wire [2:0]       _tails_T_60 = mem_MPORT_addr + 3'h1;	// @[InputUnit.scala:103:45, :106:14]
  ...
  wire             _heads_T_19 = head == ({1'h0, {2{to_q_oh_enc[3]}}} | {3{to_q_oh_enc[7]}});	// @[InputUnit.scala:123:16, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [2:0]       _heads_WIRE_2 = {to_q_oh_enc[7], 2'h0};	// @[Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [2:0]       _heads_T_40 = head + 3'h1;	// @[InputUnit.scala:103:45, :125:16, Mux.scala:27:73]
  always @(posedge clock) begin
    if (reset) begin
      heads_0 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_1 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_2 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_3 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_4 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_5 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_6 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_7 <= 3'h4;	// @[InputUnit.scala:86:{24,32}]
      heads_8 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      heads_9 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      tails_0 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_1 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_2 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_3 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_4 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_5 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_6 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_7 <= 3'h4;	// @[InputUnit.scala:86:32, :87:24]
      tails_8 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
      tails_9 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
    end
    else begin
      if (_T_21 & to_q == 4'h0) begin	// @[Cat.scala:33:92, InputUnit.scala:86:24, :120:27, :122:21, package.scala:73:59]
      ...
      if (_T_21 & to_q == 4'h8) begin	// @[Cat.scala:33:92, InputUnit.scala:86:24, :109:46, :120:27, :122:21, package.scala:73:59]
        if (_heads_T_19)	// @[InputUnit.scala:123:16]
      ...
      if (mem_MPORT_en & io_enq_0_bits_virt_channel_id == 4'h8) begin	// @[InputUnit.scala:87:24, :100:{27,44}, :103:45, :109:46]
        if (_tails_T_29)	// @[InputUnit.scala:104:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        heads_0 = _RANDOM_0[2:0];	// @[InputUnit.scala:86:24]
        heads_1 = _RANDOM_0[5:3];	// @[InputUnit.scala:86:24]
        heads_2 = _RANDOM_0[8:6];	// @[InputUnit.scala:86:24]
        heads_3 = _RANDOM_0[11:9];	// @[InputUnit.scala:86:24]
        heads_4 = _RANDOM_0[14:12];	// @[InputUnit.scala:86:24]
        heads_5 = _RANDOM_0[17:15];	// @[InputUnit.scala:86:24]
        heads_6 = _RANDOM_0[20:18];	// @[InputUnit.scala:86:24]
        heads_7 = _RANDOM_0[23:21];	// @[InputUnit.scala:86:24]
        heads_8 = _RANDOM_0[26:24];	// @[InputUnit.scala:86:24]
        heads_9 = _RANDOM_0[29:27];	// @[InputUnit.scala:86:24]
        tails_0 = {_RANDOM_0[31:30], _RANDOM_1[0]};	// @[InputUnit.scala:86:24, :87:24]
        tails_1 = _RANDOM_1[3:1];	// @[InputUnit.scala:87:24]
        tails_2 = _RANDOM_1[6:4];	// @[InputUnit.scala:87:24]
        tails_3 = _RANDOM_1[9:7];	// @[InputUnit.scala:87:24]
        tails_4 = _RANDOM_1[12:10];	// @[InputUnit.scala:87:24]
        tails_5 = _RANDOM_1[15:13];	// @[InputUnit.scala:87:24]
        tails_6 = _RANDOM_1[18:16];	// @[InputUnit.scala:87:24]
        tails_7 = _RANDOM_1[21:19];	// @[InputUnit.scala:87:24]
        tails_8 = _RANDOM_1[24:22];	// @[InputUnit.scala:87:24]
        tails_9 = _RANDOM_1[27:25];	// @[InputUnit.scala:87:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue qs_5 (	// @[InputUnit.scala:90:49]
    ...
    .io_deq_valid        (_qs_5_io_deq_valid),
  ...
  Queue qs_6 (	// @[InputUnit.scala:90:49]
    ...
    .io_deq_valid        (_qs_6_io_deq_valid),
  ...
  Queue qs_8 (	// @[InputUnit.scala:90:49]
    .clock               (clock),
    .reset               (reset),
    .io_enq_valid        (_GEN_8 | ~mem_MPORT_en & _T_2 & io_enq_0_bits_virt_channel_id == 4'h8),	// @[InputUnit.scala:91:31, :100:{27,44}, :107:{34,50}, :109:46, :120:27, :127:29, :128:32]
  ...
  Queue qs_9 (	// @[InputUnit.scala:90:49]
    ...
    .io_deq_valid        (_qs_9_io_deq_valid),
