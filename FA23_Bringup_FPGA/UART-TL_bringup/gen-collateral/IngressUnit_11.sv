...
module IngressUnit_11(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_WIRE = io_in_bits_egress_id == 3'h4;	// @[IngressUnit.scala:30:72]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(io_in_bits_egress_id == 3'h2 | _route_buffer_io_enq_bits_flow_egress_node_WIRE)) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_egress_node     ({3'h0, _route_buffer_io_enq_bits_flow_egress_node_WIRE}),	// @[IngressUnit.scala:30:72, :41:50]
  ...
  Queue_104 route_q (	// @[IngressUnit.scala:27:23]
    .clock                  (clock),
    .reset                  (reset),
  ...
  Queue_106 vcalloc_q (	// @[IngressUnit.scala:76:25]
    .clock                  (clock),
    .reset                  (reset),
