...
module NoCMonitor_6(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_464 = io_in_flit_0_bits_flow_ingress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_486 = io_in_flit_0_bits_flow_egress_node == 4'h6;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_96 = io_in_flit_0_bits_flow_ingress_node_id == 3'h2;	// @[Types.scala:55:25]
    wire         _T_98 = io_in_flit_0_bits_flow_egress_node_id == 3'h2;	// @[Types.scala:55:25, :56:24]
    wire         _T_485 = io_in_flit_0_bits_flow_ingress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_472 = io_in_flit_0_bits_flow_egress_node == 4'h7;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_478 = io_in_flit_0_bits_flow_ingress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_351 = io_in_flit_0_bits_flow_ingress_node == 4'h4;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_352 = io_in_flit_0_bits_flow_egress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_297 = io_in_flit_0_bits_flow_ingress_node_id == 3'h1;	// @[Types.scala:55:25]
    wire         _T_299 = io_in_flit_0_bits_flow_egress_node_id == 3'h1;	// @[Types.scala:55:25, :56:24]
    wire         _T_172 = io_in_flit_0_bits_flow_egress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_457 = io_in_flit_0_bits_flow_ingress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_188 = io_in_flit_0_bits_flow_ingress_node_id == 3'h4;	// @[Types.scala:53:21, :55:25]
    wire         _T_344 = io_in_flit_0_bits_flow_ingress_node == 4'h5;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_338 = io_in_flit_0_bits_flow_egress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_324 = io_in_flit_0_bits_flow_egress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_488 = io_in_flit_0_bits_flow_ingress_node_id == 3'h0;	// @[Types.scala:53:21, :55:25]
    wire         _T_490 = io_in_flit_0_bits_flow_egress_node_id == 3'h0;	// @[Types.scala:53:21, :56:24]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:22:16]
      ...
      if (_T_4 & ~reset & ~((|io_in_flit_0_bits_virt_channel_id) | _T_464 & _T_486 & _T_96 & _T_98 | _T_485 & _T_472 & _T_96 & _T_98 | _T_464 & _T_472 & _T_96 & _T_98 | _T_478 & _T_486 & _T_96 & _T_98 | _T_478 & _T_472 & _T_96 & _T_98 | _T_485 & _T_486 & _T_96 & _T_98)) begin	// @[Monitor.scala:29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h1 | _T_464 & _T_486 & _T_96 & _T_98 | _T_485 & _T_472 & _T_96 & _T_98 | _T_464 & _T_472 & _T_96 & _T_98 | _T_478 & _T_486 & _T_96 & _T_98 | _T_478 & _T_472 & _T_96 & _T_98 | _T_485 & _T_486 & _T_96 & _T_98)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h3 | _T_351 & _T_352 & _T_297 & _T_299 | _T_351 & _T_172 & _T_297 & _T_299 | _T_457 & _T_352 & _T_188 & _T_299 | _T_344 & _T_338 & _T_297 & _T_299 | _T_351 & _T_324 & _T_297 & _T_299 | _T_351 & _T_338 & _T_297 & _T_299 | _T_344 & _T_352 & _T_297 & _T_299 | _T_457 & _T_324 & _T_188 & _T_299 | _T_344 & _T_172 & _T_297 & _T_299 | _T_344 & _T_324 & _T_297 & _T_299 | _T_457 & _T_338 & _T_188 & _T_299)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h4 | _T_478 & _T_486 & _T_297 & _T_299 | _T_478 & _T_472 & _T_297 & _T_299 | _T_464 & _T_472 & _T_297 & _T_299 | _T_485 & _T_472 & _T_297 & _T_299 | _T_464 & _T_486 & _T_297 & _T_299 | _T_485 & _T_486 & _T_297 & _T_299)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h5 | _T_478 & _T_486 & _T_297 & _T_299 | _T_478 & _T_472 & _T_297 & _T_299 | _T_464 & _T_472 & _T_297 & _T_299 | _T_485 & _T_472 & _T_297 & _T_299 | _T_464 & _T_486 & _T_297 & _T_299 | _T_485 & _T_486 & _T_297 & _T_299)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h7 | _T_351 & _T_324 & _T_488 & _T_490 | _T_344 & _T_324 & _T_488 & _T_490 | _T_344 & _T_338 & _T_488 & _T_490 | _T_351 & _T_338 & _T_488 & _T_490 | _T_344 & _T_352 & _T_488 & _T_490 | _T_351 & _T_352 & _T_488 & _T_490)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h8 | _T_485 & _T_472 & _T_488 & _T_490 | _T_464 & _T_472 & _T_488 & _T_490 | _T_457 & _T_486 & _T_488 & _T_490 | _T_457 & _T_472 & _T_488 & _T_490 | _T_464 & _T_486 & _T_488 & _T_490 | _T_478 & _T_472 & _T_488 & _T_490 | _T_478 & _T_486 & _T_488 & _T_490 | _T_485 & _T_486 & _T_488 & _T_490)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h9 | _T_485 & _T_472 & _T_488 & _T_490 | _T_464 & _T_472 & _T_488 & _T_490 | _T_457 & _T_486 & _T_488 & _T_490 | _T_457 & _T_472 & _T_488 & _T_490 | _T_464 & _T_486 & _T_488 & _T_490 | _T_478 & _T_472 & _T_488 & _T_490 | _T_478 & _T_486 & _T_488 & _T_490 | _T_485 & _T_486 & _T_488 & _T_490)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
