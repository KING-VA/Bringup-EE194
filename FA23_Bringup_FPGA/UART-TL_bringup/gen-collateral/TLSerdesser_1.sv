...
module TLSerdesser_1(
  ...
  input  [34:0] auto_manager_in_a_bits_address,
  ...
  output [4:0]  auto_manager_in_d_bits_sink,
  ...
  output [34:0] auto_client_out_a_bits_address,
  ...
  wire [34:0] _outArb_io_out_bits_address;	// @[Serdes.scala:622:24]
  ...
  TLMonitor_94 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_sink    (_inDes_io_out_bits_union[5:1]),	// @[Serdes.scala:465:17, :629:23]
  ...
  assign auto_manager_in_d_bits_sink = _inDes_io_out_bits_union[5:1];	// @[Serdes.scala:465:17, :629:23]
