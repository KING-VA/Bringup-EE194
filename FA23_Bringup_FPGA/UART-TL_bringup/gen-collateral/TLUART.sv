...
module TLUART(
  ...
  wire [3:0][63:0] _GEN = {{{48'h0, div}}, {{30'h0, ip_rxwm, ip_txwm, 30'h0, ie_rxwm, ie_txwm}}, {{7'h0, rxwm, 15'h0, rxen, 7'h0, txwm, 14'h0, nstop, txen}}, {{~_rxq_io_deq_valid, 23'h0, _rxq_io_deq_bits, ~_txq_io_enq_ready, 31'h0}}};	// @[Cat.scala:33:92, MuxLiteral.scala:49:{10,48}, RegMapFIFO.scala:24:9, :45:21, RegisterRouter.scala:82:24, UART.scala:79:19, :82:19, :84:16, :90:17, :91:17, :98:17, :99:17, :100:18, :134:15, :137:28, :138:28]
  ...
  QueueCompatibility_8 txq (	// @[UART.scala:79:19]
    .clock        (clock),
    .reset        (reset),
  ...
  QueueCompatibility_8 rxq (	// @[UART.scala:82:19]
    .clock        (clock),
    .reset        (reset),
