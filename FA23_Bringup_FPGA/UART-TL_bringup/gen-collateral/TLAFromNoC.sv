...
module TLAFromNoC(
  ...
  output [34:0] io_protocol_bits_address,
  ...
  assign io_protocol_bits_source = _GEN[39:35];	// @[Tilelink.scala:87:18, :94:22, :95:13]
  assign io_protocol_bits_address = _GEN[34:0];	// @[Tilelink.scala:87:18, :94:22]
