...
module TLMonitor_44(
  ...
  wire         _T_884 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_808 = _T_884 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire [514:0] _a_opcodes_set_T_1 = {511'h0, _T_808 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:52:29]
  wire [526:0] _d_sizes_clr_T_5 = 527'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [514:0] _a_sizes_set_T_1 = {511'h0, _T_808 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  wire         _T_957 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_803 = _T_957 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  wire         _T_823 = _T_957 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_884) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_957) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_808 ? _a_set_T[57:0] : 58'h0)) & ~(_T_823 ? _d_clr_T[57:0] : 58'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_808 ? _a_opcodes_set_T_1[231:0] : 232'h0)) & ~(_T_823 ? _d_opcodes_clr_T_5[231:0] : 232'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_808 ? _a_sizes_set_T_1[231:0] : 232'h0)) & ~(_T_823 ? _d_sizes_clr_T_5[231:0] : 232'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_884 | _T_957)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_884 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_803) begin	// @[Monitor.scala:549:20]
      opcode_1 <= io_in_d_bits_opcode;	// @[Monitor.scala:535:22]
      param_1 <= 2'h0;	// @[Monitor.scala:536:22]
      size_1 <= io_in_d_bits_size;	// @[Monitor.scala:537:22]
      source_1 <= io_in_d_bits_source;	// @[Monitor.scala:538:22]
    end
    sink <= ~_T_803 & sink;	// @[Monitor.scala:539:22, :549:{20,32}, :554:15]
    denied <= ~_T_803 & denied;	// @[Monitor.scala:539:22, :540:22, :549:{20,32}, :554:15, :555:15]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    wire             source_ok = (&(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h2 & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h1 & io_in_a_bits_source[3:0] < 4'hA | ~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA;	// @[Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             _T_208 = io_in_a_bits_size > 3'h2;	// @[Misc.scala:205:21, Monitor.scala:640:42]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Misc.scala:208:26, OneHot.scala:63:49, Parameters.scala:54:32]
    wire             mask_acc = _T_208 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_208 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire             source_ok_1 = (&(io_in_d_bits_source[5:4])) & io_in_d_bits_source[3:0] < 4'hA | io_in_d_bits_source[5:4] == 2'h2 & io_in_d_bits_source[3:0] < 4'hA | io_in_d_bits_source[5:4] == 2'h1 & io_in_d_bits_source[3:0] < 4'hA | io_in_d_bits_source[5:4] == 2'h0 & io_in_d_bits_source[3:0] < 4'hA;	// @[Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             _T_753 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_777 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    wire  [231:0]    _GEN_22 = {224'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44]
    wire  [231:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_22;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire             _T_856 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    wire             _T_827 = _T_856 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    wire             same_cycle_resp = _same_cycle_resp_T_1 & io_in_a_bits_source == io_in_d_bits_source;	// @[Monitor.scala:648:26, :681:{88,113}]
    wire  [57:0]     _GEN_23 = {52'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    wire             _GEN_24 = _T_827 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_25 = _T_827 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _T_913 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [57:0]     _T_809 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [57:0]     _T_828 = inflight >> _GEN_23;	// @[Monitor.scala:611:27, :682:25]
    wire  [231:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_22;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [63:0]     _d_clr_wo_ready_T = 64'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [57:0]     _T_914 = 58'h0 >> _GEN_23;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [231:0]    _c_size_lookup_T_1 = 232'h0 >> _GEN_22;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      if (io_in_a_valid & ~reset & ~((~((&(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA) | io_in_a_bits_address[7:6] == 2'h0) & (~(io_in_a_bits_source[5:4] == 2'h2 & io_in_a_bits_source[3:0] < 4'hA) | io_in_a_bits_address[7:6] == 2'h1) & (~(io_in_a_bits_source[5:4] == 2'h1 & io_in_a_bits_source[3:0] < 4'hA) | io_in_a_bits_address[7:6] == 2'h2) & (~(~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA) | (&(io_in_a_bits_address[7:6]))))) begin	// @[Monitor.scala:42:11, :63:{7,36}, :65:16, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :137:{45,65}]
      ...
      if (_GEN_8 & ~reset & ~_T_208) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_208) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~((&(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h2 & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h1 & io_in_a_bits_source[3:0] < 4'hA | ~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel carries Get type which master claims it can't emit (connected at MemoryBus.scala:47:50)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size != 3'h7 & io_in_a_bits_address[27:16] == 12'h800)) begin	// @[Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:{31,65}, :670:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(((&(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h2 & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h1 & io_in_a_bits_source[3:0] < 4'hA | ~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[27:16] == 12'h800)) begin	// @[Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(((&(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h2 & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h1 & io_in_a_bits_source[3:0] < 4'hA | ~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA) & io_in_a_bits_size != 3'h7 & io_in_a_bits_address[27:16] == 12'h800)) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_856 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_856 & ~d_release_ack ? _d_clr_wo_ready_T[57:0] : 58'h0) | a_set_wo_ready == 58'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_913 & ~reset & ~(_T_914[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at MemoryBus.scala:47:50)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_913 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin	// @[Monitor.scala:49:11, :747:42, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at MemoryBus.scala:47:50)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:18], _RANDOM_1[13:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        inflight = {_RANDOM_2[31:1], _RANDOM_3[26:0]};	// @[Monitor.scala:540:22, :611:27]
        inflight_opcodes = {_RANDOM_3[31:27], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11[2:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_11[31:3], _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18[10:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_18[13:11];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_18[16:14];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_18[31:17], _RANDOM_19[16:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = {_RANDOM_35[31:30], _RANDOM_36[0]};	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
