...
module AsyncQueueSink_10(
  ...
  input  [2:0]  io_async_mem_0_opcode,
                ...
                io_async_mem_0_size,
  input  [5:0]  io_async_mem_0_source,
  ...
  input  [2:0]  io_async_mem_1_opcode,
                ...
                io_async_mem_1_size,
  input  [5:0]  io_async_mem_1_source,
  input  [28:0] io_async_mem_1_address,
  ...
  input  [2:0]  io_async_mem_2_opcode,
                ...
                io_async_mem_2_size,
  input  [5:0]  io_async_mem_2_source,
  input  [28:0] io_async_mem_2_address,
  ...
  input  [2:0]  io_async_mem_3_opcode,
                ...
                io_async_mem_3_size,
  input  [5:0]  io_async_mem_3_source,
  input  [28:0] io_async_mem_3_address,
  ...
  input  [2:0]  io_async_mem_4_opcode,
                ...
                io_async_mem_4_size,
  input  [5:0]  io_async_mem_4_source,
  input  [28:0] io_async_mem_4_address,
  ...
  input  [2:0]  io_async_mem_5_opcode,
                ...
                io_async_mem_5_size,
  input  [5:0]  io_async_mem_5_source,
  input  [28:0] io_async_mem_5_address,
  ...
  input  [2:0]  io_async_mem_6_opcode,
                ...
                io_async_mem_6_size,
  input  [5:0]  io_async_mem_6_source,
  input  [28:0] io_async_mem_6_address,
  ...
  input  [2:0]  io_async_mem_7_opcode,
                ...
                io_async_mem_7_size,
  input  [5:0]  io_async_mem_7_source,
  input  [28:0] io_async_mem_7_address,
  ...
  wire [116:0]     _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  wire [7:0][2:0]  _GEN_1 = {{io_async_mem_7_size}, {io_async_mem_6_size}, {io_async_mem_5_size}, {io_async_mem_4_size}, {io_async_mem_3_size}, {io_async_mem_2_size}, {io_async_mem_1_size}, {io_async_mem_0_size}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0][5:0]  _GEN_2 = {{io_async_mem_7_source}, {io_async_mem_6_source}, {io_async_mem_5_source}, {io_async_mem_4_source}, {io_async_mem_3_source}, {io_async_mem_2_source}, {io_async_mem_1_source}, {io_async_mem_0_source}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0][28:0] _GEN_3 = {{io_async_mem_7_address}, {io_async_mem_6_address}, {io_async_mem_5_address}, {io_async_mem_4_address}, {io_async_mem_3_address}, {io_async_mem_2_address}, {io_async_mem_1_address}, {io_async_mem_0_address}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0][7:0]  _GEN_4 = {{io_async_mem_7_mask}, {io_async_mem_6_mask}, {io_async_mem_5_mask}, {io_async_mem_4_mask}, {io_async_mem_3_mask}, {io_async_mem_2_mask}, {io_async_mem_1_mask}, {io_async_mem_0_mask}};	// @[SynchronizerReg.scala:209:24]
  ...
  ClockCrossingReg_w117 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[116:114];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[113:111];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[110:108];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[107:102];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_address = _io_deq_bits_deq_bits_reg_io_q[101:73];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_mask = _io_deq_bits_deq_bits_reg_io_q[72:65];	// @[SynchronizerReg.scala:207:25, :211:26]
