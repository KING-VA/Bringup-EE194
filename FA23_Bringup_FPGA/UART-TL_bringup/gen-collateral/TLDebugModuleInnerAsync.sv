...
module TLDebugModuleInnerAsync(
  ...
  TLAsyncCrossingSink_9 dmiXing (	// @[Debug.scala:1848:27]
    .clock                         (io_debug_clock),
    .reset                         (io_debug_reset),
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_224 dmactive_synced_dmactive_synced_dmactiveSync (	// @[ShiftReg.scala:45:23]
    .clock (io_debug_clock),
    .reset (io_debug_reset),
    .io_d  (io_dmactive),
    .io_q  (_dmactive_synced_dmactive_synced_dmactiveSync_io_q)
  );
  AsyncQueueSink_30 dmactive_synced_dmInner_io_innerCtrl_sink (	// @[AsyncQueue.scala:207:22]
    .clock                        (io_debug_clock),
    .reset                        (io_debug_reset),
