...
module TLBToNoC_1(
  ...
  Queue_213 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_egress_id = {_q_io_deq_bits_source[4:2] == 3'h2, _q_io_deq_bits_source[4:2] == 3'h3, 1'h0} | (_q_io_deq_bits_source[4:3] == 2'h0 ? 3'h6 : 3'h0);	// @[Edges.scala:228:27, Mux.scala:27:73, Parameters.scala:54:{10,32}, Tilelink.scala:45:17]
endmodule
