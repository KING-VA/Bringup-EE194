...
module IngressUnit_12(
  ...
  wire        _route_q_io_deq_bits_vc_sel_5_0;	// @[IngressUnit.scala:27:23]
  wire        _route_q_io_deq_bits_vc_sel_4_0;	// @[IngressUnit.scala:27:23]
  ...
  wire        _route_q_io_deq_bits_vc_sel_0_5;	// @[IngressUnit.scala:27:23]
  wire        _route_q_io_deq_bits_vc_sel_0_6;	// @[IngressUnit.scala:27:23]
  wire        _route_q_io_deq_bits_vc_sel_0_7;	// @[IngressUnit.scala:27:23]
  wire        _route_q_io_deq_bits_vc_sel_0_8;	// @[IngressUnit.scala:27:23]
  wire        _route_q_io_deq_bits_vc_sel_0_9;	// @[IngressUnit.scala:27:23]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (4'h0),	// @[IngressUnit.scala:36:35]
    .io_enq_bits_flow_ingress_node_id (3'h0),	// @[IngressUnit.scala:36:35]
    .io_enq_bits_flow_egress_node     (4'h0),	// @[IngressUnit.scala:36:35]
    .io_enq_bits_flow_egress_node_id  (3'h0),	// @[IngressUnit.scala:36:35]
    .io_enq_bits_virt_channel_id      (4'h0),	// @[IngressUnit.scala:36:35]
  ...
  Queue_83 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_deq_bits_vc_sel_5_0 (_route_q_io_deq_bits_vc_sel_5_0),
    .io_deq_bits_vc_sel_4_0 (_route_q_io_deq_bits_vc_sel_4_0),
    ...
    .io_deq_bits_vc_sel_0_5 (_route_q_io_deq_bits_vc_sel_0_5),
    .io_deq_bits_vc_sel_0_6 (_route_q_io_deq_bits_vc_sel_0_6),
    .io_deq_bits_vc_sel_0_7 (_route_q_io_deq_bits_vc_sel_0_7),
    .io_deq_bits_vc_sel_0_8 (_route_q_io_deq_bits_vc_sel_0_8),
    .io_deq_bits_vc_sel_0_9 (_route_q_io_deq_bits_vc_sel_0_9)
  );
