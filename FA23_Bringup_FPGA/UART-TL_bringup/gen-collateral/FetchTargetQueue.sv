...
module FetchTargetQueue(
  ...
  input  [49:0] io_enq_bits_bpd_meta_0,
  input         io_deq_valid,
  ...
  output [49:0] io_bpdupdate_bits_meta_0,
  ...
  wire [15:0]       ghist_1_MPORT_1_data_old_history;	// @[fetch-target-queue.scala:178:24]
  wire [23:0]       _ghist_1_R0_data;	// @[fetch-target-queue.scala:144:43]
  wire [23:0]       _ghist_0_R0_data;	// @[fetch-target-queue.scala:144:43]
  ...
  wire [23:0]       _GEN = {ghist_1_MPORT_1_data_ras_idx, ghist_1_MPORT_1_data_new_saw_branch_taken, ghist_1_MPORT_1_data_new_saw_branch_not_taken, io_enq_bits_ghist_current_saw_branch_not_taken, ghist_1_MPORT_1_data_old_history};	// @[fetch-target-queue.scala:144:43, :178:24]
  ...
  wire [15:0]       new_ghist_new_history_old_history = _new_ghist_new_history_old_history_T & prev_entry_cfi_idx_valid ? {prev_ghist_old_history[14:0], 1'h1} : (|(prev_entry_br_mask & (prev_entry_cfi_idx_valid ? (new_ghist_cfi_idx_oh | {1'h0, &prev_entry_cfi_idx_bits, _GEN_1[1], _GEN_1[0] | (&prev_entry_cfi_idx_bits)}) & ~(_new_ghist_new_history_old_history_T ? new_ghist_cfi_idx_oh : 4'h0) : 4'hF))) | prev_ghist_current_saw_branch_not_taken ? {prev_ghist_old_history[14:0], 1'h0} : prev_ghist_old_history;	// @[OneHot.scala:57:35, fetch-target-queue.scala:155:27, :156:27, :160:28, frontend.scala:90:{39,44}, :91:{67,69,73,84}, :98:{53,61}, :99:{37,61,91}, :100:37, util.scala:373:{29,45}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      prev_ghist_old_history <= 16'h0;	// @[fetch-target-queue.scala:155:{27,42}]
      ...
      if (io_redirect_valid | ~REG_3) begin	// @[fetch-target-queue.scala:158:17, :314:28, :332:{23,44}]
        ...
        prev_ghist_old_history <= _ghist_0_R0_data[15:0];	// @[fetch-target-queue.scala:144:43, :155:27]
        prev_ghist_current_saw_branch_not_taken <= _ghist_0_R0_data[16];	// @[fetch-target-queue.scala:144:43, :155:27]
        prev_ghist_ras_idx <= _ghist_0_R0_data[23:19];	// @[fetch-target-queue.scala:144:43, :155:27]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        prev_ghist_old_history = {_RANDOM_50[31:28], _RANDOM_51[11:0]};	// @[fetch-target-queue.scala:143:21, :155:27]
        prev_ghist_current_saw_branch_not_taken = _RANDOM_51[12];	// @[fetch-target-queue.scala:155:27]
        prev_ghist_ras_idx = _RANDOM_51[19:15];	// @[fetch-target-queue.scala:155:27]
        prev_entry_cfi_idx_valid = _RANDOM_51[20];	// @[fetch-target-queue.scala:155:27, :156:27]
        prev_entry_cfi_idx_bits = _RANDOM_51[22:21];	// @[fetch-target-queue.scala:155:27, :156:27]
        prev_entry_cfi_taken = _RANDOM_51[23];	// @[fetch-target-queue.scala:155:27, :156:27]
        prev_entry_br_mask = _RANDOM_51[31:28];	// @[fetch-target-queue.scala:155:27, :156:27]
        prev_entry_cfi_is_call = _RANDOM_52[0];	// @[fetch-target-queue.scala:156:27]
        prev_entry_cfi_is_ret = _RANDOM_52[1];	// @[fetch-target-queue.scala:156:27]
        first_empty = _RANDOM_54[25];	// @[fetch-target-queue.scala:214:28]
        io_ras_update_REG = _RANDOM_54[26];	// @[fetch-target-queue.scala:214:28, :222:31]
        io_ras_update_pc_REG = {_RANDOM_54[31:27], _RANDOM_55, _RANDOM_56[2:0]};	// @[fetch-target-queue.scala:214:28, :223:31]
        io_ras_update_idx_REG = _RANDOM_56[7:3];	// @[fetch-target-queue.scala:223:31, :224:31]
        bpd_update_mispredict = _RANDOM_56[8];	// @[fetch-target-queue.scala:223:31, :226:38]
        bpd_update_repair = _RANDOM_56[9];	// @[fetch-target-queue.scala:223:31, :227:34]
        bpd_repair_idx = _RANDOM_56[13:10];	// @[fetch-target-queue.scala:223:31, :228:27]
        bpd_end_idx = _RANDOM_56[17:14];	// @[fetch-target-queue.scala:223:31, :229:24]
        bpd_repair_pc = {_RANDOM_56[31:18], _RANDOM_57[25:0]};	// @[fetch-target-queue.scala:223:31, :230:26]
        bpd_entry_cfi_idx_valid = _RANDOM_57[26];	// @[fetch-target-queue.scala:230:26, :234:26]
        bpd_entry_cfi_idx_bits = _RANDOM_57[28:27];	// @[fetch-target-queue.scala:230:26, :234:26]
        bpd_entry_cfi_taken = _RANDOM_57[29];	// @[fetch-target-queue.scala:230:26, :234:26]
        bpd_entry_cfi_mispredicted = _RANDOM_57[30];	// @[fetch-target-queue.scala:230:26, :234:26]
        bpd_entry_cfi_type = {_RANDOM_57[31], _RANDOM_58[1:0]};	// @[fetch-target-queue.scala:230:26, :234:26]
        bpd_entry_br_mask = _RANDOM_58[5:2];	// @[fetch-target-queue.scala:234:26]
        bpd_pc = {_RANDOM_59[31:23], _RANDOM_60[30:0]};	// @[fetch-target-queue.scala:242:26]
        bpd_target = {_RANDOM_60[31], _RANDOM_61, _RANDOM_62[6:0]};	// @[fetch-target-queue.scala:242:26, :243:27]
        REG = _RANDOM_62[7];	// @[fetch-target-queue.scala:243:27, :248:23]
        bpd_repair_idx_REG = _RANDOM_62[11:8];	// @[fetch-target-queue.scala:243:27, :250:37]
        bpd_end_idx_REG = _RANDOM_62[15:12];	// @[fetch-target-queue.scala:243:27, :251:37]
        REG_1 = _RANDOM_62[16];	// @[fetch-target-queue.scala:243:27, :256:44]
        do_commit_update_REG = _RANDOM_62[17];	// @[fetch-target-queue.scala:243:27, :274:61]
        REG_2 = _RANDOM_62[18];	// @[fetch-target-queue.scala:243:27, :278:16]
        io_bpdupdate_valid_REG = _RANDOM_62[19];	// @[fetch-target-queue.scala:243:27, :284:37]
        io_bpdupdate_bits_is_mispredict_update_REG = _RANDOM_62[20];	// @[fetch-target-queue.scala:243:27, :285:54]
        io_bpdupdate_bits_is_repair_update_REG = _RANDOM_62[21];	// @[fetch-target-queue.scala:243:27, :286:54]
        io_enq_ready_REG = _RANDOM_62[22];	// @[fetch-target-queue.scala:243:27, :308:26]
        REG_3 = _RANDOM_62[23];	// @[fetch-target-queue.scala:243:27, :332:23]
        prev_entry_REG_cfi_idx_valid = _RANDOM_62[24];	// @[fetch-target-queue.scala:243:27, :333:26]
        prev_entry_REG_cfi_idx_bits = _RANDOM_62[26:25];	// @[fetch-target-queue.scala:243:27, :333:26]
        prev_entry_REG_cfi_taken = _RANDOM_62[27];	// @[fetch-target-queue.scala:243:27, :333:26]
        prev_entry_REG_br_mask = _RANDOM_63[3:0];	// @[fetch-target-queue.scala:333:26]
        prev_entry_REG_cfi_is_call = _RANDOM_63[4];	// @[fetch-target-queue.scala:333:26]
        prev_entry_REG_cfi_is_ret = _RANDOM_63[5];	// @[fetch-target-queue.scala:333:26]
        REG_4 = _RANDOM_64[24:21];	// @[fetch-target-queue.scala:337:16]
        ram_REG_cfi_idx_valid = _RANDOM_64[25];	// @[fetch-target-queue.scala:337:{16,46}]
        ram_REG_cfi_idx_bits = _RANDOM_64[27:26];	// @[fetch-target-queue.scala:337:{16,46}]
        ram_REG_cfi_taken = _RANDOM_64[28];	// @[fetch-target-queue.scala:337:{16,46}]
        ram_REG_cfi_mispredicted = _RANDOM_64[29];	// @[fetch-target-queue.scala:337:{16,46}]
        ram_REG_cfi_type = {_RANDOM_64[31:30], _RANDOM_65[0]};	// @[fetch-target-queue.scala:337:{16,46}]
        ram_REG_br_mask = _RANDOM_65[4:1];	// @[fetch-target-queue.scala:337:46]
        ram_REG_cfi_is_call = _RANDOM_65[5];	// @[fetch-target-queue.scala:337:46]
        ram_REG_cfi_is_ret = _RANDOM_65[6];	// @[fetch-target-queue.scala:337:46]
        ram_REG_ras_top = {_RANDOM_65[31:8], _RANDOM_66[15:0]};	// @[fetch-target-queue.scala:337:46]
        ram_REG_ras_idx = _RANDOM_66[20:16];	// @[fetch-target-queue.scala:337:46]
        ram_REG_start_bank = _RANDOM_66[21];	// @[fetch-target-queue.scala:337:46]
        io_get_ftq_pc_0_entry_REG_cfi_idx_valid = _RANDOM_66[22];	// @[fetch-target-queue.scala:337:46, :351:42]
        io_get_ftq_pc_0_entry_REG_cfi_idx_bits = _RANDOM_66[24:23];	// @[fetch-target-queue.scala:337:46, :351:42]
        io_get_ftq_pc_0_entry_REG_ras_idx = _RANDOM_68[17:13];	// @[fetch-target-queue.scala:351:42]
        io_get_ftq_pc_0_entry_REG_start_bank = _RANDOM_68[18];	// @[fetch-target-queue.scala:351:42]
        io_get_ftq_pc_0_pc_REG = {_RANDOM_68[31:19], _RANDOM_69[26:0]};	// @[fetch-target-queue.scala:351:42, :356:42]
        io_get_ftq_pc_0_next_pc_REG = {_RANDOM_69[31:27], _RANDOM_70, _RANDOM_71[2:0]};	// @[fetch-target-queue.scala:356:42, :357:42]
        io_get_ftq_pc_0_next_val_REG = _RANDOM_71[3];	// @[fetch-target-queue.scala:357:42, :358:42]
        io_get_ftq_pc_0_com_pc_REG = {_RANDOM_71[31:4], _RANDOM_72[11:0]};	// @[fetch-target-queue.scala:357:42, :359:42]
        io_get_ftq_pc_1_entry_REG_cfi_idx_bits = _RANDOM_72[14:13];	// @[fetch-target-queue.scala:351:42, :359:42]
        io_get_ftq_pc_1_entry_REG_br_mask = _RANDOM_72[23:20];	// @[fetch-target-queue.scala:351:42, :359:42]
        io_get_ftq_pc_1_entry_REG_cfi_is_call = _RANDOM_72[24];	// @[fetch-target-queue.scala:351:42, :359:42]
        io_get_ftq_pc_1_entry_REG_cfi_is_ret = _RANDOM_72[25];	// @[fetch-target-queue.scala:351:42, :359:42]
        io_get_ftq_pc_1_entry_REG_start_bank = _RANDOM_74[8];	// @[fetch-target-queue.scala:351:42]
        io_get_ftq_pc_1_pc_REG = {_RANDOM_74[31:9], _RANDOM_75[16:0]};	// @[fetch-target-queue.scala:351:42, :356:42]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_get_ftq_pc_1_ghist_old_history = _ghist_1_R0_data[15:0];	// @[fetch-target-queue.scala:144:43]
  assign io_get_ftq_pc_1_ghist_current_saw_branch_not_taken = _ghist_1_R0_data[16];	// @[fetch-target-queue.scala:144:43]
  assign io_get_ftq_pc_1_ghist_new_saw_branch_not_taken = _ghist_1_R0_data[17];	// @[fetch-target-queue.scala:144:43]
  assign io_get_ftq_pc_1_ghist_new_saw_branch_taken = _ghist_1_R0_data[18];	// @[fetch-target-queue.scala:144:43]
  assign io_get_ftq_pc_1_ghist_ras_idx = _ghist_1_R0_data[23:19];	// @[fetch-target-queue.scala:144:43]
  ...
  assign io_bpdupdate_bits_ghist_old_history = _ghist_0_R0_data[15:0];	// @[fetch-target-queue.scala:144:43]
