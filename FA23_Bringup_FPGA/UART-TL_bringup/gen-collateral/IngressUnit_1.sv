...
module IngressUnit_1(
  ...
  wire        _GEN = _T_15 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & (|_route_buffer_io_enq_bits_flow_egress_node_WIRE);	// @[IngressUnit.scala:26:28, :55:59, :58:86, :62:24, :64:{41,53}, :65:26, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    ...
    if (_vcalloc_q_io_deq_bits_vc_sel_0_0 | _vcalloc_q_io_deq_bits_vc_sel_0_1 | _vcalloc_q_io_deq_bits_vc_sel_0_2 | _vcalloc_q_io_deq_bits_vc_sel_0_3 | _vcalloc_q_io_deq_bits_vc_sel_0_4 | _vcalloc_q_io_deq_bits_vc_sel_0_5 | _vcalloc_q_io_deq_bits_vc_sel_0_6 | _vcalloc_q_io_deq_bits_vc_sel_0_7 | _vcalloc_q_io_deq_bits_vc_sel_0_8 | _vcalloc_q_io_deq_bits_vc_sel_0_9)	// @[IngressUnit.scala:76:25, :123:67]
      ...
      out_bundle_bits_out_virt_channel <= 4'h0;	// @[IngressUnit.scala:116:8]
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (4'h0),
  ...
  Queue_11 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_15 & io_in_bits_egress_id == 5'h3),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_15 & io_in_bits_egress_id == 5'h2),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
