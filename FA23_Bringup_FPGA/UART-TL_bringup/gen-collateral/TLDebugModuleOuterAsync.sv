...
module TLDebugModuleOuterAsync(
  ...
  TLXbar_12 dmiXbar (	// @[Debug.scala:667:28]
    .clock                     (io_dmi_clock),
    .reset                     (io_dmi_reset),
  ...
  IntSyncCrossingSource_12 intsource (	// @[Crossing.scala:28:31]
  ...
  TLAsyncCrossingSource_10 asource (	// @[AsyncCrossing.scala:89:29]
    .clock                          (io_dmi_clock),
    .reset                          (io_dmi_reset),
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_224 dmactiveAck_dmactiveAckSync (	// @[ShiftReg.scala:45:23]
    .clock (io_dmi_clock),
    .reset (io_dmi_reset),
    .io_d  (io_ctrl_dmactiveAck),
    .io_q  (_dmactiveAck_dmactiveAckSync_io_q)
  );
  AsyncQueueSource_29 io_innerCtrl_source (	// @[AsyncQueue.scala:216:24]
    .clock                        (io_dmi_clock),
    .reset                        (io_dmi_reset),
