...
module IngressUnit_13(
  ...
  input  [2:0]  io_in_bits_egress_id,
  ...
  wire        _T_17 = io_in_bits_egress_id == 3'h1;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_5 = io_in_bits_egress_id == 3'h3;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_6 = io_in_bits_egress_id == 3'h5;	// @[IngressUnit.scala:30:72]
  wire [1:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = {2{_T_17}} | {&io_in_bits_egress_id, _route_buffer_io_enq_bits_flow_egress_node_id_T_6};	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        _T_15 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & (&_route_buffer_io_enq_bits_flow_egress_node_WIRE);	// @[IngressUnit.scala:26:28, :55:59, :64:41, Mux.scala:27:73]
  wire        _GEN = _T_15 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~(&_route_buffer_io_enq_bits_flow_egress_node_WIRE);	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26, Mux.scala:27:73]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(_T_17 | _route_buffer_io_enq_bits_flow_egress_node_id_T_5 | _route_buffer_io_enq_bits_flow_egress_node_id_T_6 | (&io_in_bits_egress_id))) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node_id (3'h4),
    ...
    .io_enq_bits_flow_egress_node_id  ({2'h0, _T_17 | _route_buffer_io_enq_bits_flow_egress_node_id_T_5 | _route_buffer_io_enq_bits_flow_egress_node_id_T_6 | (&io_in_bits_egress_id)}),	// @[IngressUnit.scala:30:72, :45:50, Mux.scala:27:73]
  ...
  Queue_83 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_5_0 (1'h0),
    .io_enq_bits_vc_sel_4_0 (1'h0),
    .io_enq_bits_vc_sel_3_0 (1'h0),
    .io_enq_bits_vc_sel_2_0 (_T_15 & _T_17),	// @[IngressUnit.scala:30:72, :63:23, :64:{41,53}, :68:66]
    .io_enq_bits_vc_sel_1_0 (_T_15 & io_in_bits_egress_id == 3'h0),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_0_3 (~_T_15),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
