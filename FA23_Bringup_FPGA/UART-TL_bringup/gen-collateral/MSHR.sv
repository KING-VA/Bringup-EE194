...
module MSHR(
  ...
  input  [19:0] io_allocate_bits_tag,
  ...
  input  [2:0]  io_directory_bits_clients,
  input  [19:0] io_directory_bits_tag,
  input         io_directory_bits_hit,
  input  [2:0]  io_directory_bits_way,
  input         io_schedule_ready,
                io_sinkc_valid,
                io_sinkc_bits_last,
  input  [19:0] io_sinkc_bits_tag,
  ...
  output [19:0] io_schedule_bits_a_bits_tag,
  ...
  output [2:0]  io_schedule_bits_dir_bits_data_clients,
  output [19:0] io_schedule_bits_dir_bits_data_tag,
  ...
  reg  [4:0]  request_source;	// @[MSHR.scala:96:20]
  reg  [19:0] request_tag;	// @[MSHR.scala:96:20]
  reg  [5:0]  request_offset;	// @[MSHR.scala:96:20]
  reg  [5:0]  request_put;	// @[MSHR.scala:96:20]
  reg  [6:0]  request_set;	// @[MSHR.scala:96:20]
  reg         meta_valid;	// @[MSHR.scala:97:27]
  reg         meta_dirty;	// @[MSHR.scala:98:17]
  reg  [1:0]  meta_state;	// @[MSHR.scala:98:17]
  reg  [2:0]  meta_clients;	// @[MSHR.scala:98:17]
  reg  [19:0] meta_tag;	// @[MSHR.scala:98:17]
  ...
  reg  [2:0]  probes_done;	// @[MSHR.scala:148:24]
  reg  [2:0]  probes_toN;	// @[MSHR.scala:149:23]
  ...
  wire [2:0]  req_clientBit = {request_source[4:2] == 3'h0 & request_source[1:0] != 2'h3, request_source == 5'h8, request_source == 5'hC};	// @[Cat.scala:33:92, MSHR.scala:96:20, :113:22, :297:69, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20]
  ...
  wire [2:0]  _final_meta_writeback_clients_T_7 = meta_clients & ~(request_param == 3'h1 | request_param == 3'h2 | request_param == 3'h5 ? req_clientBit : 3'h0);	// @[Cat.scala:33:92, MSHR.scala:96:20, :98:17, :224:{50,52,56}, :297:69, Parameters.scala:267:13, :279:{11,43,66,75}]
  wire [2:0]  _GEN = ({3{~meta_hit}} | ~probes_toN) & meta_clients;	// @[MSHR.scala:98:17, :149:23, :227:21, :228:36, :230:{36,54}, compatibility.scala:76:26]
  wire [1:0]  _final_meta_writeback_state_T_6 = {1'h1, ~req_acquire};	// @[MSHR.scala:103:14, :217:53, :236:40]
  wire [1:0]  _final_meta_writeback_state_T_9 = {1'h1, ~(~(|meta_clients) & req_acquire)};	// @[MSHR.scala:98:17, :103:14, :217:53, :218:{25,39}, :242:{55,72}]
  wire [1:0]  _final_meta_writeback_state_T_13 = {meta_state == 2'h2, 1'h1};	// @[MSHR.scala:98:17, :103:14, :109:22, Mux.scala:81:{58,61}]
  wire [2:0]  _final_meta_writeback_clients_T_14 = (meta_hit ? meta_clients & ~probes_toN : 3'h0) | (req_acquire ? req_clientBit : 3'h0);	// @[Cat.scala:33:92, MSHR.scala:98:17, :149:23, :217:53, :243:{40,64,66,88}, :244:40, :297:69]
  ...
  wire [2:0]  _final_meta_writeback_clients_T_16 = meta_clients & ~probes_toN;	// @[MSHR.scala:98:17, :149:23, :256:{52,54}]
  ...
  wire [2:0]  _io_schedule_bits_dir_bits_data_WIRE_clients = bad_grant ? (meta_hit ? _final_meta_writeback_clients_T_16 : 3'h0) : request_prio_2 ? _final_meta_writeback_clients_T_7 : request_control ? _GEN : _final_meta_writeback_clients_T_14;	// @[MSHR.scala:96:20, :98:17, :147:22, :221:54, :224:{34,50}, :226:57, :227:21, :230:36, :243:{34,88}, :249:20, :250:21, :256:{36,52}, :262:36, :297:69, compatibility.scala:76:26]
  wire [2:0]  excluded_client = meta_hit & request_prio_0 & (_excluded_client_T_1 | (&request_opcode) | request_opcode == 3'h4) ? req_clientBit : 3'h0;	// @[Cat.scala:33:92, MSHR.scala:96:20, :98:17, :277:{28,57}, :297:69, Parameters.scala:268:{14,52}, :276:{77,87}]
  ...
  wire [2:0]  new_meta_clients = _T_509 ? _io_schedule_bits_dir_bits_data_WIRE_clients : io_directory_bits_clients;	// @[MSHR.scala:221:54, :249:20, :250:21, :503:{21,40}]
  ...
  wire [4:0]  new_request_source = io_allocate_valid ? io_allocate_bits_source : request_source;	// @[MSHR.scala:96:20, :504:24]
  ...
  wire [2:0]  new_clientBit = {new_request_source[4:2] == 3'h0 & new_request_source[1:0] != 2'h3, new_request_source == 5'h8, new_request_source == 5'hC};	// @[Cat.scala:33:92, MSHR.scala:113:22, :297:69, :504:24, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20]
  wire        _T_536 = ~new_meta_hit & (|new_meta_state);	// @[MSHR.scala:503:21, :604:{13,27,45}]
  wire        _GEN_3 = new_request_prio_2 | (new_request_control ? ~new_meta_hit : ~_T_536);	// @[MSHR.scala:503:21, :504:24, :551:22, :569:60, :583:14, :586:61, :589:27, :604:{27,58}, :605:19]
  wire        _GEN_4 = new_request_prio_2 | (new_request_control ? ~(new_meta_hit & (|new_meta_clients)) : ~(_T_536 & (|new_meta_clients)));	// @[MSHR.scala:503:21, :504:24, :548:22, :569:60, :586:61, :589:27, :593:{61,75}, :594:20, :604:{27,58}, :608:{60,74}, :609:20]
  ...
  wire        _GEN_5 = new_request_prio_2 | new_request_control;	// @[MSHR.scala:504:24, :554:22, :569:60, :586:61, :615:72]
  wire        _GEN_6 = _GEN_5 | ~_T_542;	// @[MSHR.scala:554:22, :569:60, :586:61, :615:{27,72}, :616:19]
  wire        _T_550 = new_meta_hit & (new_needT | new_meta_state == 2'h2) & (|(new_meta_clients & ~(_T_551 | (&new_request_opcode) | new_request_opcode == 3'h4 ? new_clientBit : 3'h0)));	// @[Cat.scala:33:92, MSHR.scala:109:22, :297:69, :503:21, :504:24, :507:26, :625:{24,42,53}, :626:{31,33,49}, Parameters.scala:267:70, :268:{14,52}, :276:{77,87}]
  wire        _GEN_7 = _GEN_5 | ~_T_550;	// @[MSHR.scala:553:22, :554:22, :569:60, :586:61, :615:72, :625:53, :626:63, :627:18]
  wire        _T_553 = _T_551 | (&new_request_opcode);	// @[MSHR.scala:504:24, :634:49, Parameters.scala:268:{14,52}]
  wire        _GEN_8 = io_schedule_ready & no_wait;	// @[MSHR.scala:137:33, :181:83, :195:28, :204:{35,50}]
  ...
  wire [2:0]  _GEN_9 = {3{io_sinkc_valid}};	// @[MSHR.scala:148:24, :459:49, :465:17]
  wire [2:0]  probe_bit = {io_sinkc_bits_source[4:2] == 3'h0 & io_sinkc_bits_source[1:0] != 2'h3, io_sinkc_bits_source == 5'h8, io_sinkc_bits_source == 5'hC};	// @[Cat.scala:33:92, MSHR.scala:113:22, :297:69, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20]
  ...
  wire        last_probe = (probes_done | probe_bit) == (meta_clients & ~excluded_client);	// @[Cat.scala:33:92, MSHR.scala:98:17, :148:24, :277:28, :287:53, :457:{33,46,64}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      request_valid <= io_allocate_valid | ~_GEN_8 & request_valid;	// @[MSHR.scala:95:30, :137:33, :195:28, :204:{35,50}, :206:20, :207:21, :530:28, :532:19]
      meta_valid <= _T_510 | ~_GEN_8 & meta_valid;	// @[MSHR.scala:95:30, :97:27, :137:33, :195:28, :204:{35,50}, :206:20, :207:21, :208:18, :537:{28,79}, :538:16]
      if (_T_510) begin	// @[MSHR.scala:537:28]
        s_rprobe <= _GEN_4;	// @[MSHR.scala:119:33, :548:22, :569:60, :586:61]
        w_rprobeackfirst <= _GEN_4;	// @[MSHR.scala:120:33, :548:22, :569:60, :586:61]
        w_rprobeacklast <= _GEN_4;	// @[MSHR.scala:121:33, :548:22, :569:60, :586:61]
        s_release <= _GEN_3;	// @[MSHR.scala:122:33, :551:22, :569:60, :586:61]
        w_releaseack <= _GEN_3;	// @[MSHR.scala:123:33, :551:22, :569:60, :586:61]
        s_pprobe <= _GEN_7;	// @[MSHR.scala:124:33, :553:22, :569:60, :586:61, :626:63]
        s_acquire <= _GEN_6;	// @[MSHR.scala:125:33, :554:22, :569:60, :586:61, :615:72]
        s_flush <= new_request_prio_2 | ~new_request_control;	// @[MSHR.scala:126:33, :504:24, :555:22, :569:60, :586:61, :587:15]
        w_grantfirst <= _GEN_6;	// @[MSHR.scala:127:33, :554:22, :569:60, :586:61, :615:72]
        w_grantlast <= _GEN_6;	// @[MSHR.scala:128:33, :554:22, :569:60, :586:61, :615:72]
        w_grant <= _GEN_6;	// @[MSHR.scala:129:33, :554:22, :569:60, :586:61, :615:72]
        w_pprobeackfirst <= _GEN_7;	// @[MSHR.scala:130:33, :553:22, :569:60, :586:61, :626:63]
        w_pprobeacklast <= _GEN_7;	// @[MSHR.scala:131:33, :553:22, :569:60, :586:61, :626:63]
        w_pprobeack <= _GEN_7;	// @[MSHR.scala:132:33, :553:22, :569:60, :586:61, :626:63]
        s_grantack <= _GEN_6;	// @[MSHR.scala:134:33, :554:22, :569:60, :586:61, :615:72]
        s_execute <= ~new_request_prio_2 & new_request_control;	// @[MSHR.scala:135:33, :504:24, :569:60, :570:17, :586:61]
        w_grantack <= _GEN_5 | ~_T_553;	// @[MSHR.scala:136:33, :554:22, :565:22, :569:60, :586:61, :615:72, :634:{49,88}, :635:20]
        if (new_request_prio_2)	// @[MSHR.scala:504:24]
          s_writeback <= ~((new_request_param == 3'h1 | new_request_param == 3'h2 | new_request_param == 3'h5) & (|(new_meta_clients & new_clientBit)) | (new_request_param == 3'h0 | new_request_param == 3'h4) & new_meta_state == 2'h2 | new_request_opcode[0] & ~new_meta_dirty);	// @[Cat.scala:33:92, MSHR.scala:109:22, :137:33, :297:69, :503:21, :504:24, :566:22, :572:{31,35,38,55}, :573:21, :576:{38,56,67}, :577:21, :580:{38,59,76,89}, :581:21, Parameters.scala:267:13, :276:87, :279:{11,43,66,75}, :282:{11,34,43}]
        ...
        s_writeback <= _GEN_8 | s_writeback;	// @[MSHR.scala:137:33, :195:28, :204:{35,50}]
      end
    end
    ...
    if (_T_510) begin	// @[MSHR.scala:537:28]
      if (_T_509) begin	// @[MSHR.scala:503:40]
        ...
        if (bad_grant) begin	// @[MSHR.scala:147:22]
          ...
          if (meta_hit)	// @[MSHR.scala:98:17]
            meta_clients <= _final_meta_writeback_clients_T_16;	// @[MSHR.scala:98:17, :256:52]
          else	// @[MSHR.scala:98:17]
            meta_clients <= 3'h0;	// @[MSHR.scala:98:17, :297:69]
        end
      ...
      probes_done <= 3'h0;	// @[MSHR.scala:148:24, :297:69]
      probes_toN <= 3'h0;	// @[MSHR.scala:149:23, :297:69]
    end
    else begin	// @[MSHR.scala:537:28]
      ...
      probes_done <= _GEN_9 & probe_bit | probes_done;	// @[Cat.scala:33:92, MSHR.scala:148:24, :459:49, :465:17]
      probes_toN <= _GEN_9 & (io_sinkc_bits_param == 3'h1 | io_sinkc_bits_param == 3'h2 | io_sinkc_bits_param == 3'h5 ? probe_bit : 3'h0) | probes_toN;	// @[Cat.scala:33:92, MSHR.scala:148:24, :149:23, :297:69, :459:49, :465:17, :466:{16,35}, Parameters.scala:267:13, :279:{11,43,66,75}]
    end
  ...
  `ifndef SYNTHESIS
    ...
    wire  [3:0][3:0] _GEN_15 = {{{2'h1, ~(|meta_clients), ~meta_dirty}}, {{3'h1, ~meta_dirty}}, {{3'h0, ~(|meta_clients)}}, {4'h8}};	// @[MSHR.scala:98:17, :106:22, :218:39, :219:81, :289:53, :297:69, :315:26, :316:{26,32}, :317:{26,32}, :318:26, Parameters.scala:46:9, :279:11]
    wire  [3:0]      before_0 = meta_hit ? _GEN_15[meta_state] : 4'h8;	// @[MSHR.scala:98:17, :219:81, :289:53, :315:26, :316:26, :317:26, :318:26, :321:{17,23}, Parameters.scala:46:9]
    wire  [3:0][3:0] _GEN_16 = {{{2'h1, ~(|_io_schedule_bits_dir_bits_data_WIRE_clients), ~_io_schedule_bits_dir_bits_data_WIRE_dirty}}, {{3'h1, ~_io_schedule_bits_dir_bits_data_WIRE_dirty}}, {{3'h0, ~(|_io_schedule_bits_dir_bits_data_WIRE_clients)}}, {4'h8}};	// @[MSHR.scala:106:22, :221:54, :249:20, :250:21, :297:69, :313:27, :315:26, :316:{26,32}, :317:{26,32}, :318:26, Parameters.scala:46:9, :279:11]
    ...
    wire             _T_107 = before_0 == 4'h8;	// @[MSHR.scala:315:26, :321:{17,23}, :373:15, Parameters.scala:46:9]
    wire             _T_430 = after == 4'h1;	// @[MSHR.scala:111:45, :315:26, :316:26, :373:15]
    ...
    wire             _T_147 = before_0 == 4'h1;	// @[MSHR.scala:111:45, :315:26, :321:{17,23}, :382:15]
    wire             _T_423 = after == 4'h8;	// @[MSHR.scala:315:26, :316:26, :382:15, Parameters.scala:46:9]
    ...
    always @(posedge clock) begin	// @[MSHR.scala:103:14]
      if (_GEN_13 & ~reset & (|meta_clients)) begin	// @[MSHR.scala:98:17, :102:35, :103:{14,29}]
      ...
      if (_GEN_14 & ~reset & meta_clients == 3'h0) begin	// @[MSHR.scala:98:17, :109:33, :110:{14,28}, :297:69]
      ...
      if (_GEN_14 & ~reset & (|(meta_clients & meta_clients - 3'h1))) begin	// @[MSHR.scala:98:17, :109:33, :111:{14,29,45,57}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        request_source = _RANDOM_0[18:14];	// @[MSHR.scala:95:30, :96:20]
        request_tag = {_RANDOM_0[31:19], _RANDOM_1[6:0]};	// @[MSHR.scala:95:30, :96:20]
        request_offset = _RANDOM_1[12:7];	// @[MSHR.scala:96:20]
        request_put = _RANDOM_1[18:13];	// @[MSHR.scala:96:20]
        request_set = _RANDOM_1[25:19];	// @[MSHR.scala:96:20]
        meta_valid = _RANDOM_1[26];	// @[MSHR.scala:96:20, :97:27]
        meta_dirty = _RANDOM_1[27];	// @[MSHR.scala:96:20, :98:17]
        meta_state = _RANDOM_1[29:28];	// @[MSHR.scala:96:20, :98:17]
        meta_clients = {_RANDOM_1[31:30], _RANDOM_2[0]};	// @[MSHR.scala:96:20, :98:17]
        meta_tag = _RANDOM_2[20:1];	// @[MSHR.scala:98:17]
        meta_hit = _RANDOM_2[21];	// @[MSHR.scala:98:17]
        meta_way = _RANDOM_2[24:22];	// @[MSHR.scala:98:17]
        s_rprobe = _RANDOM_2[25];	// @[MSHR.scala:98:17, :119:33]
        w_rprobeackfirst = _RANDOM_2[26];	// @[MSHR.scala:98:17, :120:33]
        w_rprobeacklast = _RANDOM_2[27];	// @[MSHR.scala:98:17, :121:33]
        s_release = _RANDOM_2[28];	// @[MSHR.scala:98:17, :122:33]
        w_releaseack = _RANDOM_2[29];	// @[MSHR.scala:98:17, :123:33]
        s_pprobe = _RANDOM_2[30];	// @[MSHR.scala:98:17, :124:33]
        s_acquire = _RANDOM_2[31];	// @[MSHR.scala:98:17, :125:33]
        s_flush = _RANDOM_3[0];	// @[MSHR.scala:126:33]
        w_grantfirst = _RANDOM_3[1];	// @[MSHR.scala:126:33, :127:33]
        w_grantlast = _RANDOM_3[2];	// @[MSHR.scala:126:33, :128:33]
        w_grant = _RANDOM_3[3];	// @[MSHR.scala:126:33, :129:33]
        w_pprobeackfirst = _RANDOM_3[4];	// @[MSHR.scala:126:33, :130:33]
        w_pprobeacklast = _RANDOM_3[5];	// @[MSHR.scala:126:33, :131:33]
        w_pprobeack = _RANDOM_3[6];	// @[MSHR.scala:126:33, :132:33]
        s_grantack = _RANDOM_3[8];	// @[MSHR.scala:126:33, :134:33]
        s_execute = _RANDOM_3[9];	// @[MSHR.scala:126:33, :135:33]
        w_grantack = _RANDOM_3[10];	// @[MSHR.scala:126:33, :136:33]
        s_writeback = _RANDOM_3[11];	// @[MSHR.scala:126:33, :137:33]
        sink = _RANDOM_3[14:12];	// @[MSHR.scala:126:33, :145:17]
        gotT = _RANDOM_3[15];	// @[MSHR.scala:126:33, :146:17]
        bad_grant = _RANDOM_3[16];	// @[MSHR.scala:126:33, :147:22]
        probes_done = _RANDOM_3[19:17];	// @[MSHR.scala:126:33, :148:24]
        probes_toN = _RANDOM_3[22:20];	// @[MSHR.scala:126:33, :149:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_schedule_bits_d_bits_param = req_acquire ? (request_param == 3'h1 ? 3'h1 : request_param == 3'h2 ? {1'h0, meta_hit & (|(meta_clients & req_clientBit)) ? 2'h2 : 2'h1} : request_param == 3'h0 ? {2'h0, req_acquire & (meta_hit ? ~(|meta_clients) & (&meta_state) : gotT)} : 3'h0) : request_param;	// @[Cat.scala:33:92, MSHR.scala:95:30, :96:20, :98:17, :102:22, :106:22, :109:22, :146:17, :217:53, :218:{25,39}, :219:{34,40,67,81}, :274:{30,47,64}, :296:41, :297:69, :299:53, Mux.scala:81:{58,61}, Parameters.scala:279:{11,43}]
  ...
  assign io_schedule_bits_dir_bits_data_clients = s_release ? _io_schedule_bits_dir_bits_data_WIRE_clients : 3'h0;	// @[MSHR.scala:122:33, :221:54, :249:20, :250:21, :297:69, :308:41]
  assign io_schedule_bits_dir_bits_data_tag = s_release ? (_GEN_0 ? meta_tag : request_tag) : 20'h0;	// @[MSHR.scala:96:20, :98:17, :122:33, :221:54, :226:57, :245:30, :270:19, :308:41, compatibility.scala:76:26]
