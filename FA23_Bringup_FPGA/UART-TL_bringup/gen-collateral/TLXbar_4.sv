...
module TLXbar_4(
  ...
  input  [5:0]  auto_out_8_d_bits_source,
  ...
  output [5:0]  auto_out_8_a_bits_source,
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h1} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire [9:0]  _GEN = auto_in_a_bits_address[25:16] ^ 10'h201;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_1 = {auto_in_a_bits_address[28:27], _GEN[9], auto_in_a_bits_address[20], _GEN[0], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_2 = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2} == 7'h0 | {auto_in_a_bits_address[28:27] ^ 2'h2, auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}, Xbar.scala:365:92]
  wire        requestAIO_0_3 = auto_in_a_bits_address[28:27] == 2'h1;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_4 = {auto_in_a_bits_address[28:27], ~(auto_in_a_bits_address[25]), auto_in_a_bits_address[20], auto_in_a_bits_address[16]} == 5'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_5 = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{45,65}]
  wire        requestAIO_0_6 = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], ~(auto_in_a_bits_address[16])} == 5'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire        requestAIO_0_7 = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], ~(auto_in_a_bits_address[20]), auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  wire [4:0]  _GEN_0 = auto_in_a_bits_address[20:16] ^ 5'h11;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_8 = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], _GEN_0[4], _GEN_0[0], auto_in_a_bits_address[14:13]} == 7'h0;	// @[Parameters.scala:137:{31,45,65}]
  ...
  wire [7:0]  _GEN_1 = _readys_filter_T_1[7:0] | _readys_filter_T_1[8:1];	// @[Arbiter.scala:24:28, package.scala:254:43]
  wire        _GEN_2 = auto_out_8_d_valid | _readys_filter_T_1[0];	// @[Arbiter.scala:24:28, package.scala:254:43]
  wire        _GEN_3 = auto_out_7_d_valid | auto_out_8_d_valid;	// @[package.scala:254:43]
  wire        _GEN_4 = auto_out_6_d_valid | auto_out_7_d_valid;	// @[package.scala:254:43]
  wire        _GEN_5 = auto_out_5_d_valid | auto_out_6_d_valid;	// @[package.scala:254:43]
  wire        _GEN_6 = auto_out_4_d_valid | auto_out_5_d_valid;	// @[package.scala:254:43]
  wire        _GEN_7 = auto_out_3_d_valid | auto_out_4_d_valid;	// @[package.scala:254:43]
  wire        _GEN_8 = _GEN_1[6] | _readys_filter_T_1[8];	// @[Arbiter.scala:24:28, package.scala:254:43]
  wire [5:0]  _GEN_9 = _GEN_1[5:0] | _GEN_1[7:2];	// @[package.scala:254:43]
  wire        _GEN_10 = _GEN_2 | _GEN_1[1];	// @[package.scala:254:43]
  wire        _GEN_11 = _GEN_3 | _GEN_1[0];	// @[package.scala:254:43]
  wire        _GEN_12 = _GEN_4 | _GEN_2;	// @[package.scala:254:43]
  wire        _GEN_13 = _GEN_5 | _GEN_3;	// @[package.scala:254:43]
  wire        _GEN_14 = _GEN_9[4] | _readys_filter_T_1[8];	// @[Arbiter.scala:24:28, package.scala:254:43]
  wire        _GEN_15 = _GEN_9[3] | _GEN_1[7];	// @[package.scala:254:43]
  wire        _GEN_16 = _GEN_9[2] | _GEN_8;	// @[package.scala:254:43]
  wire [1:0]  _GEN_17 = _GEN_9[1:0] | _GEN_9[5:4];	// @[package.scala:254:43]
  wire [8:0]  readys_readys = ~({readys_mask[8], _readys_filter_T_1[8] | readys_mask[7], _GEN_1[7] | readys_mask[6], _GEN_8 | readys_mask[5], _GEN_9[5] | readys_mask[4], _GEN_14 | readys_mask[3], _GEN_15 | readys_mask[2], _GEN_16 | readys_mask[1], _GEN_17[1] | readys_mask[0]} & {_GEN_17[0] | _readys_filter_T_1[8], _GEN_10 | _GEN_9[3] | _GEN_1[7], _GEN_11 | _GEN_9[2] | _GEN_8, _GEN_12 | _GEN_9[1] | _GEN_9[5], _GEN_13 | _GEN_9[0] | _GEN_14, _GEN_6 | _GEN_4 | _GEN_10 | _GEN_15, _GEN_7 | _GEN_5 | _GEN_11 | _GEN_16, auto_out_2_d_valid | auto_out_3_d_valid | _GEN_6 | _GEN_12 | _GEN_17[1], auto_out_1_d_valid | auto_out_2_d_valid | _GEN_7 | _GEN_13 | _GEN_17[0]});	// @[Arbiter.scala:23:23, :24:28, :25:58, :26:{18,29,39,48}, package.scala:254:43]
  ...
  wire [5:0]  out_30_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 6'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 6'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 6'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 6'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 6'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 6'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 6'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_source : 6'h0) | (muxStateEarly_8 ? auto_out_8_d_bits_source : 6'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
