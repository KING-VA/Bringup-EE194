...
module NoCMonitor_1(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_315 = io_in_flit_0_bits_flow_ingress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_309 = io_in_flit_0_bits_flow_egress_node == 4'h4;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_35 = io_in_flit_0_bits_flow_ingress_node_id == 3'h2;	// @[Types.scala:55:25]
    wire         _T_299 = io_in_flit_0_bits_flow_egress_node_id == 3'h2;	// @[Types.scala:55:25, :56:24]
    wire         _T_316 = io_in_flit_0_bits_flow_egress_node == 4'h5;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_288 = io_in_flit_0_bits_flow_egress_node == 4'h6;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_302 = io_in_flit_0_bits_flow_egress_node == 4'h7;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_258 = io_in_flit_0_bits_flow_ingress_node == 4'h4;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_295 = io_in_flit_0_bits_flow_egress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_197 = io_in_flit_0_bits_flow_ingress_node_id == 3'h1;	// @[Types.scala:55:25]
    wire         _T_199 = io_in_flit_0_bits_flow_egress_node_id == 3'h1;	// @[Types.scala:55:25, :56:24]
    wire         _T_251 = io_in_flit_0_bits_flow_ingress_node == 4'h7;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_259 = io_in_flit_0_bits_flow_egress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_138 = io_in_flit_0_bits_flow_ingress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_141 = io_in_flit_0_bits_flow_ingress_node_id == 3'h4;	// @[Types.scala:54:21, :55:25]
    wire         _T_237 = io_in_flit_0_bits_flow_ingress_node == 4'h5;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_245 = io_in_flit_0_bits_flow_egress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_216 = io_in_flit_0_bits_flow_ingress_node == 4'h6;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_318 = io_in_flit_0_bits_flow_ingress_node_id == 3'h0;	// @[Monitor.scala:32:44, Types.scala:55:25]
    wire         _T_320 = io_in_flit_0_bits_flow_egress_node_id == 3'h0;	// @[Monitor.scala:32:44, Types.scala:56:24]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:22:16]
      ...
      if (_T_4 & ~reset & _GEN) begin	// @[Monitor.scala:21:46, :29:22, :32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h1 | _T_315 & _T_309 & _T_35 & _T_299 | _T_315 & _T_316 & _T_35 & _T_299 | _T_315 & _T_288 & _T_35 & _T_299 | _T_315 & _T_302 & _T_35 & _T_299)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h2 | _T_258 & _T_295 & _T_197 & _T_199 | _T_251 & _T_259 & _T_197 & _T_199 | _T_138 & _T_259 & _T_141 & _T_199 | _T_251 & _T_295 & _T_197 & _T_199 | _T_237 & _T_245 & _T_197 & _T_199 | _T_216 & _T_245 & _T_197 & _T_199 | _T_216 & _T_295 & _T_197 & _T_199 | _T_216 & _T_259 & _T_197 & _T_199 | _T_258 & _T_245 & _T_197 & _T_199 | _T_237 & _T_259 & _T_197 & _T_199 | _T_258 & _T_259 & _T_197 & _T_199 | _T_251 & _T_245 & _T_197 & _T_199 | _T_237 & _T_295 & _T_197 & _T_199 | _T_138 & _T_245 & _T_141 & _T_199)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & io_in_flit_0_bits_virt_channel_id == 4'h4) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h5 | _T_315 & _T_309 & _T_197 & _T_199 | _T_315 & _T_316 & _T_197 & _T_199 | _T_315 & _T_288 & _T_197 & _T_199 | _T_315 & _T_302 & _T_197 & _T_199)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h6 | _T_216 & _T_259 & _T_318 & _T_320 | _T_216 & _T_245 & _T_318 & _T_320 | _T_237 & _T_245 & _T_318 & _T_320 | _T_258 & _T_245 & _T_318 & _T_320 | _T_237 & _T_259 & _T_318 & _T_320 | _T_251 & _T_245 & _T_318 & _T_320 | _T_251 & _T_259 & _T_318 & _T_320 | _T_258 & _T_259 & _T_318 & _T_320)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & io_in_flit_0_bits_virt_channel_id == 4'h8) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h9 | _T_315 & _T_288 & _T_318 & _T_320 | _T_315 & _T_295 & _T_318 & _T_299 | _T_315 & _T_302 & _T_318 & _T_320 | _T_315 & _T_309 & _T_318 & _T_320 | _T_315 & _T_316 & _T_318 & _T_320)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
