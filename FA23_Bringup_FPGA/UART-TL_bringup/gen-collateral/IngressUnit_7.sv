...
module IngressUnit_7(
  ...
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 3'h2;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (4'h2),
  ...
  Queue_11 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_2_0 (_T_15 & io_in_bits_egress_id == 5'h7),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_15 & io_in_bits_egress_id == 5'h6),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
