...
module TLMonitor_78(
  ...
  wire        _T_1373 = io_in_d_valid & ~(|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight_sizes <= (inflight_sizes | (a_set ? {3'h0, a_set ? 5'hD : 5'h0} : 8'h0)) & ~{8{d_clr}};	// @[Bundles.scala:262:74, Monitor.scala:615:33, :629:31, :645:38, :652:{27,72}, :655:{28,59}, :657:28, :667:31, :675:{72,91}, :678:21, :704:{39,54,56}, :745:35]
      if (_T_1454 | io_in_d_valid)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_10 = _T_1397 & a_set_wo_ready;	// @[Monitor.scala:648:26, :680:71, :684:30]
    wire             _GEN_11 = _T_1397 & ~a_set_wo_ready;	// @[Monitor.scala:648:26, :680:71, :684:30]
    wire             _T_1483 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      if (io_in_a_valid & ~reset & ~(io_in_a_bits_address[34:12] == 23'h3 | {io_in_a_bits_address[34:15], io_in_a_bits_address[13:12]} == 22'h0 | io_in_a_bits_address[34:16] == 19'h1 | io_in_a_bits_address[34:16] == 19'h2 | {io_in_a_bits_address[34:17] ^ 18'h8, io_in_a_bits_address[15:12]} == 22'h0 | io_in_a_bits_address[34:16] == 19'h200 | io_in_a_bits_address[34:12] == 23'h2010 | io_in_a_bits_address[34:16] == 19'h800 | io_in_a_bits_address[34:26] == 9'h3 | io_in_a_bits_address[34:12] == 23'h10020 | io_in_a_bits_address[34:31] == 4'h1 | io_in_a_bits_address[34:32] == 3'h1 | io_in_a_bits_address[34:33] == 2'h1 | io_in_a_bits_address[34:31] == 4'h8)) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, Parameters.scala:137:{31,45,65}, :672:30]
      ...
      if (_T_1323 & ~reset & opcode != 3'h4) begin	// @[Monitor.scala:42:11, :384:22, :389:19, :390:32]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1323 & ~reset & size != 4'h6) begin	// @[Monitor.scala:42:11, :386:22, :389:19, :392:32]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1397 & ~reset & ~(inflight | a_set_wo_ready)) begin	// @[Monitor.scala:49:11, :611:27, :648:26, :680:71, :682:49]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1426 & a_first_1 & io_in_a_valid & ~d_release_ack & ~reset & ~io_in_a_ready) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1426 & ~d_release_ack) | ~a_set_wo_ready)) begin	// @[Monitor.scala:49:11, :648:26, :670:46, :671:{26,71,74}, :699:{29,48,51}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 5 (connected at tile.scala:138:21)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
