...
module AsyncQueueSink_12(
  ...
  wire [80:0]      _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  wire [7:0]       _GEN_3 = {{io_async_mem_7_sink}, {io_async_mem_6_sink}, {io_async_mem_5_sink}, {io_async_mem_4_sink}, {io_async_mem_3_sink}, {io_async_mem_2_sink}, {io_async_mem_1_sink}, {io_async_mem_0_sink}};	// @[SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[80:78];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[77:76];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[75:73];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[72:67];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_sink = _io_deq_bits_deq_bits_reg_io_q[66];	// @[SynchronizerReg.scala:207:25, :211:26]
