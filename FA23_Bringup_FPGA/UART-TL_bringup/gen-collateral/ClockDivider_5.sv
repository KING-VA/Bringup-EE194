...
module ClockDivider_5(
  input         auto_clock_in_member_allClocks_tileClockGroup_tile_1_clock,
  ...
  assign auto_tl_in_d_bits_data = {27'h0, _out_out_bits_data_WIRE_1 ? (auto_tl_in_a_bits_address[3] ? {_regs_3_io_q, 27'h0, _regs_2_io_q} : {_regs_1_io_q, 27'h0, _regs_0_io_q}) : 37'h0};	// @[Cat.scala:33:92, ClockDivider.scala:34:53, MuxLiteral.scala:49:10, RegisterRouter.scala:82:24]
endmodule
