  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_source = _RANDOM_0[10];	// @[AsyncQueue.scala:80:16]
        mem_0_address = {_RANDOM_0[31:11], _RANDOM_1[13:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_mask = _RANDOM_1[21:14];	// @[AsyncQueue.scala:80:16]
        mem_0_data = {_RANDOM_1[31:22], _RANDOM_2, _RANDOM_3[21:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_corrupt = _RANDOM_3[22];	// @[AsyncQueue.scala:80:16]
        mem_1_opcode = _RANDOM_3[25:23];	// @[AsyncQueue.scala:80:16]
        mem_1_param = _RANDOM_3[28:26];	// @[AsyncQueue.scala:80:16]
        mem_1_size = {_RANDOM_3[31:29], _RANDOM_4[0]};	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_4[1];	// @[AsyncQueue.scala:80:16]
        mem_1_address = {_RANDOM_4[31:2], _RANDOM_5[4:0]};	// @[AsyncQueue.scala:80:16]
        mem_1_mask = _RANDOM_5[12:5];	// @[AsyncQueue.scala:80:16]
        mem_1_data = {_RANDOM_5[31:13], _RANDOM_6, _RANDOM_7[12:0]};	// @[AsyncQueue.scala:80:16]
        mem_1_corrupt = _RANDOM_7[13];	// @[AsyncQueue.scala:80:16]
        mem_2_opcode = _RANDOM_7[16:14];	// @[AsyncQueue.scala:80:16]
        mem_2_param = _RANDOM_7[19:17];	// @[AsyncQueue.scala:80:16]
        mem_2_size = _RANDOM_7[23:20];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_7[24];	// @[AsyncQueue.scala:80:16]
        mem_2_address = {_RANDOM_7[31:25], _RANDOM_8[27:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_mask = {_RANDOM_8[31:28], _RANDOM_9[3:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_data = {_RANDOM_9[31:4], _RANDOM_10, _RANDOM_11[3:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_corrupt = _RANDOM_11[4];	// @[AsyncQueue.scala:80:16]
        mem_3_opcode = _RANDOM_11[7:5];	// @[AsyncQueue.scala:80:16]
        mem_3_param = _RANDOM_11[10:8];	// @[AsyncQueue.scala:80:16]
        mem_3_size = _RANDOM_11[14:11];	// @[AsyncQueue.scala:80:16]
        mem_3_source = _RANDOM_11[15];	// @[AsyncQueue.scala:80:16]
        mem_3_address = {_RANDOM_11[31:16], _RANDOM_12[18:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_mask = _RANDOM_12[26:19];	// @[AsyncQueue.scala:80:16]
        mem_3_data = {_RANDOM_12[31:27], _RANDOM_13, _RANDOM_14[26:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_corrupt = _RANDOM_14[27];	// @[AsyncQueue.scala:80:16]
        mem_4_opcode = _RANDOM_14[30:28];	// @[AsyncQueue.scala:80:16]
        mem_4_param = {_RANDOM_14[31], _RANDOM_15[1:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_size = _RANDOM_15[5:2];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_15[6];	// @[AsyncQueue.scala:80:16]
        mem_4_address = {_RANDOM_15[31:7], _RANDOM_16[9:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_mask = _RANDOM_16[17:10];	// @[AsyncQueue.scala:80:16]
        mem_4_data = {_RANDOM_16[31:18], _RANDOM_17, _RANDOM_18[17:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_corrupt = _RANDOM_18[18];	// @[AsyncQueue.scala:80:16]
        mem_5_opcode = _RANDOM_18[21:19];	// @[AsyncQueue.scala:80:16]
        mem_5_param = _RANDOM_18[24:22];	// @[AsyncQueue.scala:80:16]
        mem_5_size = _RANDOM_18[28:25];	// @[AsyncQueue.scala:80:16]
        mem_5_source = _RANDOM_18[29];	// @[AsyncQueue.scala:80:16]
        mem_5_address = {_RANDOM_18[31:30], _RANDOM_19, _RANDOM_20[0]};	// @[AsyncQueue.scala:80:16]
        mem_5_mask = _RANDOM_20[8:1];	// @[AsyncQueue.scala:80:16]
        mem_5_data = {_RANDOM_20[31:9], _RANDOM_21, _RANDOM_22[8:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_corrupt = _RANDOM_22[9];	// @[AsyncQueue.scala:80:16]
        mem_6_opcode = _RANDOM_22[12:10];	// @[AsyncQueue.scala:80:16]
        mem_6_param = _RANDOM_22[15:13];	// @[AsyncQueue.scala:80:16]
        mem_6_size = _RANDOM_22[19:16];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_22[20];	// @[AsyncQueue.scala:80:16]
        mem_6_address = {_RANDOM_22[31:21], _RANDOM_23[23:0]};	// @[AsyncQueue.scala:80:16]
        mem_6_mask = _RANDOM_23[31:24];	// @[AsyncQueue.scala:80:16]
        mem_6_data = {_RANDOM_24, _RANDOM_25};	// @[AsyncQueue.scala:80:16]
        mem_6_corrupt = _RANDOM_26[0];	// @[AsyncQueue.scala:80:16]
        mem_7_opcode = _RANDOM_26[3:1];	// @[AsyncQueue.scala:80:16]
        mem_7_param = _RANDOM_26[6:4];	// @[AsyncQueue.scala:80:16]
        mem_7_size = _RANDOM_26[10:7];	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_26[11];	// @[AsyncQueue.scala:80:16]
        mem_7_address = {_RANDOM_26[31:12], _RANDOM_27[14:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_mask = _RANDOM_27[22:15];	// @[AsyncQueue.scala:80:16]
        mem_7_data = {_RANDOM_27[31:23], _RANDOM_28, _RANDOM_29[22:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_corrupt = _RANDOM_29[23];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_29[27:24];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_29[28];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = {_RANDOM_29[31:29], _RANDOM_30[0]};	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
