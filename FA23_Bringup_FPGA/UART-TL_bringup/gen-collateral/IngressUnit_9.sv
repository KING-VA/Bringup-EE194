...
module IngressUnit_9(
  ...
  wire [3:0]  _vcalloc_buffer_io_deq_bits_virt_channel_id;	// @[IngressUnit.scala:75:30]
  ...
  wire        _T_20 = io_in_bits_egress_id == 5'h8;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 5'h14;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_3 = io_in_bits_egress_id == 5'hB;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_4 = io_in_bits_egress_id == 5'hE;	// @[IngressUnit.scala:30:72]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = (_route_buffer_io_enq_bits_flow_egress_node_id_T ? 3'h6 : 3'h0) | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_2}} | {_route_buffer_io_enq_bits_flow_egress_node_id_T_3, {2{_T_20}}} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_4 ? 3'h5 : 3'h0);	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 3'h3;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  wire        _T_17 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// @[IngressUnit.scala:26:28, :55:59, :64:41]
  wire        _GEN = _T_17 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
  ...
  wire [14:0] _c_T_2 = {_vcalloc_q_io_deq_bits_vc_sel_5_0, _vcalloc_q_io_deq_bits_vc_sel_4_0, _vcalloc_q_io_deq_bits_vc_sel_3_0, _vcalloc_q_io_deq_bits_vc_sel_2_0, _vcalloc_q_io_deq_bits_vc_sel_1_0, _vcalloc_q_io_deq_bits_vc_sel_0_9, _vcalloc_q_io_deq_bits_vc_sel_0_8, _vcalloc_q_io_deq_bits_vc_sel_0_7, _vcalloc_q_io_deq_bits_vc_sel_0_6, _vcalloc_q_io_deq_bits_vc_sel_0_5, _vcalloc_q_io_deq_bits_vc_sel_0_4, _vcalloc_q_io_deq_bits_vc_sel_0_3, _vcalloc_q_io_deq_bits_vc_sel_0_2, _vcalloc_q_io_deq_bits_vc_sel_0_1, _vcalloc_q_io_deq_bits_vc_sel_0_0} & {io_out_credit_available_5_0, io_out_credit_available_4_0, io_out_credit_available_3_0, io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, 2'h3, io_out_credit_available_0_5, io_out_credit_available_0_4, io_out_credit_available_0_3, 1'h1, io_out_credit_available_0_1, io_out_credit_available_0_0};	// @[IngressUnit.scala:76:25, :107:{41,48,74}]
  ...
  reg  [3:0]  out_bundle_bits_flit_flow_ingress_node;	// @[IngressUnit.scala:116:8]
  reg  [2:0]  out_bundle_bits_flit_flow_ingress_node_id;	// @[IngressUnit.scala:116:8]
  reg  [3:0]  out_bundle_bits_flit_flow_egress_node;	// @[IngressUnit.scala:116:8]
  reg  [2:0]  out_bundle_bits_flit_flow_egress_node_id;	// @[IngressUnit.scala:116:8]
  reg  [3:0]  out_bundle_bits_out_virt_channel;	// @[IngressUnit.scala:116:8]
  wire [2:0]  _GEN_0 = {_vcalloc_q_io_deq_bits_vc_sel_0_7, _vcalloc_q_io_deq_bits_vc_sel_0_6, _vcalloc_q_io_deq_bits_vc_sel_0_5} | {_vcalloc_q_io_deq_bits_vc_sel_0_3, _vcalloc_q_io_deq_bits_vc_sel_0_2, _vcalloc_q_io_deq_bits_vc_sel_0_9 | _vcalloc_q_io_deq_bits_vc_sel_0_1};	// @[IngressUnit.scala:76:25, OneHot.scala:30:18, :31:18, :32:28]
  always @(posedge clock) begin
    ...
    if (_vcalloc_q_io_deq_bits_vc_sel_0_0 | _vcalloc_q_io_deq_bits_vc_sel_0_1 | _vcalloc_q_io_deq_bits_vc_sel_0_2 | _vcalloc_q_io_deq_bits_vc_sel_0_3 | _vcalloc_q_io_deq_bits_vc_sel_0_4 | _vcalloc_q_io_deq_bits_vc_sel_0_5 | _vcalloc_q_io_deq_bits_vc_sel_0_6 | _vcalloc_q_io_deq_bits_vc_sel_0_7 | _vcalloc_q_io_deq_bits_vc_sel_0_8 | _vcalloc_q_io_deq_bits_vc_sel_0_9)	// @[IngressUnit.scala:76:25, :123:67]
      out_bundle_bits_out_virt_channel <= {|{_vcalloc_q_io_deq_bits_vc_sel_0_9, _vcalloc_q_io_deq_bits_vc_sel_0_8}, |{_vcalloc_q_io_deq_bits_vc_sel_0_7, _vcalloc_q_io_deq_bits_vc_sel_0_6, _vcalloc_q_io_deq_bits_vc_sel_0_5, _vcalloc_q_io_deq_bits_vc_sel_0_4}, |(_GEN_0[2:1]), _GEN_0[2] | _GEN_0[0]};	// @[Cat.scala:33:92, IngressUnit.scala:76:25, :116:8, OneHot.scala:30:18, :31:18, :32:{14,28}]
    else	// @[IngressUnit.scala:123:67]
      out_bundle_bits_out_virt_channel <= 4'h0;	// @[IngressUnit.scala:51:44, :116:8]
  end // always @(posedge)
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T | _T_20 | _route_buffer_io_enq_bits_flow_egress_node_id_T_2 | _route_buffer_io_enq_bits_flow_egress_node_id_T_3 | _route_buffer_io_enq_bits_flow_egress_node_id_T_4)) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bundle_bits_flit_flow_ingress_node = _RANDOM_2[18:15];	// @[IngressUnit.scala:116:8]
        out_bundle_bits_flit_flow_ingress_node_id = _RANDOM_2[21:19];	// @[IngressUnit.scala:116:8]
        out_bundle_bits_flit_flow_egress_node = _RANDOM_2[25:22];	// @[IngressUnit.scala:116:8]
        out_bundle_bits_flit_flow_egress_node_id = _RANDOM_2[28:26];	// @[IngressUnit.scala:116:8]
        out_bundle_bits_out_virt_channel = _RANDOM_3[4:1];	// @[IngressUnit.scala:116:8]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    .clock                            (clock),
    .reset                            (reset),
    ...
    .io_enq_bits_flow_ingress_node    (4'h3),
    .io_enq_bits_flow_ingress_node_id (3'h0),
    ...
    .io_enq_bits_flow_egress_node_id  ({1'h0, _T_20, 1'h0}),	// @[IngressUnit.scala:30:72, :45:50]
    .io_enq_bits_virt_channel_id      (4'h0),	// @[IngressUnit.scala:51:44]
  ...
  Queue_83 route_q (	// @[IngressUnit.scala:27:23]
    .clock                  (clock),
    .reset                  (reset),
    .io_enq_valid           (_GEN),	// @[IngressUnit.scala:62:24, :64:53, :65:26]
    .io_enq_bits_vc_sel_5_0 (_T_17 & io_in_bits_egress_id == 5'hA),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_4_0 (_T_17 & io_in_bits_egress_id == 5'h9),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_3_0 (_T_17 & _T_20),	// @[IngressUnit.scala:30:72, :63:23, :64:{41,53}, :68:66]
    .io_enq_bits_vc_sel_2_0 (_T_17 & io_in_bits_egress_id == 5'h1),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_17 & io_in_bits_egress_id == 5'h0),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_0_3 (1'h0),
    .io_enq_bits_vc_sel_0_9 (~_T_17),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
    ...
    .io_deq_bits_vc_sel_5_0 (io_vcalloc_req_bits_vc_sel_5_0),
  ...
  Queue_10 vcalloc_buffer (	// @[IngressUnit.scala:75:30]
    .clock                            (clock),
    .reset                            (reset),
  ...
  Queue_85 vcalloc_q (	// @[IngressUnit.scala:76:25]
    .clock                  (clock),
    .reset                  (reset),
    .io_enq_valid           (_vcalloc_q_io_enq_valid_T),	// @[Decoupled.scala:51:35]
    .io_enq_bits_vc_sel_5_0 (io_vcalloc_resp_vc_sel_5_0),
    ...
    .io_deq_bits_vc_sel_5_0 (_vcalloc_q_io_deq_bits_vc_sel_5_0),
  ...
  assign io_salloc_req_0_bits_vc_sel_5_0 = _vcalloc_q_io_deq_bits_vc_sel_5_0;	// @[IngressUnit.scala:76:25]
  assign io_salloc_req_0_bits_vc_sel_4_0 = _vcalloc_q_io_deq_bits_vc_sel_4_0;	// @[IngressUnit.scala:76:25]
  ...
  assign io_salloc_req_0_bits_vc_sel_0_5 = _vcalloc_q_io_deq_bits_vc_sel_0_5;	// @[IngressUnit.scala:76:25]
  assign io_salloc_req_0_bits_vc_sel_0_6 = _vcalloc_q_io_deq_bits_vc_sel_0_6;	// @[IngressUnit.scala:76:25]
  assign io_salloc_req_0_bits_vc_sel_0_7 = _vcalloc_q_io_deq_bits_vc_sel_0_7;	// @[IngressUnit.scala:76:25]
  assign io_salloc_req_0_bits_vc_sel_0_8 = _vcalloc_q_io_deq_bits_vc_sel_0_8;	// @[IngressUnit.scala:76:25]
  assign io_salloc_req_0_bits_vc_sel_0_9 = _vcalloc_q_io_deq_bits_vc_sel_0_9;	// @[IngressUnit.scala:76:25]
