...
module RocketTile_1(
  ...
  DCache_1 dcache (	// @[HellaCache.scala:267:43]
    .clock                             (clock),
    .reset                             (reset),
  ...
  HellaCacheArbiter_1 dcacheArb (	// @[HellaCache.scala:278:25]
    .clock                                     (clock),
    ...
    .io_requestor_1_req_valid                  (_core_io_dmem_req_valid),	// @[RocketTile.scala:128:20]
    .io_requestor_1_req_bits_addr              (_core_io_dmem_req_bits_addr),	// @[RocketTile.scala:128:20]
    .io_requestor_1_req_bits_tag               (_core_io_dmem_req_bits_tag),	// @[RocketTile.scala:128:20]
    .io_requestor_1_req_bits_cmd               (_core_io_dmem_req_bits_cmd),	// @[RocketTile.scala:128:20]
    .io_requestor_1_req_bits_size              (_core_io_dmem_req_bits_size),	// @[RocketTile.scala:128:20]
    .io_requestor_1_req_bits_signed            (_core_io_dmem_req_bits_signed),	// @[RocketTile.scala:128:20]
    .io_requestor_1_req_bits_dprv              (_core_io_dmem_req_bits_dprv),	// @[RocketTile.scala:128:20]
    .io_requestor_1_req_bits_dv                (_core_io_dmem_req_bits_dv),	// @[RocketTile.scala:128:20]
    .io_requestor_1_s1_kill                    (_core_io_dmem_s1_kill),	// @[RocketTile.scala:128:20]
    .io_requestor_1_s1_data_data               (_core_io_dmem_s1_data_data),	// @[RocketTile.scala:128:20]
  ...
  Rocket_1 core (	// @[RocketTile.scala:128:20]
    .clock                                      (clock),
    .reset                                      (reset),
