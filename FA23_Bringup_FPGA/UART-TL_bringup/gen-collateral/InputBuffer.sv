...
module InputBuffer(
  ...
  wire             _tails_T_29 = mem_MPORT_addr == ({1'h0, {2{_tails_T_32}}} | {3{_tails_T_36}});	// @[InputUnit.scala:104:14, Mux.scala:27:73, :29:36]
  wire [2:0]       _tails_WIRE_2 = {_tails_T_36, 2'h0};	// @[Mux.scala:27:73, :29:36]
  ...
  wire             _heads_T_19 = head == ({1'h0, {2{to_q_oh_enc[2]}}} | {3{to_q_oh_enc[6]}});	// @[InputUnit.scala:123:16, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [2:0]       _heads_WIRE_2 = {to_q_oh_enc[6], 2'h0};	// @[Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      heads_6 <= 3'h4;	// @[InputUnit.scala:86:{24,32}]
      heads_7 <= 3'h0;	// @[InputUnit.scala:86:{24,32}]
      ...
      tails_6 <= 3'h4;	// @[InputUnit.scala:86:32, :87:24]
      tails_7 <= 3'h0;	// @[InputUnit.scala:86:32, :87:24]
