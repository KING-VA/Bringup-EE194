...
module NoCMonitor_7(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_371 = io_in_flit_0_bits_flow_ingress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_386 = io_in_flit_0_bits_flow_egress_node == 4'h7;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_51 = io_in_flit_0_bits_flow_ingress_node_id == 3'h2;	// @[Types.scala:55:25]
    wire         _T_53 = io_in_flit_0_bits_flow_egress_node_id == 3'h2;	// @[Types.scala:55:25, :56:24]
    wire         _T_378 = io_in_flit_0_bits_flow_ingress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_385 = io_in_flit_0_bits_flow_ingress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_308 = io_in_flit_0_bits_flow_ingress_node == 4'h4;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_309 = io_in_flit_0_bits_flow_egress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_236 = io_in_flit_0_bits_flow_ingress_node_id == 3'h1;	// @[Types.scala:55:25]
    wire         _T_238 = io_in_flit_0_bits_flow_egress_node_id == 3'h1;	// @[Types.scala:55:25, :56:24]
    wire         _T_138 = io_in_flit_0_bits_flow_egress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_301 = io_in_flit_0_bits_flow_ingress_node == 4'h5;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_295 = io_in_flit_0_bits_flow_egress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_280 = io_in_flit_0_bits_flow_ingress_node == 4'h6;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_364 = io_in_flit_0_bits_flow_ingress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_274 = io_in_flit_0_bits_flow_egress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_154 = io_in_flit_0_bits_flow_ingress_node_id == 3'h4;	// @[Types.scala:53:21, :55:25]
    wire         _T_388 = io_in_flit_0_bits_flow_ingress_node_id == 3'h0;	// @[Types.scala:53:21, :55:25]
    wire         _T_390 = io_in_flit_0_bits_flow_egress_node_id == 3'h0;	// @[Types.scala:53:21, :56:24]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:22:16]
      ...
      if (_T_4 & ~reset & ~((|io_in_flit_0_bits_virt_channel_id) | _T_371 & _T_386 & _T_51 & _T_53 | _T_378 & _T_386 & _T_51 & _T_53 | _T_385 & _T_386 & _T_51 & _T_53)) begin	// @[Monitor.scala:29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h1 | _T_371 & _T_386 & _T_51 & _T_53 | _T_378 & _T_386 & _T_51 & _T_53 | _T_385 & _T_386 & _T_51 & _T_53)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h3 | _T_308 & _T_309 & _T_236 & _T_238 | _T_308 & _T_138 & _T_236 & _T_238 | _T_301 & _T_295 & _T_236 & _T_238 | _T_280 & _T_138 & _T_236 & _T_238 | _T_280 & _T_309 & _T_236 & _T_238 | _T_308 & _T_295 & _T_236 & _T_238 | _T_301 & _T_309 & _T_236 & _T_238 | _T_364 & _T_274 & _T_154 & _T_238 | _T_280 & _T_274 & _T_236 & _T_238 | _T_364 & _T_309 & _T_154 & _T_238 | _T_301 & _T_138 & _T_236 & _T_238 | _T_301 & _T_274 & _T_236 & _T_238 | _T_364 & _T_295 & _T_154 & _T_238 | _T_280 & _T_295 & _T_236 & _T_238 | _T_308 & _T_274 & _T_236 & _T_238)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h4 | _T_371 & _T_386 & _T_236 & _T_238 | _T_378 & _T_386 & _T_236 & _T_238 | _T_385 & _T_386 & _T_236 & _T_238)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h5 | _T_371 & _T_386 & _T_236 & _T_238 | _T_378 & _T_386 & _T_236 & _T_238 | _T_385 & _T_386 & _T_236 & _T_238)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h7 | _T_280 & _T_309 & _T_388 & _T_390 | _T_280 & _T_274 & _T_388 & _T_390 | _T_308 & _T_274 & _T_388 & _T_390 | _T_301 & _T_274 & _T_388 & _T_390 | _T_280 & _T_295 & _T_388 & _T_390 | _T_301 & _T_295 & _T_388 & _T_390 | _T_308 & _T_295 & _T_388 & _T_390 | _T_301 & _T_309 & _T_388 & _T_390 | _T_308 & _T_309 & _T_388 & _T_390)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h8 | _T_364 & _T_386 & _T_388 & _T_390 | _T_371 & _T_386 & _T_388 & _T_390 | _T_378 & _T_386 & _T_388 & _T_390 | _T_385 & _T_386 & _T_388 & _T_390)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      end
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h9 | _T_364 & _T_386 & _T_388 & _T_390 | _T_371 & _T_386 & _T_388 & _T_390 | _T_378 & _T_386 & _T_388 & _T_390 | _T_385 & _T_386 & _T_388 & _T_390)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
