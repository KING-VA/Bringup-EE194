...
module TLCToNoC_1(
  ...
  wire        _q_io_deq_ready_T_2 = io_flit_ready & (is_body | ~(_q_io_deq_bits_opcode[0]));	// @[Edges.scala:101:36, Tilelink.scala:45:17, :59:24, :61:{35,47,50}]
  wire        _io_flit_bits_head_output = head & ~is_body;	// @[Edges.scala:230:25, Tilelink.scala:59:24, :63:{35,38}]
  wire        _io_flit_bits_tail_output = (tail_counter == 9'h1 | (_q_io_deq_bits_opcode[0] ? ~(_tail_beats1_decode_T_1[11:3]) : 9'h0) == 9'h0) & (is_body | ~(_q_io_deq_bits_opcode[0]));	// @[Edges.scala:101:36, :220:14, :228:27, :231:{25,37,47}, Tilelink.scala:45:17, :59:24, :61:50, :64:{35,47}, package.scala:235:{46,71,76}]
    ...
    if (reset) begin
      ...
      if (_q_io_deq_ready_T_2 & _q_io_deq_valid) begin	// @[Decoupled.scala:51:35, Tilelink.scala:45:17, :61:35]
        if (head) begin	// @[Edges.scala:230:25]
          if (_q_io_deq_bits_opcode[0])	// @[Edges.scala:101:36, Tilelink.scala:45:17]
  ...
  Queue_202 q (	// @[Tilelink.scala:45:17]
    .clock               (clock),
    .reset               (reset),
  ...
  assign io_flit_bits_egress_id = {1'h0, (_q_io_deq_bits_address[7:6] == 2'h0 ? 4'hC : 4'h0) | {4{_q_io_deq_bits_address[7:6] == 2'h1}}} | (_q_io_deq_bits_address[7:6] == 2'h2 ? 5'h12 : 5'h0) | ((&(_q_io_deq_bits_address[7:6])) ? 5'h15 : 5'h0);	// @[Edges.scala:220:14, Mux.scala:27:73, Parameters.scala:137:{31,45,65}, Tilelink.scala:45:17]
endmodule
