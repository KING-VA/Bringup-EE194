...
module TLFIFOFixer(
  ...
  input  [2:0]  auto_out_3_b_bits_source,
  ...
  input  [4:0]  auto_out_3_d_bits_sink,
  ...
  output        auto_out_3_c_bits_corrupt,
                auto_out_3_d_ready,
                auto_out_3_e_valid,
  output [4:0]  auto_out_3_e_bits_sink,
  ...
  TLMonitor_5 monitor_1 (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_opcode  (auto_out_1_b_bits_opcode),
    ...
    .io_in_b_bits_corrupt (auto_out_1_b_bits_corrupt),
  ...
  TLMonitor_5 monitor_2 (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_opcode  (auto_out_2_b_bits_opcode),
    ...
    .io_in_b_bits_mask    (auto_out_2_b_bits_mask),
    .io_in_b_bits_corrupt (auto_out_2_b_bits_corrupt),
  ...
  TLMonitor_7 monitor_3 (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_opcode  (auto_out_3_b_bits_opcode),
    ...
    .io_in_b_bits_mask    (auto_out_3_b_bits_mask),
    .io_in_b_bits_corrupt (auto_out_3_b_bits_corrupt),
