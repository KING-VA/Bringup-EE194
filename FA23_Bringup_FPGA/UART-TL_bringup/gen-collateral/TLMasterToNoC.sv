...
module TLMasterToNoC(
  ...
  output [4:0]  io_tilelink_d_bits_sink,
  ...
  wire        _e_io_protocol_ready;	// @[Tilelink.scala:225:17]
  wire [4:0]  _e_io_flit_bits_payload;	// @[Tilelink.scala:225:17]
  wire [4:0]  _e_io_flit_bits_egress_id;	// @[Tilelink.scala:225:17]
  ...
  TLAToNoC a (	// @[Tilelink.scala:221:17]
    ...
    .io_protocol_bits_source  (io_tilelink_a_bits_source | 5'h10),	// @[Tilelink.scala:227:58, :231:58]
  ...
  TLEToNoC e (	// @[Tilelink.scala:225:17]
    ...
    .io_protocol_bits_sink  (5'h0),
    .io_flit_ready          (1'h0),
    .io_protocol_ready      (_e_io_protocol_ready),
    .io_flit_valid          (io_flits_e_valid),
    .io_flit_bits_head      (io_flits_e_bits_head),
    .io_flit_bits_payload   (_e_io_flit_bits_payload),
    .io_flit_bits_egress_id (_e_io_flit_bits_egress_id)
  );
