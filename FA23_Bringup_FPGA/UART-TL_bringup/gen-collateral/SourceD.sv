...
module SourceD(
  ...
  wire [6:0]      s1_req_set = busy ? s1_req_reg_set : io_req_bits_set;	// @[Reg.scala:19:16, SourceD.scala:83:21, :87:19]
  ...
  wire [6:0]      pre_s3_req_set = s3_latch ? s2_req_set : s3_req_set;	// @[Reg.scala:19:16, SourceD.scala:176:18, :313:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_source = _RANDOM_0[22:18];	// @[Reg.scala:19:16, SourceD.scala:83:21]
        s1_req_reg_offset = _RANDOM_1[16:11];	// @[Reg.scala:19:16]
        s1_req_reg_put = _RANDOM_1[22:17];	// @[Reg.scala:19:16]
        s1_req_reg_set = _RANDOM_1[29:23];	// @[Reg.scala:19:16]
        ...
        s1_latch_bypass = _RANDOM_2[5];	// @[Reg.scala:19:16, SourceD.scala:89:32]
        s1_bypass_r = _RANDOM_2[6];	// @[Reg.scala:19:16]
        queue_io_enq_valid_REG = _RANDOM_2[7];	// @[Reg.scala:19:16, SourceD.scala:120:40]
        queue_io_enq_valid_REG_1 = _RANDOM_2[8];	// @[Reg.scala:19:16, SourceD.scala:120:32]
        s2_full = _RANDOM_2[9];	// @[Reg.scala:19:16, SourceD.scala:146:24]
        s2_valid_pb = _RANDOM_2[10];	// @[Reg.scala:19:16, SourceD.scala:147:28]
        ...
        s2_req_source = {_RANDOM_2[31:28], _RANDOM_3[0]};	// @[Reg.scala:19:16]
        s2_req_put = {_RANDOM_3[31:27], _RANDOM_4[0]};	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_4[7:1];	// @[Reg.scala:19:16]
        ...
        s3_full = _RANDOM_6[29];	// @[Reg.scala:19:16, SourceD.scala:189:24]
        s3_valid_d = _RANDOM_6[30];	// @[Reg.scala:19:16, SourceD.scala:190:27]
        ...
        s3_req_source = _RANDOM_7[20:16];	// @[Reg.scala:19:16]
        s3_req_set = _RANDOM_8[27:21];	// @[Reg.scala:19:16]
        ...
        s4_full = _RANDOM_11[16];	// @[Reg.scala:19:16, SourceD.scala:247:24]
        ...
        s4_req_set = _RANDOM_13[15:9];	// @[Reg.scala:19:16]
        ...
        s5_req_set = _RANDOM_19[27:21];	// @[Reg.scala:19:16]
        ...
        s6_req_set = _RANDOM_23[30:24];	// @[Reg.scala:19:16]
        ...
        s3_bypass_data_REG = _RANDOM_28[9];	// @[Reg.scala:19:16, SourceD.scala:335:19]
        s3_bypass_data_REG_1 = {_RANDOM_28[31:10], _RANDOM_29, _RANDOM_30[9:0]};	// @[Reg.scala:19:16, SourceD.scala:335:66]
      `endif // RANDOMIZE_REG_INIT
    end // initial
