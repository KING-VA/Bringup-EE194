...
module TLMonitor_19(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      if (io_in_a_valid & ~reset & ~(io_in_a_bits_address[28:12] == 17'h3 | {io_in_a_bits_address[28:15], io_in_a_bits_address[13:12]} == 16'h0 | {io_in_a_bits_address[28:17] ^ 12'h8, io_in_a_bits_address[15:12]} == 16'h0 | io_in_a_bits_address[28:16] == 13'h200 | io_in_a_bits_address[28:12] == 17'h2010 | io_in_a_bits_address[28:26] == 3'h3 | io_in_a_bits_address[28:12] == 17'h10020)) begin	// @[Monitor.scala:42:11, Parameters.scala:137:{31,45,65}, :672:30]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_4 = `RANDOM;
        _RANDOM_5 = `RANDOM;
        d_first_counter = _RANDOM_1[25:17];	// @[Edges.scala:228:27]
        opcode_1 = _RANDOM_1[28:26];	// @[Edges.scala:228:27, Monitor.scala:535:22]
        param_1 = _RANDOM_1[30:29];	// @[Edges.scala:228:27, Monitor.scala:536:22]
        size_1 = {_RANDOM_1[31], _RANDOM_2[2:0]};	// @[Edges.scala:228:27, Monitor.scala:537:22]
        source_1 = _RANDOM_2[3];	// @[Monitor.scala:537:22, :538:22]
        sink = _RANDOM_2[4];	// @[Monitor.scala:537:22, :539:22]
        denied = _RANDOM_2[5];	// @[Monitor.scala:537:22, :540:22]
        inflight = _RANDOM_2[6];	// @[Monitor.scala:537:22, :611:27]
        inflight_opcodes = _RANDOM_2[10:7];	// @[Monitor.scala:537:22, :613:35]
        inflight_sizes = _RANDOM_2[18:11];	// @[Monitor.scala:537:22, :615:33]
        d_first_counter_1 = {_RANDOM_2[31:28], _RANDOM_3[4:0]};	// @[Edges.scala:228:27, Monitor.scala:537:22]
        watchdog = {_RANDOM_3[31:5], _RANDOM_4[4:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_4[31:27], _RANDOM_5[3:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
