...
module BoomMSHRFile(
  ...
  input  [22:0] io_req_0_bits_old_meta_tag,
  ...
  output [34:0] io_mem_acquire_bits_address,
  ...
  output [22:0] io_meta_write_bits_data_tag,
  output        io_meta_read_valid,
  output [5:0]  io_meta_read_bits_idx,
  output [3:0]  io_meta_read_bits_way_en,
  output [22:0] io_meta_read_bits_tag,
  ...
  output [22:0] io_wb_req_bits_tag,
  ...
  wire [34:0] _mmios_0_io_mem_access_bits_address;	// @[mshrs.scala:710:22]
  ...
  wire [34:0] _mshrs_1_io_mem_acquire_bits_address;	// @[mshrs.scala:620:22]
  wire        _mshrs_1_io_mem_grant_ready;	// @[mshrs.scala:620:22]
  wire        _mshrs_1_io_mem_finish_valid;	// @[mshrs.scala:620:22]
  wire [4:0]  _mshrs_1_io_mem_finish_bits_sink;	// @[mshrs.scala:620:22]
  ...
  wire [22:0] _mshrs_1_io_meta_write_bits_data_tag;	// @[mshrs.scala:620:22]
  ...
  wire [22:0] _mshrs_1_io_meta_read_bits_tag;	// @[mshrs.scala:620:22]
  wire        _mshrs_1_io_wb_req_valid;	// @[mshrs.scala:620:22]
  wire [22:0] _mshrs_1_io_wb_req_bits_tag;	// @[mshrs.scala:620:22]
  ...
  wire [34:0] _mshrs_0_io_mem_acquire_bits_address;	// @[mshrs.scala:620:22]
  wire        _mshrs_0_io_mem_grant_ready;	// @[mshrs.scala:620:22]
  wire        _mshrs_0_io_mem_finish_valid;	// @[mshrs.scala:620:22]
  wire [4:0]  _mshrs_0_io_mem_finish_bits_sink;	// @[mshrs.scala:620:22]
  ...
  wire [22:0] _mshrs_0_io_meta_write_bits_data_tag;	// @[mshrs.scala:620:22]
  ...
  wire [22:0] _mshrs_0_io_meta_read_bits_tag;	// @[mshrs.scala:620:22]
  wire        _mshrs_0_io_wb_req_valid;	// @[mshrs.scala:620:22]
  wire [22:0] _mshrs_0_io_wb_req_bits_tag;	// @[mshrs.scala:620:22]
  ...
  wire        cacheable = {io_req_0_bits_addr[34:31], io_req_0_bits_addr[28:25], io_req_0_bits_addr[20], io_req_0_bits_addr[17:16] ^ 2'h2} == 11'h0 | {io_req_0_bits_addr[34:31], io_req_0_bits_addr[28:25] ^ 4'h4, io_req_0_bits_addr[20], io_req_0_bits_addr[17:16]} == 11'h0 | io_req_0_bits_addr[34:31] == 4'h1 | io_req_0_bits_addr[34:32] == 3'h1 | io_req_0_bits_addr[34:33] == 2'h1 | io_req_0_bits_addr[34:31] == 4'h8;	// @[Mux.scala:47:70, Parameters.scala:137:{31,45,65}, :671:42]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (idle & io_mem_acquire_ready) begin	// @[Arbiter.scala:88:28, :89:24]
        ...
        beatsLeft <= beatsLeft - {8'h0, io_mem_acquire_ready & out_3_valid};	// @[Arbiter.scala:87:30, :113:52, :125:29, ReadyValidCancel.scala:49:33]
  ...
  Arbiter_12 lb_read_arb (	// @[mshrs.scala:569:28]
  ...
  Arbiter_13 lb_write_arb (	// @[mshrs.scala:570:28]
  ...
  Arbiter_14 meta_write_arb (	// @[mshrs.scala:599:30]
  ...
  Arbiter_15 meta_read_arb (	// @[mshrs.scala:600:30]
  ...
  Arbiter_16 wb_req_arb (	// @[mshrs.scala:601:30]
  ...
  Arbiter_17 replay_arb (	// @[mshrs.scala:602:30]
  ...
  Arbiter_18 resp_arb (	// @[mshrs.scala:603:30]
  ...
  Arbiter_19 refill_arb (	// @[mshrs.scala:604:30]
  ...
  Arbiter_20 mmio_alloc_arb (	// @[mshrs.scala:703:30]
  ...
  assign io_mem_acquire_bits_address = (muxStateEarly_0 ? _mshrs_0_io_mem_acquire_bits_address : 35'h0) | (muxStateEarly_1 ? _mshrs_1_io_mem_acquire_bits_address : 35'h0) | (muxStateEarly_2 ? _mmios_0_io_mem_access_bits_address : 35'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, mshrs.scala:620:22, :710:22]
  ...
  assign io_mem_finish_bits_sink = ((beatsLeft_1 ? state_1_0 : _mshrs_0_io_mem_finish_valid) ? _mshrs_0_io_mem_finish_bits_sink : 5'h0) | ((beatsLeft_1 ? state_1_1 : earlyWinner_1_1) ? _mshrs_1_io_mem_finish_bits_sink : 5'h0);	// @[Arbiter.scala:87:30, :97:79, :116:26, :117:30, Mux.scala:27:73, mshrs.scala:620:22]
