...
module FPU(
  ...
  wire             _dfma_io_out_valid;	// @[FPU.scala:879:28]
  ...
  wire             _ifpu_io_out_valid;	// @[FPU.scala:855:20]
  ...
  DivSqrtRecFN_small divSqrt (	// @[FPU.scala:982:55]
    ...
    .io_detectTininess (1'h1),	// @[FPU.scala:982:55]
  ...
  DivSqrtRecFN_small_9 divSqrt_1 (	// @[FPU.scala:982:55]
    .clock             (clock),
    .reset             (divSqrt_killed),	// @[FPU.scala:971:33]
