...
module SinkC(
  ...
  wire [34:0] _c_io_deq_bits_address;	// @[Decoupled.scala:375:21]
  ...
  wire [6:0]  _io_set_output = _c_io_deq_valid ? _c_io_deq_bits_address[14:8] : io_set_r;	// @[Decoupled.scala:375:21, Parameters.scala:213:22, :215:28, Reg.scala:19:16, SinkC.scala:86:18]
  ...
  always @(posedge clock) begin
    ...
    if (_c_io_deq_valid) begin	// @[Decoupled.scala:375:21]
      ...
      io_set_r <= _c_io_deq_bits_address[14:8];	// @[Decoupled.scala:375:21, Parameters.scala:213:22, :215:28, Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_set_r = _RANDOM_0[10:4];	// @[Edges.scala:228:27, Reg.scala:19:16]
        io_bs_dat_data_r = {_RANDOM_0[31:11], _RANDOM_1, _RANDOM_2[10:0]};	// @[Edges.scala:228:27, Reg.scala:19:16]
        bs_adr_bits_beat_r = _RANDOM_2[13:11];	// @[Reg.scala:19:16]
        lists = _RANDOM_2[15:14];	// @[Reg.scala:19:16, SinkC.scala:110:24]
  ...
  Queue_242 c (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_243 io_bs_adr_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_req_bits_tag = _c_io_deq_bits_address[34:15];	// @[Decoupled.scala:375:21, Parameters.scala:213:22, :214:19]
  assign io_req_bits_offset = _c_io_deq_bits_address[5:0];	// @[Cat.scala:33:92, Decoupled.scala:375:21]
  assign io_req_bits_put = {4'h0, put};	// @[SinkC.scala:134:18, :145:24]
  assign io_req_bits_set = _c_io_deq_bits_address[14:8];	// @[Decoupled.scala:375:21, Parameters.scala:213:22, :215:28]
  ...
  assign io_resp_bits_set = _c_io_deq_bits_address[14:8];	// @[Decoupled.scala:375:21, Parameters.scala:213:22, :215:28]
  assign io_resp_bits_tag = _c_io_deq_bits_address[34:15];	// @[Decoupled.scala:375:21, Parameters.scala:213:22, :214:19]
