...
module EgressUnit(
  ...
  wire       _q_io_enq_bits_ingress_id_T_10 = io_in_0_bits_flow_ingress_node_id == 3'h0;	// @[EgressUnit.scala:32:27]
  ...
  Queue_22 q (	// @[EgressUnit.scala:22:17]
    .clock                  (clock),
    .reset                  (reset),
    ...
    .io_enq_bits_ingress_id ((io_in_0_bits_flow_ingress_node == 4'h4 & _q_io_enq_bits_ingress_id_T_10 ? 5'hE : 5'h0) | {io_in_0_bits_flow_ingress_node == 4'h5 & _q_io_enq_bits_ingress_id_T_10, 4'h0} | (io_in_0_bits_flow_ingress_node == 4'h6 & _q_io_enq_bits_ingress_id_T_10 ? 5'h12 : 5'h0) | (io_in_0_bits_flow_ingress_node == 4'h7 & _q_io_enq_bits_ingress_id_T_10 ? 5'h14 : 5'h0)),	// @[EgressUnit.scala:31:{39,75}, :32:27, Mux.scala:27:73]
