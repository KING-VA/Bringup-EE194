...
module SinkA(
  ...
  assign io_req_bits_tag = io_a_bits_address[34:15];	// @[Parameters.scala:213:22, :214:19]
  assign io_req_bits_offset = io_a_bits_address[5:0];	// @[Cat.scala:33:92]
  assign io_req_bits_put = put;	// @[SinkA.scala:83:16]
  assign io_req_bits_set = io_a_bits_address[14:8];	// @[Parameters.scala:213:22, :215:28]
