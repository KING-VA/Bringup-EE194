...
module Queue_293(
  ...
  assign io_deq_bits_ghist_old_history = _ram_ext_R0_data[73:58];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_target = _ram_ext_R0_data[122:83];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_meta_0 = _ram_ext_R0_data[172:123];	// @[Decoupled.scala:273:95]
endmodule
