...
module CSRFile_1(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if ((insn_ret ? ret_prv : _io_trace_0_exception_output ? (trapToDebug ? (reg_debug ? reg_mstatus_prv : 2'h3) : _GEN_12) : reg_mstatus_prv) == 2'h2)	// @[CSR.scala:368:21, :371:28, :373:28, :451:26, :831:83, :902:119, :956:43, :971:20, :972:24, :973:25, :980:17, :982:31, :992:37, :1000:15, :1001:35, :1013:15, :1025:15, :1049:19, :1051:48, :1052:29, :1068:66, :1088:13, :1548:35]
    ...
    if (csr_wen) begin	// @[package.scala:73:59]
      if (&_decoded_decoded_T_8)	// @[Cat.scala:33:92, pla.scala:98:74]
        ...
        reg_mie <= _reg_bp_0_control_WIRE_1 & 64'hAAA;	// @[CSR.scala:464:20, :1209:59, :1544:39]
