  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_1_size = {_RANDOM_3[31], _RANDOM_4[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_4[5:3];	// @[AsyncQueue.scala:80:16]
        ...
        mem_2_size = _RANDOM_7[27:24];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_7[30:28];	// @[AsyncQueue.scala:80:16]
        ...
        mem_3_size = _RANDOM_11[20:17];	// @[AsyncQueue.scala:80:16]
        mem_3_source = _RANDOM_11[23:21];	// @[AsyncQueue.scala:80:16]
        ...
        mem_4_size = _RANDOM_15[13:10];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_15[16:14];	// @[AsyncQueue.scala:80:16]
        ...
        mem_5_size = _RANDOM_19[6:3];	// @[AsyncQueue.scala:80:16]
        mem_5_source = _RANDOM_19[9:7];	// @[AsyncQueue.scala:80:16]
        ...
        mem_6_size = _RANDOM_22[31:28];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_23[2:0];	// @[AsyncQueue.scala:80:16]
        ...
        mem_7_size = _RANDOM_26[24:21];	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_26[27:25];	// @[AsyncQueue.scala:80:16]
