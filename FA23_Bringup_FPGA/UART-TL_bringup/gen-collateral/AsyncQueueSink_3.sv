...
module AsyncQueueSink_3(
  ...
  wire [7:0][4:0] _GEN = {{io_async_mem_7_sink}, {io_async_mem_6_sink}, {io_async_mem_5_sink}, {io_async_mem_4_sink}, {io_async_mem_3_sink}, {io_async_mem_2_sink}, {io_async_mem_1_sink}, {io_async_mem_0_sink}};	// @[SynchronizerReg.scala:209:18]
  ...
  ClockCrossingReg_w5 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
