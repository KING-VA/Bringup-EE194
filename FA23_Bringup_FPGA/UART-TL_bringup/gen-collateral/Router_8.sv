...
module Router_8(
  ...
  wire        fires_count = _vc_allocator_io_req_0_ready & _input_unit_0_from_7_io_vcalloc_req_valid;	// @[Decoupled.scala:51:35, Router.scala:112:13, :131:30, :137:31]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_5 = `RANDOM;
        _RANDOM_6 = `RANDOM;
        switch_io_sel_REG_0_0_0_0 = _RANDOM_0[0];	// @[Router.scala:176:14]
        debug_tsc = {_RANDOM_0[31:1], _RANDOM_1, _RANDOM_2[0]};	// @[Router.scala:176:14, :193:28]
        debug_sample = {_RANDOM_2[31:1], _RANDOM_3, _RANDOM_4[0]};	// @[Router.scala:193:28, :195:31]
        util_ctr = {_RANDOM_4[31:1], _RANDOM_5, _RANDOM_6[0]};	// @[Router.scala:195:31, :201:29]
        fired = _RANDOM_6[1];	// @[Router.scala:201:29, :202:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  NoCMonitor_8 monitor (	// @[Nodes.scala:24:25]
    .clock                                  (clock),
    .reset                                  (reset),
  ...
  InputUnit_8 input_unit_0_from_7 (	// @[Router.scala:112:13]
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_out_credit_available_0_6             (_output_unit_0_to_0_io_credit_available_6),	// @[Router.scala:122:13]
    ...
    .io_vcalloc_req_bits_vc_sel_0_2          (_input_unit_0_from_7_io_vcalloc_req_bits_vc_sel_0_2),
    .io_vcalloc_req_bits_vc_sel_0_6          (_input_unit_0_from_7_io_vcalloc_req_bits_vc_sel_0_6),
    ...
    .io_salloc_req_0_bits_vc_sel_0_6         (_input_unit_0_from_7_io_salloc_req_0_bits_vc_sel_0_6),
  ...
  OutputUnit_8 output_unit_0_to_0 (	// @[Router.scala:122:13]
    .clock                                   (clock),
    .reset                                   (reset),
    ...
    .io_credit_available_6                   (_output_unit_0_to_0_io_credit_available_6),
    .io_channel_status_2_occupied            (_output_unit_0_to_0_io_channel_status_2_occupied),
    .io_channel_status_6_occupied            (_output_unit_0_to_0_io_channel_status_6_occupied),
  ...
  Switch_8 switch (	// @[Router.scala:129:24]
  ...
  SwitchAllocator_8 switch_allocator (	// @[Router.scala:130:34]
    .clock                      (clock),
    .reset                      (reset),
    ...
    .io_req_0_0_bits_vc_sel_0_6 (_input_unit_0_from_7_io_salloc_req_0_bits_vc_sel_0_6),	// @[Router.scala:112:13]
  ...
  RotatingSingleVCAllocator_8 vc_allocator (	// @[Router.scala:131:30]
    .clock                          (clock),
    .reset                          (reset),
    .io_req_0_valid                 (_input_unit_0_from_7_io_vcalloc_req_valid),	// @[Router.scala:112:13]
    .io_req_0_bits_vc_sel_0_2       (_input_unit_0_from_7_io_vcalloc_req_bits_vc_sel_0_2),	// @[Router.scala:112:13]
    .io_req_0_bits_vc_sel_0_6       (_input_unit_0_from_7_io_vcalloc_req_bits_vc_sel_0_6),	// @[Router.scala:112:13]
    .io_channel_status_0_2_occupied (_output_unit_0_to_0_io_channel_status_2_occupied),	// @[Router.scala:122:13]
    .io_channel_status_0_6_occupied (_output_unit_0_to_0_io_channel_status_6_occupied),	// @[Router.scala:122:13]
  ...
  RouteComputer_8 route_computer (	// @[Router.scala:134:32]
