...
module AsyncQueueSource(
  ...
  output [4:0]  io_async_mem_0_sink,
  ...
  output        io_async_mem_1_source,
  output [4:0]  io_async_mem_1_sink,
  ...
  output        io_async_mem_2_source,
  output [4:0]  io_async_mem_2_sink,
  ...
  output        io_async_mem_3_source,
  output [4:0]  io_async_mem_3_sink,
  ...
  output        io_async_mem_4_source,
  output [4:0]  io_async_mem_4_sink,
  ...
  output        io_async_mem_5_source,
  output [4:0]  io_async_mem_5_sink,
  ...
  output        io_async_mem_6_source,
  output [4:0]  io_async_mem_6_sink,
  ...
  output        io_async_mem_7_source,
  output [4:0]  io_async_mem_7_sink,
  ...
  reg  [4:0]  mem_0_sink;	// @[AsyncQueue.scala:80:16]
  ...
  reg         mem_1_source;	// @[AsyncQueue.scala:80:16]
  reg  [4:0]  mem_1_sink;	// @[AsyncQueue.scala:80:16]
  reg         mem_1_denied;	// @[AsyncQueue.scala:80:16]
  ...
  reg         mem_2_source;	// @[AsyncQueue.scala:80:16]
  reg  [4:0]  mem_2_sink;	// @[AsyncQueue.scala:80:16]
  reg         mem_2_denied;	// @[AsyncQueue.scala:80:16]
  ...
  reg         mem_3_source;	// @[AsyncQueue.scala:80:16]
  reg  [4:0]  mem_3_sink;	// @[AsyncQueue.scala:80:16]
  reg         mem_3_denied;	// @[AsyncQueue.scala:80:16]
  ...
  reg         mem_4_source;	// @[AsyncQueue.scala:80:16]
  reg  [4:0]  mem_4_sink;	// @[AsyncQueue.scala:80:16]
  reg         mem_4_denied;	// @[AsyncQueue.scala:80:16]
  ...
  reg         mem_5_source;	// @[AsyncQueue.scala:80:16]
  reg  [4:0]  mem_5_sink;	// @[AsyncQueue.scala:80:16]
  reg         mem_5_denied;	// @[AsyncQueue.scala:80:16]
  ...
  reg         mem_6_source;	// @[AsyncQueue.scala:80:16]
  reg  [4:0]  mem_6_sink;	// @[AsyncQueue.scala:80:16]
  reg         mem_6_denied;	// @[AsyncQueue.scala:80:16]
  ...
  reg         mem_7_source;	// @[AsyncQueue.scala:80:16]
  reg  [4:0]  mem_7_sink;	// @[AsyncQueue.scala:80:16]
  reg         mem_7_denied;	// @[AsyncQueue.scala:80:16]
  ...
  always @(posedge clock) begin
    if (_GEN) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_0_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_0_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_0_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_0_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_0_source <= ~_GEN & mem_0_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
    if (_GEN_0) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_1_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_1_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_1_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_1_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_1_source <= ~_GEN_0 & mem_1_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
    if (_GEN_1) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_2_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_2_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_2_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_2_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_2_source <= ~_GEN_1 & mem_2_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
    if (_GEN_2) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_3_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_3_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_3_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_3_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_3_source <= ~_GEN_2 & mem_3_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
    if (_GEN_3) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_4_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_4_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_4_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_4_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_4_source <= ~_GEN_3 & mem_4_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
    if (_GEN_4) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_5_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_5_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_5_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_5_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_5_source <= ~_GEN_4 & mem_5_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
    if (_GEN_5) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_6_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_6_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_6_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_6_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_6_source <= ~_GEN_5 & mem_6_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
    if (_GEN_6) begin	// @[AsyncQueue.scala:80:16, :86:{24,37}]
      ...
      mem_7_sink <= io_enq_bits_sink;	// @[AsyncQueue.scala:80:16]
      mem_7_denied <= io_enq_bits_denied;	// @[AsyncQueue.scala:80:16]
      mem_7_data <= io_enq_bits_data;	// @[AsyncQueue.scala:80:16]
      mem_7_corrupt <= io_enq_bits_corrupt;	// @[AsyncQueue.scala:80:16]
    end
    mem_7_source <= ~_GEN_6 & mem_7_source;	// @[AsyncQueue.scala:80:16, :86:{24,37}]
  end // always @(posedge)
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_source = _RANDOM_0[9];	// @[AsyncQueue.scala:80:16]
        mem_0_sink = _RANDOM_0[14:10];	// @[AsyncQueue.scala:80:16]
        mem_0_denied = _RANDOM_0[15];	// @[AsyncQueue.scala:80:16]
        mem_0_data = {_RANDOM_0[31:16], _RANDOM_1, _RANDOM_2[15:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_corrupt = _RANDOM_2[16];	// @[AsyncQueue.scala:80:16]
        mem_1_opcode = _RANDOM_2[19:17];	// @[AsyncQueue.scala:80:16]
        mem_1_param = _RANDOM_2[21:20];	// @[AsyncQueue.scala:80:16]
        mem_1_size = _RANDOM_2[25:22];	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_2[26];	// @[AsyncQueue.scala:80:16]
        mem_1_sink = _RANDOM_2[31:27];	// @[AsyncQueue.scala:80:16]
        mem_1_denied = _RANDOM_3[0];	// @[AsyncQueue.scala:80:16]
        mem_1_data = {_RANDOM_3[31:1], _RANDOM_4, _RANDOM_5[0]};	// @[AsyncQueue.scala:80:16]
        mem_1_corrupt = _RANDOM_5[1];	// @[AsyncQueue.scala:80:16]
        mem_2_opcode = _RANDOM_5[4:2];	// @[AsyncQueue.scala:80:16]
        mem_2_param = _RANDOM_5[6:5];	// @[AsyncQueue.scala:80:16]
        mem_2_size = _RANDOM_5[10:7];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_5[11];	// @[AsyncQueue.scala:80:16]
        mem_2_sink = _RANDOM_5[16:12];	// @[AsyncQueue.scala:80:16]
        mem_2_denied = _RANDOM_5[17];	// @[AsyncQueue.scala:80:16]
        mem_2_data = {_RANDOM_5[31:18], _RANDOM_6, _RANDOM_7[17:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_corrupt = _RANDOM_7[18];	// @[AsyncQueue.scala:80:16]
        mem_3_opcode = _RANDOM_7[21:19];	// @[AsyncQueue.scala:80:16]
        mem_3_param = _RANDOM_7[23:22];	// @[AsyncQueue.scala:80:16]
        mem_3_size = _RANDOM_7[27:24];	// @[AsyncQueue.scala:80:16]
        mem_3_source = _RANDOM_7[28];	// @[AsyncQueue.scala:80:16]
        mem_3_sink = {_RANDOM_7[31:29], _RANDOM_8[1:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_denied = _RANDOM_8[2];	// @[AsyncQueue.scala:80:16]
        mem_3_data = {_RANDOM_8[31:3], _RANDOM_9, _RANDOM_10[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_corrupt = _RANDOM_10[3];	// @[AsyncQueue.scala:80:16]
        mem_4_opcode = _RANDOM_10[6:4];	// @[AsyncQueue.scala:80:16]
        mem_4_param = _RANDOM_10[8:7];	// @[AsyncQueue.scala:80:16]
        mem_4_size = _RANDOM_10[12:9];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_10[13];	// @[AsyncQueue.scala:80:16]
        mem_4_sink = _RANDOM_10[18:14];	// @[AsyncQueue.scala:80:16]
        mem_4_denied = _RANDOM_10[19];	// @[AsyncQueue.scala:80:16]
        mem_4_data = {_RANDOM_10[31:20], _RANDOM_11, _RANDOM_12[19:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_corrupt = _RANDOM_12[20];	// @[AsyncQueue.scala:80:16]
        mem_5_opcode = _RANDOM_12[23:21];	// @[AsyncQueue.scala:80:16]
        mem_5_param = _RANDOM_12[25:24];	// @[AsyncQueue.scala:80:16]
        mem_5_size = _RANDOM_12[29:26];	// @[AsyncQueue.scala:80:16]
        mem_5_source = _RANDOM_12[30];	// @[AsyncQueue.scala:80:16]
        mem_5_sink = {_RANDOM_12[31], _RANDOM_13[3:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_denied = _RANDOM_13[4];	// @[AsyncQueue.scala:80:16]
        mem_5_data = {_RANDOM_13[31:5], _RANDOM_14, _RANDOM_15[4:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_corrupt = _RANDOM_15[5];	// @[AsyncQueue.scala:80:16]
        mem_6_opcode = _RANDOM_15[8:6];	// @[AsyncQueue.scala:80:16]
        mem_6_param = _RANDOM_15[10:9];	// @[AsyncQueue.scala:80:16]
        mem_6_size = _RANDOM_15[14:11];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_15[15];	// @[AsyncQueue.scala:80:16]
        mem_6_sink = _RANDOM_15[20:16];	// @[AsyncQueue.scala:80:16]
        mem_6_denied = _RANDOM_15[21];	// @[AsyncQueue.scala:80:16]
        mem_6_data = {_RANDOM_15[31:22], _RANDOM_16, _RANDOM_17[21:0]};	// @[AsyncQueue.scala:80:16]
        mem_6_corrupt = _RANDOM_17[22];	// @[AsyncQueue.scala:80:16]
        mem_7_opcode = _RANDOM_17[25:23];	// @[AsyncQueue.scala:80:16]
        mem_7_param = _RANDOM_17[27:26];	// @[AsyncQueue.scala:80:16]
        mem_7_size = _RANDOM_17[31:28];	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_18[0];	// @[AsyncQueue.scala:80:16]
        mem_7_sink = _RANDOM_18[5:1];	// @[AsyncQueue.scala:80:16]
        mem_7_denied = _RANDOM_18[6];	// @[AsyncQueue.scala:80:16]
        mem_7_data = {_RANDOM_18[31:7], _RANDOM_19, _RANDOM_20[6:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_corrupt = _RANDOM_20[7];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_20[11:8];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_20[12];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_20[16:13];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
  ...
  assign io_async_mem_1_sink = mem_1_sink;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_1_denied = mem_1_denied;	// @[AsyncQueue.scala:80:16]
  ...
  assign io_async_mem_2_sink = mem_2_sink;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_2_denied = mem_2_denied;	// @[AsyncQueue.scala:80:16]
  ...
  assign io_async_mem_3_sink = mem_3_sink;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_3_denied = mem_3_denied;	// @[AsyncQueue.scala:80:16]
  ...
  assign io_async_mem_4_sink = mem_4_sink;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_4_denied = mem_4_denied;	// @[AsyncQueue.scala:80:16]
  ...
  assign io_async_mem_5_sink = mem_5_sink;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_5_denied = mem_5_denied;	// @[AsyncQueue.scala:80:16]
  ...
  assign io_async_mem_6_sink = mem_6_sink;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_6_denied = mem_6_denied;	// @[AsyncQueue.scala:80:16]
  ...
  assign io_async_mem_7_sink = mem_7_sink;	// @[AsyncQueue.scala:80:16]
  assign io_async_mem_7_denied = mem_7_denied;	// @[AsyncQueue.scala:80:16]
