...
module BoomFrontend(
  ...
  output [34:0] auto_icache_master_out_a_bits_address,
  ...
  wire [15:0]      _bpd_update_arbiter_io_out_bits_ghist_old_history;	// @[frontend.scala:927:34]
  wire [39:0]      _bpd_update_arbiter_io_out_bits_target;	// @[frontend.scala:927:34]
  wire [49:0]      _bpd_update_arbiter_io_out_bits_meta_0;	// @[frontend.scala:927:34]
  ...
  wire [15:0]      _ftq_io_bpdupdate_bits_ghist_old_history;	// @[frontend.scala:864:19]
  wire [39:0]      _ftq_io_bpdupdate_bits_target;	// @[frontend.scala:864:19]
  wire [49:0]      _ftq_io_bpdupdate_bits_meta_0;	// @[frontend.scala:864:19]
  ...
  wire [15:0]      _f4_io_deq_bits_ghist_old_history;	// @[frontend.scala:861:11]
  ...
  wire [49:0]      _f4_io_deq_bits_bpd_meta_0;	// @[frontend.scala:861:11]
  ...
  wire [15:0]      _f4_btb_corrections_io_deq_bits_ghist_old_history;	// @[frontend.scala:844:34]
  wire [39:0]      _f4_btb_corrections_io_deq_bits_target;	// @[frontend.scala:844:34]
  wire [49:0]      _f4_btb_corrections_io_deq_bits_meta_0;	// @[frontend.scala:844:34]
  ...
  wire [49:0]      _f3_bpd_resp_io_deq_bits_meta_0;	// @[frontend.scala:523:11]
  ...
  wire [15:0]      _f3_io_deq_bits_ghist_old_history;	// @[frontend.scala:518:11]
  ...
  wire [34:0]      _tlb_io_resp_paddr;	// @[frontend.scala:339:19]
  ...
  wire [49:0]      _bpd_io_resp_f3_meta_0;	// @[frontend.scala:333:19]
  ...
  reg  [15:0]      s1_ghist_old_history;	// @[frontend.scala:383:29]
  ...
  reg  [34:0]      s1_ppc_REG;	// @[frontend.scala:400:42]
  ...
  wire [15:0]      f1_predicted_ghist_old_history = _f1_predicted_ghist_new_history_old_history_T & f1_do_redirect ? {s1_ghist_old_history[14:0], 1'h1} : (|({_bpd_io_resp_f1_preds_3_is_br & _bpd_io_resp_f1_preds_3_predicted_pc_valid, _bpd_io_resp_f1_preds_2_is_br & _bpd_io_resp_f1_preds_2_predicted_pc_valid, _bpd_io_resp_f1_preds_1_is_br & _bpd_io_resp_f1_preds_1_predicted_pc_valid, _bpd_io_resp_f1_preds_0_is_br & _bpd_io_resp_f1_preds_0_predicted_pc_valid} & f1_mask[3:0] & (f1_do_redirect ? (f1_predicted_ghist_cfi_idx_oh | {1'h0, &f1_redirect_idx, _GEN_3[1], _GEN_3[0] | (&f1_redirect_idx)}) & ~(_f1_predicted_ghist_new_history_old_history_T ? f1_predicted_ghist_cfi_idx_oh : 4'h0) : 4'hF))) | s1_ghist_current_saw_branch_not_taken ? {s1_ghist_old_history[14:0], 1'h0} : s1_ghist_old_history;	// @[Mux.scala:47:70, OneHot.scala:57:35, frontend.scala:90:{39,44}, :91:{67,69,73,84}, :98:{53,61}, :99:{37,61,91}, :100:37, :178:31, :333:19, :367:16, :383:29, :413:45, :420:{40,72}, util.scala:373:{29,45}]
  ...
  reg  [15:0]      s2_ghist_old_history;	// @[frontend.scala:444:21]
  ...
  reg  [34:0]      s2_ppc;	// @[frontend.scala:446:24]
    ...
    if (_GEN_48) begin	// @[frontend.scala:816:38, :955:30, :967:38]
      if (_GEN_45) begin	// @[frontend.scala:484:58, :816:38, :823:79]
        if (_T_11) begin	// @[frontend.scala:483:45]
          ...
          s1_ghist_old_history <= 16'h0;	// @[frontend.scala:383:29]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_ghist_old_history = _RANDOM_1[25:10];	// @[frontend.scala:381:29, :383:29]
        s1_ghist_current_saw_branch_not_taken = _RANDOM_1[26];	// @[frontend.scala:381:29, :383:29]
        s1_ghist_new_saw_branch_not_taken = _RANDOM_1[27];	// @[frontend.scala:381:29, :383:29]
        s1_ghist_new_saw_branch_taken = _RANDOM_1[28];	// @[frontend.scala:381:29, :383:29]
        s1_ghist_ras_idx = {_RANDOM_1[31:29], _RANDOM_2[1:0]};	// @[frontend.scala:381:29, :383:29]
        s1_is_replay = _RANDOM_2[2];	// @[frontend.scala:383:29, :384:29]
        s1_is_sfence = _RANDOM_2[3];	// @[frontend.scala:383:29, :385:29]
        s1_tsrc = _RANDOM_2[5:4];	// @[frontend.scala:383:29, :387:29]
        tlb_io_sfence_REG_valid = _RANDOM_2[6];	// @[frontend.scala:383:29, :395:35]
        tlb_io_sfence_REG_bits_rs1 = _RANDOM_2[7];	// @[frontend.scala:383:29, :395:35]
        tlb_io_sfence_REG_bits_rs2 = _RANDOM_2[8];	// @[frontend.scala:383:29, :395:35]
        tlb_io_sfence_REG_bits_addr = {_RANDOM_2[31:9], _RANDOM_3[15:0]};	// @[frontend.scala:383:29, :395:35]
        s1_tlb_resp_REG_pf_inst = _RANDOM_6[2];	// @[frontend.scala:399:46]
        s1_tlb_resp_REG_ae_inst = _RANDOM_6[10];	// @[frontend.scala:399:46]
        s1_ppc_REG = {_RANDOM_6[31:19], _RANDOM_7[21:0]};	// @[frontend.scala:399:46, :400:42]
        s2_valid = _RANDOM_7[22];	// @[frontend.scala:400:42, :442:25]
        s2_vpc = {_RANDOM_7[31:23], _RANDOM_8[30:0]};	// @[frontend.scala:400:42, :443:25]
        s2_ghist_old_history = {_RANDOM_8[31], _RANDOM_9[14:0]};	// @[frontend.scala:443:25, :444:21]
        s2_ghist_current_saw_branch_not_taken = _RANDOM_9[15];	// @[frontend.scala:444:21]
        s2_ghist_new_saw_branch_not_taken = _RANDOM_9[16];	// @[frontend.scala:444:21]
        s2_ghist_new_saw_branch_taken = _RANDOM_9[17];	// @[frontend.scala:444:21]
        s2_ghist_ras_idx = _RANDOM_9[22:18];	// @[frontend.scala:444:21]
        s2_ppc = {_RANDOM_9[31:23], _RANDOM_10[25:0]};	// @[frontend.scala:444:21, :446:24]
        s2_tsrc = _RANDOM_10[27:26];	// @[frontend.scala:446:24, :447:24]
        s2_tlb_resp_pf_inst = _RANDOM_13[11];	// @[frontend.scala:450:28]
        s2_tlb_resp_ae_inst = _RANDOM_13[19];	// @[frontend.scala:450:28]
        s2_tlb_miss = _RANDOM_13[28];	// @[frontend.scala:450:28, :451:28]
        s2_is_replay_REG = _RANDOM_13[29];	// @[frontend.scala:450:28, :452:29]
        ras_read_idx = {_RANDOM_13[31:30], _RANDOM_14[2:0]};	// @[frontend.scala:450:28, :542:29]
        f3_bpd_resp_io_enq_valid_REG = _RANDOM_14[3];	// @[frontend.scala:542:29, :551:57]
        f3_prev_half = _RANDOM_14[19:4];	// @[frontend.scala:542:29, :589:28]
        f3_prev_is_half = _RANDOM_14[20];	// @[frontend.scala:542:29, :591:32]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ICache_2 icache (	// @[frontend.scala:300:26]
    .clock                          (clock),
    .reset                          (reset),
  ...
  BranchPredictor bpd (	// @[frontend.scala:333:19]
    ...
    .io_f0_req_bits_ghist_old_history      (_GEN_48 ? (_GEN_45 ? (_T_11 ? s2_ghist_old_history : _GEN_10 ? f2_predicted_ghist_old_history : _T_5 ? f1_predicted_ghist_old_history : 16'h0) : f3_predicted_ghist_old_history) : io_cpu_redirect_ghist_old_history),	// @[frontend.scala:99:37, :363:49, :429:{18,35}, :434:18, :444:21, :483:45, :484:58, :490:14, :493:38, :498:95, :501:20, :504:20, :816:38, :823:79, :955:30, :967:38]
  ...
  TLB_4 tlb (	// @[frontend.scala:339:19]
    .clock                         (clock),
    .reset                         (reset),
  ...
  Queue_291 f3 (	// @[frontend.scala:518:11]
    .clock                                          (clock),
  ...
  Queue_292 f3_bpd_resp (	// @[frontend.scala:523:11]
    .clock                                  (clock),
    .reset                                  (reset | f4_clear),	// @[frontend.scala:522:44, :955:30, :956:17, :967:38]
    .io_enq_valid                           (_f3_io_deq_valid & f3_bpd_resp_io_enq_valid_REG),	// @[frontend.scala:518:11, :551:{47,57}]
  ...
  Queue_293 f4_btb_corrections (	// @[frontend.scala:844:34]
    .clock                                          (clock),
    .reset                                          (reset),
  ...
  Queue_294 f4 (	// @[frontend.scala:861:11]
    .clock                                          (clock),
  ...
  Arbiter_27 bpd_update_arbiter (	// @[frontend.scala:927:34]
