...
module TLRAM(
  ...
  wire        backingscratchpad_MPORT_en;	// @[SRAM.scala:296:20]
  wire        backingscratchpad_MPORT_1_en;	// @[SRAM.scala:295:20]
  wire [63:0] _backingscratchpad_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  reg         d_full;	// @[SRAM.scala:104:30]
  reg         d_respond;	// @[SRAM.scala:105:26]
  reg  [1:0]  d_size;	// @[SRAM.scala:108:26]
  reg  [9:0]  d_source;	// @[SRAM.scala:109:26]
  reg         d_read;	// @[SRAM.scala:110:26]
  reg         d_atomic;	// @[SRAM.scala:111:26]
  reg         d_sublane;	// @[SRAM.scala:112:26]
  reg  [27:0] d_address;	// @[SRAM.scala:113:26]
  ...
  wire [9:0]  in_d_bits_source = d_mux ? d_source : r_source;	// @[SRAM.scala:109:26, :124:26, :192:24, :198:29]
  ...
  assign backingscratchpad_MPORT_1_en = d_wb | a_fire & ~a_read;	// @[Decoupled.scala:51:35, SRAM.scala:215:23, :237:35, :295:{20,52,55}]
  assign backingscratchpad_MPORT_en = ~backingscratchpad_MPORT_1_en & a_fire;	// @[Decoupled.scala:51:35, SRAM.scala:295:20, :296:{15,20}]
  ...
  assign r_raw_data_0 = REG ? _backingscratchpad_RW0_rdata[7:0] : r_0;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  assign r_raw_data_1 = REG ? _backingscratchpad_RW0_rdata[15:8] : r_1;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  assign r_raw_data_2 = REG ? _backingscratchpad_RW0_rdata[23:16] : r_2;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  assign r_raw_data_3 = REG ? _backingscratchpad_RW0_rdata[31:24] : r_3;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  assign r_raw_data_4 = REG ? _backingscratchpad_RW0_rdata[39:32] : r_4;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  assign r_raw_data_5 = REG ? _backingscratchpad_RW0_rdata[47:40] : r_5;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  assign r_raw_data_6 = REG ? _backingscratchpad_RW0_rdata[55:48] : r_6;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  assign r_raw_data_7 = REG ? _backingscratchpad_RW0_rdata[63:56] : r_7;	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16, SRAM.scala:307:58, package.scala:80:42]
  ...
  always @(posedge clock) begin
    ...
    if (_T_17) begin	// @[SRAM.scala:241:18]
      ...
      if (REG) begin	// @[SRAM.scala:307:58]
        d_raw_data_0 <= _backingscratchpad_RW0_rdata[7:0];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
        d_raw_data_1 <= _backingscratchpad_RW0_rdata[15:8];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
        d_raw_data_2 <= _backingscratchpad_RW0_rdata[23:16];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
        d_raw_data_3 <= _backingscratchpad_RW0_rdata[31:24];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
        d_raw_data_4 <= _backingscratchpad_RW0_rdata[39:32];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
        d_raw_data_5 <= _backingscratchpad_RW0_rdata[47:40];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
        d_raw_data_6 <= _backingscratchpad_RW0_rdata[55:48];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
        d_raw_data_7 <= _backingscratchpad_RW0_rdata[63:56];	// @[DescribedSRAM.scala:17:26, SRAM.scala:117:26]
      end
    ...
    REG <= backingscratchpad_MPORT_en;	// @[SRAM.scala:296:20, :307:58]
    if (REG) begin	// @[SRAM.scala:307:58]
      r_0 <= _backingscratchpad_RW0_rdata[7:0];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      r_1 <= _backingscratchpad_RW0_rdata[15:8];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      r_2 <= _backingscratchpad_RW0_rdata[23:16];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      r_3 <= _backingscratchpad_RW0_rdata[31:24];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      r_4 <= _backingscratchpad_RW0_rdata[39:32];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      r_5 <= _backingscratchpad_RW0_rdata[47:40];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      r_6 <= _backingscratchpad_RW0_rdata[55:48];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
      r_7 <= _backingscratchpad_RW0_rdata[63:56];	// @[DescribedSRAM.scala:17:26, Reg.scala:19:16]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_source = _RANDOM_0[19:10];	// @[SRAM.scala:104:30, :109:26]
        d_read = _RANDOM_0[20];	// @[SRAM.scala:104:30, :110:26]
        d_atomic = _RANDOM_0[21];	// @[SRAM.scala:104:30, :111:26]
        d_sublane = _RANDOM_0[22];	// @[SRAM.scala:104:30, :112:26]
        d_address = {_RANDOM_0[31:23], _RANDOM_1[18:0]};	// @[SRAM.scala:104:30, :113:26]
        d_mask = _RANDOM_1[26:19];	// @[SRAM.scala:113:26, :114:26]
        d_rmw_data = {_RANDOM_1[31:27], _RANDOM_2, _RANDOM_3[26:0]};	// @[SRAM.scala:113:26, :115:26]
        d_raw_data_0 = {_RANDOM_3[31:28], _RANDOM_4[3:0]};	// @[SRAM.scala:115:26, :117:26]
        d_raw_data_1 = _RANDOM_4[11:4];	// @[SRAM.scala:117:26]
        d_raw_data_2 = _RANDOM_4[19:12];	// @[SRAM.scala:117:26]
        d_raw_data_3 = _RANDOM_4[27:20];	// @[SRAM.scala:117:26]
        d_raw_data_4 = {_RANDOM_4[31:28], _RANDOM_5[3:0]};	// @[SRAM.scala:117:26]
        d_raw_data_5 = _RANDOM_5[11:4];	// @[SRAM.scala:117:26]
        d_raw_data_6 = _RANDOM_5[19:12];	// @[SRAM.scala:117:26]
        d_raw_data_7 = _RANDOM_5[27:20];	// @[SRAM.scala:117:26]
        r_full = _RANDOM_5[28];	// @[SRAM.scala:117:26, :120:30]
        r_size = _RANDOM_6[4:3];	// @[SRAM.scala:123:26]
        r_source = _RANDOM_6[14:5];	// @[SRAM.scala:123:26, :124:26]
        r_read = _RANDOM_6[15];	// @[SRAM.scala:123:26, :125:26]
        r_atomic = _RANDOM_6[16];	// @[SRAM.scala:123:26, :126:26]
        r_sublane = _RANDOM_6[17];	// @[SRAM.scala:123:26, :127:26]
        r_address = {_RANDOM_6[31:18], _RANDOM_7[13:0]};	// @[SRAM.scala:123:26, :128:26]
        r_mask = _RANDOM_7[21:14];	// @[SRAM.scala:128:26, :129:26]
        r_rmw_data = {_RANDOM_7[31:22], _RANDOM_8, _RANDOM_9[21:0]};	// @[SRAM.scala:128:26, :130:26]
        REG = _RANDOM_9[24];	// @[SRAM.scala:130:26, :307:58]
        r_0 = {_RANDOM_9[31:25], _RANDOM_10[0]};	// @[Reg.scala:19:16, SRAM.scala:130:26]
        r_1 = _RANDOM_10[8:1];	// @[Reg.scala:19:16]
        r_2 = _RANDOM_10[16:9];	// @[Reg.scala:19:16]
        r_3 = _RANDOM_10[24:17];	// @[Reg.scala:19:16]
        r_4 = {_RANDOM_10[31:25], _RANDOM_11[0]};	// @[Reg.scala:19:16]
        r_5 = _RANDOM_11[8:1];	// @[Reg.scala:19:16]
        r_6 = _RANDOM_11[16:9];	// @[Reg.scala:19:16]
        r_7 = _RANDOM_11[24:17];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  backingscratchpad backingscratchpad (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (d_wb ? d_address[15:3] : auto_in_a_bits_address[15:3]),	// @[SRAM.scala:113:26, :215:23, :298:21]
    .RW0_en    (backingscratchpad_MPORT_en | backingscratchpad_MPORT_1_en),	// @[DescribedSRAM.scala:17:26, SRAM.scala:295:20, :296:20]
    .RW0_clk   (clock),
    .RW0_wmode (backingscratchpad_MPORT_1_en),	// @[SRAM.scala:295:20]
    ...
    .RW0_rdata (_backingscratchpad_RW0_rdata)
  );
