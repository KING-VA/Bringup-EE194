...
module OutputUnit(
  ...
  wire       _GEN_1 = ~(io_out_vc_free[5]) & states_5_occupied;	// @[OutputUnit.scala:66:19, :74:{25,30}, :76:18]
  wire       _GEN_2 = ~(io_out_vc_free[6]) & states_6_occupied;	// @[OutputUnit.scala:66:19, :74:{25,30}, :76:18]
  wire       _GEN_3 = ~(io_out_vc_free[9]) & states_9_occupied;	// @[OutputUnit.scala:66:19, :74:{25,30}, :76:18]
  always @(posedge clock) begin
    if (reset) begin
      states_9_occupied <= 1'h0;	// @[OutputUnit.scala:66:19]
      states_9_c <= 3'h4;	// @[OutputUnit.scala:66:19, :105:29]
      states_6_occupied <= 1'h0;	// @[OutputUnit.scala:66:19]
      states_6_c <= 3'h4;	// @[OutputUnit.scala:66:19, :105:29]
      ...
      states_9_occupied <= io_allocs_9_alloc | _GEN_3;	// @[OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18]
      states_9_c <= states_9_c + {2'h0, io_out_credit_return[9]} - {2'h0, io_credit_alloc_9_alloc};	// @[OutputUnit.scala:66:19, :94:36, :97:{18,26}]
      states_6_occupied <= io_allocs_6_alloc | _GEN_2;	// @[OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18]
      states_6_c <= states_6_c + {2'h0, io_out_credit_return[6]} - {2'h0, io_credit_alloc_6_alloc};	// @[OutputUnit.scala:66:19, :94:36, :97:{18,26}]
      states_5_occupied <= io_allocs_5_alloc | _GEN_1;	// @[OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[OutputUnit.scala:75:13]
      ...
      if (io_out_vc_free[6] & ~reset & ~states_6_occupied) begin	// @[OutputUnit.scala:66:19, :74:25, :75:13]
        if (`ASSERT_VERBOSE_COND_)	// @[OutputUnit.scala:75:13]
          $error("Assertion failed\n    at OutputUnit.scala:75 assert(s.occupied)\n");	// @[OutputUnit.scala:75:13]
        if (`STOP_COND_)	// @[OutputUnit.scala:75:13]
          $fatal;	// @[OutputUnit.scala:75:13]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        states_6_occupied = _RANDOM_1[31];	// @[OutputUnit.scala:66:19]
        states_6_c = _RANDOM_2[2:0];	// @[OutputUnit.scala:66:19]
        states_5_occupied = _RANDOM_2[20];	// @[OutputUnit.scala:66:19]
        states_5_c = _RANDOM_2[23:21];	// @[OutputUnit.scala:66:19]
        states_2_occupied = _RANDOM_4[19];	// @[OutputUnit.scala:66:19]
        states_2_c = _RANDOM_4[22:20];	// @[OutputUnit.scala:66:19]
  ...
  assign io_credit_available_6 = |states_6_c;	// @[OutputUnit.scala:66:19, :90:14]
  ...
  assign io_channel_status_5_occupied = _GEN_1;	// @[OutputUnit.scala:66:19, :74:30, :76:18]
  assign io_channel_status_6_occupied = _GEN_2;	// @[OutputUnit.scala:66:19, :74:30, :76:18]
  assign io_channel_status_9_occupied = _GEN_3;	// @[OutputUnit.scala:66:19, :74:30, :76:18]
