...
module TLXbar_1(
  ...
  wire        _portsAOI_in_0_a_ready_WIRE = ~(auto_in_a_bits_address[28]) & auto_out_0_a_ready | auto_in_a_bits_address[28] & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:{45,65}]
  ...
  wire [5:0]  out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 6'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 6'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_out_1_a_valid = auto_in_a_valid & auto_in_a_bits_address[28];	// @[Parameters.scala:137:45, Xbar.scala:430:50]
  ...
  assign auto_out_0_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[28]);	// @[Parameters.scala:137:{45,65}, Xbar.scala:430:50]
