...
module NoCMonitor(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_264 = io_in_flit_0_bits_flow_ingress_node == 4'h4;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_115 = io_in_flit_0_bits_flow_egress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_145 = io_in_flit_0_bits_flow_ingress_node_id == 3'h1;	// @[Types.scala:55:25]
    wire         _T_147 = io_in_flit_0_bits_flow_egress_node_id == 3'h1;	// @[Types.scala:55:25, :56:24]
    wire         _T_257 = io_in_flit_0_bits_flow_ingress_node == 4'h7;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_265 = io_in_flit_0_bits_flow_egress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_236 = io_in_flit_0_bits_flow_ingress_node == 4'h5;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_244 = io_in_flit_0_bits_flow_egress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_251 = io_in_flit_0_bits_flow_egress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_215 = io_in_flit_0_bits_flow_ingress_node == 4'h6;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_128 = io_in_flit_0_bits_flow_ingress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_131 = io_in_flit_0_bits_flow_ingress_node_id == 3'h4;	// @[Types.scala:53:21, :55:25]
    wire         _T_267 = io_in_flit_0_bits_flow_ingress_node_id == 3'h0;	// @[Monitor.scala:32:44, Types.scala:55:25]
    wire         _T_269 = io_in_flit_0_bits_flow_egress_node_id == 3'h0;	// @[Monitor.scala:32:44, Types.scala:56:24]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:22:16]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h2 | _T_264 & _T_115 & _T_145 & _T_147 | _T_257 & _T_265 & _T_145 & _T_147 | _T_257 & _T_115 & _T_145 & _T_147 | _T_236 & _T_244 & _T_145 & _T_147 | _T_257 & _T_251 & _T_145 & _T_147 | _T_215 & _T_115 & _T_145 & _T_147 | _T_215 & _T_265 & _T_145 & _T_147 | _T_264 & _T_244 & _T_145 & _T_147 | _T_236 & _T_265 & _T_145 & _T_147 | _T_128 & _T_251 & _T_131 & _T_147 | _T_264 & _T_265 & _T_145 & _T_147 | _T_257 & _T_244 & _T_145 & _T_147 | _T_215 & _T_251 & _T_145 & _T_147 | _T_128 & _T_265 & _T_131 & _T_147 | _T_236 & _T_115 & _T_145 & _T_147 | _T_236 & _T_251 & _T_145 & _T_147 | _T_128 & _T_244 & _T_131 & _T_147 | _T_215 & _T_244 & _T_145 & _T_147 | _T_264 & _T_251 & _T_145 & _T_147)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h6 | _T_215 & _T_265 & _T_267 & _T_269 | _T_215 & _T_251 & _T_267 & _T_269 | _T_264 & _T_251 & _T_267 & _T_269 | _T_236 & _T_251 & _T_267 & _T_269 | _T_215 & _T_244 & _T_267 & _T_269 | _T_236 & _T_244 & _T_267 & _T_269 | _T_264 & _T_244 & _T_267 & _T_269 | _T_236 & _T_265 & _T_267 & _T_269 | _T_257 & _T_244 & _T_267 & _T_269 | _T_257 & _T_251 & _T_267 & _T_269 | _T_257 & _T_265 & _T_267 & _T_269 | _T_264 & _T_265 & _T_267 & _T_269)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
