...
module OutputUnit_2(
  ...
  wire       _GEN_4 = ~(io_out_vc_free[8]) & states_8_occupied;	// @[OutputUnit.scala:66:19, :74:{25,30}, :76:18]
  wire       _GEN_5 = ~(io_out_vc_free[9]) & states_9_occupied;	// @[OutputUnit.scala:66:19, :74:{25,30}, :76:18]
  always @(posedge clock) begin
    if (reset) begin
      ...
      states_9_occupied <= io_allocs_9_alloc | _GEN_5;	// @[OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18]
      states_9_c <= states_9_c + {2'h0, io_out_credit_return[9]} - {2'h0, io_credit_alloc_9_alloc};	// @[OutputUnit.scala:66:19, :94:36, :97:{18,26}]
      states_8_occupied <= io_allocs_8_alloc | _GEN_4;	// @[OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18]
  ...
  assign io_channel_status_8_occupied = _GEN_4;	// @[OutputUnit.scala:66:19, :74:30, :76:18]
  assign io_channel_status_9_occupied = _GEN_5;	// @[OutputUnit.scala:66:19, :74:30, :76:18]
