...
module NoCMonitor_8(
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_269 = io_in_flit_0_bits_flow_ingress_node == 4'h4;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_120 = io_in_flit_0_bits_flow_egress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_150 = io_in_flit_0_bits_flow_ingress_node_id == 3'h1;	// @[Types.scala:55:25]
    wire         _T_152 = io_in_flit_0_bits_flow_egress_node_id == 3'h1;	// @[Types.scala:55:25, :56:24]
    wire         _T_262 = io_in_flit_0_bits_flow_ingress_node == 4'h7;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_270 = io_in_flit_0_bits_flow_egress_node == 4'h1;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_241 = io_in_flit_0_bits_flow_ingress_node == 4'h5;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_249 = io_in_flit_0_bits_flow_egress_node == 4'h2;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_256 = io_in_flit_0_bits_flow_egress_node == 4'h0;	// @[Monitor.scala:21:46, Types.scala:54:21]
    wire         _T_220 = io_in_flit_0_bits_flow_ingress_node == 4'h6;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_133 = io_in_flit_0_bits_flow_ingress_node == 4'h3;	// @[Monitor.scala:21:46, Types.scala:53:21]
    wire         _T_136 = io_in_flit_0_bits_flow_ingress_node_id == 3'h4;	// @[Types.scala:53:21, :55:25]
    wire         _T_272 = io_in_flit_0_bits_flow_ingress_node_id == 3'h0;	// @[Monitor.scala:32:44, Types.scala:55:25]
    wire         _T_274 = io_in_flit_0_bits_flow_egress_node_id == 3'h0;	// @[Monitor.scala:32:44, Types.scala:56:24]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:22:16]
      ...
      if (_T_4 & ~reset & io_in_flit_0_bits_virt_channel_id == 4'h1) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h3 | _T_269 & _T_120 & _T_150 & _T_152 | _T_262 & _T_270 & _T_150 & _T_152 | _T_262 & _T_120 & _T_150 & _T_152 | _T_241 & _T_249 & _T_150 & _T_152 | _T_262 & _T_256 & _T_150 & _T_152 | _T_220 & _T_120 & _T_150 & _T_152 | _T_220 & _T_270 & _T_150 & _T_152 | _T_269 & _T_249 & _T_150 & _T_152 | _T_241 & _T_270 & _T_150 & _T_152 | _T_133 & _T_256 & _T_136 & _T_152 | _T_269 & _T_270 & _T_150 & _T_152 | _T_262 & _T_249 & _T_150 & _T_152 | _T_220 & _T_256 & _T_150 & _T_152 | _T_133 & _T_270 & _T_136 & _T_152 | _T_241 & _T_120 & _T_150 & _T_152 | _T_241 & _T_256 & _T_150 & _T_152 | _T_133 & _T_249 & _T_136 & _T_152 | _T_220 & _T_249 & _T_150 & _T_152 | _T_269 & _T_256 & _T_150 & _T_152)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & io_in_flit_0_bits_virt_channel_id == 4'h5) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & ~(io_in_flit_0_bits_virt_channel_id != 4'h7 | _T_220 & _T_270 & _T_272 & _T_274 | _T_220 & _T_256 & _T_272 & _T_274 | _T_269 & _T_256 & _T_272 & _T_274 | _T_241 & _T_256 & _T_272 & _T_274 | _T_220 & _T_249 & _T_272 & _T_274 | _T_241 & _T_249 & _T_272 & _T_274 | _T_269 & _T_249 & _T_272 & _T_274 | _T_241 & _T_270 & _T_272 & _T_274 | _T_262 & _T_249 & _T_272 & _T_274 | _T_262 & _T_256 & _T_272 & _T_274 | _T_262 & _T_270 & _T_272 & _T_274 | _T_269 & _T_270 & _T_272 & _T_274)) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44,52}, Types.scala:53:21, :54:21, :55:{25,45}, :56:24]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
      ...
      if (_T_4 & ~reset & io_in_flit_0_bits_virt_channel_id == 4'h9) begin	// @[Monitor.scala:21:46, :29:22, :32:{17,44}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:32:17]
          $error("Assertion failed\n    at Monitor.scala:32 assert(flit.bits.virt_channel_id =/= i.U || v.possibleFlows.toSeq.map(_.isFlow(flit.bits.flow)).orR)\n");	// @[Monitor.scala:32:17]
        if (`STOP_COND_)	// @[Monitor.scala:32:17]
          $fatal;	// @[Monitor.scala:32:17]
