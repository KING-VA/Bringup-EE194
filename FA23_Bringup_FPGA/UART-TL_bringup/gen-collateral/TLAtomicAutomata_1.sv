...
module TLAtomicAutomata_1(
  ...
  reg  [28:0]     cam_a_0_bits_address;	// @[AtomicAutomata.scala:79:24]
  ...
  wire [6:0]      _GEN = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h1};	// @[AtomicAutomata.scala:199:23, Parameters.scala:137:{31,45}]
  wire [6:0]      _GEN_0 = {auto_in_a_bits_address[28:27], auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2};	// @[AtomicAutomata.scala:83:44, Parameters.scala:137:{31,45}]
  wire [6:0]      _GEN_1 = {auto_in_a_bits_address[28:27] ^ 2'h2, auto_in_a_bits_address[25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13]};	// @[AtomicAutomata.scala:83:44, Parameters.scala:137:{31,45}]
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_1 == 7'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_1 == 7'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :670:56, :671:42]
  ...
  wire            _GEN_10 = out_1_ready & out_1_earlyValid & ~a_isSupported & cam_free_0;	// @[Arbiter.scala:123:31, AtomicAutomata.scala:79:24, :82:44, :94:32, :153:38, :155:15, :176:50, :178:23, :179:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_address = {_RANDOM_0[31:18], _RANDOM_1[14:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        ...
        beatsLeft = {_RANDOM_5[31], _RANDOM_6[7:0]};	// @[Arbiter.scala:87:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[8];	// @[Arbiter.scala:87:30, :116:26]
        state_1 = _RANDOM_6[9];	// @[Arbiter.scala:87:30, :116:26]
        d_first_counter = _RANDOM_6[18:10];	// @[Arbiter.scala:87:30, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? cam_a_0_bits_source : 6'h0) | (muxStateEarly_1 ? auto_in_a_bits_source : 6'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_address = (muxStateEarly_0 ? cam_a_0_bits_address : 29'h0) | (muxStateEarly_1 ? auto_in_a_bits_address : 29'h0);	// @[Arbiter.scala:117:30, AtomicAutomata.scala:79:24, Bundles.scala:259:74, Mux.scala:27:73]
