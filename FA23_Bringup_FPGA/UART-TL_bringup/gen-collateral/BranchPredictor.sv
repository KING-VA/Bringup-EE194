...
module BranchPredictor(
  ...
  input  [49:0] io_update_bits_meta_0,
  ...
  output [49:0] io_resp_f3_meta_0
);

  reg [15:0] banked_predictors_0_io_f1_ghist_REG;	// @[predictor.scala:239:48]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_3 = `RANDOM;
        _RANDOM_4 = `RANDOM;
        banked_predictors_0_io_f1_ghist_REG = _RANDOM_0[15:0];	// @[predictor.scala:239:48]
        io_resp_f1_pc_REG = {_RANDOM_0[31:16], _RANDOM_1[23:0]};	// @[predictor.scala:239:48, :362:27]
        io_resp_f2_pc_REG = {_RANDOM_1[31:24], _RANDOM_2};	// @[predictor.scala:362:27, :363:27]
        io_resp_f3_pc_REG = {_RANDOM_3, _RANDOM_4[7:0]};	// @[predictor.scala:364:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
