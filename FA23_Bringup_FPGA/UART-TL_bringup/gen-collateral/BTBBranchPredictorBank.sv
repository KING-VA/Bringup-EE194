...
module BTBBranchPredictorBank(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        f3_meta_REG_write_way = _RANDOM_11[18];	// @[btb.scala:53:32, predictor.scala:185:30]
        f3_meta_write_way = _RANDOM_11[19];	// @[btb.scala:53:24, predictor.scala:185:30]
        doing_reset = _RANDOM_11[20];	// @[btb.scala:60:28, predictor.scala:185:30]
        reset_idx = _RANDOM_11[27:21];	// @[btb.scala:61:28, predictor.scala:185:30]
        REG = _RANDOM_11[28];	// @[btb.scala:104:18, predictor.scala:185:30]
        io_resp_f2_0_predicted_pc_REG_valid = _RANDOM_11[29];	// @[btb.scala:105:44, predictor.scala:185:30]
        io_resp_f2_0_predicted_pc_REG_bits = {_RANDOM_11[31:30], _RANDOM_12, _RANDOM_13[5:0]};	// @[btb.scala:105:44, predictor.scala:185:30]
        io_resp_f2_0_is_br_REG = _RANDOM_13[6];	// @[btb.scala:105:44, :106:44]
        io_resp_f2_0_is_jal_REG = _RANDOM_13[7];	// @[btb.scala:105:44, :107:44]
        REG_1 = _RANDOM_13[8];	// @[btb.scala:105:44, :108:20]
        REG_2 = _RANDOM_13[9];	// @[btb.scala:105:44, :112:26]
        REG_3 = _RANDOM_13[10];	// @[btb.scala:105:44, :112:18]
        io_resp_f3_0_predicted_pc_REG_valid = _RANDOM_13[11];	// @[btb.scala:105:44, :113:44]
        io_resp_f3_0_predicted_pc_REG_bits = {_RANDOM_13[31:12], _RANDOM_14[19:0]};	// @[btb.scala:105:44, :113:44]
        io_resp_f3_0_is_br_REG = _RANDOM_14[20];	// @[btb.scala:113:44, :114:44]
        io_resp_f3_0_is_jal_REG = _RANDOM_14[21];	// @[btb.scala:113:44, :115:44]
        REG_4 = _RANDOM_14[22];	// @[btb.scala:113:44, :116:28]
        REG_5 = _RANDOM_14[23];	// @[btb.scala:113:44, :116:20]
        REG_6 = _RANDOM_14[24];	// @[btb.scala:104:18, :113:44]
        io_resp_f2_1_predicted_pc_REG_valid = _RANDOM_14[25];	// @[btb.scala:105:44, :113:44]
        io_resp_f2_1_predicted_pc_REG_bits = {_RANDOM_14[31:26], _RANDOM_15, _RANDOM_16[1:0]};	// @[btb.scala:105:44, :113:44]
        io_resp_f2_1_is_br_REG = _RANDOM_16[2];	// @[btb.scala:105:44, :106:44]
        io_resp_f2_1_is_jal_REG = _RANDOM_16[3];	// @[btb.scala:105:44, :107:44]
        REG_7 = _RANDOM_16[4];	// @[btb.scala:105:44, :108:20]
        REG_8 = _RANDOM_16[5];	// @[btb.scala:105:44, :112:26]
        REG_9 = _RANDOM_16[6];	// @[btb.scala:105:44, :112:18]
        io_resp_f3_1_predicted_pc_REG_valid = _RANDOM_16[7];	// @[btb.scala:105:44, :113:44]
        io_resp_f3_1_predicted_pc_REG_bits = {_RANDOM_16[31:8], _RANDOM_17[15:0]};	// @[btb.scala:105:44, :113:44]
        io_resp_f3_1_is_br_REG = _RANDOM_17[16];	// @[btb.scala:113:44, :114:44]
        io_resp_f3_1_is_jal_REG = _RANDOM_17[17];	// @[btb.scala:113:44, :115:44]
        REG_10 = _RANDOM_17[18];	// @[btb.scala:113:44, :116:28]
        REG_11 = _RANDOM_17[19];	// @[btb.scala:113:44, :116:20]
        REG_12 = _RANDOM_17[20];	// @[btb.scala:104:18, :113:44]
        io_resp_f2_2_predicted_pc_REG_valid = _RANDOM_17[21];	// @[btb.scala:105:44, :113:44]
        io_resp_f2_2_predicted_pc_REG_bits = {_RANDOM_17[31:22], _RANDOM_18[29:0]};	// @[btb.scala:105:44, :113:44]
        io_resp_f2_2_is_br_REG = _RANDOM_18[30];	// @[btb.scala:105:44, :106:44]
        io_resp_f2_2_is_jal_REG = _RANDOM_18[31];	// @[btb.scala:105:44, :107:44]
        REG_13 = _RANDOM_19[0];	// @[btb.scala:108:20]
        REG_14 = _RANDOM_19[1];	// @[btb.scala:108:20, :112:26]
        REG_15 = _RANDOM_19[2];	// @[btb.scala:108:20, :112:18]
        io_resp_f3_2_predicted_pc_REG_valid = _RANDOM_19[3];	// @[btb.scala:108:20, :113:44]
        io_resp_f3_2_predicted_pc_REG_bits = {_RANDOM_19[31:4], _RANDOM_20[11:0]};	// @[btb.scala:108:20, :113:44]
        io_resp_f3_2_is_br_REG = _RANDOM_20[12];	// @[btb.scala:113:44, :114:44]
        io_resp_f3_2_is_jal_REG = _RANDOM_20[13];	// @[btb.scala:113:44, :115:44]
        REG_16 = _RANDOM_20[14];	// @[btb.scala:113:44, :116:28]
        REG_17 = _RANDOM_20[15];	// @[btb.scala:113:44, :116:20]
        REG_18 = _RANDOM_20[16];	// @[btb.scala:104:18, :113:44]
        io_resp_f2_3_predicted_pc_REG_valid = _RANDOM_20[17];	// @[btb.scala:105:44, :113:44]
        io_resp_f2_3_predicted_pc_REG_bits = {_RANDOM_20[31:18], _RANDOM_21[25:0]};	// @[btb.scala:105:44, :113:44]
        io_resp_f2_3_is_br_REG = _RANDOM_21[26];	// @[btb.scala:105:44, :106:44]
        io_resp_f2_3_is_jal_REG = _RANDOM_21[27];	// @[btb.scala:105:44, :107:44]
        REG_19 = _RANDOM_21[28];	// @[btb.scala:105:44, :108:20]
        REG_20 = _RANDOM_21[29];	// @[btb.scala:105:44, :112:26]
        REG_21 = _RANDOM_21[30];	// @[btb.scala:105:44, :112:18]
        io_resp_f3_3_predicted_pc_REG_valid = _RANDOM_21[31];	// @[btb.scala:105:44, :113:44]
        io_resp_f3_3_predicted_pc_REG_bits = {_RANDOM_22, _RANDOM_23[7:0]};	// @[btb.scala:113:44]
        io_resp_f3_3_is_br_REG = _RANDOM_23[8];	// @[btb.scala:113:44, :114:44]
        io_resp_f3_3_is_jal_REG = _RANDOM_23[9];	// @[btb.scala:113:44, :115:44]
        REG_22 = _RANDOM_23[10];	// @[btb.scala:113:44, :116:28]
        REG_23 = _RANDOM_23[11];	// @[btb.scala:113:44, :116:20]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_f3_meta = {49'h0, f3_meta_write_way};	// @[btb.scala:53:24, :56:14]
endmodule
