...
module AsyncQueueSink_9(
  ...
  wire [7:0][30:0] _GEN_3 = {{io_async_mem_7_address}, {io_async_mem_6_address}, {io_async_mem_5_address}, {io_async_mem_4_address}, {io_async_mem_3_address}, {io_async_mem_2_address}, {io_async_mem_1_address}, {io_async_mem_0_address}};	// @[SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[112:110];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[109:104];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_address = _io_deq_bits_deq_bits_reg_io_q[103:73];	// @[SynchronizerReg.scala:207:25, :211:26]
