...
module AsyncQueueSink_30(
  ...
  wire [18:0] _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  ClockCrossingReg_w19 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({io_async_mem_0_resumereq, io_async_mem_0_hartsel, io_async_mem_0_ackhavereset, io_async_mem_0_hasel, io_async_mem_0_hamask_2, io_async_mem_0_hamask_1, io_async_mem_0_hamask_0, io_async_mem_0_hrmask_2, io_async_mem_0_hrmask_1, io_async_mem_0_hrmask_0}),	// @[SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_resumereq = _io_deq_bits_deq_bits_reg_io_q[18];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hartsel = _io_deq_bits_deq_bits_reg_io_q[17:8];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_ackhavereset = _io_deq_bits_deq_bits_reg_io_q[7];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hasel = _io_deq_bits_deq_bits_reg_io_q[6];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_0 = _io_deq_bits_deq_bits_reg_io_q[3];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_1 = _io_deq_bits_deq_bits_reg_io_q[4];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_2 = _io_deq_bits_deq_bits_reg_io_q[5];	// @[SynchronizerReg.scala:207:25, :211:26]
