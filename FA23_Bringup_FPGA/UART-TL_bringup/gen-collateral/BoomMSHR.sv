...
module BoomMSHR(
  ...
  input  [22:0] io_req_old_meta_tag,
  ...
  reg  [22:0]      req_old_meta_tag;	// @[mshrs.scala:109:20]
  ...
  reg  [4:0]       grantack_bits_sink;	// @[mshrs.scala:138:21]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_old_meta_tag = {_RANDOM_15[31:21], _RANDOM_16[11:0]};	// @[mshrs.scala:109:20]
        req_way_en = _RANDOM_16[15:12];	// @[mshrs.scala:109:20]
        req_needs_wb = _RANDOM_16[21];	// @[mshrs.scala:109:20, :113:29]
        new_coh_state = _RANDOM_16[23:22];	// @[mshrs.scala:109:20, :115:24]
        counter = {_RANDOM_16[31:24], _RANDOM_17[0]};	// @[Edges.scala:228:27, mshrs.scala:109:20]
        grantack_valid = _RANDOM_17[1];	// @[Edges.scala:228:27, mshrs.scala:138:21]
        grantack_bits_sink = _RANDOM_17[6:2];	// @[Edges.scala:228:27, mshrs.scala:138:21]
        refill_ctr = _RANDOM_17[9:7];	// @[Edges.scala:228:27, mshrs.scala:139:24]
        commit_line = _RANDOM_17[10];	// @[Edges.scala:228:27, mshrs.scala:140:24]
        grant_had_data = _RANDOM_17[11];	// @[Edges.scala:228:27, mshrs.scala:141:27]
        finish_to_prefetch = _RANDOM_17[12];	// @[Edges.scala:228:27, mshrs.scala:142:31]
        meta_hazard = _RANDOM_17[14:13];	// @[Edges.scala:228:27, mshrs.scala:145:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_mem_acquire_bits_address = {req_addr[34:6], 6'h0};	// @[Edges.scala:350:15, mshrs.scala:109:20, :112:51]
  ...
  assign io_meta_write_bits_data_tag = req_addr[34:12];	// @[mshrs.scala:109:20, :111:26, :286:27]
  ...
  assign io_meta_read_bits_tag = req_addr[34:12];	// @[mshrs.scala:109:20, :111:26, :286:27]
