...
module SourceC(
  ...
  reg  [19:0] req_r_tag;	// @[Reg.scala:19:16]
  reg  [6:0]  req_r_set;	// @[Reg.scala:19:16]
  reg  [2:0]  req_r_way;	// @[Reg.scala:19:16]
  wire [6:0]  req_set = busy ? req_r_set : io_req_bits_set;	// @[Reg.scala:19:16, SourceC.scala:65:21, :68:17]
  ...
  reg  [19:0] s2_req_tag;	// @[Reg.scala:19:16]
  ...
  reg  [19:0] s3_req_tag;	// @[Reg.scala:19:16]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_tag = {_RANDOM_0[31:18], _RANDOM_1[5:0]};	// @[Reg.scala:19:16, SourceC.scala:57:21]
        req_r_set = _RANDOM_1[12:6];	// @[Reg.scala:19:16]
        req_r_way = _RANDOM_1[15:13];	// @[Reg.scala:19:16]
        s2_valid = _RANDOM_1[17];	// @[Reg.scala:19:16, SourceC.scala:93:25]
        s2_req_opcode = _RANDOM_1[20:18];	// @[Reg.scala:19:16]
        s2_req_param = _RANDOM_1[23:21];	// @[Reg.scala:19:16]
        s2_req_source = _RANDOM_1[26:24];	// @[Reg.scala:19:16]
        s2_req_tag = {_RANDOM_1[31:27], _RANDOM_2[14:0]};	// @[Reg.scala:19:16]
        s2_req_set = _RANDOM_2[21:15];	// @[Reg.scala:19:16]
        s3_valid = _RANDOM_2[30];	// @[Reg.scala:19:16, SourceC.scala:99:25]
        s3_req_opcode = {_RANDOM_2[31], _RANDOM_3[1:0]};	// @[Reg.scala:19:16]
        s3_req_param = _RANDOM_3[4:2];	// @[Reg.scala:19:16]
        s3_req_source = _RANDOM_3[7:5];	// @[Reg.scala:19:16]
        s3_req_tag = _RANDOM_3[27:8];	// @[Reg.scala:19:16]
        s3_req_set = {_RANDOM_3[31:28], _RANDOM_4[2:0]};	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  QueueCompatibility queue (	// @[SourceC.scala:53:21]
    ...
    .io_enq_bits_address ({s3_req_tag, s3_req_set, 8'h0}),	// @[Cat.scala:33:92, Reg.scala:19:16]
