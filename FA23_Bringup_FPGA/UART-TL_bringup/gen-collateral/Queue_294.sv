...
module Queue_294(
  ...
  assign io_deq_bits_ghist_old_history = _ram_ext_R0_data[473:458];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_current_saw_branch_not_taken = _ram_ext_R0_data[474];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_new_saw_branch_not_taken = _ram_ext_R0_data[475];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_new_saw_branch_taken = _ram_ext_R0_data[476];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ghist_ras_idx = _ram_ext_R0_data[481:477];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_xcpt_pf_if = _ram_ext_R0_data[483];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_xcpt_ae_if = _ram_ext_R0_data[484];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_0 = _ram_ext_R0_data[485];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_1 = _ram_ext_R0_data[486];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_2 = _ram_ext_R0_data[487];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_debug_if_oh_3 = _ram_ext_R0_data[488];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_0 = _ram_ext_R0_data[489];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_1 = _ram_ext_R0_data[490];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_2 = _ram_ext_R0_data[491];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bp_xcpt_if_oh_3 = _ram_ext_R0_data[492];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_bpd_meta_0 = _ram_ext_R0_data[559:510];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_fsrc = _ram_ext_R0_data[561:560];	// @[Decoupled.scala:273:95]
endmodule
