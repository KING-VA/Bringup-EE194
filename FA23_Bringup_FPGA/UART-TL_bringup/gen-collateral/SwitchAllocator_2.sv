...
module SwitchAllocator_2(
  ...
  wire _arbs_0_io_chosen_oh_0;	// @[SwitchAllocator.scala:83:45]
  ...
  SwitchArbiter_9 arbs_0 (	// @[SwitchAllocator.scala:83:45]
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_req_0_0_ready = _arbs_0_io_in_0_ready & _arbs_0_io_in_0_valid_T_9;	// @[Decoupled.scala:51:35, SwitchAllocator.scala:83:45, :95:37]
  ...
  assign io_switch_sel_0_0_0_0 = _arbs_0_io_in_0_valid_T_9 & _arbs_0_io_chosen_oh_0 & _arbs_0_io_out_0_valid;	// @[SwitchAllocator.scala:83:45, :95:37, :108:97]
endmodule
