...
module TLDToNoC(
  ...
  wire        _io_flit_bits_tail_output = (tail_counter == 9'h1 | (_q_io_deq_bits_opcode[0] ? ~(_tail_beats1_decode_T_1[11:3]) : 9'h0) == 9'h0) & (is_body | ~(_q_io_deq_bits_opcode[0]));	// @[Edges.scala:105:36, :220:14, :228:27, :231:{25,37,47}, Tilelink.scala:45:17, :59:24, :61:50, :64:{35,47}, package.scala:235:{46,71,76}]
  ...
  assign io_flit_bits_egress_id = {1'h0, {1'h0, _q_io_deq_bits_source == 5'h10} | {2{_q_io_deq_bits_source[4:2] == 3'h3}}} | (_q_io_deq_bits_source[4:2] == 3'h2 ? 3'h5 : 3'h0) | {3{_q_io_deq_bits_source[4:3] == 2'h0}};	// @[Edges.scala:220:14, Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}, Tilelink.scala:45:17]
endmodule
