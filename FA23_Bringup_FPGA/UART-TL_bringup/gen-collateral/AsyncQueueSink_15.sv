...
module AsyncQueueSink_15(
  ...
  wire [78:0]      _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  ClockCrossingReg_w79 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[78:76];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[75:74];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[73:71];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[70:67];	// @[SynchronizerReg.scala:207:25, :211:26]
