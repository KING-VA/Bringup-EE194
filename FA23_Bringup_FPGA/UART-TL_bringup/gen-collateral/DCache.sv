...
module DCache(
  ...
  wire [9:0]       releaseDataBeat = {1'h0, beats1_1 & ~counter1_1} + {8'h0, releaseRejected ? 2'h0 : {1'h0, s1_release_data_valid} + {1'h0, s2_release_data_valid}};	// @[Bitwise.scala:77:12, DCache.scala:778:38, :779:38, :780:44, :781:{43,48,93}, Edges.scala:220:14, :229:28, :233:{25,27}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_tag = _RANDOM_141[28:21];	// @[Reg.scala:19:16]
        s1_req_cmd = {_RANDOM_141[31:29], _RANDOM_142[1:0]};	// @[Reg.scala:19:16]
        s1_req_size = _RANDOM_142[3:2];	// @[Reg.scala:19:16]
        s1_req_signed = _RANDOM_142[4];	// @[Reg.scala:19:16]
        s1_req_dprv = _RANDOM_142[6:5];	// @[Reg.scala:19:16]
        s1_req_dv = _RANDOM_142[7];	// @[Reg.scala:19:16]
        s1_req_no_alloc = _RANDOM_142[9];	// @[Reg.scala:19:16]
        s1_req_no_xcpt = _RANDOM_142[10];	// @[Reg.scala:19:16]
        s1_req_mask = _RANDOM_144[18:11];	// @[Reg.scala:19:16]
        s1_tlb_req_vaddr = {_RANDOM_144[31:19], _RANDOM_145[26:0]};	// @[Reg.scala:19:16]
        s1_tlb_req_passthrough = _RANDOM_145[27];	// @[Reg.scala:19:16]
        s1_tlb_req_size = _RANDOM_145[29:28];	// @[Reg.scala:19:16]
        s1_tlb_req_cmd = {_RANDOM_145[31:30], _RANDOM_146[2:0]};	// @[Reg.scala:19:16]
        s1_tlb_req_prv = _RANDOM_146[4:3];	// @[Reg.scala:19:16]
        cached_grant_wait = _RANDOM_150[15];	// @[DCache.scala:200:34]
        resetting = _RANDOM_150[16];	// @[DCache.scala:200:34, :201:26]
        flushCounter = _RANDOM_150[24:17];	// @[DCache.scala:200:34, :202:29]
        release_ack_wait = _RANDOM_150[25];	// @[DCache.scala:200:34, :203:33]
        release_ack_addr = {_RANDOM_150[31:26], _RANDOM_151[28:0]};	// @[DCache.scala:200:34, :204:29]
        release_state = {_RANDOM_151[31:29], _RANDOM_152[0]};	// @[DCache.scala:204:29, :205:30]
        refill_way = _RANDOM_152[4:1];	// @[DCache.scala:205:30, :206:23]
        uncachedInFlight_0 = _RANDOM_152[5];	// @[DCache.scala:205:30, :213:33]
        uncachedReqs_0_addr = {_RANDOM_152[31:6], _RANDOM_153[13:0]};	// @[DCache.scala:205:30, :214:25]
        uncachedReqs_0_tag = _RANDOM_153[21:14];	// @[DCache.scala:214:25]
        uncachedReqs_0_size = _RANDOM_153[28:27];	// @[DCache.scala:214:25]
        uncachedReqs_0_signed = _RANDOM_153[29];	// @[DCache.scala:214:25]
        s1_did_read = _RANDOM_156[12];	// @[Reg.scala:19:16]
        s1_read_mask = _RANDOM_156[13];	// @[Reg.scala:19:16]
        s2_valid = _RANDOM_156[14];	// @[DCache.scala:308:25, Reg.scala:19:16]
        s2_probe = _RANDOM_156[15];	// @[DCache.scala:310:25, Reg.scala:19:16]
        s2_not_nacked_in_s1 = _RANDOM_156[16];	// @[DCache.scala:312:36, Reg.scala:19:16]
        s2_req_addr = {_RANDOM_156[31:17], _RANDOM_157[24:0]};	// @[DCache.scala:316:19, Reg.scala:19:16]
        s2_req_tag = {_RANDOM_157[31:25], _RANDOM_158[0]};	// @[DCache.scala:316:19]
        s2_req_cmd = _RANDOM_158[5:1];	// @[DCache.scala:316:19]
        s2_req_size = _RANDOM_158[7:6];	// @[DCache.scala:316:19]
        s2_req_signed = _RANDOM_158[8];	// @[DCache.scala:316:19]
        s2_req_dprv = _RANDOM_158[10:9];	// @[DCache.scala:316:19]
        s2_req_dv = _RANDOM_158[11];	// @[DCache.scala:316:19]
        s2_req_no_alloc = _RANDOM_158[13];	// @[DCache.scala:316:19]
        s2_req_no_xcpt = _RANDOM_158[14];	// @[DCache.scala:316:19]
        s2_req_mask = _RANDOM_160[22:15];	// @[DCache.scala:316:19]
        s2_tlb_xcpt_pf_ld = _RANDOM_163[4];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_pf_st = _RANDOM_163[5];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_gf_ld = _RANDOM_163[8];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_gf_st = _RANDOM_163[9];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ae_ld = _RANDOM_163[12];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ae_st = _RANDOM_163[13];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ma_ld = _RANDOM_163[16];	// @[DCache.scala:319:24]
        s2_tlb_xcpt_ma_st = _RANDOM_163[17];	// @[DCache.scala:319:24]
        s2_pma_cacheable = _RANDOM_166[20];	// @[DCache.scala:320:19]
        s2_pma_must_alloc = _RANDOM_166[21];	// @[DCache.scala:320:19]
        s2_uncached_resp_addr = {_RANDOM_166[31:23], _RANDOM_167[30:0]};	// @[DCache.scala:320:19, :321:34]
        s2_vaddr_r = {_RANDOM_167[31], _RANDOM_168, _RANDOM_169[6:0]};	// @[DCache.scala:321:34, Reg.scala:19:16]
        s2_meta_correctable_errors_r = _RANDOM_169[8];	// @[Reg.scala:19:16]
        s2_meta_correctable_errors_r_1 = _RANDOM_169[9];	// @[Reg.scala:19:16]
        s2_meta_correctable_errors_r_2 = _RANDOM_169[10];	// @[Reg.scala:19:16]
        s2_meta_correctable_errors_r_3 = _RANDOM_169[11];	// @[Reg.scala:19:16]
        s2_meta_uncorrectable_errors_r = _RANDOM_169[12];	// @[Reg.scala:19:16]
        s2_meta_uncorrectable_errors_r_1 = _RANDOM_169[13];	// @[Reg.scala:19:16]
        s2_meta_uncorrectable_errors_r_2 = _RANDOM_169[14];	// @[Reg.scala:19:16]
        s2_meta_uncorrectable_errors_r_3 = _RANDOM_169[15];	// @[Reg.scala:19:16]
        s2_meta_corrected_r = {_RANDOM_169[31:16], _RANDOM_170[8:0]};	// @[Reg.scala:19:16]
        s2_meta_corrected_r_1 = {_RANDOM_170[31:9], _RANDOM_171[1:0]};	// @[Reg.scala:19:16]
        s2_meta_corrected_r_2 = _RANDOM_171[26:2];	// @[Reg.scala:19:16]
        s2_meta_corrected_r_3 = {_RANDOM_171[31:27], _RANDOM_172[19:0]};	// @[Reg.scala:19:16]
        s2_data = {_RANDOM_172[31:20], _RANDOM_173, _RANDOM_174[19:0]};	// @[Reg.scala:19:16]
        s2_probe_way = _RANDOM_174[23:20];	// @[Reg.scala:19:16]
        s2_probe_state_state = _RANDOM_174[25:24];	// @[Reg.scala:19:16]
        s2_hit_way = _RANDOM_174[29:26];	// @[Reg.scala:19:16]
        s2_hit_state_state = _RANDOM_174[31:30];	// @[Reg.scala:19:16]
        s2_waw_hazard = _RANDOM_175[0];	// @[Reg.scala:19:16]
        s2_victim_way_r = _RANDOM_175[2:1];	// @[Reg.scala:19:16]
        lrscCount = _RANDOM_175[9:3];	// @[DCache.scala:449:26, Reg.scala:19:16]
        lrscAddr = {_RANDOM_175[31:10], _RANDOM_176[11:0]};	// @[DCache.scala:452:21, Reg.scala:19:16]
        pstore1_cmd = _RANDOM_176[17:13];	// @[DCache.scala:452:21, Reg.scala:19:16]
        pstore1_addr = {_RANDOM_176[31:18], _RANDOM_177[25:0]};	// @[DCache.scala:452:21, Reg.scala:19:16]
        pstore1_data = {_RANDOM_177[31:26], _RANDOM_178, _RANDOM_179[25:0]};	// @[Reg.scala:19:16]
        pstore1_way = _RANDOM_179[29:26];	// @[Reg.scala:19:16]
        pstore1_mask = {_RANDOM_179[31:30], _RANDOM_180[5:0]};	// @[Reg.scala:19:16]
        pstore1_rmw_r = _RANDOM_180[6];	// @[Reg.scala:19:16]
        pstore2_valid = _RANDOM_180[7];	// @[DCache.scala:478:30, Reg.scala:19:16]
        pstore_drain_on_miss_REG = _RANDOM_180[8];	// @[DCache.scala:480:56, Reg.scala:19:16]
        pstore1_held = _RANDOM_180[9];	// @[DCache.scala:481:29, Reg.scala:19:16]
        pstore2_addr = {_RANDOM_180[31:10], _RANDOM_181[17:0]};	// @[Reg.scala:19:16]
        pstore2_way = _RANDOM_181[21:18];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r = _RANDOM_181[29:22];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_1 = {_RANDOM_181[31:30], _RANDOM_182[5:0]};	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_2 = _RANDOM_182[13:6];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_3 = _RANDOM_182[21:14];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_4 = _RANDOM_182[29:22];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_5 = {_RANDOM_182[31:30], _RANDOM_183[5:0]};	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_6 = _RANDOM_183[13:6];	// @[Reg.scala:19:16]
        pstore2_storegen_data_r_7 = _RANDOM_183[21:14];	// @[Reg.scala:19:16]
        pstore2_storegen_mask = _RANDOM_183[29:22];	// @[DCache.scala:508:19, Reg.scala:19:16]
        counter = {_RANDOM_183[31], _RANDOM_184[7:0]};	// @[Edges.scala:228:27, Reg.scala:19:16]
        grantInProgress = _RANDOM_184[8];	// @[DCache.scala:644:32, Edges.scala:228:27]
        blockProbeAfterGrantCount = _RANDOM_184[11:9];	// @[DCache.scala:645:42, Edges.scala:228:27]
        blockUncachedGrant = _RANDOM_184[12];	// @[DCache.scala:727:33, Edges.scala:228:27]
        counter_1 = _RANDOM_184[21:13];	// @[Edges.scala:228:27]
        s1_release_data_valid = _RANDOM_184[22];	// @[DCache.scala:778:38, Edges.scala:228:27]
        s2_release_data_valid = _RANDOM_184[23];	// @[DCache.scala:779:38, Edges.scala:228:27]
        io_cpu_s2_xcpt_REG = _RANDOM_184[24];	// @[DCache.scala:909:32, Edges.scala:228:27]
        doUncachedResp = _RANDOM_186[25];	// @[DCache.scala:924:31]
        REG = _RANDOM_186[26];	// @[DCache.scala:924:31, :984:18]
        io_cpu_perf_release_counter = _RANDOM_187[12:4];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
