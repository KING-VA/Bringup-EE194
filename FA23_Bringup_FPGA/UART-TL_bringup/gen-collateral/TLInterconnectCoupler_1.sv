...
module TLInterconnectCoupler_1(
  ...
  input         auto_bus_xing_in_a_mem_0_source,
  input  [34:0] auto_bus_xing_in_a_mem_0_address,
  ...
  input         auto_bus_xing_in_a_mem_1_source,
  input  [34:0] auto_bus_xing_in_a_mem_1_address,
  ...
  input         auto_bus_xing_in_a_mem_2_source,
  input  [34:0] auto_bus_xing_in_a_mem_2_address,
  ...
  input         auto_bus_xing_in_a_mem_3_source,
  input  [34:0] auto_bus_xing_in_a_mem_3_address,
  ...
  input         auto_bus_xing_in_a_mem_4_source,
  input  [34:0] auto_bus_xing_in_a_mem_4_address,
  ...
  input         auto_bus_xing_in_a_mem_5_source,
  input  [34:0] auto_bus_xing_in_a_mem_5_address,
  ...
  input         auto_bus_xing_in_a_mem_6_source,
  input  [34:0] auto_bus_xing_in_a_mem_6_address,
  ...
  input         auto_bus_xing_in_a_mem_7_source,
  input  [34:0] auto_bus_xing_in_a_mem_7_address,
  ...
  output [34:0] auto_widget_out_a_bits_address,
  ...
  output        auto_bus_xing_in_d_mem_0_source,
  output [4:0]  auto_bus_xing_in_d_mem_0_sink,
  output        auto_bus_xing_in_d_mem_0_denied,
  ...
  output        auto_bus_xing_in_d_mem_1_source,
  output [4:0]  auto_bus_xing_in_d_mem_1_sink,
  output        auto_bus_xing_in_d_mem_1_denied,
  ...
  output        auto_bus_xing_in_d_mem_2_source,
  output [4:0]  auto_bus_xing_in_d_mem_2_sink,
  output        auto_bus_xing_in_d_mem_2_denied,
  ...
  output        auto_bus_xing_in_d_mem_3_source,
  output [4:0]  auto_bus_xing_in_d_mem_3_sink,
  output        auto_bus_xing_in_d_mem_3_denied,
  ...
  output        auto_bus_xing_in_d_mem_4_source,
  output [4:0]  auto_bus_xing_in_d_mem_4_sink,
  output        auto_bus_xing_in_d_mem_4_denied,
  ...
  output        auto_bus_xing_in_d_mem_5_source,
  output [4:0]  auto_bus_xing_in_d_mem_5_sink,
  output        auto_bus_xing_in_d_mem_5_denied,
  ...
  output        auto_bus_xing_in_d_mem_6_source,
  output [4:0]  auto_bus_xing_in_d_mem_6_sink,
  output        auto_bus_xing_in_d_mem_6_denied,
  ...
  output        auto_bus_xing_in_d_mem_7_source,
  output [4:0]  auto_bus_xing_in_d_mem_7_sink,
  output        auto_bus_xing_in_d_mem_7_denied,
  ...
  TLAsyncCrossingSink asink (	// @[AsyncCrossing.scala:98:27]
    .clock                         (clock),
    .reset                         (reset),
