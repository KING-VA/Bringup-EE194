...
module TLMonitor_18(
  ...
  wire         _T_1427 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_1351 = _T_1427 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_1351 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {252'h0, io_in_a_bits_source, 2'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:46:9]
  wire [270:0] _d_sizes_clr_T_5 = 271'hFF << {263'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [259:0] _a_sizes_set_T_1 = {255'h0, _T_1351 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {252'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire         _T_1500 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1366 = _T_1500 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_1500) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_1351 ? _a_set_T[16:0] : 17'h0)) & ~(_T_1366 ? _d_clr_T[16:0] : 17'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1351 ? _a_opcodes_set_T_1[67:0] : 68'h0)) & ~(_T_1366 ? _d_opcodes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1351 ? _a_sizes_set_T_1[135:0] : 136'h0)) & ~(_T_1366 ? _d_sizes_clr_T_5[135:0] : 136'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1427 | _T_1500)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26, OneHot.scala:57:35]
    end
    if (_T_1427 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_1500 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _source_ok_WIRE_2 = io_in_a_bits_source == 5'hD;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_3 = io_in_a_bits_source == 5'hE;	// @[Parameters.scala:46:9]
    wire             _WIRE_2_4 = io_in_a_bits_source == 5'h8;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_5 = io_in_a_bits_source == 5'h9;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_6 = io_in_a_bits_source == 5'hA;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_8 = io_in_a_bits_source == 5'h3;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_9 = io_in_a_bits_source == 5'h4;	// @[Parameters.scala:46:9]
    wire             source_ok = _source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_8 | _source_ok_WIRE_9;	// @[Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             _T_483 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Misc.scala:208:26, OneHot.scala:63:49, Parameters.scala:57:20]
    wire             mask_acc = _T_483 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_483 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire             _T_202 = io_in_a_bits_size == 4'h6;	// @[Parameters.scala:91:48]
    ...
    wire             _T_403 = io_in_a_bits_size == 4'h6;	// @[Parameters.scala:91:48]
    wire             _GEN_11 = io_in_a_valid & io_in_a_bits_opcode == 3'h4;	// @[Monitor.scala:104:{25,45}, Parameters.scala:46:9]
    wire             _T_543 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             _T_652 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    wire             _GEN_14 = io_in_a_valid & io_in_a_bits_opcode == 3'h1;	// @[Misc.scala:201:81, Monitor.scala:122:{25,56}]
    wire             _T_760 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             source_ok_1 = io_in_d_bits_source == 5'h10 | io_in_d_bits_source == 5'hC | io_in_d_bits_source == 5'hD | io_in_d_bits_source == 5'hE | io_in_d_bits_source == 5'h8 | io_in_d_bits_source == 5'h9 | io_in_d_bits_source == 5'hA | io_in_d_bits_source[4:2] == 3'h0 & io_in_d_bits_source[1:0] != 2'h3 | io_in_d_bits_source == 5'h3 | io_in_d_bits_source == 5'h4;	// @[Misc.scala:201:34, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             _T_1296 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_1320 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    ...
    wire             _T_1399 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    wire             _T_1370 = _T_1399 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    ...
    wire             _GEN_28 = _T_1370 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_29 = _T_1370 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire  [7:0]      _GEN_30 = {4'h0, io_in_d_bits_size};	// @[Bundles.scala:259:74, Monitor.scala:691:36]
    wire             _T_1456 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [16:0]     _T_1352 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [16:0]     _T_1371 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [16:0]     _T_1457 = 17'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_483) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_483) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_543 & (_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_8 | _source_ok_WIRE_9))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(_T_652 & (_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_8 | _source_ok_WIRE_9) & (_T_652 & io_in_a_bits_address[28:12] == 17'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 16'h0 | _GEN_8 == 16'h0 | io_in_a_bits_address[28:16] == 13'h200 | io_in_a_bits_address[28:12] == 17'h2010 | io_in_a_bits_address[28:26] == 3'h3 | io_in_a_bits_address[28:12] == 17'h10020)))) begin	// @[Bundles.scala:148:30, Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,45,65}, :670:56, :671:42, :672:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(_T_760 & (_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_8 | _source_ok_WIRE_9) & (_T_760 & io_in_a_bits_address[28:12] == 17'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 16'h0 | _GEN_8 == 16'h0 | io_in_a_bits_address[28:16] == 13'h200 | io_in_a_bits_address[28:12] == 17'h2010 | io_in_a_bits_address[28:26] == 3'h3 | io_in_a_bits_address[28:12] == 17'h10020)))) begin	// @[Bundles.scala:148:30, Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,45,65}, :670:56, :671:42, :672:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_8 | _source_ok_WIRE_9) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 16'h0 | io_in_a_bits_address[28:12] == 17'h3 | _GEN_8 == 16'h0 | io_in_a_bits_address[28:16] == 13'h200 | io_in_a_bits_address[28:12] == 17'h2010 | io_in_a_bits_address[28:26] == 3'h3 | io_in_a_bits_address[28:12] == 17'h10020))) begin	// @[Bundles.scala:148:30, Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,45,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_8 | _source_ok_WIRE_9) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 16'h0 | io_in_a_bits_address[28:12] == 17'h3 | _GEN_8 == 16'h0 | io_in_a_bits_address[28:16] == 13'h200 | io_in_a_bits_address[28:12] == 17'h2010 | io_in_a_bits_address[28:26] == 3'h3 | io_in_a_bits_address[28:12] == 17'h10020))) begin	// @[Bundles.scala:148:30, Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,45,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_17 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | ~(|(io_in_a_bits_source[4:2])) & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_8 | _source_ok_WIRE_9) & io_in_a_bits_address[28:12] == 17'h3)) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1399 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1399 & ~d_release_ack ? _d_clr_wo_ready_T[16:0] : 17'h0) | a_set_wo_ready == 17'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1456 & ~reset & ~(_T_1457[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1456 & ~reset & _GEN_30 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:24], _RANDOM_1[20:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        source_1 = _RANDOM_2[11:7];	// @[Monitor.scala:535:22, :538:22]
        sink = _RANDOM_2[12];	// @[Monitor.scala:535:22, :539:22]
        denied = _RANDOM_2[13];	// @[Monitor.scala:535:22, :540:22]
        inflight = _RANDOM_2[30:14];	// @[Monitor.scala:535:22, :611:27]
        inflight_opcodes = {_RANDOM_2[31], _RANDOM_3, _RANDOM_4, _RANDOM_5[2:0]};	// @[Monitor.scala:535:22, :613:35]
        inflight_sizes = {_RANDOM_5[31:3], _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9[10:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_9[19:11];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_9[28:20];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_9[31:29], _RANDOM_10[28:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_18[11:3];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
