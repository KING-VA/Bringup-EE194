...
module TLMonitor_28(
  ...
  wire         _T_923 = _T_1077 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_24 = _T_947 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_25 = _T_947 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire  [32:0]     _T_948 = inflight >> _GEN_23;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [32:0]     _T_1034 = 33'h0 >> _GEN_23;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~((_WIRE_2_1 & _T_172 | _WIRE_2_4 & _T_172 | ~(|(io_in_a_bits_source[5:2])) & io_in_a_bits_source[1:0] != 2'h3 & _T_172) & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:54, :83:78, Mux.scala:27:73, Parameters.scala:46:9, :52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~((_WIRE_2_1 & _T_294 | _WIRE_2_4 & _T_294 | ~(|(io_in_a_bits_source[5:2])) & io_in_a_bits_source[1:0] != 2'h3 & _T_294) & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, Mux.scala:27:73, Parameters.scala:46:9, :52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        a_first_counter_1 = _RANDOM_11[12:10];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_11[15:13];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_11[31:16], _RANDOM_12[15:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_21[30:28];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
