...
module TLAsyncCrossingSource(
  ...
  output        auto_out_a_mem_1_source,
  ...
  output        auto_out_a_mem_2_source,
  ...
  output        auto_out_a_mem_3_source,
  ...
  output        auto_out_a_mem_4_source,
  ...
  output        auto_out_a_mem_5_source,
  ...
  output        auto_out_a_mem_6_source,
  ...
  output        auto_out_a_mem_7_source,
  ...
  AsyncQueueSource_8 x1_a_source (	// @[AsyncQueue.scala:216:24]
    .clock                        (clock),
    .reset                        (reset),
  ...
  AsyncQueueSink_11 bundleIn_0_d_sink (	// @[AsyncQueue.scala:207:22]
    .clock                        (clock),
    .reset                        (reset),
