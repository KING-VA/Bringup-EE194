...
module IngressUnit_19(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_4 = io_in_bits_egress_id == 3'h1;	// @[IngressUnit.scala:30:72]
  ...
  wire [12:0] _c_T_2 = {_vcalloc_q_io_deq_bits_vc_sel_3_0, _vcalloc_q_io_deq_bits_vc_sel_2_0, _vcalloc_q_io_deq_bits_vc_sel_1_0, _vcalloc_q_io_deq_bits_vc_sel_0_9, _vcalloc_q_io_deq_bits_vc_sel_0_8, _vcalloc_q_io_deq_bits_vc_sel_0_7, _vcalloc_q_io_deq_bits_vc_sel_0_6, _vcalloc_q_io_deq_bits_vc_sel_0_5, _vcalloc_q_io_deq_bits_vc_sel_0_4, _vcalloc_q_io_deq_bits_vc_sel_0_3, _vcalloc_q_io_deq_bits_vc_sel_0_2, _vcalloc_q_io_deq_bits_vc_sel_0_1, _vcalloc_q_io_deq_bits_vc_sel_0_0} & {io_out_credit_available_3_0, io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, io_out_credit_available_0_7, 1'h1, io_out_credit_available_0_5, io_out_credit_available_0_4, io_out_credit_available_0_3, 1'h1, io_out_credit_available_0_1, io_out_credit_available_0_0};	// @[IngressUnit.scala:76:25, :107:{41,48,74}]
  ...
  wire [2:0]  _GEN = {_vcalloc_q_io_deq_bits_vc_sel_0_7, _vcalloc_q_io_deq_bits_vc_sel_0_6, _vcalloc_q_io_deq_bits_vc_sel_0_5} | {_vcalloc_q_io_deq_bits_vc_sel_0_3, _vcalloc_q_io_deq_bits_vc_sel_0_2, _vcalloc_q_io_deq_bits_vc_sel_0_9 | _vcalloc_q_io_deq_bits_vc_sel_0_1};	// @[IngressUnit.scala:76:25, OneHot.scala:30:18, :31:18, :32:28]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T_4 | _route_buffer_io_enq_bits_flow_egress_node_id_T_5 | _route_buffer_io_enq_bits_flow_egress_node_id_T_6 | (&io_in_bits_egress_id))) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (4'h6),
    .io_enq_bits_flow_ingress_node_id (3'h1),
    .io_enq_bits_flow_egress_node     ({2'h0, {2{_route_buffer_io_enq_bits_flow_egress_node_id_T_4}} | {&io_in_bits_egress_id, _route_buffer_io_enq_bits_flow_egress_node_id_T_6}}),	// @[IngressUnit.scala:30:72, :41:50, Mux.scala:27:73]
    .io_enq_bits_flow_egress_node_id  ({2'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_4 | _route_buffer_io_enq_bits_flow_egress_node_id_T_5 | _route_buffer_io_enq_bits_flow_egress_node_id_T_6 | (&io_in_bits_egress_id)}),	// @[IngressUnit.scala:30:72, :45:50, Mux.scala:27:73]
  ...
  Queue_118 route_q (	// @[IngressUnit.scala:27:23]
    .clock                  (clock),
    .reset                  (reset),
  ...
  Queue_120 vcalloc_q (	// @[IngressUnit.scala:76:25]
    .clock                  (clock),
    .reset                  (reset),
