...
module ClockGroupParameterModifier_1(
  input  auto_frequency_specifier_in_member_allClocks_implicit_clock_clock,
         ...
         auto_frequency_specifier_in_member_allClocks_tileClockGroup_boom_tile_2_clock,
         auto_frequency_specifier_in_member_allClocks_tileClockGroup_boom_tile_2_reset,
         auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_1_clock,
         auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_1_reset,
         auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_0_clock,
         auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_0_reset,
  ...
  output auto_frequency_specifier_out_member_allClocks_implicit_clock_clock,
         ...
         auto_frequency_specifier_out_member_allClocks_tileClockGroup_boom_tile_2_clock,
         auto_frequency_specifier_out_member_allClocks_tileClockGroup_boom_tile_2_reset,
         auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_1_clock,
         auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_1_reset,
         auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_0_clock,
         auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_0_reset,
  ...
  assign auto_frequency_specifier_out_member_allClocks_tileClockGroup_boom_tile_2_clock = auto_frequency_specifier_in_member_allClocks_tileClockGroup_boom_tile_2_clock;
  assign auto_frequency_specifier_out_member_allClocks_tileClockGroup_boom_tile_2_reset = auto_frequency_specifier_in_member_allClocks_tileClockGroup_boom_tile_2_reset;
  assign auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_1_clock = auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_1_clock;
  assign auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_1_reset = auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_1_reset;
  assign auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_0_clock = auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_0_clock;
  assign auto_frequency_specifier_out_member_allClocks_tileClockGroup_tile_0_reset = auto_frequency_specifier_in_member_allClocks_tileClockGroup_tile_0_reset;
