...
module TLBuffer_14(
  ...
  input  [4:0]  auto_out_0_b_bits_source,
  input  [34:0] auto_out_0_b_bits_address,
  ...
  wire       _bundleIn_3_d_q_io_deq_valid;	// @[Decoupled.scala:375:21]
  wire [2:0] _bundleIn_3_d_q_io_deq_bits_opcode;	// @[Decoupled.scala:375:21]
  wire [1:0] _bundleIn_3_d_q_io_deq_bits_param;	// @[Decoupled.scala:375:21]
  wire [2:0] _bundleIn_3_d_q_io_deq_bits_size;	// @[Decoupled.scala:375:21]
  wire [4:0] _bundleIn_3_d_q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  wire [2:0] _bundleIn_3_d_q_io_deq_bits_sink;	// @[Decoupled.scala:375:21]
  wire       _bundleIn_3_d_q_io_deq_bits_denied;	// @[Decoupled.scala:375:21]
  wire       _bundleIn_3_d_q_io_deq_bits_corrupt;	// @[Decoupled.scala:375:21]
  wire       _bundleOut_3_a_q_io_enq_ready;	// @[Decoupled.scala:375:21]
  ...
  wire [2:0] _bundleIn_2_d_q_io_deq_bits_size;	// @[Decoupled.scala:375:21]
  wire [4:0] _bundleIn_2_d_q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  wire [2:0] _bundleIn_2_d_q_io_deq_bits_sink;	// @[Decoupled.scala:375:21]
  ...
  wire [2:0] _bundleIn_1_d_q_io_deq_bits_size;	// @[Decoupled.scala:375:21]
  ...
  TLMonitor_56 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  TLMonitor_57 monitor_2 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  TLMonitor_58 monitor_3 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (_bundleOut_3_a_q_io_enq_ready),	// @[Decoupled.scala:375:21]
    ...
    .io_in_d_valid        (_bundleIn_3_d_q_io_deq_valid),	// @[Decoupled.scala:375:21]
    .io_in_d_bits_opcode  (_bundleIn_3_d_q_io_deq_bits_opcode),	// @[Decoupled.scala:375:21]
    .io_in_d_bits_param   (_bundleIn_3_d_q_io_deq_bits_param),	// @[Decoupled.scala:375:21]
    .io_in_d_bits_size    (_bundleIn_3_d_q_io_deq_bits_size),	// @[Decoupled.scala:375:21]
    .io_in_d_bits_source  (_bundleIn_3_d_q_io_deq_bits_source),	// @[Decoupled.scala:375:21]
    .io_in_d_bits_sink    (_bundleIn_3_d_q_io_deq_bits_sink),	// @[Decoupled.scala:375:21]
    .io_in_d_bits_denied  (_bundleIn_3_d_q_io_deq_bits_denied),	// @[Decoupled.scala:375:21]
    .io_in_d_bits_corrupt (_bundleIn_3_d_q_io_deq_bits_corrupt),	// @[Decoupled.scala:375:21]
    .io_in_e_valid        (auto_in_3_e_valid),
    .io_in_e_bits_sink    (auto_in_3_e_bits_sink)
  );
  Queue_273 x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_274 bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_273 bundleOut_1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_274 bundleIn_1_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_273 bundleOut_2_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_274 bundleIn_2_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_273 bundleOut_3_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_ready        (_bundleOut_3_a_q_io_enq_ready),
  ...
  Queue_274 bundleIn_3_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_deq_valid        (_bundleIn_3_d_q_io_deq_valid),
    .io_deq_bits_opcode  (_bundleIn_3_d_q_io_deq_bits_opcode),
    .io_deq_bits_param   (_bundleIn_3_d_q_io_deq_bits_param),
    .io_deq_bits_size    (_bundleIn_3_d_q_io_deq_bits_size),
    .io_deq_bits_source  (_bundleIn_3_d_q_io_deq_bits_source),
    .io_deq_bits_sink    (_bundleIn_3_d_q_io_deq_bits_sink),
    .io_deq_bits_denied  (_bundleIn_3_d_q_io_deq_bits_denied),
    .io_deq_bits_data    (auto_in_3_d_bits_data),
    .io_deq_bits_corrupt (_bundleIn_3_d_q_io_deq_bits_corrupt)
  );
  assign auto_in_3_a_ready = _bundleOut_3_a_q_io_enq_ready;	// @[Decoupled.scala:375:21]
  ...
  assign auto_in_3_d_valid = _bundleIn_3_d_q_io_deq_valid;	// @[Decoupled.scala:375:21]
  assign auto_in_3_d_bits_opcode = _bundleIn_3_d_q_io_deq_bits_opcode;	// @[Decoupled.scala:375:21]
  assign auto_in_3_d_bits_param = _bundleIn_3_d_q_io_deq_bits_param;	// @[Decoupled.scala:375:21]
  assign auto_in_3_d_bits_size = _bundleIn_3_d_q_io_deq_bits_size;	// @[Decoupled.scala:375:21]
  assign auto_in_3_d_bits_source = _bundleIn_3_d_q_io_deq_bits_source;	// @[Decoupled.scala:375:21]
  assign auto_in_3_d_bits_sink = _bundleIn_3_d_q_io_deq_bits_sink;	// @[Decoupled.scala:375:21]
  assign auto_in_3_d_bits_denied = _bundleIn_3_d_q_io_deq_bits_denied;	// @[Decoupled.scala:375:21]
  assign auto_in_3_d_bits_corrupt = _bundleIn_3_d_q_io_deq_bits_corrupt;	// @[Decoupled.scala:375:21]
