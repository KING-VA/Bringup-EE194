...
module ICache(
  ...
  wire [23:0]  _tag_array_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  wire         writeEnable_1 = refill_one_beat & (counter == 9'h1 | beats1 == 9'h0) & auto_master_out_d_valid;	// @[Edges.scala:220:14, :228:27, :231:{25,37,47}, ICache.scala:383:41, :391:37]
  ...
  assign s1_tag_hit_0 = _s1_vb_T_1[0] & _tag_array_0_RW0_rdata[22:0] == io_s1_paddr[34:12];	// @[DescribedSRAM.scala:17:26, ICache.scala:485:30, :500:25, :506:{26,33}, package.scala:155:13]
  ...
  always @(posedge clock) begin
    ...
    if (s1_valid) begin	// @[ICache.scala:333:25]
      ...
      s2_tl_error <= s1_hit & _tag_array_0_RW0_rdata[23];	// @[DescribedSRAM.scala:17:26, ICache.scala:353:40, :510:32, Reg.scala:19:16, package.scala:155:13]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        refill_paddr = {_RANDOM_1[31:19], _RANDOM_2[21:0]};	// @[ICache.scala:355:25, Reg.scala:19:16]
        counter = {_RANDOM_3[31:29], _RANDOM_4[5:0]};	// @[Edges.scala:228:27]
        accruedRefillError = _RANDOM_4[6];	// @[Edges.scala:228:27, ICache.scala:420:31]
        vb_array = {_RANDOM_4[31:7], _RANDOM_5, _RANDOM_6[6:0]};	// @[Edges.scala:228:27, ICache.scala:440:25]
        s2_dout_0 = {_RANDOM_7[31:20], _RANDOM_8[19:0]};	// @[Reg.scala:19:16]
        s2_tag_disparity_r_0 = _RANDOM_8[20];	// @[Reg.scala:19:16]
        s2_tl_error = _RANDOM_8[21];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  tag_array_0 tag_array_0 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata ({refillError, refill_paddr[34:12]}),	// @[Cat.scala:33:92, ICache.scala:380:33, :422:43, Reg.scala:19:16]
    .RW0_rdata (_tag_array_0_RW0_rdata)
  );
  data_arrays_0_0 data_arrays_0_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (refill_one_beat ? _mem_idx_T_6 | refill_cnt : io_req_bits_addr[11:3]),	// @[Edges.scala:233:25, ICache.scala:383:41, :557:31, :566:{10,40,67}]
  ...
  assign auto_master_out_a_bits_address = {refill_paddr[34:6], 6'h0};	// @[ICache.scala:434:40, :760:64, Reg.scala:19:16]
