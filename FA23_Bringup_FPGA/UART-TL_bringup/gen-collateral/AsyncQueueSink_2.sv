...
module AsyncQueueSink_2(
  ...
  input  [1:0]  io_async_mem_0_source,
  input  [34:0] io_async_mem_0_address,
  ...
  input  [1:0]  io_async_mem_1_source,
  input  [34:0] io_async_mem_1_address,
  ...
  input  [1:0]  io_async_mem_2_source,
  input  [34:0] io_async_mem_2_address,
  ...
  input  [1:0]  io_async_mem_3_source,
  input  [34:0] io_async_mem_3_address,
  ...
  input  [1:0]  io_async_mem_4_source,
  input  [34:0] io_async_mem_4_address,
  ...
  input  [1:0]  io_async_mem_5_source,
  input  [34:0] io_async_mem_5_address,
  ...
  input  [1:0]  io_async_mem_6_source,
  input  [34:0] io_async_mem_6_address,
  ...
  input  [1:0]  io_async_mem_7_source,
  input  [34:0] io_async_mem_7_address,
  ...
  output [34:0] io_deq_bits_address,
  ...
  wire [111:0]     _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  wire [7:0][2:0]  _GEN_0 = {{io_async_mem_7_param}, {io_async_mem_6_param}, {io_async_mem_5_param}, {io_async_mem_4_param}, {io_async_mem_3_param}, {io_async_mem_2_param}, {io_async_mem_1_param}, {io_async_mem_0_param}};	// @[SynchronizerReg.scala:209:24]
  ...
  wire [7:0][1:0]  _GEN_2 = {{io_async_mem_7_source}, {io_async_mem_6_source}, {io_async_mem_5_source}, {io_async_mem_4_source}, {io_async_mem_3_source}, {io_async_mem_2_source}, {io_async_mem_1_source}, {io_async_mem_0_source}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0][34:0] _GEN_3 = {{io_async_mem_7_address}, {io_async_mem_6_address}, {io_async_mem_5_address}, {io_async_mem_4_address}, {io_async_mem_3_address}, {io_async_mem_2_address}, {io_async_mem_1_address}, {io_async_mem_0_address}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0][63:0] _GEN_4 = {{io_async_mem_7_data}, {io_async_mem_6_data}, {io_async_mem_5_data}, {io_async_mem_4_data}, {io_async_mem_3_data}, {io_async_mem_2_data}, {io_async_mem_1_data}, {io_async_mem_0_data}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0]       _GEN_5 = {{io_async_mem_7_corrupt}, {io_async_mem_6_corrupt}, {io_async_mem_5_corrupt}, {io_async_mem_4_corrupt}, {io_async_mem_3_corrupt}, {io_async_mem_2_corrupt}, {io_async_mem_1_corrupt}, {io_async_mem_0_corrupt}};	// @[SynchronizerReg.scala:209:24]
  ...
  ClockCrossingReg_w112 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({_GEN[index], _GEN_0[index], _GEN_1[index], _GEN_2[index], _GEN_3[index], _GEN_4[index], _GEN_5[index]}),	// @[AsyncQueue.scala:152:55, SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_opcode = _io_deq_bits_deq_bits_reg_io_q[111:109];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_param = _io_deq_bits_deq_bits_reg_io_q[108:106];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_size = _io_deq_bits_deq_bits_reg_io_q[105:102];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_source = _io_deq_bits_deq_bits_reg_io_q[101:100];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_address = _io_deq_bits_deq_bits_reg_io_q[99:65];	// @[SynchronizerReg.scala:207:25, :211:26]
