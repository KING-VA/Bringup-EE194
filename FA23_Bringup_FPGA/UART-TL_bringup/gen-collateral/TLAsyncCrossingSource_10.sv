...
module TLAsyncCrossingSource_10(
  input         clock,
                reset,
                auto_in_a_valid,
  ...
  TLMonitor_86 monitor (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  AsyncQueueSource_28 x1_a_source (	// @[AsyncQueue.scala:216:24]
    .clock                        (clock),
    .reset                        (reset),
  ...
  AsyncQueueSink_28 bundleIn_0_d_sink (	// @[AsyncQueue.scala:207:22]
    .clock                        (clock),
    .reset                        (reset),
