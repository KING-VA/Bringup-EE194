  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_source = _RANDOM_0[10:9];	// @[AsyncQueue.scala:80:16]
        mem_0_sink = _RANDOM_0[15:11];	// @[AsyncQueue.scala:80:16]
        mem_0_denied = _RANDOM_0[16];	// @[AsyncQueue.scala:80:16]
        mem_0_data = {_RANDOM_0[31:17], _RANDOM_1, _RANDOM_2[16:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_corrupt = _RANDOM_2[17];	// @[AsyncQueue.scala:80:16]
        mem_1_opcode = _RANDOM_2[20:18];	// @[AsyncQueue.scala:80:16]
        mem_1_param = _RANDOM_2[22:21];	// @[AsyncQueue.scala:80:16]
        mem_1_size = _RANDOM_2[26:23];	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_2[28:27];	// @[AsyncQueue.scala:80:16]
        mem_1_sink = {_RANDOM_2[31:29], _RANDOM_3[1:0]};	// @[AsyncQueue.scala:80:16]
        mem_1_denied = _RANDOM_3[2];	// @[AsyncQueue.scala:80:16]
        mem_1_data = {_RANDOM_3[31:3], _RANDOM_4, _RANDOM_5[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_1_corrupt = _RANDOM_5[3];	// @[AsyncQueue.scala:80:16]
        mem_2_opcode = _RANDOM_5[6:4];	// @[AsyncQueue.scala:80:16]
        mem_2_param = _RANDOM_5[8:7];	// @[AsyncQueue.scala:80:16]
        mem_2_size = _RANDOM_5[12:9];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_5[14:13];	// @[AsyncQueue.scala:80:16]
        mem_2_sink = _RANDOM_5[19:15];	// @[AsyncQueue.scala:80:16]
        mem_2_denied = _RANDOM_5[20];	// @[AsyncQueue.scala:80:16]
        mem_2_data = {_RANDOM_5[31:21], _RANDOM_6, _RANDOM_7[20:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_corrupt = _RANDOM_7[21];	// @[AsyncQueue.scala:80:16]
        mem_3_opcode = _RANDOM_7[24:22];	// @[AsyncQueue.scala:80:16]
        mem_3_param = _RANDOM_7[26:25];	// @[AsyncQueue.scala:80:16]
        mem_3_size = _RANDOM_7[30:27];	// @[AsyncQueue.scala:80:16]
        mem_3_source = {_RANDOM_7[31], _RANDOM_8[0]};	// @[AsyncQueue.scala:80:16]
        mem_3_sink = _RANDOM_8[5:1];	// @[AsyncQueue.scala:80:16]
        mem_3_denied = _RANDOM_8[6];	// @[AsyncQueue.scala:80:16]
        mem_3_data = {_RANDOM_8[31:7], _RANDOM_9, _RANDOM_10[6:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_corrupt = _RANDOM_10[7];	// @[AsyncQueue.scala:80:16]
        mem_4_opcode = _RANDOM_10[10:8];	// @[AsyncQueue.scala:80:16]
        mem_4_param = _RANDOM_10[12:11];	// @[AsyncQueue.scala:80:16]
        mem_4_size = _RANDOM_10[16:13];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_10[18:17];	// @[AsyncQueue.scala:80:16]
        mem_4_sink = _RANDOM_10[23:19];	// @[AsyncQueue.scala:80:16]
        mem_4_denied = _RANDOM_10[24];	// @[AsyncQueue.scala:80:16]
        mem_4_data = {_RANDOM_10[31:25], _RANDOM_11, _RANDOM_12[24:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_corrupt = _RANDOM_12[25];	// @[AsyncQueue.scala:80:16]
        mem_5_opcode = _RANDOM_12[28:26];	// @[AsyncQueue.scala:80:16]
        mem_5_param = _RANDOM_12[30:29];	// @[AsyncQueue.scala:80:16]
        mem_5_size = {_RANDOM_12[31], _RANDOM_13[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_source = _RANDOM_13[4:3];	// @[AsyncQueue.scala:80:16]
        mem_5_sink = _RANDOM_13[9:5];	// @[AsyncQueue.scala:80:16]
        mem_5_denied = _RANDOM_13[10];	// @[AsyncQueue.scala:80:16]
        mem_5_data = {_RANDOM_13[31:11], _RANDOM_14, _RANDOM_15[10:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_corrupt = _RANDOM_15[11];	// @[AsyncQueue.scala:80:16]
        mem_6_opcode = _RANDOM_15[14:12];	// @[AsyncQueue.scala:80:16]
        mem_6_param = _RANDOM_15[16:15];	// @[AsyncQueue.scala:80:16]
        mem_6_size = _RANDOM_15[20:17];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_15[22:21];	// @[AsyncQueue.scala:80:16]
        mem_6_sink = _RANDOM_15[27:23];	// @[AsyncQueue.scala:80:16]
        mem_6_denied = _RANDOM_15[28];	// @[AsyncQueue.scala:80:16]
        mem_6_data = {_RANDOM_15[31:29], _RANDOM_16, _RANDOM_17[28:0]};	// @[AsyncQueue.scala:80:16]
        mem_6_corrupt = _RANDOM_17[29];	// @[AsyncQueue.scala:80:16]
        mem_7_opcode = {_RANDOM_17[31:30], _RANDOM_18[0]};	// @[AsyncQueue.scala:80:16]
        mem_7_param = _RANDOM_18[2:1];	// @[AsyncQueue.scala:80:16]
        mem_7_size = _RANDOM_18[6:3];	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_18[8:7];	// @[AsyncQueue.scala:80:16]
        mem_7_sink = _RANDOM_18[13:9];	// @[AsyncQueue.scala:80:16]
        mem_7_denied = _RANDOM_18[14];	// @[AsyncQueue.scala:80:16]
        mem_7_data = {_RANDOM_18[31:15], _RANDOM_19, _RANDOM_20[14:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_corrupt = _RANDOM_20[15];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_20[19:16];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_20[20];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_20[24:21];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
