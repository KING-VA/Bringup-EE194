...
module TLSlaveToNoC_3(
  ...
  input  [34:0] io_tilelink_b_bits_address,
  ...
  wire [4:0]  _e_io_protocol_bits_sink;	// @[Tilelink.scala:268:17]
  ...
  TLDToNoC_1 d (	// @[Tilelink.scala:267:17]
    ...
    .io_protocol_bits_sink    (io_tilelink_d_bits_sink | 5'h8),	// @[Tilelink.scala:273:54]
  ...
  TLEFromNoC_1 e (	// @[Tilelink.scala:268:17]
    ...
    .io_flit_bits_payload  (io_flits_e_bits_payload[4:0]),	// @[Tilelink.scala:281:14]
    .io_protocol_valid     (io_tilelink_e_valid),
    .io_protocol_bits_sink (_e_io_protocol_bits_sink)
  );
  assign io_tilelink_e_bits_sink = {2'h0, _e_io_protocol_bits_sink[2:0]};	// @[Tilelink.scala:262:67, :268:17, :275:27]
