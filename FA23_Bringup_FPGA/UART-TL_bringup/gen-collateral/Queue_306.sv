...
module Queue_306(
  ...
  wire [387:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_rob_idx = _ram_ext_R0_data[215:211];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_pdst = _ram_ext_R0_data[229:224];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_is_amo = _ram_ext_R0_data[338];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_uses_stq = _ram_ext_R0_data[340];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_ldst = _ram_ext_R0_data[350:345];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_dst_rtype = _ram_ext_R0_data[371:370];	// @[Decoupled.scala:273:95]
endmodule
