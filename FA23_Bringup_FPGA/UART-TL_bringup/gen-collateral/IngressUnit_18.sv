...
module IngressUnit_18(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_1 = io_in_bits_egress_id == 3'h4;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 3'h6;	// @[IngressUnit.scala:30:72]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(io_in_bits_egress_id == 3'h2 | _route_buffer_io_enq_bits_flow_egress_node_id_T_1 | _route_buffer_io_enq_bits_flow_egress_node_id_T_2)) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_egress_node     ({2'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_2, _route_buffer_io_enq_bits_flow_egress_node_id_T_1}),	// @[IngressUnit.scala:30:72, :41:50, Mux.scala:27:73]
    .io_enq_bits_flow_egress_node_id  (3'h0),
