...
module TageTable(
  ...
  wire [6:0]  update_wdata_3_tag = io_update_pc[17:11] ^ io_update_hist[6:0] ^ io_update_hist[13:7] ^ {5'h0, io_update_hist[15:14]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :62:{30,50}]
  ...
  always @(posedge clock) begin
    ...
    s2_tag <= io_f1_req_pc[17:11] ^ io_f1_req_ghist[6:0] ^ io_f1_req_ghist[13:7] ^ {5'h0, io_f1_req_ghist[15:14]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :62:{30,50}, :95:29]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tag = _RANDOM_0[15:9];	// @[tage.scala:72:28, :95:29]
        io_f3_resp_0_valid_REG = _RANDOM_0[16];	// @[tage.scala:72:28, :104:38]
        io_f3_resp_0_bits_u_REG = _RANDOM_0[18:17];	// @[tage.scala:72:28, :105:38]
        io_f3_resp_0_bits_ctr_REG = _RANDOM_0[21:19];	// @[tage.scala:72:28, :106:38]
        io_f3_resp_1_valid_REG = _RANDOM_0[22];	// @[tage.scala:72:28, :104:38]
        io_f3_resp_1_bits_u_REG = _RANDOM_0[24:23];	// @[tage.scala:72:28, :105:38]
        io_f3_resp_1_bits_ctr_REG = _RANDOM_0[27:25];	// @[tage.scala:72:28, :106:38]
        io_f3_resp_2_valid_REG = _RANDOM_0[28];	// @[tage.scala:72:28, :104:38]
        io_f3_resp_2_bits_u_REG = _RANDOM_0[30:29];	// @[tage.scala:72:28, :105:38]
        io_f3_resp_2_bits_ctr_REG = {_RANDOM_0[31], _RANDOM_1[1:0]};	// @[tage.scala:72:28, :106:38]
        io_f3_resp_3_valid_REG = _RANDOM_1[2];	// @[tage.scala:104:38, :106:38]
        io_f3_resp_3_bits_u_REG = _RANDOM_1[4:3];	// @[tage.scala:105:38, :106:38]
        io_f3_resp_3_bits_ctr_REG = _RANDOM_1[7:5];	// @[tage.scala:106:38]
        clear_u_ctr = _RANDOM_1[27:8];	// @[tage.scala:106:38, :109:28]
        wrbypass_tags_0 = {_RANDOM_1[31:28], _RANDOM_2[2:0]};	// @[tage.scala:106:38, :141:29]
        wrbypass_tags_1 = _RANDOM_2[9:3];	// @[tage.scala:141:29]
        wrbypass_idxs_0 = _RANDOM_2[17:10];	// @[tage.scala:141:29, :142:29]
        wrbypass_idxs_1 = _RANDOM_2[25:18];	// @[tage.scala:141:29, :142:29]
        wrbypass_0_0 = _RANDOM_2[28:26];	// @[tage.scala:141:29, :143:29]
        wrbypass_0_1 = _RANDOM_2[31:29];	// @[tage.scala:141:29, :143:29]
        wrbypass_0_2 = _RANDOM_3[2:0];	// @[tage.scala:143:29]
        wrbypass_0_3 = _RANDOM_3[5:3];	// @[tage.scala:143:29]
        wrbypass_1_0 = _RANDOM_3[8:6];	// @[tage.scala:143:29]
        wrbypass_1_1 = _RANDOM_3[11:9];	// @[tage.scala:143:29]
        wrbypass_1_2 = _RANDOM_3[14:12];	// @[tage.scala:143:29]
        wrbypass_1_3 = _RANDOM_3[17:15];	// @[tage.scala:143:29]
        wrbypass_enq_idx = _RANDOM_3[18];	// @[tage.scala:143:29, :144:33]
      `endif // RANDOMIZE_REG_INIT
    end // initial
