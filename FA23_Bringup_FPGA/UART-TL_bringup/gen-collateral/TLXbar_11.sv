...
module TLXbar_11(
  ...
  output [17:0] auto_out_0_a_bits_address,
  output [7:0]  auto_out_0_a_bits_mask,
  output        auto_out_0_a_bits_corrupt,
                auto_out_0_d_ready
);

  wire        requestAIO_0_0 = auto_in_a_bits_address[34:31] == 4'h0;	// @[Bundles.scala:259:74, Parameters.scala:137:{45,65}]
  wire        requestAIO_0_1 = auto_in_a_bits_address[34:31] == 4'h1 | auto_in_a_bits_address[34:32] == 3'h1 | auto_in_a_bits_address[34:33] == 2'h1 | auto_in_a_bits_address[34:31] == 4'h8;	// @[Parameters.scala:137:{31,45,65}, Xbar.scala:365:92]
  wire        _portsAOI_in_0_a_ready_WIRE = requestAIO_0_0 & auto_out_0_a_ready | requestAIO_0_1 & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65, Xbar.scala:365:92]
  ...
  wire        out_9_bits_corrupt = muxStateEarly_1 & auto_out_1_d_bits_corrupt;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  wire        out_9_bits_denied = muxStateEarly_1 & auto_out_1_d_bits_denied;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
  ...
  wire [2:0]  out_9_bits_opcode = {2'h0, muxStateEarly_0} | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0);	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:89:24]
        beatsLeft <= (winnerQual_0 ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0);	// @[Arbiter.scala:87:30, :98:79, :111:73, :112:44, Bundles.scala:259:74, Edges.scala:105:36, :220:14, package.scala:235:{46,71,76}]
  ...
  TLMonitor_91 monitor (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_out_0_a_bits_address = auto_in_a_bits_address[17:0];	// @[BundleMap.scala:247:19]
