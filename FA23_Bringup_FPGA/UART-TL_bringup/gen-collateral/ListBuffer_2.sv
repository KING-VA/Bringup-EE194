...
module ListBuffer_2(
  ...
  input  [19:0] io_push_bits_data_tag,
  ...
  output [19:0] io_data_tag,
  output [5:0]  io_data_offset,
                io_data_put
);

  wire [49:0] _data_ext_R0_data;	// @[ListBuffer.scala:50:18]
  ...
  assign io_data_source = _data_ext_R0_data[17:13];	// @[ListBuffer.scala:50:18]
  assign io_data_tag = _data_ext_R0_data[37:18];	// @[ListBuffer.scala:50:18]
  assign io_data_offset = _data_ext_R0_data[43:38];	// @[ListBuffer.scala:50:18]
  assign io_data_put = _data_ext_R0_data[49:44];	// @[ListBuffer.scala:50:18]
endmodule
