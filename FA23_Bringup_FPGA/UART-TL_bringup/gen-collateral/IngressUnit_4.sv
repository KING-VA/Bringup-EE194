...
module IngressUnit_4(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_5 = io_in_bits_egress_id == 5'hF;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_6 = io_in_bits_egress_id == 5'h12;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_7 = io_in_bits_egress_id == 5'h15;	// @[IngressUnit.scala:30:72]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = {_route_buffer_io_enq_bits_flow_egress_node_id_T_4, 2'h0} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_5 ? 3'h5 : 3'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_6 ? 3'h6 : 3'h0) | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_7}};	// @[IngressUnit.scala:30:72, :45:50, Mux.scala:27:73]
  wire        at_dest = _route_buffer_io_enq_bits_flow_egress_node_WIRE == 3'h1;	// @[IngressUnit.scala:55:59, Mux.scala:27:73]
  wire        _T_15 = _route_buffer_io_enq_ready & io_in_valid & io_in_bits_head & at_dest;	// @[IngressUnit.scala:26:28, :55:59, :64:41]
  wire        _GEN = _T_15 | io_in_valid & _route_buffer_io_enq_ready & io_in_bits_head & ~at_dest;	// @[IngressUnit.scala:26:28, :55:59, :58:{86,89}, :62:24, :64:{41,53}, :65:26]
  ...
  wire [11:0] _c_T_2 = {_vcalloc_q_io_deq_bits_vc_sel_2_0, _vcalloc_q_io_deq_bits_vc_sel_1_0, _vcalloc_q_io_deq_bits_vc_sel_0_9, _vcalloc_q_io_deq_bits_vc_sel_0_8, _vcalloc_q_io_deq_bits_vc_sel_0_7, _vcalloc_q_io_deq_bits_vc_sel_0_6, _vcalloc_q_io_deq_bits_vc_sel_0_5, _vcalloc_q_io_deq_bits_vc_sel_0_4, _vcalloc_q_io_deq_bits_vc_sel_0_3, _vcalloc_q_io_deq_bits_vc_sel_0_2, _vcalloc_q_io_deq_bits_vc_sel_0_1, _vcalloc_q_io_deq_bits_vc_sel_0_0} & {io_out_credit_available_2_0, io_out_credit_available_1_0, io_out_credit_available_0_9, io_out_credit_available_0_8, 1'h1, io_out_credit_available_0_6, io_out_credit_available_0_5, io_out_credit_available_0_4, 1'h1, io_out_credit_available_0_2, io_out_credit_available_0_1, io_out_credit_available_0_0};	// @[IngressUnit.scala:76:25, :107:{41,48,74}]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T_4 | _route_buffer_io_enq_bits_flow_egress_node_id_T_5 | _route_buffer_io_enq_bits_flow_egress_node_id_T_6 | _route_buffer_io_enq_bits_flow_egress_node_id_T_7)) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node    (4'h1),
    .io_enq_bits_flow_ingress_node_id (3'h1),
    ...
    .io_enq_bits_flow_egress_node_id  ({2'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T_4 | _route_buffer_io_enq_bits_flow_egress_node_id_T_5 | _route_buffer_io_enq_bits_flow_egress_node_id_T_6 | _route_buffer_io_enq_bits_flow_egress_node_id_T_7}),	// @[IngressUnit.scala:30:72, :45:50, Mux.scala:27:73]
  ...
  Queue_11 route_q (	// @[IngressUnit.scala:27:23]
    .clock                  (clock),
    .reset                  (reset),
    .io_enq_valid           (_GEN),	// @[IngressUnit.scala:62:24, :64:53, :65:26]
    .io_enq_bits_vc_sel_2_0 (_T_15 & io_in_bits_egress_id == 5'h5),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_1_0 (_T_15 & io_in_bits_egress_id == 5'h4),	// @[IngressUnit.scala:63:23, :64:{41,53}, :68:{40,66}]
    .io_enq_bits_vc_sel_0_1 (1'h0),
    .io_enq_bits_vc_sel_0_5 (~_T_15),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
  ...
  Queue_13 vcalloc_q (	// @[IngressUnit.scala:76:25]
    .clock                  (clock),
    .reset                  (reset),
