...
module InputBuffer_4(
  ...
  wire             _tails_T_29 = mem_MPORT_addr == ({1'h0, {1'h0, {1'h0, {2{_tails_T_30}}} | {3{_tails_T_31}}} | (_tails_T_33 ? 4'hB : 4'h0) | {4{_tails_T_34}}} | (_tails_T_35 ? 5'h13 : 5'h0) | (_tails_T_38 ? 5'h17 : 5'h0) | (_tails_T_39 ? 5'h1B : 5'h0));	// @[InputUnit.scala:86:32, :103:45, :104:14, Mux.scala:27:73, :29:36]
  wire [4:0]       _tails_WIRE_2 = {_tails_T_35, {_tails_T_33, _tails_T_31, 2'h0} | (_tails_T_34 ? 4'hC : 4'h0)} | (_tails_T_38 ? 5'h14 : 5'h0) | (_tails_T_39 ? 5'h18 : 5'h0);	// @[InputUnit.scala:86:32, :103:45, Mux.scala:27:73, :29:36]
  ...
  wire             _heads_T_19 = head == ({1'h0, {1'h0, {1'h0, {2{to_q_oh_enc[0]}}} | {3{to_q_oh_enc[1]}}} | (to_q_oh_enc[3] ? 4'hB : 4'h0) | {4{to_q_oh_enc[4]}}} | (to_q_oh_enc[5] ? 5'h13 : 5'h0) | (to_q_oh_enc[8] ? 5'h17 : 5'h0) | (to_q_oh_enc[9] ? 5'h1B : 5'h0));	// @[InputUnit.scala:86:32, :103:45, :123:16, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  wire [4:0]       _heads_WIRE_2 = {to_q_oh_enc[5], {to_q_oh_enc[3], to_q_oh_enc[1], 2'h0} | (to_q_oh_enc[4] ? 4'hC : 4'h0)} | (to_q_oh_enc[8] ? 5'h14 : 5'h0) | (to_q_oh_enc[9] ? 5'h18 : 5'h0);	// @[InputUnit.scala:86:32, :103:45, Mux.scala:27:73, :47:70, OneHot.scala:82:30]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      heads_8 <= 5'h14;	// @[InputUnit.scala:86:{24,32}]
      heads_9 <= 5'h18;	// @[InputUnit.scala:86:{24,32}]
      ...
      tails_8 <= 5'h14;	// @[InputUnit.scala:86:32, :87:24]
      tails_9 <= 5'h18;	// @[InputUnit.scala:86:32, :87:24]
    end
    else begin
