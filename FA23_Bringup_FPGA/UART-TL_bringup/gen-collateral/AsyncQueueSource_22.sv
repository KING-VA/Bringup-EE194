...
module AsyncQueueSource_22(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_hrmask_0 = _RANDOM_0[15];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_1 = _RANDOM_0[16];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_0[17];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_0[18];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_0[19];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// @[AsyncQueue.scala:52:25, :80:16]
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_168 ridx_ridx_gray (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_async_ridx),
