...
module OutputUnit_7(
  ...
  wire       _GEN = ~(io_out_vc_free[3]) & states_3_occupied;	// @[OutputUnit.scala:66:19, :74:{25,30}, :76:18]
  wire       _GEN_0 = ~(io_out_vc_free[7]) & states_7_occupied;	// @[OutputUnit.scala:66:19, :74:{25,30}, :76:18]
  always @(posedge clock) begin
    if (reset) begin
      ...
      states_7_occupied <= io_allocs_7_alloc | _GEN_0;	// @[OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18]
      states_7_c <= states_7_c + {2'h0, io_out_credit_return[7]} - {2'h0, io_credit_alloc_7_alloc};	// @[OutputUnit.scala:66:19, :94:36, :97:{18,26}]
      states_3_occupied <= io_allocs_3_alloc | _GEN;	// @[OutputUnit.scala:66:19, :74:30, :76:18, :83:20, :84:18]
  ...
  assign io_channel_status_3_occupied = _GEN;	// @[OutputUnit.scala:66:19, :74:30, :76:18]
  assign io_channel_status_7_occupied = _GEN_0;	// @[OutputUnit.scala:66:19, :74:30, :76:18]
