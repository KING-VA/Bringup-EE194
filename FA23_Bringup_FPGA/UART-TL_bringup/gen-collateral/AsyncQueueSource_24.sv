  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_source = _RANDOM_0[12:10];	// @[AsyncQueue.scala:80:16]
        mem_0_address = {_RANDOM_0[31:13], _RANDOM_1[15:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_data = {_RANDOM_1[31:16], _RANDOM_2, _RANDOM_3[15:0]};	// @[AsyncQueue.scala:80:16]
        mem_0_corrupt = _RANDOM_3[16];	// @[AsyncQueue.scala:80:16]
        mem_1_opcode = _RANDOM_3[19:17];	// @[AsyncQueue.scala:80:16]
        mem_1_param = _RANDOM_3[22:20];	// @[AsyncQueue.scala:80:16]
        mem_1_size = _RANDOM_3[26:23];	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_3[29:27];	// @[AsyncQueue.scala:80:16]
        mem_1_address = {_RANDOM_3[31:30], _RANDOM_4, _RANDOM_5[0]};	// @[AsyncQueue.scala:80:16]
        mem_1_data = {_RANDOM_5[31:1], _RANDOM_6, _RANDOM_7[0]};	// @[AsyncQueue.scala:80:16]
        mem_1_corrupt = _RANDOM_7[1];	// @[AsyncQueue.scala:80:16]
        mem_2_opcode = _RANDOM_7[4:2];	// @[AsyncQueue.scala:80:16]
        mem_2_param = _RANDOM_7[7:5];	// @[AsyncQueue.scala:80:16]
        mem_2_size = _RANDOM_7[11:8];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_7[14:12];	// @[AsyncQueue.scala:80:16]
        mem_2_address = {_RANDOM_7[31:15], _RANDOM_8[17:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_data = {_RANDOM_8[31:18], _RANDOM_9, _RANDOM_10[17:0]};	// @[AsyncQueue.scala:80:16]
        mem_2_corrupt = _RANDOM_10[18];	// @[AsyncQueue.scala:80:16]
        mem_3_opcode = _RANDOM_10[21:19];	// @[AsyncQueue.scala:80:16]
        mem_3_param = _RANDOM_10[24:22];	// @[AsyncQueue.scala:80:16]
        mem_3_size = _RANDOM_10[28:25];	// @[AsyncQueue.scala:80:16]
        mem_3_source = _RANDOM_10[31:29];	// @[AsyncQueue.scala:80:16]
        mem_3_address = {_RANDOM_11, _RANDOM_12[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_data = {_RANDOM_12[31:3], _RANDOM_13, _RANDOM_14[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_3_corrupt = _RANDOM_14[3];	// @[AsyncQueue.scala:80:16]
        mem_4_opcode = _RANDOM_14[6:4];	// @[AsyncQueue.scala:80:16]
        mem_4_param = _RANDOM_14[9:7];	// @[AsyncQueue.scala:80:16]
        mem_4_size = _RANDOM_14[13:10];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_14[16:14];	// @[AsyncQueue.scala:80:16]
        mem_4_address = {_RANDOM_14[31:17], _RANDOM_15[19:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_data = {_RANDOM_15[31:20], _RANDOM_16, _RANDOM_17[19:0]};	// @[AsyncQueue.scala:80:16]
        mem_4_corrupt = _RANDOM_17[20];	// @[AsyncQueue.scala:80:16]
        mem_5_opcode = _RANDOM_17[23:21];	// @[AsyncQueue.scala:80:16]
        mem_5_param = _RANDOM_17[26:24];	// @[AsyncQueue.scala:80:16]
        mem_5_size = _RANDOM_17[30:27];	// @[AsyncQueue.scala:80:16]
        mem_5_source = {_RANDOM_17[31], _RANDOM_18[1:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_address = {_RANDOM_18[31:2], _RANDOM_19[4:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_data = {_RANDOM_19[31:5], _RANDOM_20, _RANDOM_21[4:0]};	// @[AsyncQueue.scala:80:16]
        mem_5_corrupt = _RANDOM_21[5];	// @[AsyncQueue.scala:80:16]
        mem_6_opcode = _RANDOM_21[8:6];	// @[AsyncQueue.scala:80:16]
        mem_6_param = _RANDOM_21[11:9];	// @[AsyncQueue.scala:80:16]
        mem_6_size = _RANDOM_21[15:12];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_21[18:16];	// @[AsyncQueue.scala:80:16]
        mem_6_address = {_RANDOM_21[31:19], _RANDOM_22[21:0]};	// @[AsyncQueue.scala:80:16]
        mem_6_data = {_RANDOM_22[31:22], _RANDOM_23, _RANDOM_24[21:0]};	// @[AsyncQueue.scala:80:16]
        mem_6_corrupt = _RANDOM_24[22];	// @[AsyncQueue.scala:80:16]
        mem_7_opcode = _RANDOM_24[25:23];	// @[AsyncQueue.scala:80:16]
        mem_7_param = _RANDOM_24[28:26];	// @[AsyncQueue.scala:80:16]
        mem_7_size = {_RANDOM_24[31:29], _RANDOM_25[0]};	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_25[3:1];	// @[AsyncQueue.scala:80:16]
        mem_7_address = {_RANDOM_25[31:4], _RANDOM_26[6:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_data = {_RANDOM_26[31:7], _RANDOM_27, _RANDOM_28[6:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_corrupt = _RANDOM_28[7];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_28[11:8];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_28[12];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_28[16:13];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
