...
module TLMonitor_45(
  ...
  wire         _T_1052 = _T_1128 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire [514:0] _a_opcodes_set_T_1 = {511'h0, _T_1052 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, Parameters.scala:52:29]
  wire [526:0] _d_sizes_clr_T_5 = 527'hF << _GEN_4;	// @[Monitor.scala:677:76, :678:74]
  wire [514:0] _a_sizes_set_T_1 = {511'h0, _T_1052 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_3;	// @[Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52, Parameters.scala:52:29]
  wire         _T_1201 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1067 = _T_1201 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_1052 ? _a_set_T[57:0] : 58'h0)) & ~(_T_1067 ? _d_clr_T[57:0] : 58'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1052 ? _a_opcodes_set_T_1[231:0] : 232'h0)) & ~(_T_1067 ? _d_opcodes_clr_T_5[231:0] : 232'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_1052 ? _a_sizes_set_T_1[231:0] : 232'h0)) & ~(_T_1067 ? _d_sizes_clr_T_5[231:0] : 232'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1128 | _T_1201)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_1128 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_1201 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_997 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_1021 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    wire  [231:0]    _GEN_26 = {224'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44, Parameters.scala:54:32]
    wire  [231:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_26;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire             _T_1100 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    ...
    wire  [57:0]     _GEN_27 = {52'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    wire             _GEN_28 = _T_1071 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_29 = _T_1071 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _T_1157 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [57:0]     _T_1053 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [57:0]     _T_1072 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    wire  [231:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_26;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [63:0]     _d_clr_wo_ready_T = 64'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [57:0]     _T_1158 = 58'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [231:0]    _c_size_lookup_T_1 = 232'h0 >> _GEN_26;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[34:16] == 19'h2 | io_in_a_bits_address[34:31] == 4'h1 | io_in_a_bits_address[34:32] == 3'h1 | io_in_a_bits_address[34:33] == 2'h1 | io_in_a_bits_address[34:31] == 4'h8))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:54:32, :92:42, :137:{31,65}, :670:56, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(((&(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h2 & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h1 & io_in_a_bits_source[3:0] < 4'hA | ~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA) & io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[34:31] == 4'h1 | io_in_a_bits_address[34:32] == 3'h1 | io_in_a_bits_address[34:33] == 2'h1 | io_in_a_bits_address[34:31] == 4'h8))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(((&(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h2 & io_in_a_bits_source[3:0] < 4'hA | io_in_a_bits_source[5:4] == 2'h1 & io_in_a_bits_source[3:0] < 4'hA | ~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'hA) & io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[34:31] == 4'h1 | io_in_a_bits_address[34:32] == 3'h1 | io_in_a_bits_address[34:33] == 2'h1 | io_in_a_bits_address[34:31] == 4'h8))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1100 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1100 & ~d_release_ack ? _d_clr_wo_ready_T[57:0] : 58'h0) | a_set_wo_ready == 58'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 3 (connected at MemoryBus.scala:47:50)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      ...
      if (_T_1157 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin	// @[Monitor.scala:49:11, :747:42, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at MemoryBus.scala:47:50)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
