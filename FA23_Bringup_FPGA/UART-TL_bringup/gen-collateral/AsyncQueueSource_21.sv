  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        mem_0_sink = _RANDOM_0[4:0];	// @[AsyncQueue.scala:80:16]
        mem_1_sink = _RANDOM_0[9:5];	// @[AsyncQueue.scala:80:16]
        mem_2_sink = _RANDOM_0[14:10];	// @[AsyncQueue.scala:80:16]
        mem_3_sink = _RANDOM_0[19:15];	// @[AsyncQueue.scala:80:16]
        mem_4_sink = _RANDOM_0[24:20];	// @[AsyncQueue.scala:80:16]
        mem_5_sink = _RANDOM_0[29:25];	// @[AsyncQueue.scala:80:16]
        mem_6_sink = {_RANDOM_0[31:30], _RANDOM_1[2:0]};	// @[AsyncQueue.scala:80:16]
        mem_7_sink = _RANDOM_1[7:3];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_1[11:8];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_1[12];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_1[16:13];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
