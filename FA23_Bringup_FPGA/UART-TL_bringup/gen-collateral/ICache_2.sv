...
module ICache_2(
  ...
  input  [34:0] io_s1_paddr,
  input         io_s1_kill,
                io_s2_kill,
                io_invalidate,
  output        auto_master_out_a_valid,
  output [34:0] auto_master_out_a_bits_address,
  ...
  wire [91:0]  _tag_array_RW0_rdata;	// @[icache.scala:156:30]
  ...
  reg  [34:0]  refill_paddr;	// @[Reg.scala:19:16]
  ...
  wire         s1_tag_hit_0 = _s1_vb_T_1[0] & _tag_array_RW0_rdata[22:0] == io_s1_paddr[34:12];	// @[icache.scala:156:30, :177:29, :178:25, :180:{28,35}]
  wire [255:0] _s1_vb_T_3 = vb_array >> {250'h1, io_s1_paddr[11:6]};	// @[icache.scala:162:25, :176:29, :178:25]
  wire         s1_tag_hit_1 = _s1_vb_T_3[0] & _tag_array_RW0_rdata[45:23] == io_s1_paddr[34:12];	// @[icache.scala:156:30, :177:29, :178:25, :180:{28,35}]
  wire [255:0] _s1_vb_T_5 = vb_array >> {250'h2, io_s1_paddr[11:6]};	// @[icache.scala:162:25, :176:29, :178:25]
  wire         s1_tag_hit_2 = _s1_vb_T_5[0] & _tag_array_RW0_rdata[68:46] == io_s1_paddr[34:12];	// @[icache.scala:156:30, :177:29, :178:25, :180:{28,35}]
  wire [255:0] _s1_vb_T_7 = vb_array >> {250'h3, io_s1_paddr[11:6]};	// @[icache.scala:162:25, :176:29, :178:25]
  wire         s1_tag_hit_3 = _s1_vb_T_7[0] & _tag_array_RW0_rdata[91:69] == io_s1_paddr[34:12];	// @[icache.scala:156:30, :177:29, :178:25, :180:{28,35}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        refill_paddr = {_RANDOM_0[31:6], _RANDOM_1[8:0]};	// @[Reg.scala:19:16, icache.scala:131:25]
        counter = _RANDOM_1[17:9];	// @[Edges.scala:228:27, Reg.scala:19:16]
        vb_array = {_RANDOM_1[31:18], _RANDOM_2, _RANDOM_3, _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9[17:0]};	// @[Reg.scala:19:16, icache.scala:162:25]
        s2_dout_0_REG = {_RANDOM_9[31:18], _RANDOM_10, _RANDOM_11[17:0]};	// @[icache.scala:162:25, :234:30]
        s2_dout_1_REG = {_RANDOM_11[31:18], _RANDOM_12, _RANDOM_13[17:0]};	// @[icache.scala:234:30]
        s2_dout_2_REG = {_RANDOM_13[31:18], _RANDOM_14, _RANDOM_15[17:0]};	// @[icache.scala:234:30]
        s2_dout_3_REG = {_RANDOM_15[31:18], _RANDOM_16, _RANDOM_17[17:0]};	// @[icache.scala:234:30]
        s2_tag_hit_0 = _RANDOM_17[18];	// @[icache.scala:234:30, :305:27]
        s2_tag_hit_1 = _RANDOM_17[19];	// @[icache.scala:234:30, :305:27]
        s2_tag_hit_2 = _RANDOM_17[20];	// @[icache.scala:234:30, :305:27]
        s2_tag_hit_3 = _RANDOM_17[21];	// @[icache.scala:234:30, :305:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  MaxPeriodFibonacciLFSR_4 repl_way_prng (	// @[PRNG.scala:91:22]
    .clock        (clock),
    .reset        (reset),
  ...
  tag_array_3 tag_array (	// @[icache.scala:156:30]
    ...
    .RW0_wdata ({4{refill_paddr[34:12]}}),	// @[Reg.scala:19:16, icache.scala:143:32, :156:30]
  ...
  assign auto_master_out_a_bits_address = {refill_paddr[34:6], 6'h0};	// @[Reg.scala:19:16, icache.scala:330:{31,48}]
