...
module Frontend(
  ...
  wire [34:0] _tlb_io_resp_paddr;	// @[Frontend.scala:100:19]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tlb_resp_pf_inst = _RANDOM_6[31];	// @[Frontend.scala:116:24]
        s2_tlb_resp_gf_inst = _RANDOM_7[3];	// @[Frontend.scala:116:24]
        s2_tlb_resp_ae_inst = _RANDOM_7[7];	// @[Frontend.scala:116:24]
        s2_tlb_resp_cacheable = _RANDOM_7[13];	// @[Frontend.scala:116:24]
        s2_speculative = _RANDOM_7[16];	// @[Frontend.scala:116:24, :118:31]
        s2_partial_insn_valid = _RANDOM_7[17];	// @[Frontend.scala:116:24, :119:38]
        s2_partial_insn = {_RANDOM_7[31:18], _RANDOM_8[1:0]};	// @[Frontend.scala:116:24, :120:28]
        wrong_path = _RANDOM_8[2];	// @[Frontend.scala:120:28, :121:27]
        s2_replay_REG = _RANDOM_8[3];	// @[Frontend.scala:120:28, :129:56]
        recent_progress_counter = _RANDOM_8[5:4];	// @[Frontend.scala:120:28, :150:40]
        fq_io_enq_valid_REG = _RANDOM_8[6];	// @[Frontend.scala:120:28, :179:29]
        gpa_valid = _RANDOM_8[7];	// @[Frontend.scala:120:28, :348:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
