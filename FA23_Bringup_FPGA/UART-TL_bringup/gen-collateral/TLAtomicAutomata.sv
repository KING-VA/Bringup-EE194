  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_address = {_RANDOM_0[31:17], _RANDOM_1[13:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        ...
        beatsLeft = {_RANDOM_5[31:30], _RANDOM_6[0]};	// @[Arbiter.scala:87:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[1];	// @[Arbiter.scala:87:30, :116:26]
        state_1 = _RANDOM_6[2];	// @[Arbiter.scala:87:30, :116:26]
        d_first_counter = _RANDOM_6[5:3];	// @[Arbiter.scala:87:30, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
