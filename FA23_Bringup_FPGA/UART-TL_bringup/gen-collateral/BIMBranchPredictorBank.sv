...
module BIMBranchPredictorBank(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        doing_reset = _RANDOM_11[18];	// @[bim.scala:44:28, predictor.scala:185:30]
        reset_idx = _RANDOM_11[29:19];	// @[bim.scala:45:26, predictor.scala:185:30]
        s2_req_rdata_0 = _RANDOM_11[31:30];	// @[bim.scala:54:32, predictor.scala:185:30]
        s2_req_rdata_1 = _RANDOM_12[1:0];	// @[bim.scala:54:32]
        s2_req_rdata_2 = _RANDOM_12[3:2];	// @[bim.scala:54:32]
        s2_req_rdata_3 = _RANDOM_12[5:4];	// @[bim.scala:54:32]
        wrbypass_idxs_0 = _RANDOM_12[16:6];	// @[bim.scala:54:32, :70:26]
        wrbypass_idxs_1 = _RANDOM_12[27:17];	// @[bim.scala:54:32, :70:26]
        wrbypass_0_0 = _RANDOM_12[29:28];	// @[bim.scala:54:32, :71:26]
        wrbypass_0_1 = _RANDOM_12[31:30];	// @[bim.scala:54:32, :71:26]
        wrbypass_0_2 = _RANDOM_13[1:0];	// @[bim.scala:71:26]
        wrbypass_0_3 = _RANDOM_13[3:2];	// @[bim.scala:71:26]
        wrbypass_1_0 = _RANDOM_13[5:4];	// @[bim.scala:71:26]
        wrbypass_1_1 = _RANDOM_13[7:6];	// @[bim.scala:71:26]
        wrbypass_1_2 = _RANDOM_13[9:8];	// @[bim.scala:71:26]
        wrbypass_1_3 = _RANDOM_13[11:10];	// @[bim.scala:71:26]
        wrbypass_enq_idx = _RANDOM_13[12];	// @[bim.scala:71:26, :72:33]
        io_resp_f3_0_taken_REG = _RANDOM_13[13];	// @[bim.scala:71:26, :128:35]
        io_resp_f3_1_taken_REG = _RANDOM_13[14];	// @[bim.scala:71:26, :128:35]
        io_resp_f3_2_taken_REG = _RANDOM_13[15];	// @[bim.scala:71:26, :128:35]
        io_resp_f3_3_taken_REG = _RANDOM_13[16];	// @[bim.scala:71:26, :128:35]
        io_f3_meta_REG = _RANDOM_13[24:17];	// @[bim.scala:71:26, :130:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_f3_meta = {42'h0, io_f3_meta_REG};	// @[bim.scala:130:{14,24}]
endmodule
