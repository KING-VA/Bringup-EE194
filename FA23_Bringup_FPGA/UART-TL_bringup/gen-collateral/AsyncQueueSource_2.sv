  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_1_param = _RANDOM_3[27:26];	// @[AsyncQueue.scala:80:16]
        mem_1_size = _RANDOM_3[31:28];	// @[AsyncQueue.scala:80:16]
        mem_1_source = _RANDOM_4[1:0];	// @[AsyncQueue.scala:80:16]
        ...
        mem_2_param = _RANDOM_7[18:17];	// @[AsyncQueue.scala:80:16]
        mem_2_size = _RANDOM_7[22:19];	// @[AsyncQueue.scala:80:16]
        mem_2_source = _RANDOM_7[24:23];	// @[AsyncQueue.scala:80:16]
        ...
        mem_3_param = _RANDOM_11[9:8];	// @[AsyncQueue.scala:80:16]
        mem_3_size = _RANDOM_11[13:10];	// @[AsyncQueue.scala:80:16]
        mem_3_source = _RANDOM_11[15:14];	// @[AsyncQueue.scala:80:16]
        ...
        mem_4_param = {_RANDOM_14[31], _RANDOM_15[0]};	// @[AsyncQueue.scala:80:16]
        mem_4_size = _RANDOM_15[4:1];	// @[AsyncQueue.scala:80:16]
        mem_4_source = _RANDOM_15[6:5];	// @[AsyncQueue.scala:80:16]
        ...
        mem_5_param = _RANDOM_18[23:22];	// @[AsyncQueue.scala:80:16]
        mem_5_size = _RANDOM_18[27:24];	// @[AsyncQueue.scala:80:16]
        mem_5_source = _RANDOM_18[29:28];	// @[AsyncQueue.scala:80:16]
        ...
        mem_6_param = _RANDOM_22[14:13];	// @[AsyncQueue.scala:80:16]
        mem_6_size = _RANDOM_22[18:15];	// @[AsyncQueue.scala:80:16]
        mem_6_source = _RANDOM_22[20:19];	// @[AsyncQueue.scala:80:16]
        ...
        mem_7_param = _RANDOM_26[5:4];	// @[AsyncQueue.scala:80:16]
        mem_7_size = _RANDOM_26[9:6];	// @[AsyncQueue.scala:80:16]
        mem_7_source = _RANDOM_26[11:10];	// @[AsyncQueue.scala:80:16]
