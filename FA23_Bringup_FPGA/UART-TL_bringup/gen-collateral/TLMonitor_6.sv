...
module TLMonitor_6(
  ...
  wire         _T_907 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_838 = _T_907 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  wire         d_release_ack = io_in_d_bits_opcode == 3'h6;	// @[Monitor.scala:670:46, Parameters.scala:46:9]
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_838 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << _GEN_1;	// @[Monitor.scala:42:11, :632:35, :643:40, :652:{27,72}, :654:{28,53}, :656:54]
  wire [270:0] _d_sizes_clr_T_5 = 271'hF << _GEN_2;	// @[Monitor.scala:677:76, :678:74]
  wire [258:0] _a_sizes_set_T_1 = {255'h0, _T_838 ? {io_in_a_bits_size, 1'h1} : 4'h0} << _GEN_1;	// @[Monitor.scala:42:11, :632:35, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire         _T_975 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_853 = _T_975 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_907) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_975) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_838 ? _a_set_T[16:0] : 17'h0)) & ~(_T_853 ? _d_clr_T[16:0] : 17'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_838 ? _a_opcodes_set_T_1[67:0] : 68'h0)) & ~(_T_853 ? _d_opcodes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :725:35]
      inflight_sizes <= (inflight_sizes | (_T_838 ? _a_sizes_set_T_1[67:0] : 68'h0)) & ~(_T_853 ? _d_sizes_clr_T_5[67:0] : 68'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_907 | _T_975)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26, OneHot.scala:57:35]
    end
    if (_T_907 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_975 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _WIRE_2_1 = io_in_a_bits_source == 5'h4;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_2 = io_in_a_bits_source == 5'h5;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_3 = io_in_a_bits_source == 5'h6;	// @[Parameters.scala:46:9]
    wire             _WIRE_2_4 = io_in_a_bits_source == 5'h0;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_5 = io_in_a_bits_source == 5'h1;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_6 = io_in_a_bits_source == 5'h2;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_7 = io_in_a_bits_source == 5'h10;	// @[Parameters.scala:46:9]
    wire             source_ok = _source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7;	// @[Parameters.scala:46:9, :1125:46]
    ...
    wire             _T_274 = io_in_a_bits_size > 3'h2;	// @[Misc.scala:205:21, Monitor.scala:640:42]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Misc.scala:208:26, OneHot.scala:63:49, Parameters.scala:46:9]
    wire             mask_acc = _T_274 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_274 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire             _GEN_6 = io_in_a_valid & io_in_a_bits_opcode == 3'h6;	// @[Monitor.scala:81:{25,54}, Parameters.scala:46:9]
    wire             _T_126 = io_in_a_bits_size == 3'h6;	// @[Parameters.scala:46:9, :91:48]
    ...
    wire             _T_234 = io_in_a_bits_size == 3'h6;	// @[Parameters.scala:46:9, :91:48]
    ...
    wire             source_ok_1 = io_in_d_bits_source == 5'h8 | io_in_d_bits_source == 5'h4 | io_in_d_bits_source == 5'h5 | io_in_d_bits_source == 5'h6 | io_in_d_bits_source == 5'h0 | io_in_d_bits_source == 5'h1 | io_in_d_bits_source == 5'h2 | io_in_d_bits_source == 5'h10;	// @[Parameters.scala:46:9, :1125:46]
    wire             _GEN_16 = io_in_d_valid & io_in_d_bits_opcode == 3'h6;	// @[Monitor.scala:310:{25,52}, Parameters.scala:46:9]
    ...
    wire             _T_783 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_807 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    ...
    wire             _T_886 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    wire             _T_857 = _T_886 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    ...
    wire             _GEN_26 = _T_857 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_27 = _T_857 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _T_936 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [16:0]     _T_839 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [16:0]     _T_858 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    wire  [67:0]     _a_size_lookup_T_1 = inflight_sizes >> _GEN_24;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [16:0]     _T_937 = 17'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~((_WIRE_2_1 & _T_126 | _WIRE_2_4 & _T_126) & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:54, :83:78, Mux.scala:27:73, Parameters.scala:46:9, :91:48, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_274) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~((_WIRE_2_1 & _T_234 | _WIRE_2_4 & _T_234) & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, Mux.scala:27:73, Parameters.scala:46:9, :91:48, :137:{31,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~_T_274) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7)) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~((_source_ok_WIRE_0 | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _source_ok_WIRE_7) & io_in_a_bits_size != 3'h7 & (io_in_a_bits_address[30:12] == 19'h4 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :92:42, :137:{31,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_886 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_936 & ~reset & ~(_T_937[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_936 & ~reset & io_in_d_bits_size != _c_size_lookup_T_1[3:1]) begin	// @[Monitor.scala:49:11, :747:42, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:54:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
