...
module IngressUnit_5(
  ...
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_2 = io_in_bits_egress_id == 5'h13;	// @[IngressUnit.scala:30:72]
  wire        _route_buffer_io_enq_bits_flow_egress_node_id_T_3 = io_in_bits_egress_id == 5'h16;	// @[IngressUnit.scala:30:72]
  wire [2:0]  _route_buffer_io_enq_bits_flow_egress_node_WIRE = {_route_buffer_io_enq_bits_flow_egress_node_id_T, 2'h0} | (_route_buffer_io_enq_bits_flow_egress_node_id_T_1 ? 3'h5 : 3'h0) | (_route_buffer_io_enq_bits_flow_egress_node_id_T_2 ? 3'h6 : 3'h0) | {3{_route_buffer_io_enq_bits_flow_egress_node_id_T_3}};	// @[IngressUnit.scala:30:72, Mux.scala:27:73]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[IngressUnit.scala:30:9]
      if (~reset & io_in_valid & ~(_route_buffer_io_enq_bits_flow_egress_node_id_T | _route_buffer_io_enq_bits_flow_egress_node_id_T_1 | _route_buffer_io_enq_bits_flow_egress_node_id_T_2 | _route_buffer_io_enq_bits_flow_egress_node_id_T_3)) begin	// @[IngressUnit.scala:30:{9,27,72}, package.scala:73:59]
  ...
  Queue_10 route_buffer (	// @[IngressUnit.scala:26:28]
    ...
    .io_enq_bits_flow_ingress_node_id (3'h2),
    ...
    .io_enq_bits_flow_egress_node_id  ({1'h0, _route_buffer_io_enq_bits_flow_egress_node_id_T | _route_buffer_io_enq_bits_flow_egress_node_id_T_1 | _route_buffer_io_enq_bits_flow_egress_node_id_T_2 | _route_buffer_io_enq_bits_flow_egress_node_id_T_3, 1'h0}),	// @[IngressUnit.scala:30:72, :45:50, Mux.scala:27:73]
  ...
  Queue_11 route_q (	// @[IngressUnit.scala:27:23]
    ...
    .io_enq_bits_vc_sel_0_1 (~_T_15),	// @[IngressUnit.scala:63:23, :64:{41,53}, :66:52]
