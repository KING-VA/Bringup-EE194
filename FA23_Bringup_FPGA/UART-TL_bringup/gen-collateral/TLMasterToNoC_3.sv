...
module TLMasterToNoC_3(
  ...
  input  [34:0] io_tilelink_a_bits_address,
  ...
  input  [34:0] io_tilelink_c_bits_address,
  input  [63:0] io_tilelink_c_bits_data,
  input         io_tilelink_c_bits_corrupt,
                io_tilelink_d_ready,
                io_tilelink_e_valid,
  input  [4:0]  io_tilelink_e_bits_sink,
  ...
  output [34:0] io_tilelink_b_bits_address,
  ...
  output [4:0]  io_flits_c_bits_egress_id,
  output        io_flits_d_ready,
                io_flits_e_valid,
                io_flits_e_bits_head,
  output [72:0] io_flits_e_bits_payload,
  output [4:0]  io_flits_e_bits_egress_id
);

  wire [4:0]  _e_io_flit_bits_payload;	// @[Tilelink.scala:225:17]
  ...
  TLBFromNoC_1 b (	// @[Tilelink.scala:222:17]
    .clock                    (clock),
    .reset                    (reset),
  ...
  TLCToNoC_1 c (	// @[Tilelink.scala:223:17]
    .clock                    (clock),
    .reset                    (reset),
  ...
  assign io_tilelink_b_bits_source = {2'h0, _b_io_protocol_bits_source[2:0]};	// @[Tilelink.scala:219:67, :222:17, :229:29]
  assign io_tilelink_d_bits_source = {2'h0, _d_io_protocol_bits_source[2:0]};	// @[Tilelink.scala:219:67, :224:17, :229:29, :233:29]
  assign io_flits_c_bits_payload = {8'h0, _c_io_flit_bits_payload};	// @[Tilelink.scala:223:17, :238:14]
  assign io_flits_e_bits_payload = {68'h0, _e_io_flit_bits_payload};	// @[Tilelink.scala:225:17, :240:14]
endmodule
