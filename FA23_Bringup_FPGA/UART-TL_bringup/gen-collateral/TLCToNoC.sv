...
module TLCToNoC(
  ...
  Queue_202 q (	// @[Tilelink.scala:45:17]
    ...
    .io_enq_bits_source  (5'h10),
    .io_enq_bits_address (35'h0),
  ...
  assign io_flit_bits_head = 1'h1;	// @[Tilelink.scala:63:38]
  assign io_flit_bits_payload = {15'h0, _q_io_deq_bits_opcode, _q_io_deq_bits_param, _q_io_deq_bits_size, _q_io_deq_bits_source, _q_io_deq_bits_address};	// @[Tilelink.scala:45:17, :68:33]
endmodule
