	platform_axi_bridge_0 #(
		...
		.s0_awid    (_connected_to_s0_awid_),    //   input,   width = 4,        s0.awid
		...
		.s0_bid     (_connected_to_s0_bid_),     //  output,   width = 4,          .bid
		...
		.s0_arid    (_connected_to_s0_arid_),    //   input,   width = 4,          .arid
		...
		.s0_rid     (_connected_to_s0_rid_),     //  output,   width = 4,          .rid
		...
		.m0_awid    (_connected_to_m0_awid_),    //  output,   width = 4,        m0.awid
		...
		.m0_bid     (_connected_to_m0_bid_),     //   input,   width = 4,          .bid
		...
		.m0_arid    (_connected_to_m0_arid_),    //  output,   width = 4,          .arid
		...
		.m0_rid     (_connected_to_m0_rid_),     //   input,   width = 4,          .rid
