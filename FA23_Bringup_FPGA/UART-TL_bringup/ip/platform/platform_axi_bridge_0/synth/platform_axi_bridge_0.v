...
module platform_axi_bridge_0 #(
	...
	platform_axi_bridge_0_altera_axi_bridge_1931_vhmf6ra #(
		...
		.s0_awid     (s0_awid),                                                              //   input,   width = 4,        s0.awid
		...
		.s0_rid      (s0_rid),                                                               //  output,   width = 4,          .rid
		...
		.m0_awid     (m0_awid),                                                              //  output,   width = 4,        m0.awid
		...
		.m0_rid      (m0_rid),                                                               //   input,   width = 4,          .rid
