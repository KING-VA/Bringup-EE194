module memory_axi_bridge_0 #(
		...
		parameter WRITE_ADDR_USER_WIDTH = 64,
		parameter READ_ADDR_USER_WIDTH  = 64,
		parameter WRITE_DATA_USER_WIDTH = 64,
		parameter WRITE_RESP_USER_WIDTH = 64,
		parameter READ_DATA_USER_WIDTH  = 64,
		...
		input  wire [34:0] s0_awaddr,  //          .awaddr
		...
		input  wire [31:0] s0_wdata,   //          .wdata
		input  wire [3:0]  s0_wstrb,   //          .wstrb
		...
		input  wire [34:0] s0_araddr,  //          .araddr
		...
		output wire [31:0] s0_rdata,   //          .rdata
		...
		output wire [34:0] m0_awaddr,  //          .awaddr
		...
		output wire [31:0] m0_wdata,   //          .wdata
		output wire [3:0]  m0_wstrb,   //          .wstrb
		...
		output wire [34:0] m0_araddr,  //          .araddr
		...
		input  wire [31:0] m0_rdata,   //          .rdata
