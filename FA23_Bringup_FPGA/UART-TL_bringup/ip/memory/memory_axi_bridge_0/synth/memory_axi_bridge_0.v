...
module memory_axi_bridge_0 #(
	...
	memory_axi_bridge_0_altera_axi_bridge_1931_vhmf6ra #(
		...
		.s0_awaddr   (s0_awaddr),                                                            //   input,  width = 35,          .awaddr
		...
		.s0_wdata    (s0_wdata),                                                             //   input,  width = 32,          .wdata
		.s0_wstrb    (s0_wstrb),                                                             //   input,   width = 4,          .wstrb
		...
		.s0_araddr   (s0_araddr),                                                            //   input,  width = 35,          .araddr
		...
		.s0_rdata    (s0_rdata),                                                             //  output,  width = 32,          .rdata
		...
		.m0_awaddr   (m0_awaddr),                                                            //  output,  width = 35,          .awaddr
		...
		.m0_wdata    (m0_wdata),                                                             //  output,  width = 32,          .wdata
		.m0_wstrb    (m0_wstrb),                                                             //  output,   width = 4,          .wstrb
		...
		.m0_araddr   (m0_araddr),                                                            //  output,  width = 35,          .araddr
		...
		.m0_rdata    (m0_rdata),                                                             //   input,  width = 32,          .rdata
