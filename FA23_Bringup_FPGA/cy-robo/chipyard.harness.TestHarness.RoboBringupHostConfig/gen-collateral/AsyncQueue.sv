...
module AsyncQueue(
  ...
  output io_enq_ready,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
         io_deq_valid,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  ...
  AsyncQueueSource source (	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .clock                        (io_enq_clock),
    .reset                        (io_enq_reset),
  ...
  AsyncQueueSink sink (	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:225:70]
    .clock                        (io_deq_clock),
    .reset                        (io_deq_reset),
