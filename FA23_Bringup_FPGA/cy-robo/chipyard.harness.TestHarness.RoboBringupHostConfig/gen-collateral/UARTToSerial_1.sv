...
module UARTToSerial_1(
  input        clock,
               reset,
               io_uart_rxd,	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:108:14]
               io_serial_in_valid,	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:108:14]
  ...
  output       io_uart_txd,	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:108:14]
               io_serial_in_ready,	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:108:14]
               io_serial_out_valid,	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:108:14]
  ...
  wire       _txm_io_tx_busy;	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:116:19]
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      dropped <= _rxm_io_out_valid & ~_rxq_io_enq_ready | dropped;	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:114:19, :115:19, :121:24, :129:{26,29,48,58}]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        dropped = _RANDOM_0[0];	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:121:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  UARTRx_TestHarness_UNIQUIFIED rxm (	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:114:19]
    .clock        (clock),
    .reset        (reset),
    .io_en        (1'h1),	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:123:13]
    .io_in        (io_uart_rxd),
    .io_div       (16'h6C),	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:125:14]
    .io_out_valid (_rxm_io_out_valid),
    .io_out_bits  (_rxm_io_out_bits)
  );
  Queue_6_TestHarness_UNIQUIFIED rxq (	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:115:19]
    .clock        (clock),
    .reset        (reset),
  ...
  UARTTx_TestHarness_UNIQUIFIED txm (	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:116:19]
    .clock       (clock),
    .reset       (reset),
    .io_en       (1'h1),	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:123:13]
    ...
    .io_div      (16'h6C),	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:125:14]
    .io_nstop    (1'h0),	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:121:24]
    .io_in_ready (_txm_io_in_ready),
    .io_out      (io_uart_txd),
    .io_tx_busy  (_txm_io_tx_busy)
  );
  Queue_6_TestHarness_UNIQUIFIED txq (	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:117:19]
    .clock        (clock),
    .reset        (reset),
