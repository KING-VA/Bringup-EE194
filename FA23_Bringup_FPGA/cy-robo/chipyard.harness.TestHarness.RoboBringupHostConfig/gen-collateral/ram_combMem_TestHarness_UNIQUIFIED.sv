...
module ram_combMem_TestHarness_UNIQUIFIED(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [2:0] R0_addr,
  input        R0_en,
               R0_clk,
  input  [2:0] W0_addr,
  ...
  `ifndef SYNTHESIS	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      integer initvar;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
