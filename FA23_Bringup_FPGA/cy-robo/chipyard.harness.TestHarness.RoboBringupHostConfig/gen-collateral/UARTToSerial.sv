...
module UARTToSerial(
  ...
  UARTRx rxm (	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:114:19]
    ...
    .io_in        (io_uart_rxd),
    .io_div       (16'h36),	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:125:14]
    .io_out_valid (_rxm_io_out_valid),
    .io_out_bits  (_rxm_io_out_bits)
  );
  Queue_6 rxq (	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:115:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_6 txq (	// @[generators/testchipip/src/main/scala/UARTAdapter.scala:117:19]
    .clock        (clock),
    .reset        (reset),
