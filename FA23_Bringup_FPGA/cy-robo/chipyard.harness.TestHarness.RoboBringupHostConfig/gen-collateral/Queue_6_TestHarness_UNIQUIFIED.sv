...
module Queue_6_TestHarness_UNIQUIFIED(
  input        clock,
               reset,
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        enq_ptr_value = _RANDOM_0[2:0];	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM_0[5:3];	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM_0[6];	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:277:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_TestHarness_UNIQUIFIED ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
