...
module Queue_2(
  ...
  input  [30:0] io_enq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [30:0] io_deq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        maybe_full = _RANDOM_0[2];	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:277:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[43:13];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
