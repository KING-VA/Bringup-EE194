...
module TLBroadcastTracker_2(
  input         clock,
                ...
                io_in_a_valid,	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:401:14]
  ...
  input  [32:0] io_in_a_bits_address,	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:401:14]
  ...
  output        io_in_a_ready,	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:401:14]
                io_out_a_valid,	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:401:14]
  ...
  output [32:0] io_out_a_bits_address,	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:401:14]
  ...
  output [26:0] io_line,	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:401:14]
  ...
  reg  [32:0] address;	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:433:24]
  wire        idle = got_e & sent_d;	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :425:24, :436:23]
  wire        _T_1 = _io_in_a_ready_output & io_in_a_valid & io_in_a_first;	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:438:22, :486:45]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      sent_d <= 1'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :425:24]
      address <= 33'h80;	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:433:24]
    end
    else begin
      if (_T_1) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:438:22]
      ...
      sent_d <= io_d_last | ~_T_1 & sent_d;	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:425:24, :438:{22,40}, :440:13, :459:20, :461:12]
    end
    shared <= ~_T_1 & shared;	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:425:24, :426:20, :438:{22,40}, :440:13, :441:13]
    if (_T_1) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:438:22]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:439:12]
      if (_T_1 & ~reset & ~idle) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:436:23, :438:22, :439:12]
      ...
      if (io_d_last & ~reset & sent_d) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:425:24, :460:12]
      ...
      if (io_probedack & ~reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:469:12]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        got_e = _RANDOM_0[0];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24]
        sent_d = _RANDOM_0[1];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :425:24]
        shared = _RANDOM_1[18];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:426:20]
        opcode = _RANDOM_0[5:3];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :427:20]
        param = _RANDOM_0[8:6];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :428:20]
        size = _RANDOM_0[11:9];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :429:20]
        source = _RANDOM_0[16:12];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :430:20]
        address = {_RANDOM_0[31:17], _RANDOM_1[17:0]};	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :426:20, :433:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_42 o_data_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:376:21]
    .clock            (clock),
    .reset            (reset),
  ...
  assign io_out_a_bits_source = {acquire ? {1'h1, ~shared} : 2'h0, source};	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:424:24, :426:20, :430:20, :492:52, :494:22, :501:{31,35}]
  ...
  assign io_line = address[32:6];	// @[generators/rocket-chip/src/main/scala/tilelink/Broadcast.scala:433:24, :480:22]
